...
- [Referencia de VBA para PowerPoint](https://docs.microsoft.com/office/vba/api/overview/powerpoint)
...
- [Introducción a los complementos de PowerPoint](https://docs.microsoft.com/office/dev/add-ins/quickstarts/powerpoint-quickstart?tabs=visual-studio)
  
- [Información general sobre la plataforma](https://docs.microsoft.com/office/dev/add-ins/overview/office-add-ins)
  
### <a name="code-samples"></a>Ejemplos de código
  
- [Ejemplos de código de PowerPoint en el Centro para desarrolladores de Office](https://developer.microsoft.com/office/gallery/?filterBy=Samples,PowerPoint)

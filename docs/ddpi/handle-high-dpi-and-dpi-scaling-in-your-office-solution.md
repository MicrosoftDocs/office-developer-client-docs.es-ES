...
- [El desarrollo de una Per-Monitor DPI-Aware WPF proporciona](https://docs.microsoft.com/windows/desktop/hidpi/declaring-managed-apps-dpi-aware) una introducción general y una guía para escribir aplicaciones de escritorio win32. Muchas de las mismas técnicas descritas en este artículo se aplicarán a las soluciones de extensibilidad de Office.
- 

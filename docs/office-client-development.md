...
- [Referencia de la biblioteca de objetos de VBA de Office](https://msdn.microsoft.com/EN-US/library/office/ff862474.aspx)
...
- [Información general sobre la plataforma](https://msdn.microsoft.com/library/office/fp179930.aspx)
  
### <a name="visual-studio-tools-for-office"></a>Visual Studio Tools para Office
  
- [Complementos VSTO para Office](https://msdn.microsoft.com/library/jj620922.aspx)
...
- [Office compartido](https://msdn.microsoft.com/library/hh872753.aspx)
  
- [OneNote](https://msdn.microsoft.com/library/jj680121.aspx) (API solo para soluciones de cliente de escritorio de OneNote Win32 en escenarios no relacionados) 

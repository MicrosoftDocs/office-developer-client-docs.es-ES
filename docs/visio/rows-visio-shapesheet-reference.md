...
- [Fila Actions (sección de acciones)](actions-row-actions-section.md)
    
- [Fila ArcTo (Sección de geometría)](arcto-row-geometry-section.md)
    
- [Fila Puntos de conexión (Sección de puntos de conexión)](connection-points-row-connection-points-section.md)
    
- [Fila Controls (Sección de controles)](controls-row-controls-section.md)
    
- [Fila Ellipse (Sección de Geometría)](ellipse-row-geometry-section.md)
...
- [Fila InfiniteLine (Sección de Geometría)](infiniteline-row-geometry-section.md)
    
- [Fila LineTo (Sección de Geometría)](lineto-row-geometry-section.md)
    
- [Fila MoveTo (Sección de Geometría)](moveto-row-geometry-section.md)
    
- [Fila NURBSTo (Sección de Geometría)](nurbsto-row-geometry-section.md)
...
- [Fila Smart Tags (sección de etiquetas de acción)](smart-tags-row-action-tags-section.md)
    
- [Fila SplineKnot (Sección de Geometría)](splineknot-row-geometry-section.md)
    
- [Fila SplineStart (Sección de Geometría)](splinestart-row-geometry-section.md)
    
- [Fila User-defined Cells (Sección de celdas definidas por el usuario)](user-defined-cells-row-user-defined-cells-section.md)

...
---
# <a name="authorentrytype-complextype-visio-xml"></a>AuthorEntry_Type complexType ('XML de Visio')
...
|Initials  <br/> |xsd: String  <br/> |opcional  <br/> ||Valores del tipo XSD: String.  <br/> |

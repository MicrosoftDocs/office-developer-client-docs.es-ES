...
También puede establecer el valor de esta celda  para una forma determinada en la ficha [](run-in-developer-mode-display-the-developer-tab.md) Ubicación del cuadro  de diálogo Comportamiento (con una  forma seleccionada, en la ficha Programador, en el grupo Diseño de formas, haga clic en Comportamiento y, a continuación, haga clic en la ficha Ubicación).  
  
Para establecer este comportamiento para  *todas las*  formas de la página de dibujo, use la celda PlowCode en la sección Diseño de página. 

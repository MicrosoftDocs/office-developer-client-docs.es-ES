...
---
# <a name="yrulerorigin-cell-ruler-amp-grid-section"></a>Celda YRulerOrigin (sección Cuadrícula &amp; de regla)

Especifica el punto cero de la regla del eje y en la página.
  
## <a name="remarks"></a>Comentarios

Esta celda corresponde a la opción vertical **Regla cero** en el cuadro de diálogo Cuadrícula de reglas (en la ficha **Ver,** haga clic en **la flecha** Mostrar). **&amp;** 
...
|Índice de celda:  <br/> |**visYRulerOrigin** <br/> |

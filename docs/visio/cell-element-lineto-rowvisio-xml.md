...
Contiene x- o coordenadas y del vértice del extremo de un segmento de línea recta.
...
|:-----|:-----|:-----|
|[Elemento de fila (geometría)](row-element-geometry-sectionvisio-xml.md) <br/> |[LineTo_Type](lineto_type-complextypevisio-xml.md) <br/> |Contiene x- o coordenadas y del vértice del extremo de un segmento de línea recta.  <br/> |

...
También puede establecer este valor mediante el control deslizante en la ficha **fuente** del cuadro de diálogo **texto** (en la ficha **Inicio** , haga clic en la flecha de **fuente** ). 
...
Para obtener una referencia a la celda TextBkgndTrans por su índice desde un programa, utilice la propiedad **CellsSRC** con los argumentos siguientes: 

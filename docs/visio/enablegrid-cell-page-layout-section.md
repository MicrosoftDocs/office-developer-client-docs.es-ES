...
Crear la cuadrícula de página mediante el **espacio entre las formas** y los valores de **tamaño promedio de las formas** en el cuadro de diálogo **Diseño de espaciado y el enrutamiento** . (En la ficha **Diseño** , haga clic en la flecha de **Configurar página** , haga clic en **Diseño y enrutamiento**y, a continuación, haga clic en **Espaciado**). 
...
Para obtener una referencia a la celda EnableGrid por su índice desde un programa, utilice la propiedad **CellsSRC** con los argumentos siguientes: 

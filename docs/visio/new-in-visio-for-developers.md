...
En la tabla siguiente se enumeran las nuevas enumeraciones y constantes introducidas en Visio 2013.
...
|[VisQuickStyleMatrixIndices (enumeración) (Visio)](https://msdn.microsoft.com/library/0fb0b448-85ba-4fc4-d933-21d574cefa2a%28Office.15%29.aspx) <br/> |Especifica nombres designados para los temas y variaciones proporcionados con Visio 2013.  <br/> |
...
En la tabla siguiente se enumeran los objetos y miembros en desuso introducidos en Visio 2013. En la columna **Miembros desusados**, solo se incluyen los miembros del objeto en desuso. 

 ...
 **THEMEVAL**([ _"theme_value"_][, _valor predeterminado_]) 
  
### <a name="parameters"></a>Parámetros

|**Name**|**Necesario/Opcional**|**Tipo de datos**|**Descripción**|
|:-----|:-----|:-----|:-----|
| _"theme_value"_ <br/> |Opcional  <br/> |**String** <br/> |Nombre de una celda en la definición de tema de la que se obtiene un valor.  <br/> |
...
La **función THEMEVAL** también puede aceptar un entero para el primer parámetro, como un valor comprendido entre 1 y 8. El uso de valores enteros recupera un color por índice de la combinación de colores del tema. Por lo tanto, un valor de "1" devolverá el color "Oscuro" del tema, "2" devuelve el color "Luz", "3" devuelve el color "Énfal 1", etc. 
  
Si la **función THEMEVAL** recibe dos argumentos, recupera el valor de la definición de tema pasada como primer argumento. Sin embargo, si el documento no tiene ningún tema aplicado, la función **THEMEVAL** usa el valor especificado como segundo argumento. 
  
**Argumentos posibles para el parámetro "theme_value"**
...
|"AccentColor2"  <br/> |Recupera el color RGB de Accent2 de la definición del tema.  <br/> |
|"AccentColor3"  <br/> |Recupera el color RGB de Accent3 de la definición del tema.  <br/> |
|"AccentColor4"  <br/> |Recupera el color RGB accent4 de la definición del tema.  <br/> |
|"AccentColor5"  <br/> |Recupera el color RGB de Accent5 de la definición del tema.  <br/> |
|"AccentColor6"  <br/> |Recupera el color RGB de Accent6 de la definición del tema.  <br/> |
...
|"LineEnd"  <br/> |Recupera el valor de celda EndArrow de la definición del tema.  <br/> |
...
|"LineEndSize"  <br/> |Recupera el valor de celda EndArrowSize de la definición del tema.  <br/> |
|"LineRounding"  <br/> |Recupera el valor de celda Redondeo de la definición del tema.  <br/> |
...
|"ConnectorRounding"  <br/> |Recupera el valor de celda Redondeo de la definición del tema.  <br/> |
|"ConnectorBegin"  <br/> |Recupera el valor de celda BeginArrow de la definición del tema.  <br/> |
|"ConnectorEnd"  <br/> |Recupera el valor de celda EndArrow de la definición del tema.  <br/> |
|"ConnectorBeginSize"  <br/> |Recupera el valor de celda BeginArrowSize de la definición del tema.  <br/> |
|"ConnectorEndSize"  <br/> |Recupera el valor de celda EndArrowSize de la definición del tema.  <br/> |
...
|"ShadowBlur"  <br/> |Recupera el valor de celda ShapeShdwBlur de la definición del tema.  <br/> |
...
|"BevelTopHeight"  <br/> |Recupera el valor de celda BevelTopHeight de la definición del tema.  <br/> |
...
|"BevelLightingAngle"  <br/> |Recupera el valor de celda BevelLightingAngle de la definición del tema.  <br/> |
...
|"TextStyle"  <br/> |Recupera el valor de celda Character.Style de la definición del tema.  <br/> |
...
|"LineStop[x]Color"  <br/> |Recupera el valor de celda Color en la  *fila x*  de la definición del tema.  <br/> |
...
Devuelve el color "Énfal 3" de la definición del tema.

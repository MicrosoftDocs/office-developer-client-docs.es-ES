...
Para obtener una referencia a la celda Contrast por su nombre desde otra fórmula, o desde un programa mediante la propiedad
 **CellsU**, utilice: 
...
| Índice de celda:  <br/> |**visImageContrast** <br/> |

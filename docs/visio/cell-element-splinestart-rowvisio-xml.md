...
Contiene coordenadas x o y para el segundo punto de control de una spline, su segundo nodo, su primer nodo, el último nodo o el grado de la spline.
...
|:-----|:-----|:-----|
|[Elemento Row (Geometría)](row-element-geometry-sectionvisio-xml.md) <br/> |[SplineStart_Type](splinestart_type-complextypevisio-xml.md) <br/> |Contiene coordenadas x o y para el segundo punto de control de una spline, su segundo nodo, su primer nodo, el último nodo o el grado de la spline.  <br/> |
...
|C  <br/> |Último nodo de una spline.  <br/> |[Fila RelEllipticalArcTo (Sección de geometría)](splinestart-row-geometry-section.md) <br/> |

...
---
# <a name="pagesheet-element-master_type-complextype-visio-xml"></a>Elemento PageSheet (Master_Type complexType) (XML de Visio)

Especifica las propiedades de la página de dibujo asociada con el patrón.

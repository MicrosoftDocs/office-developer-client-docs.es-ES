...
---
# <a name="cell-element-moveto-row-visio-xml"></a>Elemento Cell (MoveTo Row) (Visio XML)
...
|:-----|:-----|:-----|
|[Elemento Row (Geometry)](row-element-geometry-sectionvisio-xml.md) <br/> |[MoveTo_Type](moveto_type-complextypevisio-xml.md) <br/> |Contiene las coordenadas x o y del primer vértice de una forma, o representa las coordenadas x o y del primer vértice después de un salto en una ruta de acceso.  <br/> |

...
Determina si la ortografía se corrige automáticamente y si se muestran los errores ortográficos de la forma seleccionada. Toma un **valor** booleano. 
...
|FALSE  <br/> |La ortografía se corrige automáticamente y se muestran los errores ortográficos de la forma seleccionada.  <br/> |

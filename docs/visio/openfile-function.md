...
Abre un documento de Microsoft Visio, si aún no está abierto, y activa la ventana de documento.
...
|:-----|:-----|:-----|:-----|
| _largos_ <br/> |Obligatorio  <br/> |**String** <br/> |El nombre del archivo, incluida la ruta de acceso del archivo, que se desea abrir.  <br/> |
...
Abre el archivo especificado "archivo. vsdx" en una nueva ventana o activa la ventana si el archivo ya está abierto. 

...
Devuelve un número binario de 16 bits en el que cada bit se establece en 1 solo si el bit correspondiente en el número binario es 0. De lo contrario, el bit se establece en 0.

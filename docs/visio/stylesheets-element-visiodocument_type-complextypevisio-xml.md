...
ms.locfileid: "19823346"
---
# <a name="stylesheets-element-visiodocumenttype-complextype-visio-xml"></a>Elemento de hojas de estilo (VisioDocument_Type complexType) ('XML de Visio')

Contiene una colección de elementos de la hoja de estilos para el documento.
...
|**Element**|**Tipo**|**Descripción**|
|:-----|:-----|:-----|
|[Hoja de estilos](stylesheet-element-stylesheets_type-complextypevisio-xml.md) <br/> |[StyleSheet_Type](stylesheet_type-complextypevisio-xml.md) <br/> |Representa un estilo definido en un documento.  <br/> |

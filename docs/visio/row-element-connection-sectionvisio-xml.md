...
---
# <a name="row-element-connection-section-visio-xml"></a>Elemento Row (sección conexión) ("XML" de Visio)

Contiene las coordenadas x o y, la dirección horizontal y vertical y el tipo de un único punto de conexión de una forma.
...
|:-----|:-----|:-----|
|[Section](section-element-sheet_type-complextypevisio-xml.md) <br/> |[Section_Type](section_type-complextypevisio-xml.md) <br/> |Contiene las coordenadas x o y, la dirección horizontal y vertical y el tipo de un único punto de conexión de una forma.  <br/> |

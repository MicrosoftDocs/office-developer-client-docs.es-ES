...
---
# <a name="cell-element-scratch-section-visio-xml"></a>Elemento Cell (sección Scratch) (Visio XML)

Especifica un área de trabajo para especificar y probar fórmulas a las que pueden hacer referencia otras celdas.
...
|:-----|:-----|:-----|
|[Elemento Row (sección Scratch)](row-element-scratch-sectionvisio-xml.md) <br/> |[ScratchRow_Type](scratch_type-complextypevisio-xml.md) <br/> |Especifica un área de trabajo para especificar y probar fórmulas a las que pueden hacer referencia otras celdas.  <br/> |

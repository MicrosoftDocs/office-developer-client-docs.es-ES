...
---
# <a name="rulesetstype-complextype-visio-xml"></a>RuleSets_Type complexType ('XML de Visio')
...
|:-----|:-----|:-----|
|[Conjuntos de reglas](ruleset-element-rulesets_type-complextypevisio-xml.md) <br/> |[RuleSet_Type](ruleset_type-complextypevisio-xml.md) <br/> ||

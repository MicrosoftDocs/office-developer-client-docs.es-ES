...
Contiene coordenadas x o y del último punto de una polilínea o una fórmula de polilínea.
...
|:-----|:-----|:-----|
|[Elemento Row (Geometría)](row-element-geometry-sectionvisio-xml.md) <br/> |[PolylineTo_Type](polylineto_type-complextypevisio-xml.md) <br/> |Contiene coordenadas x o y del último punto de una polilínea o una fórmula de polilínea.  <br/> |

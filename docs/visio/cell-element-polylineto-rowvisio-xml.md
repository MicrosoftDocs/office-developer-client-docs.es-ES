...
---
# <a name="cell-element-polylineto-row-visio-xml"></a>Elemento cell (fila PolylineTo) ("XML" de Visio)

Contiene las coordenadas x o y del último punto de una polilínea o una fórmula de polilínea.
...
|:-----|:-----|:-----|
|[Elemento Row (geometría)](row-element-geometry-sectionvisio-xml.md) <br/> |[PolylineTo_Type](polylineto_type-complextypevisio-xml.md) <br/> |Contiene las coordenadas x o y del último punto de una polilínea o una fórmula de polilínea.  <br/> |
...
|:-----|:-----|:-----|
|X  <br/> |Coordenada x del vértice del extremo de una polilínea.  <br/> |[Fila PolylineTo (Sección de Geometría)](polylineto-row-geometry-section.md) <br/> |
|v  <br/> |Coordenada y del vértice del extremo de una polilínea.  <br/> |[Fila PolylineTo (Sección de Geometría)](polylineto-row-geometry-section.md) <br/> |
|A  <br/> |Fórmula de polilínea.  <br/> |[Fila PolylineTo (Sección de Geometría)](polylineto-row-geometry-section.md) <br/> |

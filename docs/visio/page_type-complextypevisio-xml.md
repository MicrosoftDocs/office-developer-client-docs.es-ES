...
---
# <a name="pagetype-complextype-visio-xml"></a>Page_Type complexType ('XML de Visio')
...
|Fondo  <br/> |Boolean con tipo  <br/> |opcional  <br/> ||Valores del tipo Boolean con tipo.  <br/> |

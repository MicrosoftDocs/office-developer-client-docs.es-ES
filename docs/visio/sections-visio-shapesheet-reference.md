...
- [Sección Propiedades del efecto adicional](additional-effect-properties-section.md)
...
- [Sección de puntos de conexión](connection-points-section.md)
    
- [Sección de controles](controls-section.md)
    
- [Sección de propiedades del documento](document-properties-section.md)
    
- [Sección de eventos](events-section.md)
...
- [Sección de geometría](geometry-section.md)
...
- [Sección de hipervínculos](hyperlinks-section.md)
    
- [Sección de propiedades de imagen](image-properties-section.md)
    
- [Sección de pertenencia a la capa](layer-membership-section.md)
    
- [Sección de capas](layers-section.md)
...
- [Sección de diseño de página](page-layout-section.md)
    
- [Sección de propiedades de página](page-properties-section.md)
    
- [Sección de párrafo](paragraph-section.md)
    
- [Sección de propiedades de impresión](print-properties-section.md)
...
- [Sección de datos de formas](shape-data-section.md)
    
- [Sección de diseño de forma](shape-layout-section.md)
    
- [Sección de transformación de forma](shape-transform-section.md)
    
- [Sección de propiedades de estilo](style-properties-section.md)
    
- [Sección de tabulaciones](tabs-section.md)
    
- [Sección de formato del bloque de texto](text-block-format-section.md)
    
- [Sección de campos de texto](text-fields-section.md)

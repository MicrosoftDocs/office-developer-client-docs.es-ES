...
---
# <a name="cell-element-layer-section-visio-xml"></a>Elemento Cell (Sección de capa) (XML de Visio)
...
|Color  <br/> |Especifica uno de los siguientes: el índice del color de la tabla de colores usado para mostrar la capa o un valor RGB que especifica un color personalizado que no está en la tabla de colores.  <br/> |Ninguno.  <br/> |
|ColorTrans  <br/> |Determina el grado de transparencia del color del texto de una capa o forma, de 0 (totalmente opaco) a 1 (totalmente transparente).  <br/> |Ninguno.  <br/> |
|Pegar  <br/> |Especifica si se pueden pegar las formas pertenecientes a la capa.  <br/> |Ninguno.  <br/> |
...
|Imprimir  <br/> |Especifica si las formas pertenecientes a la capa se imprimen cuando se imprime el dibujo.  <br/> |Ninguno.  <br/> |
|Ajustar  <br/> |Especifica si otras formas pueden ajustarse a las formas asignadas a la capa.  <br/> |Ninguno.  <br/> |

...
---
# <a name="angletopar-function"></a>ANGLETOPAR (función)

Devuelve un ángulo transformado en el sistema de coordenadas primario de la forma de destino. Convierte un ángulo de las coordenadas locales en una forma de origen a las coordenadas principales de una forma de destino. 
...
|:-----|:-----|:-----|:-----|
| _ánguloOrigen_ <br/> |Obligatorio  <br/> |**Numérico** <br/> |Un ángulo en el sistema de coordenadas de origen.  <br/> |

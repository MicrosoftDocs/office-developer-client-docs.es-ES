...
---
# <a name="commentstype-complextype-visio-xml"></a>ComplexType Comments_Type (XML de Visio)
...
|:-----|:-----|:-----|:-----|:-----|
|ShowCommentTags  <br/> |xsd: Boolean  <br/> |opcional  <br/> ||Valores del tipo xsd: Boolean.  <br/> |

...
Contiene la coordenada x, la coordenada y o la curvatura de un arco circular.
...
|**Elemento**|**Tipo**|**Descripción**|
|:-----|:-----|:-----|
|[RefBy](refby-element-cell_type-complextypevisio-xml.md) <br/> |[RefBy_Type](refby_type-complextypevisio-xml.md) <br/> |Contiene la coordenada x, la coordenada y o la curvatura de un arco circular.  <br/> |

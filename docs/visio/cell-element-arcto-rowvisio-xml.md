...
---
# <a name="cell-element-arcto-row-visio-xml"></a>Elemento de celda (fila ArcTo) ('XML de Visio')

Contiene la x coordenadas, coordenada y o curvatura de un arco circular.
...
|:-----|:-----|:-----|
|[Elemento de fila (geometría)](row-element-geometry-sectionvisio-xml.md) <br/> |[ArcTo_Type](arcto_type-complextypevisio-xml.md) <br/> |Contiene las coordenadas x e y y la curvatura de un arco circular.  <br/> |
   
### <a name="child-elements"></a>Elementos secundarios

|**Element**|**Tipo**|**Descripción**|
|:-----|:-----|:-----|
|[RefBy](refby-element-cell_type-complextypevisio-xml.md) <br/> |[RefBy_Type](refby_type-complextypevisio-xml.md) <br/> |Contiene la x coordenadas, coordenada y o curvatura de un arco circular.  <br/> |
...
|X  <br/> |La coordenada x del vértice del extremo de un arco.  <br/> |[Fila ArcTo (Sección de geometría)](arcto-row-geometry-section.md) <br/> |

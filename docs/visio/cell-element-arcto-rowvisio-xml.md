...
---
# <a name="cell-element-arcto-row-visio-xml"></a>Elemento Cell (fila ArcTo) (XML de Visio)

Contiene la coordenada x, la coordenada y o la proa de un arco circular.
...
|:-----|:-----|:-----|
|[Elemento Row (Geometría)](row-element-geometry-sectionvisio-xml.md) <br/> |[ArcTo_Type](arcto_type-complextypevisio-xml.md) <br/> |Contiene las coordenadas x e y, y la curvatura de un arco circular.  <br/> |
   
### <a name="child-elements"></a>Elementos secundarios

|**Elemento**|**Tipo**|**Descripción**|
|:-----|:-----|:-----|
|[RefBy](refby-element-cell_type-complextypevisio-xml.md) <br/> |[RefBy_Type](refby_type-complextypevisio-xml.md) <br/> |Contiene la coordenada x, la coordenada y o la proa de un arco circular.  <br/> |

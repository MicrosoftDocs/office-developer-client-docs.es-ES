...
---
# <a name="stylesheetstype-complextype-visio-xml"></a>StyleSheets_Type complexType ('XML de Visio')
...
|:-----|:-----|:-----|
|[Hoja de estilos](stylesheet-element-stylesheets_type-complextypevisio-xml.md) <br/> |[StyleSheet_Type](stylesheet_type-complextypevisio-xml.md) <br/> ||

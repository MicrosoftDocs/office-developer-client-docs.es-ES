...
Para obtener una referencia a la celda AlignRight por su nombre desde otra fórmula, o desde un programa mediante la propiedad
 **CellsU**, utilice: 
  
|||
|:-----|:-----|
| Nombre de celda:  <br/> | AlignRight  <br/> |
   
Para obtener una referencia a la celda AlignRight por su índice desde un programa, utilice la propiedad **CellsSRC** con los argumentos siguientes: 
  
|||
|:-----|:-----|
| Índice de sección:  <br/> |**visSectionObject** <br/> |
| Índice de fila:  <br/> |**visRowAlign** <br/> |
| Índice de celda:  <br/> |**visAlignRight** <br/> |

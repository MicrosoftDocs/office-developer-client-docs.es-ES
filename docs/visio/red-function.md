...
El valor devuelto es un número entre 0 y 255, ambos incluidos, o una referencia a una celda que da como resultado un índice. Si  _la_ expresión no es válida, esta función devuelve 0 (negro). 

...
---
# <a name="cell-element-line-gradient-section-visio-xml"></a>Elemento Cell (sección Degradado de línea) (Visio XML)

Contiene el color, la transparencia o la posición de un detente degradado para un degradado de línea.
...
|:-----|:-----|:-----|
|[Elemento Row (sección Degradado de línea)](row-element-line-gradient-sectionvisio-xml.md) <br/> |[LineGradientRow_Type](linegradientrow_type-complextypevisio-xml.md) <br/> |Contiene el color, la transparencia y la posición de un detente degradado para un degradado de línea.  <br/> |
...
|:-----|:-----|:-----|
|GradientStopColor  <br/> |Valor de color de la detención de degradado.  <br/> |[Fila de detención de degradado (sección Degradado de línea)](gradient-stop-row-line-gradient-section.md) <br/> |
|GradientStopColorTrans  <br/> |La cantidad de transparencia del color de la parada de degradado, como porcentaje.  <br/> |[Fila de detención de degradado (sección Degradado de línea)](gradient-stop-row-line-gradient-section.md) <br/> |
|GradientStopPosition  <br/> |La posición del degradado se detiene en la dirección del degradado de línea, como un porcentaje desde el punto de origen del degradado hasta el borde exterior del degradado.  <br/> |[Fila de detención de degradado (sección Degradado de línea)](gradient-stop-row-line-gradient-section.md) <br/> |

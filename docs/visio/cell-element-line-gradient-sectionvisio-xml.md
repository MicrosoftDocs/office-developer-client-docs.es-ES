...
---
# <a name="cell-element-line-gradient-section-visio-xml"></a>Elemento cell (sección degradado de línea) ("XML" de Visio)

Contiene el color, la transparencia o la posición de un punto de degradado de un degradado de línea.
...
|:-----|:-----|:-----|
|[Elemento Row (sección degradado de línea)](row-element-line-gradient-sectionvisio-xml.md) <br/> |[LineGradientRow_Type](linegradientrow_type-complextypevisio-xml.md) <br/> |Contiene el color, la transparencia y la posición de un punto de degradado de un degradado de línea.  <br/> |
...
|:-----|:-----|:-----|
|GradientStopColor  <br/> |El valor de color del delimitador de degradado.  <br/> |[Fila parada de degradado (sección degradado de línea)](gradient-stop-row-line-gradient-section.md) <br/> |
|GradientStopColorTrans  <br/> |La cantidad de transparencia del color de delimitador de degradado, como un porcentaje.  <br/> |[Fila parada de degradado (sección degradado de línea)](gradient-stop-row-line-gradient-section.md) <br/> |
|GradientStopPosition  <br/> |Posición del delimitador de degradado a lo largo de la dirección del degradado de línea, como un porcentaje desde el punto de origen del degradado hasta el borde exterior del degradado.  <br/> |[Fila parada de degradado (sección degradado de línea)](gradient-stop-row-line-gradient-section.md) <br/> |

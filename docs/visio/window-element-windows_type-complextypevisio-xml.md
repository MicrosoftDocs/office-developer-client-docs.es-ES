...
Representa una ventana abierta en una instancia de Microsoft Visio. Este elemento contiene información necesaria para volver a crear exactamente una ventana de interfaz de usuario en el área de trabajo de la aplicación cuando el archivo se abre inicialmente por Visio.
...
|[GlueSettings](gluesettings-element-window_type-complextypevisio-xml.md) <br/> |[GlueSettings_Type](gluesettings_type-complextypevisio-xml.md) <br/> |Especifica los objetos a los que se pegan las formas cuando el pegado está habilitado en el documento.  <br/> |
...
|[ShowGuides](showguides-element-window_type-complextypevisio-xml.md) <br/> |[ShowGuides_Type](showguides_type-complextypevisio-xml.md) <br/> |Especifica si las guías se muestran en la ventana de dibujo.  <br/> |
...
|[StencilGroupPos](stencilgrouppos-element-window_type-complextypevisio-xml.md) <br/> |[StencilGroupPos_Type](stencilgrouppos_type-complextypevisio-xml.md) <br/> |Contiene un entero que especifica la posición relativa de una galería de símbolos dentro de un grupo de una ventana.  <br/> |
...
|:-----|:-----|:-----|:-----|:-----|
|Container  <br/> |xsd:unsignedInt  <br/> |opcional  <br/> |Id. de contenedor: Page, Sheet o Master. Solo es relevante y necesario si **se especifica ContainerType.**  <br/> |Valores del tipo xsd:unsignedInt.  <br/> |
|ContainerType  <br/> |xsd:token  <br/> |opcional  <br/> |Puede ser uno de los siguientes valores: Document, Page o Master. Solo es relevante cuando **WindowType** se especifica como Dibujo o Hoja.  <br/> |Valores del tipo xsd:token.  <br/> |
...
|Master  <br/> |xsd:unsignedInt  <br/> |opcional  <br/> |Id. de patrón si esta ventana muestra un patrón.  <br/> |Valores del tipo xsd:unsignedInt.  <br/> |
|Page  <br/> |xsd:unsignedInt  <br/> |opcional  <br/> |Id. de página si esta ventana muestra una página. Solo es relevante cuando **WindowType** se especifica como Drawing y **ContainerType** se especifica como Page.  <br/> |Valores del tipo xsd:unsignedInt.  <br/> |
|ParentWindow  <br/> |xsd:unsignedInt  <br/> |opcional  <br/> |Id. de ventana en la que está incluida esta ventana de galería de símbolos. Solo es relevante cuando **WindowType** se especifica como Galería de símbolos.  <br/> |Valores del tipo xsd:unsignedInt.  <br/> |
...
|Sheet  <br/> |xsd:unsignedInt  <br/> |opcional  <br/> |Id. de hoja en el contenedor. Solo es relevante cuando se especifica Container como Sheet.  <br/> |Valores del tipo xsd:unsignedInt.  <br/> |
|ViewCenterX  <br/> |xsd:double  <br/> |opcional  <br/> |**ViewCenterX** y **ViewCenterY** especifican un punto central en una página que una nueva vista (ventana) supone cuando se abre inicialmente.  <br/> |Valores del tipo xsd:double.  <br/> |
|ViewCenterY  <br/> |xsd:double  <br/> |opcional  <br/> |**ViewCenterX** y **ViewCenterY** especifican un punto central en una página que una nueva vista (ventana) supone cuando se abre inicialmente.  <br/> |Valores del tipo xsd:double.  <br/> |
...
|WindowState  <br/> |xsd:unsignedInt  <br/> |opcional  <br/> |Un número entero que especifica las marcas de bits.  <br/> |Valores del tipo xsd:unsignedInt.  <br/> |
|WindowTop  <br/> |xsd:short  <br/> |opcional  <br/> |Coordenada superior del rectángulo de la ventana.  <br/> |Valores del tipo xsd:short.  <br/> |
|WindowType  <br/> |xsd:token  <br/> |necesario  <br/> |Valor enumerado que puede ser uno de los siguientes: Dibujo, Hoja, Galería de símbolos o Icono.  <br/> |Valores del tipo xsd:token.  <br/> |

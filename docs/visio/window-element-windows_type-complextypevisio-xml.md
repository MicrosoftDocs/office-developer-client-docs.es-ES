...
|[GlueSettings](gluesettings-element-window_type-complextypevisio-xml.md) <br/> |[GlueSettings_Type](gluesettings_type-complextypevisio-xml.md) <br/> |Especifica los objetos a los que se pegan las formas cuando está habilitado el pegado en el documento.  <br/> |
...
|[ShowGuides](showguides-element-window_type-complextypevisio-xml.md) <br/> |[ShowGuides_Type](showguides_type-complextypevisio-xml.md) <br/> |Especifica si se muestran las guías en la ventana de dibujo.  <br/> |
...
|[SnapSettings](snapsettings-element-window_type-complextypevisio-xml.md) <br/> |[SnapSettings_Type](snapsettings_type-complextypevisio-xml.md) <br/> |Especifica los objetos a los que se ajustan las formas cuando se activa ajustar en la ventana.  <br/> |
...
|[StencilGroupPos](stencilgrouppos-element-window_type-complextypevisio-xml.md) <br/> |[StencilGroupPos_Type](stencilgrouppos_type-complextypevisio-xml.md) <br/> |Contiene un valor de tipo Integer que especifica la posición relativa de una galería de símbolos dentro de un grupo en una ventana.  <br/> |
...
|ContainerType  <br/> |xsd: token  <br/> |opcional  <br/> |Puede ser uno de los siguientes valores: Document, page o Master. Solo es relevante cuando **WindowType** se especifica como dibujo o como hoja.  <br/> |Valores del tipo xsd: token.  <br/> |
|Document  <br/> |xsd: String  <br/> |opcional  <br/> |Ruta de acceso al archivo del documento que se muestra en esta ventana.  <br/> |Valores del tipo xsd: String.  <br/> |
...
|WindowState  <br/> |xsd: unsignedInt  <br/> |opcional  <br/> |Un entero que especifica marcas de bits.  <br/> |Valores del tipo xsd: unsignedInt.  <br/> |

...
---
# <a name="rowmap-element-datarecordset_type-complextype-visio-xml"></a>Elemento RowMap (DataRecordSet_Type complexType) (Visio XML)

Mapas una fila de conjunto de registros de datos a una forma.

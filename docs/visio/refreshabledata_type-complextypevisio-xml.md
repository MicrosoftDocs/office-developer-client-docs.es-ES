---
title: ComplexType RefreshableData_Type (XML de Visio)
manager: soliver
ms.date: 03/09/2015
...
ms.locfileid: "34542873"
---
# <a name="refreshabledatatype-complextype-visio-xml"></a>ComplexType RefreshableData_Type (XML de Visio)

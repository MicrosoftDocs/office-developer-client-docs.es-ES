...
|:-----|:-----|:-----|
| Centímetros  <br/> | PDA  <br/> |**visCentimeters (69)** <br/> |
...
| Semanas transcurridas  <br/> | ueva  <br/> |**visElapsedWeek (43)** <br/> |
| Días transcurridos  <br/> | ed  <br/> |**visElapsedDay (44)** <br/> |
| Horas transcurridas  <br/> | verdad  <br/> |**visElapsedHour (45)** <br/> |
| Minutos transcurridos  <br/> | em  <br/> |**visElapsedMin (46)** <br/> |
| Segundos transcurridos  <br/> | es  <br/> |**visElapsedSec (47)** <br/> |
| Pies  <br/> | cm  <br/> |**visFeet (66)** <br/> |
| Pulgadas  <br/> | a  <br/> |**visInches (65)** <br/> |
| Kilómetros  <br/> | km  <br/> |**visKilometers (72)** <br/> |
| Caudalímetro  <br/> | m  <br/> |**visMeters (71)** <br/> |
...
| Metros  <br/> | YD  <br/> |**visYards (75)** <br/> |
...
| Pies y pulgadas  <br/> | PIES/PULGADAS  <br/> |**visFeetAndInches (67)** <br/> |
...
Puede especificar unidades de medida fraccionarias en la celda **DrawingScale** para afectar al número de subdivisiones de regla que Visio muestra en la ventana de dibujo. De forma predeterminada, Visio divide las distancias en diez subdivisiones al mostrar las reglas. Si usa unidades de medida fraccionarias en la celda **DrawingScale** , Visio divide la distancia en lo siguiente: 
  
- Octavos para *visInchFrac* y *visMileFrac* 
    
- Duodécimas para *visFeetAndInches* 
...
| Caudalímetro  <br/> | M. CUADRADOS, M CUADRADOS, M.^2, M ^2  <br/> |**visMeters (71)** <br/> |
...
| Metros  <br/> | YD. CUADRADAS, YD CUADRADAS, YD.^2, YD^2  <br/> |**visYards (75)** <br/> |
...
|**For**|**Uso**|
|:-----|:-----|
| Centímetros  <br/> | PDA  <br/> |
| Cíceros  <br/> | C  <br/> |
| Cíceros y didots  <br/> | CICERO/DIDOT  <br/> |
| Fecha u hora  <br/> | OBSOLET  <br/> |
| Grados  <br/> | Grad  <br/> |
| Grados, minutos, segundos  <br/> | °  <br/> |
| Didots  <br/> | D  <br/> |
| Semanas transcurridas  <br/> | UEVA  <br/> |
| Días transcurridos  <br/> | ED  <br/> |
| Horas transcurridas  <br/> | VERDAD  <br/> |
| Minutos transcurridos  <br/> | LETRA  <br/> |
| Segundos transcurridos  <br/> | ES  <br/> |
| Pies  <br/> | CM  <br/> |
| Pies y pulgadas  <br/> | PIES/PULGADAS  <br/> |
| Pulgadas  <br/> | EN  <br/> |
| Pulgadas en fracciones  <br/> | IN_F  <br/> |
| Kilómetros  <br/> | KM  <br/> |
| Caudalímetro  <br/> | M  <br/> |
| Miles  <br/> | MI  <br/> |
...
| _/unidad_ <br/> |Unidades en las que se expresa originalmente el _número_ .  <br/> |
| _flag_ <br/> |Sistema de medida que se utiliza cuando se muestra la unidad implícita. Vea los valores a continuación.  <br/> |
   
El _indicador_ de parámetro es una de las letras siguientes (mayúscula o minúscula), que indica el sistema de medida que debe usarse cuando se muestra la unidad implícita-Value. 
  
|**_Anotación_**|**Sistema de medida**|**Ejemplo**|
|:-----|:-----|:-----|
| a, A  <br/> | Angular  <br/> | = 5 [DEG, A]  <br/> |
| d, D  <br/> | Drawing  <br/> | = 5 [in, D]  <br/> |
| e, E  <br/> | Duracion  <br/> | = 5 [EH, E]  <br/> |
| p, P  <br/> | Page  <br/> | = 5 [in, P]  <br/> |
| t, T  <br/> | Tipo  <br/> | = 5 [PT, T]  <br/> |
   
Además, puede utilizar las unidades implícitas DL, DP, DT, DA, DE para las unidades de dibujo, página, texto, ángulos y tiempo, respectivamente. Cuando se utilizan estas unidades, se supone que el valor asociado está expresado en unidades internas. Por ejemplo, si el sistema de medidas actual es centímetros, *= 2 dl* sería interpretado como 2 unidades internas (pulgadas) y se mostraría como 5,08 cm. 
...
|**visTypeUnits** <br/> |Unidades seleccionadas en el cuadro de **texto** bajo **Mostrar** en la ficha **avanzadas** del cuadro de diálogo **Opciones de Visio** (haga clic en la pestaña **archivo** y, a continuación, en **Opciones**).  <br/> |

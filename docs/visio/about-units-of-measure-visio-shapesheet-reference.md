...
---
# <a name="about-units-of-measure-visio-shapesheet-reference"></a>Acerca de las unidades de medida (Visio ShapeSheet Reference)
...
|**Para especificar estas unidades de medida**|**Finalidad**|**Constante de automatización**|
|:-----|:-----|:-----|
...
| Hactáin  <br/> | HECTÁREAS, HECTÁREA, HA., HA  <br/> |**visHectare (37)** <br/> |
...
| _unidad_ <br/> |Las unidades en las que  _se_ expresa originalmente el número.  <br/> |
| _flag_ <br/> |Sistema de medida que se utiliza cuando se muestra la unidad implícita. Vea los valores a continuación.  <br/> |
   
La marca  _de parámetro_ es una de las siguientes letras (mayúsculas o minúsculas) que indican el sistema de medida que se debe usar cuando se muestra la unidad de valor implícito. 
...
|**visTypeUnits** <br/> |Las unidades seleccionadas en  el  **cuadro** Texto en Mostrar en la ficha Avanzadas del cuadro de diálogo **Opciones** de Visio (haga clic en la pestaña **Archivo** y, a continuación, haga clic en **Opciones).**  <br/> |

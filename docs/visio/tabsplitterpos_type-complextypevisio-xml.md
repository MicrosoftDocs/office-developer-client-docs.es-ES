---
title: TabSplitterPos_Type complexType ('XML de Visio')
manager: soliver
ms.date: 03/09/2015
...
ms.locfileid: "25398797"
---
# <a name="tabsplitterpostype-complextype-visio-xml"></a>TabSplitterPos_Type complexType ('XML de Visio')

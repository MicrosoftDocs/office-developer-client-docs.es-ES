...
Convierte una fórmula que produce códigos de carácter de 16 bits que son códigos de juego de caracteres multibyte o de byte único en una cadena de códigos de caracteres Unicode de 16 bits, mediante los conjuntos de caracteres especificados. 

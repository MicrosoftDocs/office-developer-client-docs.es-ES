...
Convierte una fórmula que produce códigos de caracteres de 16 bits que se amplían códigos de conjunto de caracteres de un byte o multibyte en una cadena de códigos de caracteres Unicode de 16 bits, mediante los conjuntos de caracteres especificados. 

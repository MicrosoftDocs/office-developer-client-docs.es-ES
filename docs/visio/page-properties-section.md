...
Puede establecer los valores de las propiedades  de página realizando una entrada  en la celda  de sección Propiedades de página o mediante el cuadro de diálogo Configurar página (en la ficha Diseño, haga clic en el iniciador de cuadros de diálogo del grupo Configuración de página).  

...
---
# <a name="cell-element-geometry-section-visio-xml"></a>Elemento Cell (Sección de geometría) (XML de Visio)
...
|:-----|:-----|:-----|
|[Elemento Row (Geometría)](row-element-geometry-sectionvisio-xml.md) <br/> |[Geometry_Type](geometry_type-complextypevisio-xml.md) <br/> |Define las propiedades que determinan las propiedades de formato y comportamiento con respecto a las líneas y arcos que integran la sección de geometría.  <br/> |
...
|NoQuickDrag  <br/> |Determina si una forma se puede seleccionar o arrastrar cuando el usuario hace clic en el área rellena definida por la sección Geometría.  <br/> |[Celda NoQuickDrag (Sección de geometría)](noquickdrag-cell-geometry-section.md) <br/> |

...
Formatos de párrafo se pueden establecer mediante la realización de una entrada en una celda de la sección de **párrafo** para aplicar un estilo de texto o introduciendo valores en el cuadro de diálogo **texto** (en la ficha **Inicio** , haga clic en el iniciador del cuadro de diálogo en el grupo **fuente** ). 
  
La sección de **párrafo** no incluye celdas para la configuración de la ficha. Para establecer tabulaciones para el texto de una forma, utilice el cuadro de diálogo **texto** . 

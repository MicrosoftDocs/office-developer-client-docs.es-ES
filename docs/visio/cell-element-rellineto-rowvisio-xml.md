...
|:-----|:-----|:-----|
|X  <br/> |La coordenada x del vértice del extremo de un segmento de línea recta con relación al ancho de la forma.  <br/> |[Fila de RelLineTo (sección de geometría)](rellineto-row-geometry-section.md) <br/> |
|v  <br/> |Coordenada y del vértice del extremo de un segmento de línea recta con relación al alto de la forma.  <br/> |[Fila de RelLineTo (sección de geometría)](rellineto-row-geometry-section.md) <br/> |

 ...
 **Publicación inicial**: octubre 2012 | **Actualización**: 2013 de marzo
...
- [Mapa de esquema](schema-mapvisio-xml.md): muestra el esquema XML del formato de archivo de Visio.
    
- [Elementos](elementsvisio-xml.md): proporciona información sobre los elementos XML que pueden aparecer en el formato de archivo de Visio.
    
- [Types](typesvisio-xml.md): proporciona información sobre los tipos XML que pueden aparecer en el formato de archivo de Visio.
...
- [Aviso sobre los derechos de autor del SDK de Visio](visio-sdk-copyright-notice.md)

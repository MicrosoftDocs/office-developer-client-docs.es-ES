...
---
# <a name="cell-element-paragraph-section-visio-xml"></a>Elemento Cell (sección Paragraph) (Visio XML)

Especifica un atributo de formato de párrafo para el texto de la forma, como sangrías, espaciado de línea, viñetas o alineación horizontal de párrafos.
...
|:-----|:-----|:-----|
|[Elemento Row (sección Paragraph)](row-element-paragraph-sectionvisio-xml.md) <br/> |[ParagraphRow_Type](paragraphrow_type-complextypevisio-xml.md) <br/> |Especifica un atributo de formato de párrafo para el texto de la forma, como sangrías, espaciado de línea, viñetas o alineación horizontal de párrafos.  <br/> |

---
title: Elemento Cell (Sección de párrafo) (XML de Visio)
manager: soliver
ms.date: 03/09/2015
...
description: Especifica un atributo de formato de párrafo para el texto de la forma, como sangrías, interlineado, viñetas o alineación horizontal de párrafos.
...
---
# <a name="cell-element-paragraph-section-visio-xml"></a>Elemento Cell (Sección de párrafo) (XML de Visio)

Especifica un atributo de formato de párrafo para el texto de la forma, como sangrías, interlineado, viñetas o alineación horizontal de párrafos.
...
|:-----|:-----|:-----|
|[Elemento Row (Sección de párrafo)](row-element-paragraph-sectionvisio-xml.md) <br/> |[ParagraphRow_Type](paragraphrow_type-complextypevisio-xml.md) <br/> |Especifica un atributo de formato de párrafo para el texto de la forma, como sangrías, interlineado, viñetas o alineación horizontal de párrafos.  <br/> |

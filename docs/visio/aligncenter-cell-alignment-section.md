...
|||
|:-----|:-----|
| Nombre de celda:  <br/> | AlignCenter  <br/> |
   
Para obtener una referencia a la celda AlignCenter por su índice desde un programa, utilice la propiedad **CellsSRC** con los argumentos siguientes: 
  
|||
|:-----|:-----|
| Índice de sección:  <br/> |**visSectionObject** <br/> |
| Índice de fila:  <br/> |**visRowAlign** <br/> |
| Índice de celda:  <br/> |**visAlignCenter** <br/> |

...
Para obtener una referencia a la celda **FillGradientEnabled** por su nombre desde otra fórmula, por valor del atributo **N** de un **elemento Cell** o desde un programa mediante la propiedad **CellsU,** use: 

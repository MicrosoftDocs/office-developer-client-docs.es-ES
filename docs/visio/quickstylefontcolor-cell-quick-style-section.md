...
---
# <a name="quickstylefontcolor-cell-quick-style-section"></a>Celda QuickStyleFontColor (Sección de estilo rápido)

Determina el color de fuente de los estilos rápidos que el texto de una forma hereda del tema activo, como un entero de 0 a 1. 

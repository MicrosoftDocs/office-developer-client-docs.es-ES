...
Para obtener una referencia a la celda **QuickStyleFontColor** por su índice desde un programa, utilice la propiedad **CellsSRC** con los argumentos siguientes: 

...
---
# <a name="angletoloc-function"></a>ANGLETOLOC (función)

Devuelve un ángulo transformado en el sistema de coordenadas local de la forma de destino. Convierte un ángulo de las coordenadas locales en una forma de origen a las coordenadas locales en una forma de destino. 

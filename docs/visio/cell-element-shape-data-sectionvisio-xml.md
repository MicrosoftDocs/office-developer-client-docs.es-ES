---
title: Elemento Cell (sección Shape Data) (Visio XML)
manager: soliver
ms.date: 03/09/2015
...
description: Especifica una propiedad de los datos de forma.
...
---
# <a name="cell-element-shape-data-section-visio-xml"></a>Elemento Cell (sección Shape Data) (Visio XML)

Especifica una propiedad de los datos de forma.
...
|:-----|:-----|:-----|
|[Elemento Row (sección Shape Data)](row-element-shape-data-sectionvisio-xml.md) <br/> |[Shape Data_Type](propertyrow_type-complextypevisio-xml.md) <br/> |Especifica una entrada de datos de forma para asociar datos a una forma.  <br/> |
...
|Comprobar  <br/> |Especifica si se consulta al usuario para especificar información de propiedades personalizadas para una forma cuando se crea una instancia o se duplica o copia la forma.  <br/> |Ninguno.  <br/> |

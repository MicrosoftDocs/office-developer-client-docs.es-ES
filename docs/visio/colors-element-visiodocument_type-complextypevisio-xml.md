...
---
# <a name="colors-element-visiodocumenttype-complextype-visio-xml"></a>Elemento de colores (VisioDocument_Type complexType) ('XML de Visio')
...
|**Element**|**Tipo**|**Descripción**|
|:-----|:-----|:-----|
|[ColorEntry](colorentry-element-colors_type-complextypevisio-xml.md) <br/> |[ColorEntry_Type](colorentry_type-complextypevisio-xml.md) <br/> |Contiene una entrada de la tabla de color.  <br/> |

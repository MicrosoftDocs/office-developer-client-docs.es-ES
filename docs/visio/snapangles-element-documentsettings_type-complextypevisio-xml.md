...
ms.locfileid: "19823269"
---
# <a name="snapangles-element-documentsettingstype-complextype-visio-xml"></a>Elemento SnapAngles (DocumentSettings_Type complexType) ('XML de Visio')

Contiene una colección de elementos de **SnapAngle** . 
...
|**Element**|**Tipo**|**Descripción**|
|:-----|:-----|:-----|
|[SnapAngle](snapangle-element-snapangles_type-complextypevisio-xml.md) <br/> |[SnapAngle_Type](snapangle_type-complextypevisio-xml.md) <br/> |Contiene un flotante elija expresión numérica que especifica un ángulo de complemento en grados.  <br/> |

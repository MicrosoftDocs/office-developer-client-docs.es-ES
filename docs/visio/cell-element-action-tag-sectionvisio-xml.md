...
---
# <a name="cell-element-action-tag-section-visio-xml"></a>Elemento Cell (sección Action Tag) (Visio XML)
...
|DisplayMode  <br/> |Determina si la etiqueta de acción aparece cuando el usuario mueve el puntero sobre la etiqueta, cuando la forma está seleccionada o todo el tiempo.  <br/> |[Celda DisplayMode (sección de etiquetas de acción)](displaymode-cell-action-tags-section.md) <br/> |

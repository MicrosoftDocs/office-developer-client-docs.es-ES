...
---
# <a name="visiodocumenttype-complextype-visio-xml"></a>VisioDocument_Type complexType ('XML de Visio')
...
|:-----|:-----|:-----|
|[Colores](colors-element-visiodocument_type-complextypevisio-xml.md) <br/> |[Colors_Type](colors_type-complextypevisio-xml.md) <br/> ||

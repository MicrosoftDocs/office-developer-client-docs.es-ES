---
title: Elemento Cell (fila Controls) (Visio XML)
manager: soliver
ms.date: 03/09/2015
...
---
# <a name="cell-element-controls-row-visio-xml"></a>Elemento Cell (fila Controls) (Visio XML)
...
|:-----|:-----|:-----|
|[Elemento Row (sección Controls)](row-element-controls-sectionvisio-xml.md) <br/> |[ControlRow_Type](controlrow_type-complextypevisio-xml.md) <br/> |Contiene una propiedad para un controlador de control determinado definido para una forma.  <br/> |
...
|xCon  <br/> |Especifica el tipo de comportamiento que la coordenada x del controlador de control muestra después de mover el controlador.  <br/> |Ninguno.  <br/> |
...
|YCon  <br/> |Especifica el tipo de comportamiento que la coordenada y del controlador de control mostrará después de mover el controlador.  <br/> |Ninguno.  <br/> |

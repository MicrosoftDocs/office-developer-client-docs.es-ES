...
Se usa en _set_expression_ parámetro de la función SETATREF para indicar que set_expression debe  evaluarse antes de asignar al parámetro de referencia en SETATREF.  
...
Al asignar el *parámetro set_expression* de la función SETATREF a una  celda a la que se hace referencia, Microsoft Visio escribe set_expression en la celda como expresión de forma predeterminada. Sin embargo, si alguna parte del parámetro  *set_expression*  está ajustada por la función SETATREFEVAL, Visio evalúa la expresión y reemplaza la función SETATREFEVAL por su resultado antes de resolver la expresión SETATREF. 

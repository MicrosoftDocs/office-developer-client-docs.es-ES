---
title: Elemento Cell (RelMoveTo Row) (Visio XML)
manager: soliver
ms.date: 03/09/2015
...
---
# <a name="cell-element-relmoveto-row-visio-xml"></a>Elemento Cell (RelMoveTo Row) (Visio XML)

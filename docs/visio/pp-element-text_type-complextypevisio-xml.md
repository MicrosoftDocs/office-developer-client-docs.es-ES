...
---
# <a name="pp-element-texttype-complextype-visio-xml"></a>elemento de PP (Text_Type complexType) ('XML de Visio')

Especifica el principio de las propiedades de un párrafo ejecutar. La ejecución se define al final del texto o hasta la siguiente etiqueta.
...
|:-----|:-----|:-----|:-----|:-----|
|IX  <br/> |xsd:unsignedInt  <br/> |necesario  <br/> |El índice del elemento **Para** que especifica el formato aplicado a esta ejecución.  <br/> |Valores del tipo xsd:unsignedInt.  <br/> |

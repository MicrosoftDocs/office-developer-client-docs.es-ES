...
---
# <a name="protectshapes-element-documentsettingstype-complextype-visio-xml"></a>Elemento ProtectShapes (complexType DocumentSettings_Type) (XML de Visio)

Especifica si se impide al usuario seleccionar formas que tienen el elemento **LockSelect** establecido en 1. 

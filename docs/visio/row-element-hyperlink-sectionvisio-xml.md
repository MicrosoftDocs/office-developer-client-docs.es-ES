...
---
# <a name="row-element-hyperlink-section-visio-xml"></a>Elemento Row (sección Hyperlink) (Visio XML)

Contiene elementos para crear varios saltos entre una forma o página de dibujo y otra página de dibujo, otro archivo o un sitio web.
...
|:-----|:-----|:-----|
|[Section](section-element-sheet_type-complextypevisio-xml.md) <br/> |[Section_Type](section_type-complextypevisio-xml.md) <br/> |Contiene elementos para crear varios saltos entre una forma o página de dibujo y otra página de dibujo, otro archivo o un sitio web.  <br/> |
   
### <a name="child-elements"></a>Elementos secundarios

|**Elemento**|**Tipo**|**Descripción**|
|:-----|:-----|:-----|
|[Cell](cell-element-hyperlink-rowvisio-xml.md) <br/> |[Cell_Type](cell_type-complextypevisio-xml.md) <br/> |Contiene la información de un solo hipervínculo asociado a una forma  <br/> |

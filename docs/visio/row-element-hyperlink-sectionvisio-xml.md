...
---
# <a name="row-element-hyperlink-section-visio-xml"></a>Elemento Row (sección hipervínculo) (XML de Visio)
...
|:-----|:-----|:-----|
|[Section](section-element-sheet_type-complextypevisio-xml.md) <br/> |[Section_Type](section_type-complextypevisio-xml.md) <br/> |Contiene elementos para crear varios saltos entre una forma o una página de dibujo y otra página de dibujo, otro archivo o un sitio Web.  <br/> |

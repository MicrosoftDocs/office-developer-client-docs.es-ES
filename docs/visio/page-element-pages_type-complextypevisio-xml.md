...
---
# <a name="page-element-pages_type-complextype-visio-xml"></a>Elemento Page (Pages_Type complexType) (Visio XML)
...
|:-----|:-----|:-----|:-----|:-----|
|Información previa  <br/> |xsd:boolean  <br/> |opcional  <br/> |Marca que indica si la página es una página en segundo plano.  <br/> |Valores del tipo xsd:boolean.  <br/> |
|BackPage  <br/> |xsd:unsignedInt  <br/> |opcional  <br/> |El identificador de la página en segundo plano de esta página.  <br/> |Valores del tipo xsd:unsignedInt.  <br/> |
...
|ReviewerID  <br/> |xsd:unsignedInt  <br/> |opcional  <br/> |El identificador del revisor asociado con la superposición de marcado.  <br/> |Valores del tipo xsd:unsignedInt.  <br/> |

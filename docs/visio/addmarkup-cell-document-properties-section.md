...
> [!NOTE]
> Puede evitar el marcado en los documentos mediante la función GUARD. Si la celda AddMarkup contiene la fórmula =GUARD(FALSE), el comando **Track Markup** está deshabilitado. 

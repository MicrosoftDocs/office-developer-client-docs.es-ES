---
title: Celda EffectSchemeIndex (sección de propiedades de tema)
manager: soliver
ms.date: 03/09/2015
...
---
# <a name="effectschemeindex-cell-theme-properties-section"></a>Celda EffectSchemeIndex (sección de propiedades de tema)

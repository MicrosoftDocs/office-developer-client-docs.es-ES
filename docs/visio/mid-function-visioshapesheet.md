...
Devuelve un número específico de caracteres de una cadena de texto, comenzando por la posición especificada, en función del número de caracteres que especifique.
...
Si  *num_chars*  negativo, MID devuelve el #VALUE! valor de error. 

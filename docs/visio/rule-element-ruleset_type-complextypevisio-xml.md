...
|Descripción  <br/> |xsd:string  <br/> |opcional  <br/> |Especifica la descripción de la regla de validación que aparece en la interfaz de usuario. El valor predeterminado es "Desconocido".  <br/> |Valores del tipo xsd:string.  <br/> |

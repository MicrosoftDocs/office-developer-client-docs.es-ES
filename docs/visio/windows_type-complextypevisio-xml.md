...
---
# <a name="windowstype-complextype-visio-xml"></a>ComplexType Windows_Type (XML de Visio)
...
|:-----|:-----|:-----|:-----|:-----|
|ClientHeight  <br/> |xsd: unsignedShort  <br/> |opcional  <br/> ||Valores del tipo xsd: unsignedShort.  <br/> |
|ClientWidth  <br/> |xsd: unsignedShort  <br/> |opcional  <br/> ||Valores del tipo xsd: unsignedShort.  <br/> |

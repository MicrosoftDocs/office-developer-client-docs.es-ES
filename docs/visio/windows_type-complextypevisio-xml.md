...
---
# <a name="windowstype-complextype-visio-xml"></a>Windows_Type complexType ('XML de Visio')
...
|:-----|:-----|:-----|:-----|:-----|
|Propiedades ClientHeight  <br/> |xsd:unsignedShort  <br/> |opcional  <br/> ||Valores del tipo xsd:unsignedShort.  <br/> |

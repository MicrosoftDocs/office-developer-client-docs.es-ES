...
Devuelve el valor de fecha y hora representado por _fechaHora_ o _expresión_.
...
Si falta *fechaHora* o no se puede interpretar como una fecha u hora válidas, DateTime devuelve un #VALUE! error. 
...
La función DATETIME también acepta un único valor numérico en *expresión* , en el que la parte entera del resultado representa el número de días transcurridos desde el 30 de diciembre de 1899, y la parte decimal representa la fracción de un día a partir de la medianoche. 

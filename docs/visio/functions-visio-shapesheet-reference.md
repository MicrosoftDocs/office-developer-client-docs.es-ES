...
- [Función AND](and-function.md)
    
- [Función ANG360](ang360-function.md)
    
- [Función ANGLEALONGPATH](anglealongpath-function.md)
    
- [Función ANGLETOLOC](angletoloc-function.md)
    
- [Función ANGLETOPAR](angletopar-function.md)
    
- [Función ARG](arg-function.md)
    
- [Función ASIN](asin-function.md)
    
- [Función ATAN2](atan2-function.md)
    
- [Función ATAN](atan-function.md)
    
- [Función BITAND](bitand-function.md)
    
- [Función BITNOT](bitnot-function.md)
    
- [Función BITOR](bitor-function.md)
    
- [Función BITXOR](bitxor-function.md)
    
- [Función BKGPAGENAME](bkgpagename-function.md)
...
- [Función BOUNDINGBOXDIST](boundingboxdist-function.md)
...
- [Función CALLOUTTARGETREF](callouttargetref-function.md)
    
- [Función CALLTHIS](callthis-function.md)
    
- [Función CATEGORY](category-function.md)
    
- [Función CEILING](ceiling-function.md)
    
- [Función CHAR](char-function.md)
    
- [Función COMPANY](company-function.md)
    
- [Función CONTAINERCOUNT](containercount-function.md)
    
- [Función CONTAINERMEMBERCOUNT](containermembercount-function.md)
    
- [Función CONTAINERSHEETREF](containersheetref-function.md)
...
- [Función CY](cy-function.md)
    
- [Función DATA1](data1-function.md)
    
- [Función DATA2](data2-function.md)
    
- [Función DATA3](data3-function.md)
...
- [Función DEPENDSON](dependson-function.md)
    
- [Función DESCRIPTION](description-function.md)
    
- [Función DIRECTORY](directory-function.md)
    
- [Función DISTTOPATH](disttopath-function.md)
    
- [Función DOCCREATION](doccreation-function.md)
    
- [Función DOCLASTEDIT](doclastedit-function.md)
    
- [Función DOCLASTPRINT](doclastprint-function.md)
...
- [Función EVALCELL](evalcell-function.md)
    
- [Función EVALTEXT](evaltext-function.md)
    
- [Función FIELDPICTURE](fieldpicture-function.md)
...
- [Función FONT](font-function.md)
    
- [Función FONTTOID](fonttoid-function.md)
    
- [Función FORMATEX](formatex-function.md)
...
- [Función GETVAL](getval-function.md)
    
- [Función GOTOPAGE](gotopage-function.md)
    
- [Función GRAVITY](gravity-function.md)
    
- [Función GREEN](green-function.md)
    
- [Función GUARD](guard-function.md)
    
- [Función HASCATEGORY](hascategory-function.md)
...
- [Función HUEDIFF](huediff-function.md)
    
- [Función HUE](hue-function.md)
    
- [Función HYPERLINKBASE](hyperlinkbase-function.md)
    
- [Función HYPERLINK](hyperlink-function.md)
    
- [Función ID](id-function.md)
    
- [Función IFERROR](iferror-function.md)
    
- [Función IF](if-function.md)
    
- [Función INDEX](index-function.md)
    
- [Función INTERSECTX](intersectx-function.md)
    
- [Función INTERSECTY](intersecty-function.md)
    
- [Función INTUP](intup-function.md)
    
- [Función INT](int-function.md)
    
- [Función IS1D](is1d-function.md)
...
- [Función ISERR](iserr-function.md)
    
- [Función ISTHEMED](isthemed-function.md)
...
- [Función LISTORDER](listorder-function.md)
    
- [Función LISTSEP](listsep-function.md)
    
- [Función LISTSHEETREF](listsheetref-function.md)
...
- [Función LOOKUP](lookup-function.md)
    
- [Función LOWER](lower-function.md)
    
- [Función LUMDIFF](lumdiff-function.md)
    
- [Función LUM](lum-function.md)
    
- [Función MAGNITUDE](magnitude-function.md)
    
- [Función MANAGER](manager-function.md)
    
- [Función MASTERNAME](mastername-function.md)
...
- [Función MSOTINT](msotint-function.md)
    
- [Función NAME](name-function.md)
    
- [Función NA](na-function.md)
    
- [Función NEARESTPOINTONPATH](nearestpointonpath-function.md)
...
- [Función OPENFILE](openfile-function.md)
    
- [Función OPENGROUPWIN](opengroupwin-function.md)
    
- [Función OPENSHEETWIN](opensheetwin-function.md)
    
- [Función OPENTEXTWIN](opentextwin-function.md)
    
- [Función OR](or-function.md)
    
- [Función PAGECOUNT](pagecount-function.md)
    
- [Función PAGENAME](pagename-function.md)
    
- [Función PAGENUMBER](pagenumber-function.md)
    
- [Función PAR](par-function.md)
    
- [Función PATHLENGTH](pathlength-function.md)
    
- [Función PATHSEGMENT](pathsegment-function.md)
    
- [Función PI](pi-function.md)
    
- [Función PLAYSOUND](playsound-function.md)
    
- [Función PNTX](pntx-function.md)
    
- [Función PNTY](pnty-function.md)
    
- [Función PNT](pnt-function.md)
    
- [Función POINTALONGPATH](pointalongpath-function.md)
    
- [Función POLYLINE](polyline-function.md)
...
- [Función RAND](rand-function.md)
    
- [Función RECTSECT](rectsect-function.md)
    
- [Función RED](red-function.md)
...
- [Función SHADE](shade-function.md)
    
- [Función SHAPETEXT](shapetext-function.md)
    
- [Función SHEETREF](sheetref-function.md)
    
- [Función SIGN](sign-function.md)
...
- [Función STRSAMEEX](strsameex-function.md)
    
- [Función STRSAME](strsame-function.md)
...
- [Función TEXTWIDTH](textwidth-function.md)
    
- [Función THEME](theme-function.md)
    
- [Función THEMECBV](themecbv-function.md)
    
- [Función THEMEGUARD](themeguard-function.md)
    
- [Función THEMERESTORE](themerestore-function.md)
...
- [Función TITLE](title-function.md)
...
- [Función TYPEDESC](typedesc-function.md)
...
- [Función USERUI](userui-function.md)
    
- [Función USE](use-function.md)

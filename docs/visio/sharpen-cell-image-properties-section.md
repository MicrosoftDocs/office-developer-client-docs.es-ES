...
Para obtener una referencia a la celda Sharpen por su nombre desde otra fórmula, o desde un programa mediante la propiedad **CellsU**, utilice: 
  
|||
|:-----|:-----|
| Nombre de celda:  <br/> | Enfocar  <br/> |
...
| Índice de celda:  <br/> |**visImageSharpen** <br/> |

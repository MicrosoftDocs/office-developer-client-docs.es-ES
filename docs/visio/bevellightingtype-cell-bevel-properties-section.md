...
Determina el tipo de iluminación que usa el efecto biselado.
...
|9   <br/> |Atardecer  <br/> |
|10  <br/> |Frío  <br/> |
|11  <br/> |Congelación  <br/> |
|12   <br/> |Plano  <br/> |
|13  <br/> |Dos puntos  <br/> |
|14   <br/> |Glow  <br/> |
|15  <br/> |Sala brillante  <br/> |
   
## <a name="remarks"></a>Comentarios

Para obtener una referencia a la celda **BevelLightingType** por su nombre desde otra fórmula, por valor del atributo **N** de un **elemento Cell** o desde un programa mediante la propiedad **CellsU,** use: 
...
|Índice de celda:  <br/> |**visBevelLightingType** <br/> |

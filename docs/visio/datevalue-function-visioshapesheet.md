...
Cualquier componente de hora  *en datetime*  o  *expresión*  se descarta. 
...
La función DATEVALUE también acepta un  valor de número único para la expresión donde la parte entera del resultado representa los días desde el 30 de diciembre de 1899. 

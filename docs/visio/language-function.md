...
Permite operaciones de comparación entre diferentes representaciones de idioma. Se usa mejor para convertir los valores de etiquetas de idioma de internet Engineering Task Force (BCP 47) en valores de identificador de configuración regional (LCID).

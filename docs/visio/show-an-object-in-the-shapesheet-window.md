...
Los Visio microsoft se almacenan internamente como un conjunto de fórmulas. Puede ver un objeto de Visio en la ventana ShapeSheet para comprobar y modificar las fórmulas que le confieren su apariencia y comportamiento.
...
Puede tener acceso a la ventana ShapeSheet y editar fórmulas solo para patrones en una galería de símbolos personalizada o de documento. A partir de Microsoft Office Visio 2003, no es posible modificar los patrones de las galerías de símbolos que incluye Visio.

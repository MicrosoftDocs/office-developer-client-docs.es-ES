...
|[PublishSettings](publishsettings-element-visiodocument_type-complextypevisio-xml.md) <br/> |[PublishSettings_Type](publishsettings_type-complextypevisio-xml.md) <br/> |Especifica el conjunto de páginas de dibujo visibles y de un conjunto de conjuntos de registros que se pueden actualizar en un dibujo.  <br/> |

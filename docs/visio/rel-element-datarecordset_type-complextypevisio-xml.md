...
---
# <a name="rel-element-datarecordset_type-complextype-visio-xml"></a>Elemento Rel (DataRecordSet_Type complexType) (XML de Visio)

Especifica una relación con una parte con el conjunto de registros asociado y la información de enlace de datos.

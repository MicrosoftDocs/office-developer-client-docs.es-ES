...
---
# <a name="ruletype-complextype-visio-xml"></a>Rule_Type complexType ('XML de Visio')
...
|:-----|:-----|:-----|:-----|:-----|
|Category  <br/> |xsd: String  <br/> |opcional  <br/> ||Valores del tipo XSD: String.  <br/> |
...
|Pasa por alto  <br/> |Boolean con tipo  <br/> |opcional  <br/> ||Valores del tipo Boolean con tipo.  <br/> |

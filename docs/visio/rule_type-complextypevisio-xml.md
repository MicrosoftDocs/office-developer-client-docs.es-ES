...
---
# <a name="ruletype-complextype-visio-xml"></a>ComplexType Rule_Type (XML de Visio)
...
|[Msdnprobar](ruletest-element-rule_type-complextypevisio-xml.md) <br/> |[RuleTest_Type](ruletest_type-complextypevisio-xml.md) <br/> ||

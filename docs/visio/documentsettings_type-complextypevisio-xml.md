...
---
# <a name="documentsettingstype-complextype-visio-xml"></a>ComplexType DocumentSettings_Type (XML de Visio)
...
|Página Web  <br/> |xsd: unsignedInt  <br/> |opcional  <br/> ||Valores del tipo xsd: unsignedInt.  <br/> |

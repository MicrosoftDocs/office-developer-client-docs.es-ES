...
Contiene celdas que especifican las acciones asociadas a un comando personalizado en un menú de etiquetas de acción o acceso directo. La sección de acciones contiene una fila Actions por cada acción.
...
|[Menú](menu-cell-actions-section.md) <br/> |Define el nombre del elemento de menú que aparece en una etiqueta de acción o un menú contextual.  <br/> |
...
|[Checked](checked-cell-actions-section.md) <br/> |Indica si el elemento de menú está activado en una etiqueta de acción o un menú contextual.  <br/> |
...
## <a name="remarks"></a>Comentarios
 ...
 Puede agregar todas las filas Actions.  *nombre*  de las filas que necesite, asigne nombres significativos a las filas y establezca valores de celda. Para agregar un comando personalizado a una sección de acciones ya existente, haga clic con el botón secundario en una fila y haga clic en **Insertar fila**, en el menú contextual. 
  
Puede hacer referencia a estas celdas por su nombre de fila, que aparece en la ventana ShapeSheet como texto en color rojo. Para asignar un nombre descriptivo a una fila Actions. *fila*  de nombre, haga clic en la fila y, a continuación, escriba un nombre como  *Custom*  , por ejemplo, para crear el nombre de fila Actions.Custom. Después, podrá hacer referencia a la celda Menu mediante Actions.Personalizada.Menu. 

...
---
# <a name="quickstylefillcolor-cell-quick-style-section"></a>Celda QuickStyleFillColor (Sección de estilo rápido)

Determina el color del tema que usa el relleno de una forma, como un entero entre 0 y 7.
  
|||
|:-----|:-----|
|Valor  <br/> |Descripción  <br/> |
|0  <br/> |El color de relleno de la forma se hereda del color del tema Oscuro.  <br/> |
|1   <br/> |El color de relleno de la forma hereda del color del tema Claro.  <br/> |
|2   <br/> |El color de relleno de la forma se hereda del color del tema Énfeño 1  <br/> |
|3   <br/> |El color de relleno de la forma se hereda del color del tema Énfeño 2  <br/> |
|4   <br/> |El color de relleno de la forma se hereda del color del tema Énfal 3  <br/> |
|5   <br/> |El color de relleno de la forma se hereda del color del tema Énf mismo 4  <br/> |
|6   <br/> |El color de relleno de la forma se hereda del color del tema Énf mismo 5  <br/> |
|7   <br/> |El color de relleno de la forma se hereda del color del tema Énfeño 6  <br/> |

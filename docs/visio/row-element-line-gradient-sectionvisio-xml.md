...
---
# <a name="row-element-line-gradient-section-visio-xml"></a>Elemento Row (sección Degradado de línea) (Visio XML)

Contiene el color, la transparencia y la posición de un detente degradado para un degradado de línea.
...
|:-----|:-----|:-----|
|[Section](section-element-sheet_type-complextypevisio-xml.md) <br/> |[Section_Type](section_type-complextypevisio-xml.md) <br/> |Contiene el color, la transparencia y la posición de un detente degradado para un degradado de línea.  <br/> |

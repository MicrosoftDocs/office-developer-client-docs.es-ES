...
- [<span data-ttu-id="1781c-358">Centro para desarrolladores de Visio</span><span class="sxs-lookup"><span data-stu-id="1781c-358">Visio Developer Center</span></span>](http://msdn.microsoft.com/en-us/office/aa905478.aspx)
    
- [<span data-ttu-id="1781c-359">Manipular documentos con formatos Office Open XML</span><span class="sxs-lookup"><span data-stu-id="1781c-359">Manipulate Office Open XML Formats Documents</span></span>](http://msdn.microsoft.com/en-us/library/aa982683%28v=office.12%29.aspx)
    
- [<span data-ttu-id="1781c-360">Crear un documento con espacios de nombres (C#) (LINQ to XML)</span><span class="sxs-lookup"><span data-stu-id="1781c-360">Create a Document with Namespaces (C#) (LINQ to XML)</span></span>](http://msdn.microsoft.com/en-us/library/bb387075.aspx)
    
- [<span data-ttu-id="1781c-361">Agregar elementos XML personalizados en documentos sin iniciar Microsoft Office</span><span class="sxs-lookup"><span data-stu-id="1781c-361">Add Custom XML Parts to Documents Without Starting Microsoft Office</span></span>](http://msdn.microsoft.com/en-us/library/bb608597%28VS.90%29.aspx)

...
description: Devuelve la cadena de separador decimal de la configuración regional del usuario actual.
...
Devuelve la cadena de separador decimal de la configuración regional del usuario actual.

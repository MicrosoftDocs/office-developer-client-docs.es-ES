...
Desplazamiento  *x*  del botón de etiqueta de acción con relación al punto definido por las celdas X e Y. 
...
|||
|:-----|:-----|
| Nombre de celda:  <br/> | SmartTags.  *nombre*  . XJustify donde SmartTags. *es*  el nombre de la fila de etiqueta de acción  <br/> |

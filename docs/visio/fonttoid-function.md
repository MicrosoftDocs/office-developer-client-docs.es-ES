...
> [!NOTE]
> Se recomienda usar la [función FONT,](font-function.md) que es similar a la **función FONTTOID.** En Microsoft Visio 2013, se introdujo la función **FONT** para reemplazar **FONTTOID**. 

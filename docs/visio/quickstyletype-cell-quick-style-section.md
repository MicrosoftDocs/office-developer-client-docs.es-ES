...
---
# <a name="quickstyletype-cell-quick-style-section"></a>Celda QuickStyleType (Sección de estilo rápido)

Determina el tipo de estilo rápido (bidimensional, unidimensional o conector) que hereda la forma. 

...
Para obtener una referencia a la celda ShapeShdwOffsetX por su nombre desde otra fórmula, o desde un programa mediante la propiedad **CellsU**, utilice: 
  
|||
|:-----|:-----|
| Nombre de celda:  <br/> | ShapeShdwOffsetX  <br/> |
...
| Índice de celda:  <br/> |**visFillShdwOffsetX** <br/> |

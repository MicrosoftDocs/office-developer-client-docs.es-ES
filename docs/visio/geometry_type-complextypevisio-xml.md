...
---
# <a name="geometrytype-complextype-visio-xml"></a>ComplexType Geometry_Type (XML de Visio)
...
|[Fila](row-element-geometry-sectionvisio-xml.md) <br/> |GeometryRow_Type  <br/> ||

...
---
# <a name="stencilgrouppos-element-windowtype-complextype-visio-xml"></a>Elemento StencilGroupPos (complexType Window_Type) (XML de Visio)

Contiene un valor de tipo Integer que especifica la posición relativa de una galería de símbolos dentro de un grupo en una ventana.

...
|[Type](type-cell-shape-data-section.md) <br/> |Especifica el tipo de datos para el valor del elemento de datos de formas: cadena (0), lista fija (1), número (2), valor booleano (3), lista variable (4), fecha u hora (5), duración (6) o moneda (7).  <br/> |
|[Format](format-cell-shape-data-section.md) <br/> |Especifica el formato de un elemento de datos de formas.  <br/> |
|[Value](value-cell-shape-data-section.md) <br/> |Contiene el valor del elemento tal y como se escribió en el cuadro de diálogo o ventana **Datos de formas**.  <br/> |

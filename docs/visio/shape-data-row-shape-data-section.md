...
## <a name="remarks"></a>Comentarios
 ...
 Puede agregar tantas prop.  *nombre*  de las filas que necesite, asigne nombres significativos a las filas y establezca valores de celda. Para agregar un elemento de datos de formas a una sección Datos de formas existente, haga clic con el botón secundario en una fila y haga clic **en Insertar fila** en el menú contextual. 
  
Puede hacer referencia a estas celdas por su nombre de fila, que aparece en la ventana ShapeSheet como texto en color rojo. Para asignar nombres significativos a filas prop. *name,*  haga clic en la fila y, a continuación, escriba un nombre como  *Price*  , por ejemplo, para crear el nombre de fila Prop.Price. Después, podrá hacer referencia a la celda Label usando Prop.Precio.Label. 

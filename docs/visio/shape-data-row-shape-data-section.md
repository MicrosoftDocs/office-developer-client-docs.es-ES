...
Contiene la información de un elemento de datos de forma única asociada con una forma. Una forma contiene una fila de datos de formas para cada elemento de datos de formas. Las filas de datos de formas se llaman Prop.nombre y contienen las celdas siguientes. Para obtener más información, vea los temas de la celda específica.
  
|**Cell**|**Descripción**|
|:-----|:-----|
|[Label](label-cell-shape-data-section.md) <br/> |Especifica la etiqueta que ven los usuarios en la ventana o el cuadro de diálogo **Datos de formas** .  <br/> |
|[Prompt](prompt-cell-shape-data-section.md) <br/> |Especifica el texto descriptivo o con instrucciones que aparece a los usuarios en la ventana o el cuadro de diálogo **Datos de formas** cuando el elemento está seleccionado.  <br/> |
...
|[Valor](value-cell-shape-data-section.md) <br/> |Contiene el valor del elemento tal como se especificó en la ventana o el cuadro de diálogo **Datos de formas** .  <br/> |
|[SortKey](sortkey-cell-shape-data-section.md) <br/> |Especifica la clave por qué los elementos en el cuadro de diálogo **Datos de formas** se muestran cuadro o ventana.  <br/> |
|[Invisible](invisible-cell-shape-data-section.md) <br/> |Especifica si el elemento de datos de formas es visible en la ventana o el cuadro de diálogo **Datos de formas** . TRUE = no visible; FALSE = visible.  <br/> |

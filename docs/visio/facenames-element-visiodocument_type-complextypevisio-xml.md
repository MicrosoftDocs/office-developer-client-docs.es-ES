...
---
# <a name="facenames-element-visiodocumenttype-complextype-visio-xml"></a>Elemento de FaceNames (VisioDocument_Type complexType) ('XML de Visio')

Contiene una colección de elementos de **nombre de fuente** . 
...
|**Element**|**Tipo**|**Descripción**|
|:-----|:-----|:-----|
|[Nombre de fuente](facename-element-facenames_type-complextypevisio-xml.md) <br/> |[FaceName_Type](facename_type-complextypevisio-xml.md) <br/> |Contiene información acerca de una fuente.  <br/> |

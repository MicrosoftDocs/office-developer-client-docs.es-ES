...
---
# <a name="ruleinfotype-complextype-visio-xml"></a>RuleInfo_Type complexType ('XML de Visio')
...
|:-----|:-----|:-----|:-----|:-----|
|Identificador de regla  <br/> |xsd:unsignedInt  <br/> |necesario  <br/> ||Valores del tipo xsd:unsignedInt.  <br/> |
|RuleSetID  <br/> |xsd:unsignedInt  <br/> |necesario  <br/> ||Valores del tipo xsd:unsignedInt.  <br/> |

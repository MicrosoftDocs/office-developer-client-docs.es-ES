...
El valor de la celda LockThemeColors corresponde a la opción de casilla de verificación **contra colores del tema** en el cuadro de diálogo **protección** . 
...
Para hacer referencia a la celda LockThemeColors por su índice desde un programa, utilice la propiedad **CellsSRC** con los argumentos siguientes: 

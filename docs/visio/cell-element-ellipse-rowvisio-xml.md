...
---
# <a name="cell-element-ellipse-row-visio-xml"></a>Elemento Cell (fila Ellipse) (Visio XML)
...
|:-----|:-----|:-----|
|[Elemento Row (Geometry)](row-element-geometry-sectionvisio-xml.md) <br/> |[Ellipse_Type](ellipse_type-complextypevisio-xml.md) <br/> |Contiene las coordenadas x o y del punto central de la elipse y dos puntos en la elipse.  <br/> |
...
|B  <br/> |Coordenada y del primer punto de la elipse; emparejado con una coordenada x representada por la celda A.  <br/> |[Fila Ellipse (Sección de Geometría)](ellipse-row-geometry-section.md) <br/> |

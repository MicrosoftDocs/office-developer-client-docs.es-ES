...
Contiene las coordenadas x o y del punto central de la elipse y de dos puntos de la elipse.
...
|:-----|:-----|:-----|
|[Elemento Row (geometría)](row-element-geometry-sectionvisio-xml.md) <br/> |[Ellipse_Type](ellipse_type-complextypevisio-xml.md) <br/> |Contiene las coordenadas x o y del punto central de la elipse y de dos puntos de la elipse.  <br/> |
...
|A  <br/> |Coordenada x del primer punto de la elipse; emparejado con la coordenada y representada por la celda B.  <br/> |[Fila Ellipse (Sección de Geometría)](ellipse-row-geometry-section.md) <br/> |
|B  <br/> |Coordenada y del primer punto de la elipse; emparejado con la coordenada x representada por la celda A.  <br/> |[Fila Ellipse (Sección de Geometría)](ellipse-row-geometry-section.md) <br/> |
|C  <br/> |Coordenada x del segundo punto de la elipse; emparejado con la coordenada y representada por la celda D.  <br/> |[Fila Ellipse (Sección de Geometría)](ellipse-row-geometry-section.md) <br/> |
|D  <br/> |Coordenada y del segundo punto de la elipse; emparejado con la coordenada y representada por la celda C.  <br/> |[Fila Ellipse (Sección de Geometría)](ellipse-row-geometry-section.md) <br/> |

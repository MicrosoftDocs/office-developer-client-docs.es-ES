...
> [!NOTE]
> Las referencias a los ensamblados Microsoft.Office.Interop.InfoPath.dll y Microsoft.Office.Interop.InfoPath.Xml.dll de interoperabilidad necesarios para los proyectos de automatización externa de InfoPath deben establecerse manualmente. Para obtener más información sobre la automatización externa, vea Escenarios y [ejemplos de automatización externa.](external-automation-scenarios-and-examples.md) 

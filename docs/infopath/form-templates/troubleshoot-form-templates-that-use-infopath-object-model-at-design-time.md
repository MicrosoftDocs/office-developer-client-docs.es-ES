...
No obstante, si es necesario, existe una forma de superar esta limitación. Para obtener información, vea [Threading Support in InfoPath Projects Using the InfoPath 2003 Object Model](threading-support-in-infopath-projects-using-the-infopath-2003-object-model.md).

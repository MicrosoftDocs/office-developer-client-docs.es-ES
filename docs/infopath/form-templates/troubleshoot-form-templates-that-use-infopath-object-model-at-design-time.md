...
No obstante, si es necesario, existe una forma de superar esta limitación. Para obtener información, vea Compatibilidad con subprocesos en proyectos de InfoPath mediante el modelo de objetos de [InfoPath 2003](threading-support-in-infopath-projects-using-the-infopath-2003-object-model.md).

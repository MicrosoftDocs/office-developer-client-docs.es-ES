...
---
# <a name="respond-to-form-events-using-the-infopath-2003-object-model"></a>Responder a eventos de formulario mediante el modelo de objetos de InfoPath 2003
...
|**Nombre**|**Controladores de eventos**|**Descripción**|
|:-----|:-----|:-----|

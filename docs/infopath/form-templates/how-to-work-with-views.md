...
|**Nombre**|**Descripción**|
|:-----|:-----|
|[DisableAutoUpdate (método)](https://msdn.microsoft.com/library/Microsoft.Office.InfoPath.View.DisableAutoUpdate.aspx)  <br/> |Deshabilita la sincronización automática entre el documento XML subyacente de un formulario y la vista asociada.  <br/> |
|[EnableAutoUpdate (método)](https://msdn.microsoft.com/library/Microsoft.Office.InfoPath.View.EnableAutoUpdate.aspx)  <br/> |Habilita la sincronización automática entre el documento XML subyacente de un formulario y la vista asociada.  <br/> |
...
|[Export (método)](https://msdn.microsoft.com/library/Microsoft.Office.InfoPath.View.Export.aspx)  <br/> |Exporta la vista a un archivo con el formato especificado.  <br/> |
|[ForceUpdate (método)](https://msdn.microsoft.com/library/Microsoft.Office.InfoPath.View.ForceUpdate.aspx)  <br/> |Fuerza la sincronización automática entre el documento XML subyacente de un formulario y la vista asociada.  <br/> |
...
|[ShowMailItem (método)](https://msdn.microsoft.com/library/Microsoft.Office.InfoPath.View.ShowMailItem.aspx)  <br/> |Crea un mensaje de correo electrónico que contiene la vista actual.  <br/> |
|[ViewInfo (propiedad)](https://msdn.microsoft.com/library/Microsoft.Office.InfoPath.View.ViewInfo.aspx)  <br/> |Obtiene una referencia a un [objeto ViewInfo](https://msdn.microsoft.com/library/Microsoft.Office.InfoPath.ViewInfo.aspx) asociado a la vista.  <br/> |
|[Window (propiedad)](https://msdn.microsoft.com/library/Microsoft.Office.InfoPath.View.Window.aspx)  <br/> |Obtiene una referencia a un [objeto Window](https://msdn.microsoft.com/library/Microsoft.Office.InfoPath.Window.aspx) asociado a la vista.  <br/> |

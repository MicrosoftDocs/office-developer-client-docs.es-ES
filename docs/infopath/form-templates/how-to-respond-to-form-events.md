---
title: Responder a eventos de formularios
manager: soliver
ms.date: 03/09/2015
...
ms.locfileid: "19815909"
---
# <a name="respond-to-form-events"></a>Responder a eventos de formularios
...
Para obtener información acerca de cómo crear controladores de eventos de InfoPath, vea [Agregar un controlador de eventos](how-to-add-an-event-handler.md).
...
|**Loading** <br/> |[LoadingEventArgs](https://msdn.microsoft.com/library/Microsoft.Office.InfoPath.LoadingEventArgs.aspx) <br/> |Especifica la vista en que se debe abrir el formulario una vez que se ha cargado.  <br/> Obtiene una referencia al objeto **XmlFormCancelEventArgs**.  <br/> Obtiene una **colección IDictionary** que contiene cualquier entrada parámetros especificados mediante la `/InputParameters` opción de línea de comandos o especificados mediante parámetros en una dirección URL de la consulta para abrir el formulario.  <br/> |
...
|**Save** <br/> |[SaveEventArgs](https://msdn.microsoft.com/library/Microsoft.Office.InfoPath.SaveEventArgs.aspx) <br/> |Realiza la operación de guardar solicitada por el usuario.  <br/> Obtiene una referencia al objeto **SaveCancelEventArgs** que se puede usar para cancelar el evento.  <br/> Obtiene el nombre de archivo utilizado en el controlador de eventos para el evento.  <br/> Obtiene si la operación de guardado se realizará como una operación "guardar" o "guardar como".  <br/> |

...
---
# <a name="write-conditional-logic-that-determines-the-run-time-environment"></a>Escritura de lógica condicional que determina el entorno en tiempo de ejecución

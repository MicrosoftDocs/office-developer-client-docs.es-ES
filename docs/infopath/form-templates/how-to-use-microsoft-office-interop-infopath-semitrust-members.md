...
Después de crear una variable del tipo de versión posterior _ **XDocument3** o **_Application3,** puede usarla para tener acceso a un objeto o miembro que proporciona nuevas funciones de InfoPath. 
  
En el siguiente ejemplo se muestra cómo usar una variable de objeto de  tipo _ **XDocument3** con la propiedad [de](https://msdn.microsoft.com/library/Microsoft.Office.Interop.InfoPath.SemiTrust._XDocument3.Permission.aspx) acceso Permission para tener acceso a la nueva interfaz de permisos y su propiedad [Enabled](https://msdn.microsoft.com/library/Microsoft.Office.Interop.InfoPath.SemiTrust.Permission.Enabled.aspx) para determinar si la configuración de permisos está habilitada para el formulario. 

---
title: Obtener acceso a datos del formulario
manager: soliver
ms.date: 12/07/2015
...
---
# <a name="access-form-data"></a>Obtener acceso a datos del formulario
...
|[Método NewFromFormTemplate(String, String, XmlFormOpenMode)](https://msdn.microsoft.com/library/Microsoft.Office.InfoPath.XmlFormCollection.NewFromFormTemplate.aspx) (sobrecarga 2)  <br/> |Crea un nuevo formulario basado en la plantilla de formulario especificada con los datos especificados por un [objeto XPathNavigator](https://msdn.microsoft.com/library/system.xml.xpath.xpathnavigator%28v=vs.110%29.aspx) .  <br/> |
...
|[Propiedad hospedada](https://msdn.microsoft.com/library/Microsoft.Office.InfoPath.XmlForm.Hosted.aspx)  <br/> |Obtiene información sobre si InfoPath está hospedada como control en otra aplicación.  <br/> |
|[HostName (propiedad)](https://msdn.microsoft.com/library/Microsoft.Office.InfoPath.XmlForm.HostName.aspx)  <br/> |Obtiene el nombre de la aplicación que hospeda a InfoPath como control.  <br/> |
...
|[Nueva propiedad](https://msdn.microsoft.com/library/Microsoft.Office.InfoPath.XmlForm.New.aspx)  <br/> |Obtiene un valor que especifica si un formulario es nuevo.  <br/> |
|[Propiedad Permission](https://msdn.microsoft.com/library/Microsoft.Office.InfoPath.XmlForm.Permission.aspx)  <br/> |Obtiene una referencia a un [objeto Permission](https://msdn.microsoft.com/library/Microsoft.Office.InfoPath.Permission.aspx) asociado al formulario.  <br/> |
|[QueryDataConnection (propiedad)](https://msdn.microsoft.com/library/Microsoft.Office.InfoPath.XmlForm.QueryDataConnection.aspx)  <br/> |Obtiene una referencia al [objeto DataConnection](https://msdn.microsoft.com/library/Microsoft.Office.InfoPath.DataConnection.aspx) que representa la conexión de datos asociada con el formulario.  <br/> |
...
|[Propiedad recuperada](https://msdn.microsoft.com/library/Microsoft.Office.InfoPath.XmlForm.Recovered.aspx)  <br/> |Obtiene un valor que indica si un formulario se guardó la última vez mediante una operación de guardado de Autorrecuperación.  <br/> |
...
|[SignedDataBlocks (propiedad)](https://msdn.microsoft.com/library/Microsoft.Office.InfoPath.XmlForm.SignedDataBlocks.aspx)  <br/> |Obtiene una referencia a la [colección SignedDataBlockCollection](https://msdn.microsoft.com/library/Microsoft.Office.InfoPath.SignedDataBlockCollection.aspx) asociada a un formulario.  <br/> |
|[Propiedad TaskPanes](https://msdn.microsoft.com/library/Microsoft.Office.InfoPath.XmlForm.TaskPanes.aspx)  <br/> |Obtiene una referencia a [la TaskPaneCollection](https://msdn.microsoft.com/library/Microsoft.Office.InfoPath.TaskPaneCollection.aspx) que está asociada a una plantilla de formulario.  <br/> |

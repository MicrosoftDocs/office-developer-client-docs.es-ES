...
El nivel más elevado de confianza que se puede conceder a una plantilla de formulario lo determina la ubicación desde donde se abre y otro código de comprobación, como se describe en la tabla siguiente. Los atributos enumerados en la tabla (por ejemplo, HTTP, UNC,  *requireFullTrust*) son entradas que se usan para determinar el nivel de confianza que se puede conceder a un formulario y se aplican a los formularios abiertos en el cliente de InfoPath. 
...
|**Valor de nombre**|**Bloquear**|**Interfaz de usuario**|**Permitir**|
|:-----|:-----|:-----|:-----|
|**Internet** <br/> |X  <br/> |||
|**Intranet** <br/> ||X  <br/> ||

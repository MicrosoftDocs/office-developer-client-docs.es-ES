...
Si firma digitalmente una plantilla de formulario, puede establecer el nivel de seguridad de la plantilla de formulario en Plena confianza, lo que significa que el formulario puede tener acceso a los archivos y la configuración en el equipo del usuario o en un dominio diferente. (Además, firmar digitalmente una plantilla de formulario no le impide usar otros niveles de seguridad, si lo prefiere. Se establece el nivel de seguridad de una plantilla de formulario firmada en el nivel de seguridad Dominio o Restringido). Además, puede implementar la plantilla de formulario firmada para los usuarios que usan un programa de correo electrónico y, después, actualizar automáticamente la plantilla de formulario firmada enviando la versión actualizada a los usuarios como datos adjuntos a un mensaje de correo electrónico, siga estos pasos:

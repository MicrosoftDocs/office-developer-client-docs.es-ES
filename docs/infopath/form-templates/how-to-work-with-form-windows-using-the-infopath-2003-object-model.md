...
|**Nombre**|**Descripción**|
|:-----|:-----|
|[Count](https://msdn.microsoft.com/library/Microsoft.Office.Interop.InfoPath.SemiTrust.Windows.Count.aspx) (propiedad)  <br/> |Devuelve el número de objetos **Window** que contiene una colección.  <br/> |
...
|[Active](https://msdn.microsoft.com/library/Microsoft.Office.Interop.InfoPath.SemiTrust.Window2.Active.aspx) (propiedad)  <br/> |Devuelve un valor **Boolean** que indica si la ventana es la que está activa en ese momento  <br/> |**Tanto el **xdDesignWindow** tipo xdeditorwindow**  <br/> |
|[Caption](https://msdn.microsoft.com/library/Microsoft.Office.Interop.InfoPath.SemiTrust.Window2.Caption.aspx) (propiedad)  <br/> |Propiedad de lectura y escritura que devuelve o establece el texto del título de la ventana representada por el objeto **Window**.  <br/> |Sólo el tipo **xdEditorWindow**  <br/> |
...
|[Ancho](https://msdn.microsoft.com/library/Microsoft.Office.Interop.InfoPath.SemiTrust.Window2.Width.aspx) (propiedad)  <br/> |Una propiedad de lectura y escritura del tipo de entero largo que especifica el ancho de la ventana representada por el objeto **Window**, se mide en puntos.  <br/> |**Tanto el **xdDesignWindow** tipo xdeditorwindow**  <br/> |

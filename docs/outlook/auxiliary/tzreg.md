...
Define cuándo se inicia el horario de verano, cuándo se produce el retorno a la hora estándar y cuántas horas es el turno de verano.
...
> Desplazamiento de sesgo durante el tiempo estándar.
    
_lDaylightBias_
  
> Desplazamiento de sesgo durante el horario de verano.
    
_stStandardDate_
  
> Hora de cambiar a la hora estándar.
...
Esta estructura es similar a **TIME_ZONE_INFORMATION**. Esta es la estructura usada por los clientes heredados para almacenar información de zona horaria para reuniones periódicas.

...
En la tabla siguiente se enumeran los valores posibles. Consulte [Constantes (API de administración de cuentas)](constants-account-management-api.md) para obtener más información sobre las constantes. 

...
Especifica el método de autenticación que se debe usar para la cuenta SMTP.
...
- **SMTP_AUTH_SAME_AS_POP** significa usar las mismas credenciales que mi servidor de correo entrante, tal como PROP_INET_USER [y](prop_inet_user.md) [PROP_INET_PASSWORD](prop_inet_password.md).

...
|E_INVALIDARG  <br/> | *Tal como se define en el archivo de encabezado winerror.h del Kit de desarrollo de software (SDK) de Windows.*  <br/> |
|E_NOTIMPL  <br/> | *Tal como se define en el archivo de encabezado winerror.h de Windows SDK.*  <br/> |
...
|La propiedad ENCRYPT_ usa las siguientes constantes que comienzan por [PROP_SMTP_SECURE_CONNECTION](prop_smtp_secure_connection.md) para especificar el tipo de conexión cifrada.  <br/> ||
...
|La propiedad SMTP_ usa las siguientes constantes que comienzan por [PROP_SMTP_AUTH_METHOD](prop_smtp_auth_method.md) y especifican el método de autenticación.  <br/> ||
...
Usa la DEFINE_GUID macro definida en el archivo de encabezado guiddef.h de Windows SDK para asociar el nombre simbólico GUID con su valor.

...
- [Localizar el mensaje de historial para una cuenta POP3 de descarga](locating-the-message-download-history-for-a-pop3-account.md): en este tema se describe cómo un cliente de correo obtiene acceso a la propiedad [PidTagAttachDataBinary](http://msdn.microsoft.com/library/3b0a8b28-863e-4b96-a4c0-fdb8f40555b9%28Office.15%29.aspx) para obtener el historial UIDL para los mensajes en la Bandeja de entrada de una cuenta POP3 de cliente. 

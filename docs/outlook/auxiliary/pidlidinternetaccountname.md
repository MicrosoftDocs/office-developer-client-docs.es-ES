...
Esta propiedad debe contener el mismo valor que devuelve la propiedad de la API de administración de cuentas [PROP_ACCT_NAME](prop_acct_name.md) para la cuenta que entregó el mensaje. 

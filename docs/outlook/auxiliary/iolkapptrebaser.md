...
Admite el rebasado de citas en una carpeta de calendario.
...
|Expuesto en:  <br/> |Outlook objeto de rebasado  <br/> |
...
|**[BeginRebaseAppointments](iolkapptrebaser-beginrebaseappointments.md)** <br/> |Inicia una tarea para el rebasamiento de citas dada una lista de citas, normalmente obtenida de **EndEnumerateAppointments**.  <br/> |

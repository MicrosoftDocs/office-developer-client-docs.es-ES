...
7. Si se produce un error en el paso 6, cambie la restricción para usar [PidTagSubject](http://msdn.microsoft.com/library/aa7ba4d9-c5e0-4ce7-a34e-65f675223bc9%28Office.15%29.aspx) (**PR_SUBJECT**) que se va a igual que el valor siguiente (se muestra a continuación utilizando `printf` estilo sustitución por razones de brevedad). 
...
1. Buscar datos adjuntos cuya [PidTagAttachLongFilename](http://msdn.microsoft.com/library/83b69e8f-0b5a-4992-b5b8-160d3bdfa22a%28Office.15%29.aspx) (**PR_ATTACH_LONG_FILENAME**) coincide con la cadena siguiente, donde `szEmailAddress` es la dirección del usuario SMTP, tal como se especifica en el perfil del usuario. . 
    
   ```cpp
    "BlobPOP%s", szEmailAddress
   ```

2. Buscar datos adjuntos cuya [PidTagAttachFilename](http://msdn.microsoft.com/library/cbf34dd6-7733-47f6-9c41-9d82656ca9dc%28Office.15%29.aspx) (**PR_ATTACH_FILENAME**) coincide con "BlobPOP %s", `szEmailAddress`.
    
3. Buscar datos adjuntos cuya [PidTagDisplayName](http://msdn.microsoft.com/library/bd094e00-5c60-4bb3-9a45-b943fab52876%28Office.15%29.aspx) (**PR_DISPLAY_NAME**) coincide con "BlobPOP %s", `szEmailAddress`.

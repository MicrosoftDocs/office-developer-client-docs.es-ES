...
Abre una sesión MAPI y mantiene una referencia a la sesión del administrador de cuentas.
...
> contempla La sesión MAPI actual.
...
Debido a problemas de referencia circular, el administrador de cuentas en sí no puede mantener la referencia para la sesión MAPI.

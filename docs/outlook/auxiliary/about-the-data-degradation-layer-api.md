...
La API de la capa de degradación de datos permite ocultar el formato de caracteres nativos subyacente de un objeto de Outlook, lo que permite a un cliente tener acceso al objeto en un formato de carácter preferido en lugar de hacerlo en el formato de carácter nativo del objeto. Proporciona las definiciones de constantes que se muestran en [constantes (API de capa de degradación de datos)](constants-data-degradation-layer-api.md)y la función [HrCreateNewWrappedObject](hrcreatenewwrappedobject.md) que devuelve un objeto de Outlook ajustado en un formato especificado. 

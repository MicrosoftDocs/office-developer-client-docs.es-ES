...
En la clave, `<domain name>` está el dominio para la configuración automática. Este nombre de dominio solo admite un \* carácter comodín al principio. En la tabla siguiente se muestran los valores que admite esta clave. 
...
|Ubicación de instalación  <br/> |REG_SZ  <br/> |La dirección URL de la ubicación para instalar el proveedor de servicios de mensajes, si aún no está instalada.  <br/> |
|Versión mínima  <br/> |REG_DWORD  <br/> |La versión mínima del archivo .dll del proveedor de servicios de mensajes que se requiere. Este valor es opcional.  <br/> |

...
---
# <a name="constants-data-degradation-layer-api"></a>Constantes (API de capa de degradación de datos)

Este tema contiene definiciones de constantes para la API de capa de degradación de datos.

...
description: Representa el nombre del servidor de un buzón general de Internet.
...
Representa el nombre del servidor de un buzón general de Internet.
...
|Etiqueta de propiedad:  <br/> |0x0100001F  <br/> |

...
Informa del progreso de la enumeración y el reasumenado de las citas.
...
> [entrada] El extremo bajo del intervalo de citas que se está procesando. Normalmente es cero.
    
_ulMax_
  
> [entrada] El extremo superior del intervalo de citas que se está procesando. Normalmente es el número de elementos de la carpeta de calendario que se está procesando.
    
_ulCur_
  
> [entrada] Elemento actual que se está procesando.
    
_State_
  
> [entrada] Valor que indica el estado del elemento que se está procesando. La **enumeración REBASE_APPT_STATE** se define en tzmovelib.h.  _State_ es uno de los siguientes valores: 
   ...
   - **REBASE_APPT_STATE_DONE:** corregir y realizar con un elemento. 
    
_pRowCur_
  
> [entrada] Puntero a una **[estructura SRow](https://msdn.microsoft.com/library/369c2d5c-8c2b-4314-9cb2-aaa89580aa2b%28Office.15%29.aspx)** que describe el elemento que se está analizando o fijando. 

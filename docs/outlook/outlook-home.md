...
- [Referencia de VBA para Outlook](https://docs.microsoft.com/office/vba/api/overview/outlook)
...
- [Introducción a los complementos de Outlook](https://docs.microsoft.com/outlook/add-ins/quick-start?tabs=visual-studio)
  
- [Información general sobre la plataforma](https://docs.microsoft.com/office/dev/add-ins/overview/office-add-ins)
  
### <a name="code-samples"></a>Ejemplos de código
  
- [Ejemplos de código de Outlook en el centro de desarrollo de Office](https://developer.microsoft.com/office/gallery/?filterBy=Samples,Outlook)

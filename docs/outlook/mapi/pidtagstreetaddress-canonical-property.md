...
---
# <a name="pidtagstreetaddress-canonical-property"></a>Propiedad canónico PidTagStreetAddress
...
|||
|:-----|:-----|
|Propiedades asociadas:  <br/> |PR_STREET_ADDRESS, PR_STREET_ADDRESS_A, PR_STREET_ADDRESS_W, PR_BUSINESS_ADDRESS_STREET, PR_BUSINESS_ADDRESS_STREET_A, PR_BUSINESS_ADDRESS_STREET_W  <br/> |

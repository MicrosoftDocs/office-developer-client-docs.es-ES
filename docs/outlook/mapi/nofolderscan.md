...
Esta propiedad proporciona una forma de que los proveedores de almacenes especifiquen Outlook para no examinar carpetas de contactos en el almacén para evitar la degradación del rendimiento. Se usa en operaciones de combinación de correspondencia durante las cuales Outlook comprueba la presencia y el valor de esta propiedad antes de iniciar el examen.
  
De forma predeterminada, esta propiedad no se expone en un almacén, lo que significa Outlook puede examinar la carpeta Contactos en el almacén. Si se expone la propiedad, los siguientes son los valores posibles:
  
- Cero (0): Outlook puede llevar a cabo el examen.
    
- Valor distinto de cero: Outlook no debe examinar carpetas de contactos en el almacén.

...
[<span data-ttu-id="7a762-116">GetUserDefaultLCID</span><span class="sxs-lookup"><span data-stu-id="7a762-116">GetUserDefaultLCID</span></span>](http://msdn.microsoft.com/es-es/library/dd318135%28VS.85%29.aspx)

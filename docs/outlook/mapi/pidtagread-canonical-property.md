---
title: Propiedad canónico PidTagRead
manager: soliver
ms.date: 03/09/2015
...
---
# <a name="pidtagread-canonical-property"></a>Propiedad canónico PidTagRead

  
  
**Se aplica a**: Outlook 
  
Indica si se ha leído una fila de tabla.
  
|||
|:-----|:-----|
|Propiedades asociadas:  <br/> |PR_READ  <br/> |

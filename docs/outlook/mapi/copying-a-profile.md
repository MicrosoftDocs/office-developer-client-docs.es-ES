...
Una forma de crear un perfil es copiar desde un perfil existente y modificar los servicios de mensajes y los proveedores de servicios necesarios. Copiar un perfil implica el uso de un objeto de administración de perfiles, proporcionado por MAPI a través de la [función MAPIAdminProfiles.](mapiadminprofiles.md) 
  
 **Para copiar un perfil**
  
1. Llama **a MAPIAdminProfiles** para recuperar un puntero de **interfaz IProfAdmin.** 
...
5. Llame [a IProfAdmin::CopyProfile](iprofadmin-copyprofile.md), pasando el valor de la **columna PR_DISPLAY_NAME** como el parámetro _lpszOldProfileName._ 

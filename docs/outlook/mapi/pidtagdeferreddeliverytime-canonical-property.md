...
Contiene la fecha y la hora en que un remitente del mensaje quiere entregar un mensaje. 
...
MAPI no realiza la entrega diferida; es una opción del sistema de mensajería subyacente para controlar la entrega diferida.

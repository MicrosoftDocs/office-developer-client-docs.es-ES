...
Contiene una lista de los meses durante los que los datos de disponibilidad del tipo ocupado o un mensaje de fuera de la oficina (OOF) están presentes en el mensaje de disponibilidad. 

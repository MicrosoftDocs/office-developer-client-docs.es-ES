...
|IDENTIFICADOR largo (LID):  <br/> |0x0000000C  <br/> |
|Tipo de datos:  <br/> |PT_LONG  <br/> |
|Área:  <br/> |Meetings  <br/> |
   
## <a name="remarks"></a>Comentarios

Esta propiedad sólo se lee si no se establece la propiedad **dispidApptRecur** ([PidLidAppointmentRecur](pidlidappointmentrecur-canonical-property.md)), pero si la propiedad **LID_IS_RECURRING** ([PidLidIsRecurring](pidlidisrecurring-canonical-property.md)) es true y el **LID_IS_EXCEPTION** ([ PidLidIsException](pidlidisexception-canonical-property.md)) es false. La palabra inferior especifica un índice en una tabla que contiene información de la zona horaria. Desde la palabra superior, solo se lee el bit más alto. Si se establece ese bit, la zona horaria a la que se hace referencia no observará el horario de verano (DST), de lo contrario, se seguirán las fechas de horario de verano detalladas en [[ms-OXOCAL]](https://msdn.microsoft.com/library/09861fde-c8e4-4028-9346-e7c214cfdba1%28Office.15%29.aspx) . 

...
Contiene el dispositivo de telecomunicaciones del usuario de mensajería para el número de teléfono para personas sordas (TTYTDD).
  
|||
|:-----|:-----|
|Propiedades asociadas:  <br/> |PR_TTYTDD_PHONE_NUMBER, PR_TTYTDD_PHONE_NUMBER_A, PR_TTYTDD_PHONE_NUMBER_W  <br/> |

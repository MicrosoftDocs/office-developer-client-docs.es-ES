...
Cuando un proveedor de almacén notifica a un indizador que un objeto está listo para la indización, genera una dirección URL MAPI que identifica de forma única el objeto al controlador de protocolo MAPI. Las direcciones URL MAPI se codifican en Unicode y tienen el siguiente formato: 
...
Ciertos caracteres se codifican si aparecen en el mensaje o los datos adjuntos. A continuación se muestran los caracteres codificados en una dirección URL MAPI:
...
El proveedor de almacenamiento debe escribir estos valores en el BLOB en el orden que se muestra. En la tabla siguiente se describe cada campo del BLOB.
...
|*cbProviderItemID* |Tamaño del identificador del elemento del proveedor, en bytes. El proveedor de almacenamiento debe enviar solo el identificador de elemento del proveedor para las carpetas, para evitar que se abran carpetas adicionales para obtener esta información.|

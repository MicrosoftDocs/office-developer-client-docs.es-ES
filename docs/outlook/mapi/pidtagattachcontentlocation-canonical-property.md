...
Contiene el encabezado de ubicación de contenido de un archivo adjunto de mensaje de Extensiones multipropósito al correo de Internet (MIME). 
...
Estas propiedades se usan para la compatibilidad con MHTML. Representan el encabezado de ubicación de contenido para la parte correspondiente del cuerpo MIME. 

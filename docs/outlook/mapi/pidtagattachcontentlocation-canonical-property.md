...
Contiene el encabezado de ubicación de contenido de un archivo adjunto de mensaje Multipurpose Internet Mail Extensions (MIME). 
...
Estas propiedades se usan para la compatibilidad con MHTML. Representan el encabezado de ubicación de contenido de la parte del cuerpo MIME correspondiente. 

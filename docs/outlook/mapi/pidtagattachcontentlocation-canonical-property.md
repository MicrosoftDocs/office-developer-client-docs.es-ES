...
Contiene el encabezado de ubicación de contenido de un mensaje adjunto de extensiones multipropósito de correo Internet (MIME). 
...
Estas propiedades se usan para la compatibilidad con MHTML. Representan el encabezado de ubicación de contenido para la parte de cuerpo MIME correspondiente. 

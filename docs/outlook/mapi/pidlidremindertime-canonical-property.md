...
Especifica la hora de la señal inicial de un aviso.
  
|||
|:-----|:-----|
|Propiedades asociadas:  <br/> |dispidReminderTime  <br/> |
|Conjunto de propiedades:  <br/> |PSETID_Common  <br/> |
|IDENTIFICADOR largo (LID):  <br/> |0x00008502  <br/> |
|Tipo de datos:  <br/> |PT_SYSTIME  <br/> |
|Área:  <br/> |Recordatorio  <br/> |
   
## <a name="remarks"></a>Comentarios

Para los objetos de calendario, esta propiedad representa la hora en que el usuario tardará más tiempo, que es la hora de inicio de la cita. Los clientes deben establecer el valor en la hora universal coordinada (UTC).

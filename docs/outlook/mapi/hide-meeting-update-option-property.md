...
---
# <a name="hide-meeting-update-option-property"></a>Hide Meeting Update Option (propiedad)
...
Un proveedor de almacenamiento que usa un servidor para enviar actualizaciones de reuniones puede modificar el cuadro de **diálogo Enviar actualización a los asistentes.** Esta funcionalidad es útil porque cuando el servidor envía una actualización de reunión, el servidor no sabe qué asistentes han sido agregados o eliminados por el usuario desde la solicitud de reunión inicial. Cuando esta propiedad es **true,** la opción Enviar actualización solo a **asistentes agregados** o eliminados no se muestra en el cuadro de diálogo Enviar actualización a **asistentes.** 

...
---
# <a name="pidlidlogdocumentsaved-canonical-property"></a>Propiedad canónico PidLidLogDocumentSaved
...
|||
|:-----|:-----|
|Propiedades asociadas:  <br/> |dispidLogDocSaved  <br/> |
|Conjunto de propiedades:  <br/> |PSETID_Log  <br/> |
|Identificador de tipo Long (LID):  <br/> |0x0000870F  <br/> |

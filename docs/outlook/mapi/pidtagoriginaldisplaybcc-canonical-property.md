...
Contiene los nombres para mostrar de los destinatarios con copia oculta (CCO) del mensaje original.
...
Estas propiedades contienen una lista separada por punto y coma. MAPI los proporciona y se copian directamente de **PR_DISPLAY_BCC** ([PidTagDisplayBcc](pidtagdisplaybcc-canonical-property.md)) cuando se genera un informe de entrega o de no entrega o un informe de leído o no leído. Estas propiedades pueden estar presentes en otros mensajes según la definición de sus clases de mensaje.

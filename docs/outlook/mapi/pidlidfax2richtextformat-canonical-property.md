...
Especifica el formato de texto enriquecido de la dirección de fax del contacto particular. 
  
|||
|:-----|:-----|
|Propiedades asociadas:  <br/> |dispidFax2RTF  <br/> |
|Conjunto de propiedades:  <br/> |PSETID_Address  <br/> |
|IDENTIFICADOR largo (LID):  <br/> |0x000080C6  <br/> |

...
Contiene un recuento de los caracteres significativos del texto del mensaje.
...
La [función RTFSync](rtfsync.md) calcula el número de caracteres del texto usando solo aquellos que considera significativos para el mensaje. Por ejemplo, en el recuento se omiten algunos espacios en blanco y otros caracteres que se pueden pasar por alto. 

...
La [función RTFSync](rtfsync.md) calcula el recuento de caracteres del texto usando solo los que considera significativos para el mensaje. Por ejemplo, se omiten algunos espacios en blanco y otros caracteres ignorables del recuento. 

...
Contiene los tipos de información codificados (EIT) que se aplican a un mensaje en tránsito para describir las conversiones.
  
|||
|:-----|:-----|
|Propiedades asociadas:  <br/> |PR_CONVERSION_EITS  <br/> |

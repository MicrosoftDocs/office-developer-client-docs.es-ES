...
Contiene TRUE si las conversiones de mensajes están prohibidas de manera predeterminada para el usuario de mensajería asociado.
  
|||
|:-----|:-----|
|Propiedades asociadas:  <br/> |PR_CONVERSION_PROHIBITED  <br/> |

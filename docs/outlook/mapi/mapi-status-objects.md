...
Para obtener más información acerca de la implementación de un objeto de estado, vea [La implementación del objeto status](status-object-implementation.md). Para obtener más información acerca del uso de un objeto de estado, vea [Tabla de estado y Objetos de estado](status-table-and-status-objects.md).

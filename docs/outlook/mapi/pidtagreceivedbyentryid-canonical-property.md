...
Contiene el identificador de entrada del usuario de mensajería que reciba el mensaje.
  
|||
|:-----|:-----|
|Propiedades asociadas:  <br/> |PR_RECEIVED_BY_ENTRYID DE MAPI  <br/> |
...
Esta propiedad corresponde a un atributo X.400 entrega envelope por mensaje MH_T_.

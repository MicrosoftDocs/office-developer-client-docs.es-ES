...
---
# <a name="upload-hierarchy-state"></a>Cargar estado de jerarquía
...
|A este estado:  <br/> |[Cargar el estado de la carpeta](upload-folder-state.md)o sincronizar el estado  <br/> |

...
---
# <a name="pidtagprimaryfaxnumber-canonical-property"></a>Propiedad canónica PidTagPrimaryFaxNumber

  
  
**Se aplica a**: Outlook 2013 | Outlook 2016 
  
Contiene el número de teléfono de máquina de fax principal del destinatario.
  
|||
|:-----|:-----|
|Propiedades asociadas:  <br/> |PR_PRIMARY_FAX_NUMBER, PR_PRIMARY_FAX_NUMBER_A, PR_PRIMARY_FAX_NUMBER_W  <br/> |

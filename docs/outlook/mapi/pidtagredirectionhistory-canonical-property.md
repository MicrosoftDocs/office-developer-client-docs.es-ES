...
Contiene información sobre la ruta cubierta por un mensaje entregado.
  
|||
|:-----|:-----|
|Propiedades asociadas:  <br/> |PR_REDIRECTION_HISTORY  <br/> |
...
Esta propiedad se usa cuando un agente automático asigna automáticamente un mensaje.

...
Si una aplicación de cliente desea recibir informes de lectura, puede dejar esta propiedad establecida o establecerla en la clave de búsqueda contenida en la propiedad **PR_SENDER_SEARCH_KEY** ([PidTagSenderSearchKey](pidtagsendersearchkey-canonical-property.md)) en la hora de envío del mensaje.

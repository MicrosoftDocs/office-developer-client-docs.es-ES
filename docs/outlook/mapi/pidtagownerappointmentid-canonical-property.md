...
Esta propiedad se usa en las convocatorias de reunión. No representa un identificador de entrada, sino un número entero largo que identifica de forma única la cita dentro de la programación del remitente.

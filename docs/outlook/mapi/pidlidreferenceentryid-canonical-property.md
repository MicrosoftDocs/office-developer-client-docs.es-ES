...
Especifica el [EntryID](entryid.md) de referencia del contacto. 
  
|||
|:-----|:-----|
|Propiedades asociadas:  <br/> |dispidReferenceEID  <br/> |
|Conjunto de propiedades:  <br/> |PSETID_Common  <br/> |
|IDENTIFICADOR largo (LID):  <br/> |0x000085BD  <br/> |
|Tipo de datos:  <br/> |PT_BINARY  <br/> |
|Área:  <br/> |Contact  <br/> |
   
## <a name="remarks"></a>Comentarios

Si está presente, esta propiedad debe ser igual al valor de **EntryId** del contacto. 

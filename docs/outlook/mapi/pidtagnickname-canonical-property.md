...
Contiene el sobrenombre del contacto.
  
|||
|:-----|:-----|
|Propiedades asociadas:  <br/> |PR_NICKNAME, PR_NICKNAME_A, PR_NICKNAME_W  <br/> |
...
Estas propiedades son opcionales. El usuario define su contenido.

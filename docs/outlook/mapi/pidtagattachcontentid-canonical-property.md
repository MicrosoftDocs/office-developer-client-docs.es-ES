...
Contiene el encabezado de identificación de contenido de un archivo adjunto de mensaje multipropósito de Extensiones de correo de Internet (MIME). 
...
Estas propiedades se usan para la compatibilidad con MHTML. Representan el encabezado de identificación de contenido de la parte del cuerpo MIME correspondiente. 

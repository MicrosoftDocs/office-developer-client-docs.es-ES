...
Contiene el tipo de dirección del usuario de mensajería en cuyo nombre se envió el mensaje original.
...
Estas propiedades son el tipo del remitente representado original de un mensaje. Se usan en un hilo de conversación.

...
> [in] **true** para incrementar el recuento de bloqueos; de lo contrario, **false**.
...
Los visores de formularios llaman **al método IMAPIFormFactory::LockServer** para mantener una aplicación de servidor de formulario abierta en la memoria. Mantener el servidor de formularios en la memoria mejora su rendimiento cuando los formularios se crean y liberan con frecuencia. 

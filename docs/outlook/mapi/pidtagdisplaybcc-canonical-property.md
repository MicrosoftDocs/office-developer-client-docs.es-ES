...
Contiene una lista ASCII de los nombres para mostrar de los destinatarios de mensajes de cualquier copia de carbón ciego (CCO), separados por punto y coma (;).
...
Si un mensaje no tiene destinatarios de copia de carbón ciego, el almacén de mensajes debe responder a una llamada [IMAPIProp::GetProps](imapiprop-getprops.md) con un valor devuelto de S_OK y una cadena vacía para **PR_DISPLAY_BCC**. 
...
- Al reenviar mensajes, los clientes no necesitan traducir los caracteres separadores en la línea de destinatario de copia de carbono ciego. 

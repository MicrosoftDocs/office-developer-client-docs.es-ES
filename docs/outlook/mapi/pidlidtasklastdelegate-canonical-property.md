...
**Se aplica a**: Outlook 2013 | Outlook 2016 
 ...
 Asigna un nombre al usuario que asignó por última vez la tarea. 
  
|||
|:-----|:-----|
|Propiedades asociadas:  <br/> |dispidTaskLastDelegate  <br/> |
|Conjunto de propiedades:  <br/> |PSETID_Task  <br/> |
|IDENTIFICADOR largo (LID):  <br/> |0x00008125  <br/> |
|Tipo de datos:  <br/> |PT_UNICODE  <br/> |
|Área:  <br/> |Tarea  <br/> |
   
## <a name="remarks"></a>Comentarios

Antes de enviar una solicitud de tarea, el cliente establece esta propiedad en el nombre del asignador de tareas. Antes de enviar una respuesta de tarea, el cliente establece esta propiedad en el nombre del usuario al que se le asigna la tarea.

...
---
# <a name="sending-messages-transport-provider-tasks"></a>Envío de mensajes: tareas del proveedor de transporte
...
- Establezca la propiedad PR_PROVIDER_SUBMIT_TIME **del** mensaje ([PidTagProviderSubmitTime](pidtagprovidersubmittime-canonical-property.md)) para indicar la fecha y la hora en que el proveedor del almacén de mensajes marcó el mensaje como enviado. 

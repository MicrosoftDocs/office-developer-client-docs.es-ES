...
---
# <a name="pidlidfax3displayname-canonical-property"></a>Propiedad canónico PidLidFax3DisplayName
...
|||
|:-----|:-----|
|Propiedades asociadas:  <br/> |dispidFax3DisplayName  <br/> |
|Conjunto de propiedades:  <br/> |PSETID_Address  <br/> |
|Identificador de tipo Long (LID):  <br/> |0x000080D0  <br/> |

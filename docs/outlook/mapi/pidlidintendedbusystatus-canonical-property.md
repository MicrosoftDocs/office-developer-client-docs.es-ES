...
Especifica el valor de la propiedad **dispidBusyStatus** ([PidLidBusyStatus](pidlidbusystatus-canonical-property.md)) de la reunión en el calendario del organizador cuando se envía la convocatoria de reunión o la actualización de la reunión.
  
|||
|:-----|:-----|
|Propiedades asociadas:  <br/> |dispidIntendedBusyStatus  <br/> |
|Conjunto de propiedades:  <br/> |PSETID_Appointment  <br/> |
|IDENTIFICADOR largo (LID):  <br/> |0x00008224  <br/> |

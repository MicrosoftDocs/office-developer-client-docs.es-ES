...
|[OpenEntry](imslogon-openentry.md) <br/> |Abre una carpeta o un objeto de mensaje y devuelve un puntero al objeto para proporcionar más acceso.  <br/> |
...
|[Aconsejar](imslogon-advise.md) <br/> |Registra un objeto con un proveedor de almacenamiento de mensajes para recibir notificaciones sobre los cambios en el almacén de mensajes.  <br/> |
|[Unadvise](imslogon-unadvise.md) <br/> |Quita el registro de un objeto para la notificación de los cambios del almacén de mensajes establecidos anteriormente mediante una llamada al método **IMSLogon::Advise.**  <br/> |

...
---
# <a name="shutting-down-a-message-store-provider"></a>Cerrando un proveedor de almacén de mensajes
...
[Cerrando un proveedor de servicios](shutting-down-a-service-provider.md)

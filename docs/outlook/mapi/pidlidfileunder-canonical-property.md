...
Especifica el nombre con el que se archivó el contacto al mostrar una lista de contactos.
  
|||
|:-----|:-----|
|Propiedades asociadas:  <br/> |dispidFileUnder  <br/> |
|Conjunto de propiedades:  <br/> |PSETID_Address  <br/> |
|IDENTIFICADOR largo (LID):  <br/> |0x00008005  <br/> |
|Tipo de datos:  <br/> |PT_UNICODE  <br/> |
|Área:  <br/> |Contact  <br/> |
   
## <a name="remarks"></a>Comentarios

La aplicación debe tratar esta propiedad como un PT_UNICODE vacío si falta en el contacto.

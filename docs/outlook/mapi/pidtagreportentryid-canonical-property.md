...
Esta propiedad es una de las propiedades de dirección para el destinatario al que el remitente ha delegado recibir los informes generados para este mensaje.

...
Indica que el objeto de mensaje incrustado de excepción tiene un cuerpo que difiere del objeto de calendario periódico.
  
|||
|:-----|:-----|
|Propiedades asociadas:  <br/> |dispidFExceptionalBody  <br/> |
|Conjunto de propiedades:  <br/> |PSETID_Appointment  <br/> |
|Id. largo (LID):  <br/> |0x00008206  <br/> |
|Tipo de datos:  <br/> |PT_BOOLEAN  <br/> |
|Área:  <br/> |Reuniones  <br/> |
   
## <a name="remarks"></a>Comentarios

Si el valor de esta propiedad es TRUE, el objeto de mensaje incrustado de excepción debe tener un cuerpo. Si el valor de esta propiedad es FALSE o si la propiedad no existe, un cliente o servidor debe obtener el cuerpo del objeto de calendario periódico.

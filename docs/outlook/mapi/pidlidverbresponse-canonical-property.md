...
Especifica la opción de votación que un encuestado seleccionó.
  
|||
|:-----|:-----|
|Propiedades asociadas:  <br/> |dispidVerbResponse  <br/> |
|Conjunto de propiedades:  <br/> |PSETID_Common  <br/> |
|IDENTIFICADOR largo (LID):  <br/> |0x00008524  <br/> |
|Tipo de datos:  <br/> |PT_UNICODE  <br/> |
|Área:  <br/> |Mensajes generales  <br/> |
   
## <a name="remarks"></a>Comentarios

Esta propiedad suele establecerse en uno de los valores delimitados que se incluyen en la propiedad **dispidVerbStream** ([PidLidVerbStream](pidlidverbstream-canonical-property.md)) en la que vota el encuestado.

...
ms.locfileid: "22581555"
---
# <a name="pidnamecharactercount-canonical-property"></a>Propiedad canónica PidNameCharacterCount

  
  
**Se aplica a**: Outlook 2013 | Outlook 2016 
  
Especifica el número de caracteres del archivo que se adjunta al documento.
  
|||
|:-----|:-----|
|Nombres descriptivos:  <br/> |Ninguna  <br/> |
|Conjunto de propiedades:  <br/> |PS_PUBLIC_STRINGS  <br/> |
|Nombre de la propiedad:  <br/> |CharCount  <br/> |

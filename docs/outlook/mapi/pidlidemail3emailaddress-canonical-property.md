---
title: Propiedad canónico PidLidEmail3EmailAddress
manager: soliver
ms.date: 03/09/2015
...
---
# <a name="pidlidemail3emailaddress-canonical-property"></a>Propiedad canónico PidLidEmail3EmailAddress
...
|||
|:-----|:-----|
|Propiedades asociadas:  <br/> |dispidEmail3EmailAddress  <br/> |
|Conjunto de propiedades:  <br/> |PSETID_Address  <br/> |
|Identificador de tipo Long (LID):  <br/> |0x000080A3  <br/> |

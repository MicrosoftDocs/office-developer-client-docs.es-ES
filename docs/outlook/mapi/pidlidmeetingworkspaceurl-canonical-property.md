...
Especifica la dirección URL del área de reuniones que está asociada con un objeto Calendar.
  
|||
|:-----|:-----|
|Propiedades asociadas:  <br/> |dispidMWSURL  <br/> |
|Conjunto de propiedades:  <br/> |PSETID_Appointment  <br/> |
|IDENTIFICADOR largo (LID):  <br/> |0x00008209  <br/> |

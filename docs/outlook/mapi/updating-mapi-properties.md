...
- Método [IMAPIProp::SetProps](imapiprop-setprops.md) de un objeto para actualizar el valor de una o más propiedades de un objeto. 
...
En el siguiente procedimiento se muestra cómo usar **SetProps** para actualizar la clase de mensaje o PR_MESSAGE_CLASS_A ([PidTagMessageClass](pidtagmessageclass-canonical-property.md)) de un mensaje. 

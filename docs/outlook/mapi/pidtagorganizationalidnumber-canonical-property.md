...
Contiene un número de identificador de organización para el contacto, como un número de identificador de empleado.
  
|||
|:-----|:-----|
|Propiedades asociadas:  <br/> |PR_ORGANIZATIONAL_ID_NUMBER, PR_ORGANIZATIONAL_ID_NUMBER_A, PR_ORGANIZATIONAL_ID_NUMBER_W  <br/> |
...
Estas son propiedades opcionales. Su uso está determinado por la organización o el usuario de mensajería.

...
---
# <a name="pidtagparententryid-canonical-property"></a>Propiedad canónico PidTagParentEntryId
...
[Propiedad canónico PidTagFolderType](pidtagfoldertype-canonical-property.md)

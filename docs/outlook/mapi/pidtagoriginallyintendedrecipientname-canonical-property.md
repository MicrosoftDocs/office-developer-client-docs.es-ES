...
---
# <a name="pidtagoriginallyintendedrecipientname-canonical-property"></a>Propiedad canónica PidTagOriginallyIntendedRecipientName
...
|||
|:-----|:-----|
|Propiedades asociadas:  <br/> |PR_ORIGINALLY_INTENDED_RECIPIENT_NAME  <br/> |

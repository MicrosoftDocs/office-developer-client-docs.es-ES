---
title: Propiedad canónico PidLidAppointmentProposedDuration
manager: soliver
ms.date: 03/09/2015
...
---
# <a name="pidlidappointmentproposedduration-canonical-property"></a>Propiedad canónico PidLidAppointmentProposedDuration

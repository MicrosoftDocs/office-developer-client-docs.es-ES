...
## <a name="see-also"></a><span data-ttu-id="9c878-110">Vea también</span><span class="sxs-lookup"><span data-stu-id="9c878-110">See also</span></span>

- [<span data-ttu-id="9c878-111">Información general sobre programación de MAPI</span><span class="sxs-lookup"><span data-stu-id="9c878-111">MAPI Programming Overview</span></span>](mapi-programming-overview.md)

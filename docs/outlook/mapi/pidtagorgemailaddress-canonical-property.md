...
Contiene la dirección de correo electrónico de la cuenta de correo electrónico de origen.
  
|||
|:-----|:-----|
|Propiedades asociadas:  <br/> |PR_ORG_EMAIL_ADDRESS, PR_ORG_EMAIL_ADDRESS_A, PR_ORG_EMAIL_ADDRESS_W  <br/> |
|Identificador:  <br/> |Por determinar  <br/> |

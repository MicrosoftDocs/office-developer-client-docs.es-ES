...
Especifica la fecha y la hora en que el asistente respondió a una solicitud de reunión o actualización de reunión recibida.
  
|||
|:-----|:-----|
|Propiedades asociadas:  <br/> |dispidApptReplyTime  <br/> |
|Conjunto de propiedades:  <br/> |PSETID_Appointment  <br/> |
|Id. largo (LID):  <br/> |0x00008220  <br/> |

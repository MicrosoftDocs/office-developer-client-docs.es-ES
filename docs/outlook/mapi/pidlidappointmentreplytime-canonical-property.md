...
Especifica la fecha y hora en que el asistente respondió a una convocatoria de reunión o una actualización de reunión recibidas.
  
|||
|:-----|:-----|
|Propiedades asociadas:  <br/> |dispidApptReplyTime  <br/> |
|Conjunto de propiedades:  <br/> |PSETID_Appointment  <br/> |
|IDENTIFICADOR largo (LID):  <br/> |0x00008220  <br/> |

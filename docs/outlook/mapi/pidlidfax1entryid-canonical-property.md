---
title: Propiedad canónico PidLidFax1EntryId
manager: soliver
ms.date: 03/09/2015
...
---
# <a name="pidlidfax1entryid-canonical-property"></a>Propiedad canónico PidLidFax1EntryId
...
|||
|:-----|:-----|
|Propiedades asociadas:  <br/> |dispidFax1EntryID  <br/> |
|Conjunto de propiedades:  <br/> |PSETID_Address  <br/> |
|Identificador de tipo Long (LID):  <br/> |0x000080B1  <br/> |

...
Abre el **entryID** mediante la libreta de direcciones de Exchange identificada  _por pEmsabpUID_. Esta función funciona de forma similar a [IAddrBook::OpenEntry,](iaddrbook-openentry.md) excepto que el uso de esta función garantiza que [IAddrBook::OpenEntry](iaddrbook-openentry.md) se abra mediante el proveedor de libreta de direcciones de Exchange esperado. 

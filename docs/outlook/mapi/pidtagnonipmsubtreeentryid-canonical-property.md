...
Muestra el identificador de entrada de la carpeta **NON_IPM_SUBTREE** en un almacén de carpetas públicas de Exchange. 
  
|||
|:-----|:-----|
|Propiedades asociadas:  <br/> |PR_NON_IPM_SUBTREE_ENTRYID  <br/> |

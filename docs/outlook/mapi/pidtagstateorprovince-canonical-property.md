...
---
# <a name="pidtagstateorprovince-canonical-property"></a>Propiedad canónica PidTagStateOrProvince

  
  
**Se aplica a**: Outlook 2013 | Outlook 2016 
  
Contiene el nombre del estado o la provincia del destinatario.
  
|||
|:-----|:-----|
|Propiedades asociadas:  <br/> |PR_STATE_OR_PROVINCE, PR_STATE_OR_PROVINCE_A, PR_STATE_OR_PROVINCE_W, PR_BUSINESS_ADDRESS_STATE_OR_PROVINCE, PR_BUSINESS_ADDRESS_STATE_OR_PROVINCE_A, PR_BUSINESS_ADDRESS_STATE_OR_PROVINCE_W  <br/> |

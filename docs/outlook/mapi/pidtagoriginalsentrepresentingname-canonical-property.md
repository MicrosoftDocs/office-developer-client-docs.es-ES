...
Estas propiedades muestran ejemplos de las propiedades de dirección para el remitente original representado de un mensaje. Se usa en un hilo de conversación.

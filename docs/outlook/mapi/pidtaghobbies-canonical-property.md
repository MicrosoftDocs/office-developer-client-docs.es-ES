...
|||
|:-----|:-----|
|Propiedades asociadas:  <br/> |PR_HOBBIES, PR_HOBBIES_A, PR_HOBBIES_W  <br/> |
...
Estas propiedades proporcionan información de identificación y acceso sobre un usuario de mensajería y el contenido se define por la organización del usuario. 

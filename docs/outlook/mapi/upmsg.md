...
Información para cargar un elemento Outlook durante el estado [del mensaje de carga](upload-message-state.md).
...
> [out]/[in] Marca para determinar el comportamiento adecuado durante la carga. 
  ...
  - UPM_HEADER
    ...
    - [salida] Item es un encabezado de mensaje.
  ...
  - UPM_COMMIT
    ...
    - [in] Confirmar el estado de carga ahora.
    
  - UPM_DELETE
    
    - [in] Elimine el elemento ahora.
    
  - UPM_SAVE
    
    - [in] Guarde los cambios en el elemento.
    
_pmsg_
  
> [salida] Abra el objeto item. Vea mapidefs.h para obtener la definición de tipo **de LPMESSAGE**. 
    
_meid_
  
> [salida] Id. de entrada del elemento.
    
_binReserved1_
  
> [in] Este miembro está reservado para el uso interno de Outlook y no es compatible. 
...
> [salida] Id. de entrada de la carpeta de origen, si se movió el elemento.

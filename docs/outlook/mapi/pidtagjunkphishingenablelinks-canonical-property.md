...
---
# <a name="pidtagjunkphishingenablelinks-canonical-property"></a>Propiedad canónica PidTagJunkPhishingEnableLinks

  
  
**Se aplica a**: Outlook 2013 | Outlook 2016 
  
Significa, si es TRUE, que debe omitirse la marca de suplantación de identidad (phishing) en el mensaje.
  
|||
|:-----|:-----|
|Propiedades asociadas:  <br/> |PR_JUNK_PHISHING_ENABLE_LINKS  <br/> |

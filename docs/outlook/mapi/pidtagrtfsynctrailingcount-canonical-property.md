...
Esta propiedad es una propiedad auxiliar de formato de texto enriquecido (RFT). Estas propiedades se usan en la función [RTFSync](rtfsync.md) y no están destinadas a ser utilizadas directamente por las aplicaciones cliente. 

...
---
# <a name="programmatically-create-a-profile-in-outlook"></a><span data-ttu-id="e057a-103">Crear mediante programación un perfil en Outlook</span><span class="sxs-lookup"><span data-stu-id="e057a-103">Programmatically create a profile in Outlook</span></span>

<span data-ttu-id="e057a-104">**Hace referencia a**: Office 365 | Outlook | Outlook 2016</span><span class="sxs-lookup"><span data-stu-id="e057a-104">**Applies to**: Office 365 | Outlook | Outlook 2016</span></span> 

<span data-ttu-id="e057a-105">En este tema se describe cómo actualizar mediante programación un perfil de Outlook 2016 agregando una propiedad MAPI a la sección **emsuid** del objeto Perfil.</span><span class="sxs-lookup"><span data-stu-id="e057a-105">This topic describes how to programmatically update a profile in Outlook 2016 by adding a MAPI property to the **emsuid** section of the Profile object.</span></span> 

<span data-ttu-id="e057a-106">En MAPI, puede actualizar un perfil estableciendo la propiedad **PR_PROFILE_USER_SMTP_EMAIL_ADDRESS_W (0x6641001F)**, como se indica en el siguiente procedimiento.</span><span class="sxs-lookup"><span data-stu-id="e057a-106">In MAPI, you can update a profile by setting the property **PR_PROFILE_USER_SMTP_EMAIL_ADDRESS_W (0x6641001F)**, as indicated in the procedure below.</span></span> 
  
### <a name="set-the-property-for-outlook-2016"></a><span data-ttu-id="e057a-107">Set the property for Outlook 2016</span><span class="sxs-lookup"><span data-stu-id="e057a-107">Set the property for Outlook 2016</span></span>

1. <span data-ttu-id="e057a-108">Make sure Outlook 2016 is property configured.</span><span class="sxs-lookup"><span data-stu-id="e057a-108">Make sure Outlook 2016 is property configured.</span></span>
    
2. <span data-ttu-id="e057a-109">Using the [IMAPIProp](https://msdn.microsoft.com/library/cc815525.aspx) interface, go to the Outlook Profile section.</span><span class="sxs-lookup"><span data-stu-id="e057a-109">Using the [IMAPIProp](https://msdn.microsoft.com/library/cc815525.aspx) interface, go to the Outlook Profile section.</span></span> 
    
   <span data-ttu-id="e057a-p101">Esto puede resultar difícil en la MAPI de Outlook, ya que en 2010 y versiones posteriores ya no existe la sección de perfil global. Para buscar la sección Perfil, busque la propiedad PR_EMSMDB_SECTION_UID (0x3D150102). El valor será el GUID de la sección de perfil en un formato binario, que se usará en los pasos siguientes. Debe recordar este valor.</span><span class="sxs-lookup"><span data-stu-id="e057a-p101">This can be difficult in Outlook's MAPI, since in 2010 and above there is no longer the global profile section. To find the Profile section, find the property PR_EMSMDB_SECTION_UID (0x3D150102). The value will be the GUID of the profile section persisted in binary form, which will be used in the subsequent steps. You will need to remember this value.</span></span> 
    
3. <span data-ttu-id="e057a-114">Add the property **PR_PROFILE_USER_SMTP_EMAIL_ADDRESS_W**.</span><span class="sxs-lookup"><span data-stu-id="e057a-114">Add the property **PR_PROFILE_USER_SMTP_EMAIL_ADDRESS_W**.</span></span> 
    
4. <span data-ttu-id="e057a-115">Set the property **0x6641001F** on the store and the **emsuid** section for all providers.</span><span class="sxs-lookup"><span data-stu-id="e057a-115">Set the property **0x6641001F** on the store and the **emsuid** section for all providers.</span></span> 
    
5. <span data-ttu-id="e057a-116">Set the property **PR_DISPLAY_NAME**.</span><span class="sxs-lookup"><span data-stu-id="e057a-116">Set the property **PR_DISPLAY_NAME**.</span></span> 
    
## <a name="code-example"></a><span data-ttu-id="e057a-117">Code example</span><span class="sxs-lookup"><span data-stu-id="e057a-117">Code example</span></span>
...
## <a name="use-mfcmapi-to-configure-outlook-profiles"></a><span data-ttu-id="e057a-118">Use MFCMAPI to configure Outlook profiles</span><span class="sxs-lookup"><span data-stu-id="e057a-118">Use MFCMAPI to configure Outlook profiles</span></span>

<span data-ttu-id="e057a-119">[MFCMAPI](https://mfcmapi.codeplex.com) provides access to MAPI stores to facilitate investigation of Exchange and Outlook issues and to provide developers support for MAPI development.</span><span class="sxs-lookup"><span data-stu-id="e057a-119">[MFCMAPI](https://mfcmapi.codeplex.com) provides access to MAPI stores to facilitate investigation of Exchange and Outlook issues and to provide developers support for MAPI development.</span></span> 
  
## <a name="see-also"></a><span data-ttu-id="e057a-120">Vea también</span><span class="sxs-lookup"><span data-stu-id="e057a-120">See also</span></span>

- [<span data-ttu-id="e057a-121">Crear un perfil de Outlook con MFCMAPI</span><span class="sxs-lookup"><span data-stu-id="e057a-121">Create an Outlook profile using MFCMAPI</span></span>](https://msdn.microsoft.com/library/office/mt723322.aspx)

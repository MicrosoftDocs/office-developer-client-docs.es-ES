...
2. <span data-ttu-id="240f5-109">Using the [IMAPIProp](https://msdn.microsoft.com/es-es/library/cc815525.aspx) interface, go to the Outlook Profile section.</span><span class="sxs-lookup"><span data-stu-id="240f5-109">Using the [IMAPIProp](https://msdn.microsoft.com/es-es/library/cc815525.aspx) interface, go to the Outlook Profile section.</span></span> 
...
- [<span data-ttu-id="240f5-121">Crear un perfil de Outlook con MFCMAPI</span><span class="sxs-lookup"><span data-stu-id="240f5-121">Create an Outlook profile using MFCMAPI</span></span>](https://msdn.microsoft.com/es-es/library/office/mt723322.aspx)

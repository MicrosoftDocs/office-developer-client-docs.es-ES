...
---
# <a name="pidnameauthor-canonical-property"></a>Propiedad canónica PidNameAuthor

  
  
**Se aplica a**: Outlook 2013 | Outlook 2016 
  
Representa al autor del archivo adjunto al documento.
  
|||
|:-----|:-----|
|Nombres descriptivos:  <br/> |Ninguno  <br/> |
|Conjunto de propiedades:  <br/> |PS_PUBLIC_STRINGS  <br/> |
|Nombre de la propiedad:  <br/> |Autor  <br/> |

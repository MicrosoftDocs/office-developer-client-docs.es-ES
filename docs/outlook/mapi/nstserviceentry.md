...
Cuando se usa **[GetProcAddress](https://msdn.microsoft.com/library/ms683212.aspx)** para buscar la dirección de esta función en msmapi32.dll, especifique "NSTServiceEntry" como el nombre del procedimiento. 

...
Hay varias acciones posibles que el método **SaveCompleted** puede realizar, según lo que contenga el parámetro de puntero de mensaje y en qué estado se encuentra el mensaje. Sin embargo, cuando una acción se realiza correctamente, guarde siempre el estado actual del mensaje al que apunta el parámetro _pMessage_ y haga la transición del formulario a [su estado Normal.](normal-state.md) 
...
|**Condición**|**Acción**|
|:-----|:-----|
|El  _parámetro pMessage_ es NULL y el parámetro  _fSameAsLoad_ del método [IPersistMessage::Save](ipersistmessage-save.md) se establece en TRUE.  <br/> |Llama al [método IMAPIViewAdviseSink::OnSaved](imapiviewadvisesink-onsaved.md) de todos los visores registrados, marca el formulario como limpio y devuelve S_OK.  <br/> |
...
|El formulario está en el estado HandsOffFromNormal.  <br/> |Libere el mensaje actual y reemplácela por el mensaje al que apunta el _parámetro pMessage._ Llama al método [IUnknown::AddRef](https://msdn.microsoft.com/library/b4316efd-73d4-4995-b898-8025a316ba63%28Office.15%29.aspx) del mensaje de reemplazo y devuelve S_OK.  <br/> |
|El formulario está en el estado HandsOffAfterSave.  <br/> |Llama al **método IMAPIViewAdviseSink::OnSaved** de todos los visores registrados, marca el formulario como limpio y devuelve S_OK.  <br/> |
|El formulario está en estado [NoScribable.](noscribble-state.md)  <br/> |Libere el mensaje actual y reemplácela por el mensaje señalado por  _pMessage_. Llame al método **IUnknown::AddRef del** mensaje de reemplazo. Llama al **método IMAPIViewAdviseSink::OnSaved** de todos los visores registrados, marca el formulario como limpio y devuelve S_OK.  <br/> |

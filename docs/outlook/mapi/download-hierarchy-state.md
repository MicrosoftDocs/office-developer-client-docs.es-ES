...
**Se aplica a**: Outlook 2013 | Outlook 2016 
 ...
 En este tema se describe lo que sucede durante el estado de jerarquía de descarga de la máquina de estado de replicación. 
...
|Estructura de datos relacionada:  <br/> |**[DNHIER](dnhier.md)** <br/> |
...
Outlook inicializa la estructura de datos **DNHIER** asociada con un puntero a la jerarquía. El cliente descarga la jerarquía e inserta nuevas carpetas o modificaciones en las carpetas del almacén local. El proceso de descarga adopta Microsoft Exchange sincronización incremental de cambios (ICS). Para obtener más información sobre ICS, consulte [Criterios de evaluación ICS](https://msdn.microsoft.com/library/aa579252%28EXCHG.80%29.aspx).

...
> [in] La cadena Unicode terminada en null que se va a comprobar.
    
## <a name="return-value"></a>Valor devuelto

La función devuelve un entero con la longitud de la cadena. Es un recuento de caracteres de la cadena, excluyendo el carácter nulo de terminación. Si  _lpsz_ es NULL, la función devuelve cero. 

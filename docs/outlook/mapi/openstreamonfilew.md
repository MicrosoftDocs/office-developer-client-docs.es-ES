...
> [in] Prefijo del nombre de archivo Unicode en el que **OpenStreamOnFileW** inicializa el **objeto IStream.** Si se establece, el prefijo no debe contener más de tres caracteres. Si  _lpszPrefix_ es NULL, se usa un prefijo de "SOF". 

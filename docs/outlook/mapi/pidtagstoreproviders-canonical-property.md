...
Contiene una lista de identificadores de proveedores de al almacenamiento de mensajes en el perfil actual.
  
|||
|:-----|:-----|
|Propiedades asociadas:  <br/> |PR_STORE_PROVIDERS  <br/> |

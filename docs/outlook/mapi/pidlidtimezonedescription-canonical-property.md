...
Especifica una descripción de cadena de la zona horaria.
  
|||
|:-----|:-----|
|Propiedades asociadas:  <br/> |dispidTimeZoneDesc  <br/> |
|Conjunto de propiedades:  <br/> |PSETID_Appointment  <br/> |
|IDENTIFICADOR largo (LID):  <br/> |0x00008234  <br/> |
|Tipo de datos:  <br/> |PT_UNICODE  <br/> |
|Área:  <br/> |Calendar  <br/> |
   
## <a name="remarks"></a>Comentarios

Esta propiedad especifica una descripción legible para el usuario de la zona horaria representada por los datos en la propiedad **dispidTimeZoneStruct** ([PidLidTimeZoneStruct](pidlidtimezonestruct-canonical-property.md)).

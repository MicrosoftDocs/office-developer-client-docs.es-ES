...
Contiene un valor de campo de encabezado de codificación de transferencia de contenido [RFC3282].
  
|||
|:-----|:-----|
|Nombres descriptivos:  <br/> |Ninguno  <br/> |
|Conjunto de propiedades:  <br/> |PS_INTERNET_HEADERS  <br/> |
|Nombre de la propiedad:  <br/> |Codificación de la transferencia de contenido  <br/> |

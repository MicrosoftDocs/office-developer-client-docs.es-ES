...
|||
|:-----|:-----|
|Propiedades asociadas:  <br/> |PR_GOVERNMENT_ID_NUMBER, PR_GOVERNMENT_ID_NUMBER_A, PR_GOVERNMENT_ID_NUMBER_W  <br/> |
...
Estas propiedades se suelen establecer en un número de cuenta de passport, el número de ciudadanos o el número fiscal como un número de la seguridad Social. 

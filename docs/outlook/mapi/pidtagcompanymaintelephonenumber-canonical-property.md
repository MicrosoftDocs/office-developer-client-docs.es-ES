...
Contiene el número de teléfono principal de una compañía
  
|||
|:-----|:-----|
|Propiedades asociadas:  <br/> |PR_COMPANY_MAIN_PHONE_NUMBER, PR_COMPANY_MAIN_PHONE_NUMBER_A, PR_COMPANY_MAIN_PHONE_NUMBER_W  <br/> |

...
---
# <a name="pidtagabsearchpath-canonical-property"></a>Propiedad canónica PidTagAbSearchPath

  
  
**Se aplica a**: Outlook 2013 | Outlook 2016 
  
Contiene una lista de identificadores de entrada para los contenedores de la libreta de direcciones que se van a buscar para resolver nombres. 
  
|||
|:-----|:-----|
|Propiedades asociadas:  <br/> |PR_AB_SEARCH_PATH  <br/> |

...
3. El proveedor de transporte llama al método [IUnknown::Release](https://msdn.microsoft.com/library/4b494c6f-f0ee-4c35-ae45-ed956f40dc7a%28Office.15%29.aspx) del objeto de soporte técnico para quitar la fila del proveedor de transporte de la tabla de estado y quitar de las tablas internas cualquier identificador único (UID) que se estableció con el método [IMAPISupport::SetProviderUID.](imapisupport-setprovideruid.md) Disminuye el número de objetos de inicio de sesión conocidos activos en este objeto de proveedor. Si el recuento alcanza cero, MAPI llama al método [IXPProvider::Shutdown](ixpprovider-shutdown.md) y **Release** en el objeto del proveedor. Si este fue el último objeto de proveedor conocido que usa esta DLL en este proceso, MAPI llama a la función **FreeLibrary** en la DLL más adelante. Se libera la memoria del objeto de compatibilidad mapi y devuelve el método **Release** del objeto de compatibilidad. 

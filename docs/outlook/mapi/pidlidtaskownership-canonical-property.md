...
Indica el rol del usuario actual con respecto a la tarea.
  
|||
|:-----|:-----|
|Propiedades asociadas:  <br/> |dispidTaskOwnership  <br/> |
|Conjunto de propiedades:  <br/> |PSETID_Task  <br/> |
|IDENTIFICADOR largo (LID):  <br/> |0x00008129  <br/> |
...
|0x00000001  <br/> |La tarea es la copia de la tarea del asignador de tarea.  <br/> |
|0x00000002  <br/> |La tarea es la copia del usuario al que se ha asignado la tarea de la tarea.  <br/> |

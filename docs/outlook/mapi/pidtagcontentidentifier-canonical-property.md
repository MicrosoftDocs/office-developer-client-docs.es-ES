...
Contiene un valor clave que permite al destinatario del mensaje identificar su contenido.
  
|||
|:-----|:-----|
|Propiedades asociadas:  <br/> |PR_CONTENT_IDENTIFIER, PR_CONTENT_IDENTIFIER_A, PR_CONTENT_IDENTIFIER_W  <br/> |

...
Contiene un número de teléfono secundario en el lugar de trabajo del destinatario. 
  
|||
|:-----|:-----|
|Propiedades asociadas:  <br/> |PR_BUSINESS2_TELEPHONE_NUMBER, PR_BUSINESS2_TELEPHONE_NUMBER_A, PR_BUSINESS2_TELEPHONE_NUMBER_W, PR_OFFICE2_TELEPHONE_NUMBER, PR_OFFICE2_TELEPHONE_NUMBER_A, PR_OFFICE2_TELEPHONE_NUMBER_W  <br/> |
...
Estas propiedades son ejemplos de las propiedades que proporcionan identificación y acceso a información sobre un destinatario. Estas propiedades las definen el destinatario y la organización del destinatario. 

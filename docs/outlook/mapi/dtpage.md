...
> Recuento de controles señalados por el **miembro lpctl.** 
    
 **lpszResourceName**
  
> Puntero al identificador de nombre o entero del recurso de cuadro de diálogo. 
...
Cada entrada de la **sección [Asignaciones de archivos** de ayuda] en MAPISVC. INF consta de una cadena de componente, no superior a 30 caracteres, en el lado izquierdo y una ruta de acceso de archivo de ayuda a la derecha. Tanto **ulItemID** como **lpszResourceName** se encuentran en el  _parámetro hInstance_ de **BuildDisplayTable**. Para obtener más información, vea [MAPISVC. Sección INF [Asignaciones de archivos de ayuda]](mapisvc-inf-help-file-mappings-section.md).

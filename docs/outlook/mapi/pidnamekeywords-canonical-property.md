...
Un valor de cadena múltiple que especifica las categorías para un objeto de mensaje, la longitud de cada cadena dentro de esta cadena de varios valores de propiedad, debe ser menor que 256.

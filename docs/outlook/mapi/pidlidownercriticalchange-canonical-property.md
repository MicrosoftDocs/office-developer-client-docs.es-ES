...
Especifica la fecha y la hora en que el organizador envió una convocatoria de reunión.
  
|||
|:-----|:-----|
|Propiedades asociadas:  <br/> |LID_OWNER_CRITICAL_CHANGE  <br/> |
|Conjunto de propiedades:  <br/> |PSETID_Meeting  <br/> |
|IDENTIFICADOR largo (LID):  <br/> |0x0000001A  <br/> |

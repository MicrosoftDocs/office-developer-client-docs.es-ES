...
Contiene el número de teléfono del asistente administrativo del destinatario. 
  
|||
|:-----|:-----|
|Propiedades asociadas:  <br/> |PR_ASSISTANT_TELEPHONE_NUMBER, PR_ASSISTANT_TELEPHONE_NUMBER_A, PR_ASSISTANT_TELEPHONE_NUMBER_W  <br/> |
...
El número de teléfono es para el asistente especificado en **la propiedad PR_ASSISTANT** ([PidTagAssistant](pidtagassistant-canonical-property.md)). 

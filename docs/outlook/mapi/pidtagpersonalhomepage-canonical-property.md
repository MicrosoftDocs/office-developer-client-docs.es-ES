...
Contiene la dirección URL de la página principal personal de un usuario.
  
|||
|:-----|:-----|
|Propiedades asociadas:  <br/> |PR_PERSONAL_HOME_PAGE, PR_PERSONAL_HOME_PAGE_A, PR_PERSONAL_HOME_PAGE_W  <br/> |

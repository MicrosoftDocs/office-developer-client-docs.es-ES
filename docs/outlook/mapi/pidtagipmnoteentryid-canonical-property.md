...
2. Si * * IMsgStore:: GetReceiveFolder * * es correcto, use la referencia a **EntryID** de la bandeja de entrada y [IMsgStore:: OpenEntry](imsgstore-openentry.md) para abrir la bandeja de entrada y obtener una referencia a un objeto **IMAPIFolder** . 

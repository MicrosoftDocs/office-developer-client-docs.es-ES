...
Contiene el **EntryID de** la carpeta Notas de Outlook. 
...
2. Si ** IMsgStore::GetReceiveFolder ** es correcto, use la referencia al **EntryID** de la Bandeja de entrada e [IMsgStore::OpenEntry](imsgstore-openentry.md) para abrir la Bandeja de entrada y obtener una referencia a un objeto **IMAPIFolder** . 

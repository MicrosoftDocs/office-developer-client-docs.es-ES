...
---
# <a name="pidtagipmnoteentryid-canonical-property"></a>Propiedad canónica PidTagIpmNoteEntryId

  
  
**Se aplica a**: Outlook 2013 | Outlook 2016 
  
Contiene la **propiedad EntryID** de la carpeta Notas de Outlook. 
  
|||
|:-----|:-----|
|Propiedades asociadas:  <br/> |PR_IPM_NOTE_ENTRYID  <br/> |
...
2. Si ** IMsgStore::GetReceiveFolder ** es correcta, a continuación, usar la referencia a la **propiedad EntryID** de la Bandeja de entrada y [IMsgStore::OpenEntry](imsgstore-openentry.md) para abrir la Bandeja de entrada y obtener una referencia a un objeto **IMAPIFolder** . 

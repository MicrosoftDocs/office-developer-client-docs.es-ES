...
---
# <a name="pidlidinstantmessagingaddress-canonical-property"></a>Propiedad canónico PidLidInstantMessagingAddress
...
|||
|:-----|:-----|
|Propiedades asociadas:  <br/> |dispidInstMsg  <br/> |
|Conjunto de propiedades:  <br/> |PSETID_Address  <br/> |
|Identificador de tipo Long (LID):  <br/> |0x00008062  <br/> |

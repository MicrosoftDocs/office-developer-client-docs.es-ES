...
Las notificaciones de libreta de direcciones permiten a un cliente conocer los eventos que se producen en cualquier entrada de la libreta de direcciones o en una entrada determinada. Puede registrarse para estas notificaciones a través de la libreta de direcciones MAPI llamando a [IAddrBook::Advise](iaddrbook-advise.md) o a través de la jerarquía o la tabla de contenido de un contenedor de libreta de direcciones llamando a [IMAPITable::Advise](imapitable-advise.md). 
...
- Cualquiera de los eventos de objeto (creados, modificados, eliminados, movidos o copiados)
    
- Tabla modificada
    
Normalmente, el registro solo se produce en el contenido del contenedor de libreta de direcciones y en las tablas de jerarquía. Es raro que los clientes se registren con los objetos de lista de distribución y usuario de mensajería de nivel inferior. Esto se debe a:
  
- Muchos proveedores de libreta de direcciones no admiten notificaciones en sus listas de distribución y usuarios de mensajería.

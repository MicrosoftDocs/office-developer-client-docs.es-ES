...
Contiene un identificador para el algoritmo que se usa para confirmar la confidencialidad del contenido del mensaje.
  
|||
|:-----|:-----|
|Propiedades asociadas:  <br/> |PR_CONTENT_CONFIDENTIALITY_ALGORITHM_ID  <br/> |

...
Esta propiedad describe la hora en que se almacena el mensaje en el servidor, en lugar de la hora de descarga en la que el proveedor de transporte copió el mensaje del servidor al almacén local.

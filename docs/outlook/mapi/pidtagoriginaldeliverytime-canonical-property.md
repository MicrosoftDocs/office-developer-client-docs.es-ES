...
Esta propiedad se copia de la propiedad **PR_MESSAGE_DELIVERY_TIME** ([PidTagMessageDeliveryTime](pidtagmessagedeliverytime-canonical-property.md)) original en operaciones de respuesta o reenvío posteriores y se usa en informes leídos y no leídos. En su lugar, los informes de entrega usan la propiedad **PR_DELIVER_TIME** ([PidTagDeliverTime](pidtagdelivertime-canonical-property.md)).

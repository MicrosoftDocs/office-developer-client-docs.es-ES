...
Especifica el nombre de archivo del sonido que debe reproducir un cliente cuando venza el aviso de ese objeto.
  
|||
|:-----|:-----|
|Propiedades asociadas:  <br/> |dispidReminderFileParam  <br/> |
|Conjunto de propiedades:  <br/> |PSETID_Common  <br/> |
|IDENTIFICADOR largo (LID):  <br/> |0x0000851F  <br/> |
|Tipo de datos:  <br/> |PT_UNICODE  <br/> |
|Área:  <br/> |Recordatorio  <br/> |
   
## <a name="remarks"></a>Comentarios

Si esta propiedad no está presente, el cliente puede usar un valor predeterminado.

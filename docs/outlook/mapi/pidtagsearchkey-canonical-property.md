...
En la tabla siguiente se resumen las diferencias importantes entre PR_ENTRYID **(** [PidTagEntryId](pidtagentryid-canonical-property.md)), **PR_RECORD_KEY** ([PidTagRecordKey](pidtagrecordkey-canonical-property.md)) y esta propiedad.
...
|Único dentro de ...  <br/> |Todo el mundo  <br/> |Instancia de proveedor  <br/> |Todo el mundo  <br/> |

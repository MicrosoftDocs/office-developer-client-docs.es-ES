...
Indica la propiedad **PR_MESSAGE_CLASS** ([PidTagMessageClass](pidtagmessageclass-canonical-property.md)) de la reunión que se generará desde la convocatoria de reunión.
  
|||
|:-----|:-----|
|Propiedades asociadas:  <br/> |dispidApptMessageClass  <br/> |
|Conjunto de propiedades:  <br/> |PSETID_Meeting  <br/> |
|IDENTIFICADOR largo (LID):  <br/> |0x00000024  <br/> |
|Tipo de datos:  <br/> |PT_TSTRING  <br/> |
|Área:  <br/> |Meetings  <br/> |
   
## <a name="remarks"></a>Comentarios

El valor de esta propiedad debe ser "IPM. Appointment "o ir precedido de" IPM. Cita. ". Esta propiedad no es obligatoria.

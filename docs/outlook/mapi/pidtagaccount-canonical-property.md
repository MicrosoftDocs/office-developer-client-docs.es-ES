...
Estas propiedades suelen incluir el nombre de correo electrónico del destinatario, es decir, el componente final de la dirección de correo electrónico, que identifica de forma exclusiva al destinatario en la organización local. El nombre de correo electrónico se corresponde con el nombre distintivo X. 400, que pretende ser un nombre corto que se garantiza que sea único dentro de un determinado dominio de mensajería.

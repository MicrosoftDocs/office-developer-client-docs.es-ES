...
Esta propiedad no aparece como una propiedad de ningún objeto, sino sólo como una columna en una tabla de perfiles. Una aplicación cliente puede usar el método [IProfAdmin:: setdefaultprofile a](iprofadmin-setdefaultprofile.md) para designar el perfil predeterminado. 

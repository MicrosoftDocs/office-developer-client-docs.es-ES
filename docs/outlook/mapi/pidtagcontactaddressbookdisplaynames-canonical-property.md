...
Contiene una lista de nombres para mostrar para los usuarios de mensajería en la libreta de direcciones de contactos.
  
|||
|:-----|:-----|
|Propiedades asociadas:  <br/> |PR_CONTAB_DISPLAY_NAMES, PR_CONTAB_DISPLAY_NAMES_A, PR_CONTAB_DISPLAY_NAMES_W  <br/> |
...
Estas propiedades las definen el usuario y la organización del usuario.

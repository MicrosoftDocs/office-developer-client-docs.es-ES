...
Representa la fecha y hora de finalización de un mensaje.
  
|||
|:-----|:-----|
|Propiedades asociadas:  <br/> |dispidCommonEnd  <br/> |
|Conjunto de propiedades:  <br/> |PSETID_Common  <br/> |
|IDENTIFICADOR largo (LID):  <br/> |0x00008517  <br/> |
...
Este valor debe ser el equivalente de la hora universal coordinada (UTC) de la propiedad **dispidTaskDueDate** ([PidLidTaskDueDate](pidlidtaskduedate-canonical-property.md)).

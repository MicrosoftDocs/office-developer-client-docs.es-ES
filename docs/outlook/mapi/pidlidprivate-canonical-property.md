...
Indica si el usuario final desea ocultar este objeto de mensaje a otros usuarios que tengan acceso al objeto de mensaje.
  
|||
|:-----|:-----|
|Propiedades asociadas:  <br/> |dispidPrivate  <br/> |
|Conjunto de propiedades:  <br/> |PSETID_Common  <br/> |
|IDENTIFICADOR largo (LID):  <br/> |0x00008506  <br/> |

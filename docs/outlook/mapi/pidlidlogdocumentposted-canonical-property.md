---
title: Propiedad canónica PidLidLogDocumentPosted
manager: soliver
ms.date: 03/09/2015
...
Indica si el documento se envió por correo electrónico o se publicó en una carpeta del servidor durante el registro en diario.
  
|||
|:-----|:-----|
|Propiedades asociadas:  <br/> |dispidLogDocPosted  <br/> |
|Conjunto de propiedades:  <br/> |PSETID_Log  <br/> |
|Id. largo (LID):  <br/> |0x00008711  <br/> |

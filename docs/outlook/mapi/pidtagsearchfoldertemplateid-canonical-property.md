...
Los criterios de la carpeta de búsqueda se especifican mediante una plantilla. Esta propiedad del mensaje que define la carpeta de búsqueda identifica su plantilla correspondiente. Además de definir los criterios de búsqueda, una plantilla también define las carpetas que se deben excluir de la búsqueda, define los elementos que se van a excluir de la búsqueda y especifica el valor de **PR_WB_SF_STORAGE_TYPE** ([PidTagSearchFolderStorageType](pidtagsearchfolderstoragetype-canonical-property.md)).
  
Para obtener más información acerca de las plantillas de carpeta de búsqueda, consulte [[ms-OXOSRCH]](https://msdn.microsoft.com/library/c72e49b8-78c7-4483-ad65-e46e9133673b%28Office.15%29.aspx) . 

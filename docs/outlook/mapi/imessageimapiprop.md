...
|[CreateAttach](imessage-createattach.md) <br/> |Crea un nuevo archivo de datos adjuntos.  <br/> |
...
|[SubmitMessage](imessage-submitmessage.md) <br/> |Guarda todos los cambios realizados en el mensaje y lo marca como listo para su envío.  <br/> |
...
|**PR_MESSAGE_CLASS** ([PidTagMessageClass](pidtagmessageclass-canonical-property.md))  <br/> |Lectura y escritura  <br/> |
|**PR_MESSAGE_FLAGS** ([PidTagMessageFlags](pidtagmessageflags-canonical-property.md))  <br/> |Lectura y escritura  <br/> |
...
|Propiedades de **PR_ORIGINATOR**  <br/> |Solo lectura  <br/> |
...
|Propiedades de **PR_RECEIVED_BY**  <br/> |Solo lectura  <br/> |
...
|Propiedades de **PR_SENDER**  <br/> |Solo lectura  <br/> |
...
Las siguientes propiedades son todas de solo lectura para los clientes, con la excepción de **PR_BODY**. Los clientes construyen esta propiedad cuando procesan un informe.
  
|**Propiedades de los mensajes de informes**|
|:-----|
...
|**PR_DISPLAY_TYPE** ([PidTagDisplayType](pidtagdisplaytype-canonical-property.md))  <br/> |Lectura y escritura  <br/> |Obligatorio  <br/> |

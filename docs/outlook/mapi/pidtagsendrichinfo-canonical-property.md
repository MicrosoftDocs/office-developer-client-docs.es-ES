...
---
# <a name="pidtagsendrichinfo-canonical-property"></a>Propiedad canónico PidTagSendRichInfo
...
[Propiedad canónico PidTagAttachDataObject](pidtagattachdataobject-canonical-property.md)

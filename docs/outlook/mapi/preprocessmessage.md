...
> [in] Puntero al mensaje que se va a procesar previamente. 
    
 _lpAdrBook_
  
> [in] Puntero a la libreta de direcciones desde la que el usuario debe seleccionar los destinatarios del mensaje. 
    
 _lpFolder_
  
> [in, out] Puntero a una carpeta. En la entrada, el  _parámetro lpFolder_ apunta a la carpeta que contiene los mensajes que se deben procesar previamente. Al salir,  _lpFolder_ apunta a la carpeta donde se han colocado los mensajes preprocesados. 
...
> [in] Puntero a la [función MAPIAllocateMore,](mapiallocatemore.md) que se usará para asignar memoria adicional cuando sea necesario. 
...
> [salida] Puntero al número de mensajes de la matriz señalados por el _parámetro lpppMessage._ 

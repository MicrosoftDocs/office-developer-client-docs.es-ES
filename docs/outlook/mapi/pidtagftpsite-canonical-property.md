...
Contiene la dirección URL del protocolo de transferencia de archivos (FTP) del contacto. FTP es un protocolo que se usa para transferir datos, como se especifica en [RFC959].
  
|||
|:-----|:-----|
|Propiedades asociadas:  <br/> |PR_FTP_SITE, PR_FTP_SITE_A, PR_FTP_SITE_W  <br/> |

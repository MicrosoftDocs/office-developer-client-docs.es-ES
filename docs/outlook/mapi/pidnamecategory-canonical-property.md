---
title: PidNameCategory (propiedad canónica)
manager: soliver
ms.date: 03/09/2015
...
---
# <a name="pidnamecategory-canonical-property"></a>PidNameCategory (propiedad canónica)

  
  
**Se aplica a**: Outlook 2013 | Outlook 2016 
  
Especifica la categoría del archivo adjunto al documento.
  
|||
|:-----|:-----|
|Nombres descriptivos:  <br/> |Ninguno  <br/> |
|Conjunto de propiedades:  <br/> |PS_PUBLIC_STRINGS  <br/> |
|Nombre de la propiedad:  <br/> |Categoría  <br/> |

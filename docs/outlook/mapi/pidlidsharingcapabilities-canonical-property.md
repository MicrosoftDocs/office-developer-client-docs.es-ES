...
|**Valor**|**Escenario**|
|:-----|:-----|
|0x00040290  <br/> |Este objeto de mensaje para compartir está relacionado con una carpeta especial.  <br/> |
|0x000402B0  <br/> |Este objeto de mensaje para compartir no está relacionado con una carpeta especial.  <br/> |

...
6. Obtener acceso el texto del mensaje con etiqueta a través de métodos de [IStream](http://msdn.microsoft.com/en-us/library/aa380034%28VS.85%29.aspx) y enviarlo al sistema de mensajería. 

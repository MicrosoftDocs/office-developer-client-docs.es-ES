...
Especifica la dirección SMTP del usuario que inició el mensaje para compartir. Se trata de una propiedad de un mensaje para compartir. 
  
|||
|:-----|:-----|
|Propiedades asociadas:  <br/> |dispidSharingInitiatorSmtp  <br/> |
|Conjunto de propiedades:  <br/> |PSETID_Sharing  <br/> |
|IDENTIFICADOR largo (LID):  <br/> |0x00008A08  <br/> |

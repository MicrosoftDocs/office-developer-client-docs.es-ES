...
El contenido se define mediante las necesidades de la organización del destinatario. Por ejemplo, algunas organizaciones pueden identificar a los usuarios de mensajería especificando el número de edificio y el número de office. 

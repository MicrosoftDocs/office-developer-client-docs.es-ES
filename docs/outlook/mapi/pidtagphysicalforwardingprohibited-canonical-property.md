...
Contiene TRUE si un remitente de mensaje prohíbe el reenvío de mensajes físicos para un destinatario específico.
  
|||
|:-----|:-----|
|Propiedades asociadas:  <br/> |PR_PHYSICAL_FORWARDING_PROHIBITED  <br/> |

...
Una aplicación cliente debe mover los mensajes interpersonales eliminados a la carpeta Elementos eliminados. Si el mensaje ya está en esta carpeta o si esta propiedad no es compatible, el cliente debe eliminar el mensaje. 

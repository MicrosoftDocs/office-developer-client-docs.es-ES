...
> [in] La parte del estado que se debe cambiar. El único valor admitido es MAPIOFFLINE_STATE_OFFLINE_MASK.
    
 _ulState_
  
> [in] Estado al que se debe cambiar. Debe ser uno de estos dos valores:

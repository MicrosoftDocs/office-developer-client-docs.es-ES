...
Contiene texto opcional para un informe generado por el sistema de mensajería.
...
Normalmente, el texto contenido en estas propiedades se genera en respuesta a un informe de entrega o de no entrega o a un informe de lectura o no leído del sistema de mensajería subyacente, pero no es el texto que se ha transferido a través de ese sistema. 

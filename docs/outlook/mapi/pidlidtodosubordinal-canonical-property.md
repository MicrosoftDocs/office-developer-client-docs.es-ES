...
---
# <a name="pidlidtodosubordinal-canonical-property"></a>Propiedad canónico PidLidToDoSubOrdinal
...
[Propiedad canónico PidLidToDoOrdinalDate](pidlidtodoordinaldate-canonical-property.md)

...
Para permitir la recepci�n de mensajes, el proveedor de almac�n de mensajes debe implementar los m�todos [IMsgStore::GetReceiveFolderTable](imsgstore-getreceivefoldertable.md) y [IMsgStore::GetReceiveFolder](imsgstore-getreceivefolder.md). Para más información, consulte [Recibir mensajes mediante el uso de los proveedores de almac�n de mensajes](receiving-messages-by-using-message-store-providers.md).

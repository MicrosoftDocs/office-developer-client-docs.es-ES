...
Contiene el valor del campo de encabezado de un mensaje List-Subscribe multipropósito de correo de Internet (MIME).
...
Para generar un campo List-Subscribe encabezado, los clientes deben establecer el valor de estas propiedades en el valor deseado. Los escritores MIME deben copiar el valor de estas propiedades en el List-Subscribe encabezado.

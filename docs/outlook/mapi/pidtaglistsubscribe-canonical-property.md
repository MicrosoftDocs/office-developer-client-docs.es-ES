...
Contiene el valor del campo de encabezado de un mensaje Multipurpose Internet Mail Extensions (MIME List-Subscribe).
...
Para generar un List-Subscribe de encabezado, los clientes deben establecer el valor de estas propiedades en el valor deseado. Los escritores MIME deben copiar el valor de estas propiedades en el List-Subscribe de encabezado.
  
Para establecer el valor de propiedades relacionadas con el servidor como estas, los clientes MIME deben escribir los campos de encabezado como se especifica en la tabla siguiente.

...
---
# <a name="pidlidremoteattachment-canonical-property"></a>Propiedad canónico PidLidRemoteAttachment
...
|||
|:-----|:-----|
|Propiedades asociadas:  <br/> |dispidRemoteAttachment  <br/> |
|Conjunto de propiedades:  <br/> |PSETID_Remote  <br/> |
|Identificador de tipo Long (LID):  <br/> |0x00008F07  <br/> |

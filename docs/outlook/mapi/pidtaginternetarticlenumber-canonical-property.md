---
title: Propiedad canónica PidTagInternetArticleNumber
manager: soliver
ms.date: 03/09/2015
...
Número asociado a un elemento de un almacén de mensajes.
  
|||
|:-----|:-----|
|Propiedades asociadas:  <br/> |PR_INTERNET_ARTICLE_NUMBER  <br/> |
...
En los almacenes de mensajes IMAPI, esta propiedad corresponde al UID de IMAPI.

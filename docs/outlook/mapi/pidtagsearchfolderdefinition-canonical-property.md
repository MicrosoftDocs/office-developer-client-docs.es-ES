...
El contenido específico de cada campo del objeto binario grande (BLOB) contenido en esta propiedad depende del identificador de plantilla que se especifica en la propiedad **PidTagSearchFolderTemplateId** ([PidTagSearchFolderTemplateId](pidtagsearchfoldertemplateid-canonical-property.md)). Para obtener información acerca de la estructura BLOB y las plantillas de búsqueda, consulte [[ms-OXOSRCH]](https://msdn.microsoft.com/library/c72e49b8-78c7-4483-ad65-e46e9133673b%28Office.15%29.aspx). 

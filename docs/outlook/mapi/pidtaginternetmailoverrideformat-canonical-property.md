...
Indica el método de codificación y la inclusión HTML para los datos adjuntos que deben establecerse en el correo saliente.
  
|||
|:-----|:-----|
|Propiedades asociadas:  <br/> |PR_INETMAIL_OVERRIDE_FORMAT  <br/> |
...
Para obtener información sobre las subsecciones en las que se divide esta propiedad, vea [[MS-OXOMSG]](https://msdn.microsoft.com/library/daa9120f-f325-4afb-a738-28f91049ab3c%28Office.15%29.aspx). 

...
Contiene un recuento de los caracteres ignorables que aparecen delante de los caracteres significativos del mensaje.
...
Esta propiedad es una propiedad auxiliar de formato de texto enriquecido (RTF). Las propiedades auxiliares RTF las usa la [función RTFSync](rtfsync.md) y no están diseñadas para ser usadas directamente por las aplicaciones cliente. 

---
title: Propiedad canónica PidLidReminderPlaySound
manager: soliver
ms.date: 03/09/2015
...
Especifica si el cliente debe reproducir un sonido cuando se atrasa el aviso.
  
|||
|:-----|:-----|
|Propiedades asociadas:  <br/> |dispidReminderPlaySound  <br/> |
|Conjunto de propiedades:  <br/> |PSETID_Common  <br/> |
|IDENTIFICADOR largo (LID):  <br/> |0x0000851E  <br/> |

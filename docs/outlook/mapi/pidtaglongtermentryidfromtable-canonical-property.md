...
Esta propiedad se puede usar en una tabla de contenido para obtener el identificador de entrada de un elemento como un identificador de entrada a largo plazo en lugar de un identificador de entrada a corto plazo. Para obtener información acerca de los identificadores a largo y corto plazo, vea **PR_ENTRYID** ([PidTagEntryId](pidtagentryid-canonical-property.md)).

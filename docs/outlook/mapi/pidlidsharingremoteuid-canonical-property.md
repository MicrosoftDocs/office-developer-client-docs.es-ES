...
Especifica el identificador de entrada de la carpeta remota que se va a compartir. Se trata de una propiedad de un mensaje para compartir.
  
|||
|:-----|:-----|
|Propiedades asociadas:  <br/> |dispidSharingRemoteUid  <br/> |
|Conjunto de propiedades:  <br/> |PSETID_Sharing  <br/> |
|IDENTIFICADOR largo (LID):  <br/> |0x00008A06  <br/> |
|Tipo de datos:  <br/> |PT_UNICODE  <br/> |
|Área:  <br/> |Uso compartido  <br/> |
   
## <a name="remarks"></a>Comentarios

Esta propiedad debe establecerse en la representación de cadena hexadecimal del valor de la propiedad tipo ([PidTagEntryId](pidtagentryid-canonical-property.md)) de la carpeta que se va a compartir. Se trata de una propiedad de un mensaje para compartir.

...
Especifica la pronunciación fonética del nombre especificado del contacto.
  
|||
|:-----|:-----|
|Propiedades asociadas:  <br/> |dispidYomiFirstName  <br/> |
|Conjunto de propiedades:  <br/> |PSETID_Address  <br/> |
|IDENTIFICADOR largo (LID):  <br/> |0x0000802C  <br/> |

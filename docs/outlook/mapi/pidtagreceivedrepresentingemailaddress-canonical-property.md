...
Estas propiedades son ejemplos de las propiedades de dirección del usuario de mensajería que representa el usuario receptor. El proveedor de transporte entrante debe establecerlos, que también es responsable de la autorización o la comprobación del delegado. Si no se está representando un usuario de mensajería, estas propiedades deben establecerse en la dirección de correo electrónico contenida en la propiedad **PR_RECEIVED_BY_EMAIL_ADDRESS** ([PidTagReceivedByEmailAddress](pidtagreceivedbyemailaddress-canonical-property.md)).
  
Una aplicación cliente que responde a un mensaje recibido en nombre de otro cliente debe copiar estas propiedades del mensaje recibido en la propiedad **PR_SENT_REPRESENTING_EMAIL_ADDRESS** ([PidTagSentRepresentingEmailAddress](pidtagsentrepresentingemailaddress-canonical-property.md)) del contestar.

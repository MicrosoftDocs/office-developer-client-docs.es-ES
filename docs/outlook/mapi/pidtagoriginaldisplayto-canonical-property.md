...
Estas propiedades contienen una lista ASCII separada por punto y coma. Se proporciona mediante MAPI y se copia directamente de **PR_DISPLAY_TO** ([PidTagDisplayTo](pidtagdisplayto-canonical-property.md)) cuando se genera un informe de entrega o de no entrega o un informe de leído o no leído. Esta propiedad puede estar presente en otros mensajes como se define en sus clases de mensaje.

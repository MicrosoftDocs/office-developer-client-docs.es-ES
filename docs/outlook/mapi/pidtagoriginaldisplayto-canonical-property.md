...
Contiene los nombres para mostrar de los destinatarios principales (Para) del mensaje original.
...
Estas propiedades contienen una lista ASCII separada por punto y coma. Se entrega mediante MAPI y se copia directamente desde **PR_DISPLAY_TO** ([PidTagDisplayTo](pidtagdisplayto-canonical-property.md)) cuando se genera un informe de entrega o no entrega o un informe leído o no leído. Esta propiedad puede estar presente en otros mensajes definidos por sus clases de mensajes.

...
Estas propiedades contienen una lista ASCII separada por punto y coma. Mapi lo ofrece y se copia directamente desde **PR_DISPLAY_TO** ([PidTagDisplayTo](pidtagdisplayto-canonical-property.md)) cuando se genera un informe de entrega o no entrega o un informe de lectura o no leído. Esta propiedad puede estar presente en otros mensajes definidos por sus clases de mensajes.

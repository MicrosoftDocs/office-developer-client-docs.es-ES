...
Indica la página de códigos usada para **PR_BODY** ([PidTagBody](pidtagbody-canonical-property.md)) o **PR_BODY_HTML** ([PidTagBodyHtml](pidtagbodyhtml-canonical-property.md)) propiedades.

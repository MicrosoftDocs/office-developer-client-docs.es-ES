...
Contiene la dirección de correo electrónico del Protocolo simple de transporte de correo (SMTP) para el usuario de mensajería representado por el remitente.

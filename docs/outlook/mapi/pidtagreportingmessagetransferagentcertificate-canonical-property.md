...
Contiene un identificador para el agente de transferencia de mensajes que generó un informe.
  
|||
|:-----|:-----|
|Propiedades asociadas:  <br/> |PR_REPORTING_MTA_CERTIFICATE  <br/> |
...
Esta propiedad corresponde a un atributo de informe por mensaje X.400.

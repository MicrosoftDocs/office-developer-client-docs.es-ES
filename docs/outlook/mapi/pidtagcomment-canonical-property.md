...
|||
|:-----|:-----|
|Propiedades asociadas:  <br/> |PR_COMMENT, PR_COMMENT_A, PR_COMMENT_W  <br/> |
...
El contenido de la cadena es definido por el usuario de mensajería. 

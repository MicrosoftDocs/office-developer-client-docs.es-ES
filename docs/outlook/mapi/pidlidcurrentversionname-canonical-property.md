...
ms.locfileid: "19818616"
---
# <a name="pidlidcurrentversionname-canonical-property"></a>Propiedad canónica PidLidCurrentVersionName
...
|Identificador de tipo Long (LID):  <br/> |0x00008554  <br/> |

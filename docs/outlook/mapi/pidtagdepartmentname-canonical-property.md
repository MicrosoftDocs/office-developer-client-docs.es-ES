...
---
# <a name="pidtagdepartmentname-canonical-property"></a>Propiedad canónico PidTagDepartmentName
...
|||
|:-----|:-----|
|Propiedades asociadas:  <br/> |PR_DEPARTMENT_NAME, PR_DEPARTMENT_NAME_A, PR_DEPARTMENT_NAME_W  <br/> |

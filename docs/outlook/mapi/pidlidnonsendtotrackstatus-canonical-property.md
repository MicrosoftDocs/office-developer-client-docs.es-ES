...
Contiene el valor de cada asistente enumerado en la propiedad **dispidNonSendableTo** ([PidLidNonSendableTo](pidlidnonsendableto-canonical-property.md)).
  
|||
|:-----|:-----|
|Propiedades asociadas:  <br/> |dispidNonSendToTrackStatus  <br/> |
|Conjunto de propiedades:  <br/> |PSETID_Common  <br/> |
|IDENTIFICADOR largo (LID):  <br/> |0x00008543  <br/> |
|Tipo de datos:  <br/> |PT_MV_LONG  <br/> |
|Área:  <br/> |Mensajes generales  <br/> |
   
## <a name="remarks"></a>Comentarios

Esta propiedad solo es necesaria cuando se establece la propiedad **dispidNonSendableTo** . El número de valores de esta propiedad debe ser igual al número de valores de **dispidNonSendableTo**. Cada valor PT_LONG de esta propiedad corresponde al asistente de la propiedad **dispidNonSendableTo** en el mismo índice. 

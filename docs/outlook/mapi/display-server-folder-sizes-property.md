...
---
# <a name="display-server-folder-sizes-property"></a>Display Server Folder Sizes (propiedad)

  
  
**Se aplica a**: Outlook 2013 | Outlook 2016 
  
Muestra los tamaños de las carpetas especificadas en el servidor en el cuadro de diálogo Tamaño **de carpeta de** Outlook. 

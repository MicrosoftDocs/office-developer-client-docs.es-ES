...
Estas propiedades son ejemplos de las propiedades de dirección base comunes a todos los usuarios de mensajería. Especifica qué sistema de mensajería usa MAPI para controlar un mensaje determinado.
  
Esta propiedad también determina el formato de la cadena de dirección en el **PR_EMAIL_ADRESS** ([PidTagEmailAddress](pidtagemailaddress-canonical-property.md)). La cadena que proporciona solo puede contener caracteres alfabéticos en mayúsculas de la a a la Z y los números del 0 al 9.
  
Entre los ejemplos válidos para la cadena se incluyen: 

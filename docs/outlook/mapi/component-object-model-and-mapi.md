...
La Windows SDK incluye una explicación completa de las reglas para implementar objetos que se ajustan al modelo de objetos componentes (COM). Estas reglas abordan cómo hacer lo siguiente:

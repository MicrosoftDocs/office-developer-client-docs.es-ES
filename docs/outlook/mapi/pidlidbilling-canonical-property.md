---
title: Propiedad canónico PidLidBilling
manager: soliver
ms.date: 03/09/2015
...
---
# <a name="pidlidbilling-canonical-property"></a>Propiedad canónico PidLidBilling
...
|||
|:-----|:-----|
|Propiedades asociadas:  <br/> |dispidBilling  <br/> |
|Conjunto de propiedades:  <br/> |PSETID_Common  <br/> |
|Identificador de tipo Long (LID):  <br/> |0x00008535  <br/> |

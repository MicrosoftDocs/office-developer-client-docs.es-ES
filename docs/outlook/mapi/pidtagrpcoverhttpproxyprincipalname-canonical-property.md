...
Contiene el nombre principal del servidor proxy que usa Microsoft Outlook para conectarse a Microsoft Exchange Server mediante una llamada a procedimiento remoto (RPC) sobre el protocolo de transferencia de hiperTexto (HTTP).
  
## 

|||
|:-----|:-----|
|Propiedades asociadas:  <br/> |PR_ROH_PROXY_PRINCIPAL_NAME  <br/> |

...
|||
|:-----|:-----|
|Propiedades asociadas:  <br/> |PR_PRIMARY_TELEPHONE_NUMBER, PR_PRIMARY_TELEPHONE_NUMBER_A, PR_PRIMARY_TELEPHONE_NUMBER_W  <br/> |
...
Estas propiedades son ejemplos de las propiedades que proporcionan identificación y acceso a la información de un destinatario. Los define el destinatario y la organización del destinatario. 

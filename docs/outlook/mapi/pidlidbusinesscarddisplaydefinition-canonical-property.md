...
|IDENTIFICADOR largo (LID):  <br/> |0x00008040  <br/> |
|Tipo de datos:  <br/> |PT_BINARY  <br/> |
|Área:  <br/> |Contact  <br/> |
   
## <a name="remarks"></a>Comentarios

El diseño de una tarjeta de presentación puede representarse como una imagen y un número de campos de texto. La imagen puede ser una foto de contacto o una imagen de tarjeta. Los campos de texto constan de un valor de otro conjunto de propiedades en el contacto y una cadena de etiqueta personalizada opcional proporcionada por el usuario. Tenga en cuenta que los valores de varios bytes se almacenan en formato Little-endian en el búfer.

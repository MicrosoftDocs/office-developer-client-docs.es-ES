...
Contiene el nombre de un contacto para obtener información sobre un formulario. 
...
Normalmente, el contacto contiene el nombre de una persona o un alias responsable de mantener el formulario. 

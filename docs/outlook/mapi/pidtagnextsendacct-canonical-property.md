...
Especifica el servidor que un cliente está intentando usar actualmente para enviar correo electrónico.
...
El formato de esta propiedad depende de la implementación. El cliente puede usar esta propiedad para determinar a qué servidor se va a dirigir el correo electrónico, pero es opcional y el valor no tiene ningún significado para el servidor.

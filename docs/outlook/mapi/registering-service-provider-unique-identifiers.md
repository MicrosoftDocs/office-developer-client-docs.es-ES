...
Los proveedores de libreta de direcciones, almacén de mensajes y transporte usan un identificador único conocido como [MAPIUID](mapiuid.md) para registrarse en objetos de servicio de varios tipos. Un **MAPIUID** es un identificador de 16 bytes que contiene un GUID. Puede crear un **MAPIUID** mediante el siguiente procedimiento: 
  
1. Defina una constante.
    
2. Invoque Visual Studio *herramienta Crear GUID**. 
 ...
 **Para registrar un MAPIUID si el proveedor es un proveedor de libreta de direcciones o almacén de mensajes**

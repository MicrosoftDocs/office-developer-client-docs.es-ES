...
Indica si esta propiedad es un objeto periódico Calendar con una o más excepciones y al menos uno de los mensajes incrustados de excepción tiene al menos un RecipientRow.
  
|||
|:-----|:-----|
|Propiedades asociadas:  <br/> |dispidFExceptionalAttendees  <br/> |
|Conjunto de propiedades:  <br/> |PSETID_Appointment  <br/> |
|IDENTIFICADOR largo (LID):  <br/> |0x0000822B  <br/> |
|Tipo de datos:  <br/> |PT_BOOLEAN  <br/> |
|Área:  <br/> |Meetings  <br/> |
   
## <a name="remarks"></a>Comentarios

Un valor de FALSE o la ausencia de esta propiedad indica que el objeto de calendario no tiene excepciones o que ninguno de los mensajes incrustados de la excepción tiene RecipientRows.

---
title: Propiedad canónico PidLidEmail3OriginalEntryId
manager: soliver
ms.date: 03/09/2015
...
---
# <a name="pidlidemail3originalentryid-canonical-property"></a>Propiedad canónico PidLidEmail3OriginalEntryId

  
  
**Se aplica a**: Outlook 
  
Especifica la **propiedad EntryId** del objeto que corresponde a la dirección de correo electrónico de terceros. 
  
|||
|:-----|:-----|
|Propiedades asociadas:  <br/> |dispidEmail3OriginalEntryID  <br/> |
|Conjunto de propiedades:  <br/> |PSETID_Address  <br/> |
|Identificador de tipo Long (LID):  <br/> |0x000080A5  <br/> |

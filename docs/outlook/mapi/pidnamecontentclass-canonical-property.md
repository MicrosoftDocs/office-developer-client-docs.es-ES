...
Para establecer el valor de esta propiedad, los clientes de extensiones multipropósito de mensajes de Internet (MIME) deben escribir un campo de encabezado de clase de contenido con el valor deseado. Los lectores MIME deben copiar el valor de un campo de encabezado de clase de contenido en el valor de esta propiedad. 

...
Codifica una vista para la tabla de destinatarios de un mensaje en la secuencia de datos Transport-Neutral formato de encapsulación (TNEF) del mensaje.
...
> [in] Puntero a la tabla de destinatarios para la que se codifica la vista. El  _parámetro lpRecipientTable_ puede ser NULL. 

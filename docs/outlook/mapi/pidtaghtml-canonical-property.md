...
Contiene el texto del cuerpo del mensaje en formato HTML.
  
|||
|:-----|:-----|
|Propiedades asociadas:  <br/> |PR_HTML  <br/> |
...
> Define las propiedades relacionadas con el cuerpo del mensaje.
...
> Especifica las propiedades y operaciones que se permiten en registrar objetos.

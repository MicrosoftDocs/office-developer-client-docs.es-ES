...
Indica la hora universal coordinada (UTC) y la fecha del cambio más reciente realizado en la tarea e indicado por la propiedad **dispidTaskHistory** ([PidLidTaskHistory](pidlidtasklastupdate-canonical-property.md)).
  
|||
|:-----|:-----|
|Propiedades asociadas:  <br/> |dispidTaskLastUpdate  <br/> |
|Conjunto de propiedades:  <br/> |PSETID_Task  <br/> |
|Id. largo (LID):  <br/> |0x00008115  <br/> |

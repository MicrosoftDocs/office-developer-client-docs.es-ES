...
---
# <a name="pidtagincompletecopy-canonical-property"></a>Propiedad canónica PidTagIncompleteCopy

  
  
**Se aplica a**: Outlook 2013 | Outlook 2016 
  
Contiene TRUE si este mensaje es una copia incompleta de otro mensaje.
...
|Área:  <br/> |Propiedades generales del mensaje  <br/> |

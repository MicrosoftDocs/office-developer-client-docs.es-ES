...
Especifica el nombre para mostrar de la dirección de fax principal del contacto.
  
|||
|:-----|:-----|
|Propiedades asociadas:  <br/> |dispidFax2DisplayName  <br/> |
|Conjunto de propiedades:  <br/> |PSETID_Address  <br/> |
|Id. largo (LID):  <br/> |0x000080C0  <br/> |

...
Contiene la fecha y hora de finalización de una cita como administrada por una aplicación de programación. 
...
La programación de aplicaciones debe establecer tanto **PR_START_DATE** ([PidTagStartDate](pidtagstartdate-canonical-property.md)) como esta propiedad al enviar las convocatorias de reunión. 

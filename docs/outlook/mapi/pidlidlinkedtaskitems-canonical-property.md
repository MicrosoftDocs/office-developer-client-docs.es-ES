...
Especifica una lista de la **** propiedad "[PidTagEntryId](pidtagentryid-canonical-property.md)" de las tareas relacionadas con el calendario. 
  
|||
|:-----|:-----|
|Propiedades asociadas:  <br/> |dispidLinkedTaskItems  <br/> |
|Conjunto de propiedades:  <br/> |PSETID_Appointment  <br/> |
|IDENTIFICADOR largo (LID):  <br/> |0x0000820C  <br/> |

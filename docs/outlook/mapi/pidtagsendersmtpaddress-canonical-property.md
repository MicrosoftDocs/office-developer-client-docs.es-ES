...
Contiene el formato de la dirección de correo electrónico de Protocolo simple de transporte de correo (SMTP) del propietario del buzón de envío.
...
Esta propiedad es un ejemplo de las propiedades de dirección del remitente del mensaje. Debe ser establecido por el proveedor de transporte saliente, que nunca debe propagar ningún valor existente previamente.

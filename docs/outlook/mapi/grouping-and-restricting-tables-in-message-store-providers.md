...
---
# <a name="grouping-and-restricting-tables-in-message-store-providers"></a>Agrupar y la restricción de las tablas de proveedores de almacén de mensajes
...
|:-----|:-----|
|[Elemento IMAPITable:: FindRow](imapitable-findrow.md) <br/> |Devuelve la tabla de las filas que coinciden con los criterios especificados.  <br/> |

...
---
# <a name="pidlidremotetransfertime-canonical-property"></a>Propiedad canónico PidLidRemoteTransferTime

  
  
**Se aplica a**: Outlook 
  
Indica el tiempo de transferencia, en segundos, para un elemento remoto.
  
|||
|:-----|:-----|
|Propiedades asociadas:  <br/> |dispidRemoteXferTime  <br/> |
|Conjunto de propiedades:  <br/> |PSETID_Remote  <br/> |
|Identificador de tipo Long (LID):  <br/> |0x00008F04  <br/> |

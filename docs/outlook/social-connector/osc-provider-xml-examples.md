---
title: Ejemplos de XML del proveedor OSC
manager: soliver
ms.date: 11/16/2014
...
Esta sección contiene ejemplos de XML que usan los elementos XML de **capacidades**, **amigos**y **activityFeed** , que cumplen con el esquema XML del proveedor de Outlook Social Connector (OSC). 
  
- [Ejemplo de XML de capacidades](capabilities-xml-example.md) muestra las **funciones** XML de un proveedor OSC, especificando sus capacidades y requisitos para el OSC. 
    
- [Ejemplo de XML de amigos](friends-xml-example.md) muestra el XML de **amigos** para dos personas en la red social. 

...
Esta sección contiene temas de referencia para la extensibilidad del proveedor de Outlook Social Connector (OSC).
  
## <a name="in-this-section"></a>En esta sección

- [Interfaces](outlook-social-connector-provider-interfaces.md)
  
- [Esquema XML](outlook-social-connector-provider-xml-schema.md)
  
- [Códigos de error](outlook-social-connector-provider-error-codes.md)

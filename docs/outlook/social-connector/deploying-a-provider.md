...
El método recomendado para implementar un proveedor de Outlook Social Connector (OSC) es usar un paquete de Windows Installer (.msi). Después de descargar el paquete de instalación en un disco duro local, el usuario final de Office instala el proveedor de OSC. Una vez completada la instalación del proveedor, el usuario puede conectarse al proveedor de OSC y proporcionar credenciales de inicio de sesión a la cuenta de red social. Si el usuario decide desinstalar el proveedor de OSC, el usuario puede usar programas y características en el Panel de control para desinstalar.  
  
## <a name="in-this-section"></a>En esta sección

- [Registro de un proveedor:](registering-a-provider.md)describe los requisitos de registro para un proveedor de OSC.
    
- [Lista de comprobación](installation-checklist.md)de instalación: proporciona una lista de comprobación para asegurarse de que un proveedor de OSC se instala correctamente.

...
- [Descargar las muestras](downloading-the-samples.md): se describe cómo descargar e instalar el proveedor de ejemplo y las plantillas.
    
- [Aplicar una plantilla de proveedor de ejemplo](applying-a-sample-provider-template.md): se describe cómo usar las plantillas de proveedor de ejemplo.

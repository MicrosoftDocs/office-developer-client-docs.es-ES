...
---
# <a name="schema-map-outlook-weather-information-schema"></a>Asignación de esquema (esquema de información de meteorología de Outlook)

En este tema se muestra la definición del esquema para el esquema de XML de información de meteorología de Outlook.

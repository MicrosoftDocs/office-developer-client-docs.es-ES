...
---
# <a name="schema-map-outlook-weather-information-schema"></a>Mapa de esquema (Outlook de información meteorológica)

En este tema se muestra la definición de esquema del Outlook xml de información meteorológica.

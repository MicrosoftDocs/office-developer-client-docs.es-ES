...
## <a name="see-also"></a><span data-ttu-id="cbceb-125">Vea también</span><span class="sxs-lookup"><span data-stu-id="cbceb-125">See also</span></span>

- [<span data-ttu-id="cbceb-126">Uso compartido de grupos</span><span class="sxs-lookup"><span data-stu-id="cbceb-126">Group sharing</span></span>](group-sharing.md)

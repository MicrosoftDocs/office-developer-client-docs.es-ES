...
En el ejemplo de código siguiente, el procedimiento GetDefaultMessageClass usa el objeto **PropertyAccessor** para determinar el formulario predeterminado de una carpeta. Si no se encuentra la propiedad de carpeta **PR \_ DEF \_ POST \_ MSGCLASS** [(PidTagDefaultPostMessageClass)](https://msdn.microsoft.com/library/cc815305\(v=office.15\)) y Outlook genera un error, **pruebe... catch** devuelve la **propiedad DefaultMessageClass** del **objeto Folder**.

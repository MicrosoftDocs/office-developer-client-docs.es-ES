...
Visual Studio 2012 instala de manera predeterminada las plantillas de complementos para Office 2010. Para usar Office Developer Tools para Visual Studio con el fin de desarrollar complementos administrados para Outlook 2013, debe [descargar](https://aka.ms/officedevtoolsforvs2012) las plantillas para Office 2013.

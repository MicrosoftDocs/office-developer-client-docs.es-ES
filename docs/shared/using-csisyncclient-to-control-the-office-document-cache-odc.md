...
<span data-ttu-id="c0099-111">Actualmente se establece el identificador de clase para responder sólo a OneDrive.</span><span class="sxs-lookup"><span data-stu-id="c0099-111">The class ID is currently set to respond only to OneDrive.</span></span>
...
##### <a name="return-values"></a><span data-ttu-id="c0099-223">Valores devueltos</span><span class="sxs-lookup"><span data-stu-id="c0099-223">Return values</span></span>
...
##### <a name="return-values"></a><span data-ttu-id="c0099-247">Valores devueltos</span><span class="sxs-lookup"><span data-stu-id="c0099-247">Return values</span></span>
...
<span data-ttu-id="c0099-267">Identifica el consumidor y que la memoria caché para usar.</span><span class="sxs-lookup"><span data-stu-id="c0099-267">Identifies the consumer and which cache to use.</span></span> <span data-ttu-id="c0099-268">Debe ser no vacía con un máximo de 32 caracteres.</span><span class="sxs-lookup"><span data-stu-id="c0099-268">Must be non-empty with a maximum of 32 characters.</span></span> 
 ...
 <span data-ttu-id="c0099-269">_bstrProgID_</span><span class="sxs-lookup"><span data-stu-id="c0099-269">_bstrProgID_</span></span>
...
#### <a name="ilsclocalsyncclientlocalfilechange"></a><span data-ttu-id="c0099-300">ILSCLocalSyncClient::LocalFileChange</span><span class="sxs-lookup"><span data-stu-id="c0099-300">ILSCLocalSyncClient::LocalFileChange</span></span>
...
<span data-ttu-id="c0099-313">Una cadena que identifica el ResourceID del archivo.</span><span class="sxs-lookup"><span data-stu-id="c0099-313">A string which identifies the ResourceID of the file.</span></span> <span data-ttu-id="c0099-314">Este valor debe ser no vacía con un máximo de 128 caracteres.</span><span class="sxs-lookup"><span data-stu-id="c0099-314">This value must be non-empty with a maximum of 128 characters.</span></span> 
...
<span data-ttu-id="c0099-359">Una cadena que especifica la nueva ruta de acceso local para el archivo.</span><span class="sxs-lookup"><span data-stu-id="c0099-359">A string which specifies the new local path for the file.</span></span> <span data-ttu-id="c0099-360">Este valor debe ser una ruta de acceso local no vacía con un máximo de 256 caracteres.</span><span class="sxs-lookup"><span data-stu-id="c0099-360">This value must be a non-empty local path with a maximum of 256 characters.</span></span> <span data-ttu-id="c0099-361">Esta ruta de acceso debe estar en el árbol del directorio especificado por la FileSystemDirectoryHint cuando se realizó la llamada a Initialize.</span><span class="sxs-lookup"><span data-stu-id="c0099-361">This path must be in the directory tree specified by the FileSystemDirectoryHint when the call to Initialize was made.</span></span> 
 ...
 <span data-ttu-id="c0099-362">_bstrNewWebPath_</span><span class="sxs-lookup"><span data-stu-id="c0099-362">_bstrNewWebPath_</span></span>
...
<span data-ttu-id="c0099-389"><a name="ILSCLocalSyncClient_ResetCache"> </a></span><span class="sxs-lookup"><span data-stu-id="c0099-389"></span></span>
...
<span data-ttu-id="c0099-410">Este método le permitirá descargas si se marcó como descargas bloqueados anteriormente (vea RenameFile).</span><span class="sxs-lookup"><span data-stu-id="c0099-410">This method will allow downloads if it was marked as downloads blocked previously (see RenameFile).</span></span>
...
##### <a name="parameters"></a><span data-ttu-id="c0099-473">Parámetros</span><span class="sxs-lookup"><span data-stu-id="c0099-473">Parameters</span></span>
 ...
 <span data-ttu-id="c0099-474">_nspType_</span><span class="sxs-lookup"><span data-stu-id="c0099-474">_nspType_</span></span>
  
<span data-ttu-id="c0099-475">Marca que define qué heurística de costo para invalidar.</span><span class="sxs-lookup"><span data-stu-id="c0099-475">A flag which defines which cost heuristic to override.</span></span> <span data-ttu-id="c0099-476">Vea la [Enumeración LSCNetworkSyncPermissionType](using-csisyncclient-to-control-the-office-document-cache-odc.md#Enum_LSCNetworkSyncPermissionType).</span><span class="sxs-lookup"><span data-stu-id="c0099-476">See [Enum LSCNetworkSyncPermissionType](using-csisyncclient-to-control-the-office-document-cache-odc.md#Enum_LSCNetworkSyncPermissionType).</span></span>
  
 <span data-ttu-id="c0099-477">_fEnableSync_</span><span class="sxs-lookup"><span data-stu-id="c0099-477">_fEnableSync_</span></span>
  
<span data-ttu-id="c0099-478">Especifica si para forzar la sincronización en, por lo tanto reemplazar esa heurística de costo, o ya no invalidarla.</span><span class="sxs-lookup"><span data-stu-id="c0099-478">Specifies whether to force synchronizing on, thus overriding that cost heuristic, or to no longer override it.</span></span> 
  
##### <a name="return-values"></a><span data-ttu-id="c0099-479">Valores devueltos</span><span class="sxs-lookup"><span data-stu-id="c0099-479">Return values</span></span>

|<span data-ttu-id="c0099-480">Valor</span><span class="sxs-lookup"><span data-stu-id="c0099-480">Value</span></span>|<span data-ttu-id="c0099-481">Descripción</span><span class="sxs-lookup"><span data-stu-id="c0099-481">Description</span></span>|
|:-----|:-----|
|<span data-ttu-id="c0099-482">E_FAIL</span><span class="sxs-lookup"><span data-stu-id="c0099-482">E_FAIL</span></span>  <br/> |<span data-ttu-id="c0099-483">Error al reemplazar heurística de sincronización.</span><span class="sxs-lookup"><span data-stu-id="c0099-483">Failure to override synchronizing heuristics.</span></span>  <br/> |
|<span data-ttu-id="c0099-484">E_LSC_NOINITIALIZED</span><span class="sxs-lookup"><span data-stu-id="c0099-484">E_LSC_NOINITIALIZED</span></span>  <br/> |<span data-ttu-id="c0099-485">[ILSCLocalSyncClient::Initialize](using-csisyncclient-to-control-the-office-document-cache-odc.md#ILSCLocalSyncClient_Initialize) no se ha llamado correctamente en el pasado.</span><span class="sxs-lookup"><span data-stu-id="c0099-485">[ILSCLocalSyncClient::Initialize ](using-csisyncclient-to-control-the-office-document-cache-odc.md#ILSCLocalSyncClient_Initialize) has not been successfully called in the past.</span></span>  <br/> |
|<span data-ttu-id="c0099-486">S_OK</span><span class="sxs-lookup"><span data-stu-id="c0099-486">S_OK</span></span>  <br/> |<span data-ttu-id="c0099-487">La llamada ha sido correcta.</span><span class="sxs-lookup"><span data-stu-id="c0099-487">The call succeeded.</span></span>  <br/> |
   
#### <a name="ilsclocalsyncclientuninitialize"></a><span data-ttu-id="c0099-488">ILSCLocalSyncClient::Uninitialize</span><span class="sxs-lookup"><span data-stu-id="c0099-488">ILSCLocalSyncClient::Uninitialize</span></span>
<span data-ttu-id="c0099-489"><a name="ILSCLocalSyncClient_Uninitialize"> </a></span><span class="sxs-lookup"><span data-stu-id="c0099-489"></span></span>

<span data-ttu-id="c0099-490">Descarga de la memoria caché desde el objeto COM y llevar a cabo operaciones de cierre.</span><span class="sxs-lookup"><span data-stu-id="c0099-490">Unloads the cache from the COM object and perform closing operations.</span></span> <span data-ttu-id="c0099-491">[ILSCLocalSyncClient::Uninitialize](using-csisyncclient-to-control-the-office-document-cache-odc.md#ILSCLocalSyncClient_Uninitialize) DEBE llamarse antes de destruir el objeto COM.</span><span class="sxs-lookup"><span data-stu-id="c0099-491">[ILSCLocalSyncClient::Uninitialize ](using-csisyncclient-to-control-the-office-document-cache-odc.md#ILSCLocalSyncClient_Uninitialize) MUST be called before destroying the COM object.</span></span> <span data-ttu-id="c0099-492">Después de llamar, no se puede llamar a ningún otras API, el objeto COM debe ser destruye y crea una nueva si desea continuar con las operaciones.</span><span class="sxs-lookup"><span data-stu-id="c0099-492">Once called, no other APIs can be called, the COM object MUST be destroyed and a new one created if you wish to continue operations.</span></span> 
  
`HRESULT ILSCLocalSyncClient::Uninitialize ()`

##### <a name="parameters"></a><span data-ttu-id="c0099-493">Parámetros</span><span class="sxs-lookup"><span data-stu-id="c0099-493">Parameters</span></span>

<span data-ttu-id="c0099-494">Ninguno.</span><span class="sxs-lookup"><span data-stu-id="c0099-494">None.</span></span>
  
##### <a name="return-values"></a><span data-ttu-id="c0099-495">Valores devueltos</span><span class="sxs-lookup"><span data-stu-id="c0099-495">Return values</span></span>

|<span data-ttu-id="c0099-496">Valor</span><span class="sxs-lookup"><span data-stu-id="c0099-496">Value</span></span>|<span data-ttu-id="c0099-497">Descripción</span><span class="sxs-lookup"><span data-stu-id="c0099-497">Description</span></span>|
|:-----|:-----|
|<span data-ttu-id="c0099-498">E_FAIL</span><span class="sxs-lookup"><span data-stu-id="c0099-498">E_FAIL</span></span>  <br/> |<span data-ttu-id="c0099-499">Error al cancelar la inicialización.</span><span class="sxs-lookup"><span data-stu-id="c0099-499">Failure to uninitialize.</span></span>  <br/> |
|<span data-ttu-id="c0099-500">E_LSC_NOINITIALIZED</span><span class="sxs-lookup"><span data-stu-id="c0099-500">E_LSC_NOINITIALIZED</span></span>  <br/> |<span data-ttu-id="c0099-501">[ILSCLocalSyncClient::Initialize](using-csisyncclient-to-control-the-office-document-cache-odc.md#ILSCLocalSyncClient_Initialize) no se ha llamado correctamente en el pasado.</span><span class="sxs-lookup"><span data-stu-id="c0099-501">[ILSCLocalSyncClient::Initialize ](using-csisyncclient-to-control-the-office-document-cache-odc.md#ILSCLocalSyncClient_Initialize) has not been successfully called in the past.</span></span>  <br/> |
|<span data-ttu-id="c0099-502">S_OK</span><span class="sxs-lookup"><span data-stu-id="c0099-502">S_OK</span></span>  <br/> |<span data-ttu-id="c0099-503">La llamada ha sido correcta.</span><span class="sxs-lookup"><span data-stu-id="c0099-503">The call succeeded.</span></span>  <br/> |
   
### <a name="interface-ienumlscevent"></a><span data-ttu-id="c0099-504">Interfaz IEnumLSCEvent</span><span class="sxs-lookup"><span data-stu-id="c0099-504">Interface IEnumLSCEvent</span></span>

<span data-ttu-id="c0099-505">Esta interfaz representa una lista de eventos de ILSCEvent.</span><span class="sxs-lookup"><span data-stu-id="c0099-505">This interface represents a list of ILSCEvent events.</span></span>
  
<span data-ttu-id="c0099-506">**Funciones miembro públicas**</span><span class="sxs-lookup"><span data-stu-id="c0099-506">**Public member functions**</span></span>

#### <a name="ienumlsceventfnext"></a><span data-ttu-id="c0099-507">IEnumLSCEvent::FNext</span><span class="sxs-lookup"><span data-stu-id="c0099-507">IEnumLSCEvent::FNext</span></span>

<span data-ttu-id="c0099-508">Recupera el siguiente evento de la lista de eventos.</span><span class="sxs-lookup"><span data-stu-id="c0099-508">Retrieves the next event from the list of events.</span></span>
  
`HRESULT IEnumLSCEvent::FNext ([out] ILSCEvent ** ppiLSCEvent)`

##### <a name="parameters"></a><span data-ttu-id="c0099-509">Parámetros</span><span class="sxs-lookup"><span data-stu-id="c0099-509">Parameters</span></span>

 <span data-ttu-id="c0099-510">_ppiLSCEvent_</span><span class="sxs-lookup"><span data-stu-id="c0099-510">_ppiLSCEvent_</span></span>
  
<span data-ttu-id="c0099-511">Un puntero a una interfaz ILSCEvent.</span><span class="sxs-lookup"><span data-stu-id="c0099-511">A pointer to an ILSCEvent interface.</span></span>
  
##### <a name="return-values"></a><span data-ttu-id="c0099-512">Valores devueltos</span><span class="sxs-lookup"><span data-stu-id="c0099-512">Return values</span></span>

|<span data-ttu-id="c0099-513">Valor</span><span class="sxs-lookup"><span data-stu-id="c0099-513">Value</span></span>|<span data-ttu-id="c0099-514">Descripción</span><span class="sxs-lookup"><span data-stu-id="c0099-514">Description</span></span>|
|:-----|:-----|
|<span data-ttu-id="c0099-515">E_FAIL</span><span class="sxs-lookup"><span data-stu-id="c0099-515">E_FAIL</span></span>  <br/> |<span data-ttu-id="c0099-516">No existen más eventos.</span><span class="sxs-lookup"><span data-stu-id="c0099-516">There are no more events.</span></span>  <br/> |
|<span data-ttu-id="c0099-517">S_OK</span><span class="sxs-lookup"><span data-stu-id="c0099-517">S_OK</span></span>  <br/> |<span data-ttu-id="c0099-518">La llamada tuvo éxito.</span><span class="sxs-lookup"><span data-stu-id="c0099-518">The call was successful.</span></span>  <br/> |
   
#### <a name="ienumlsceventreset"></a><span data-ttu-id="c0099-519">IEnumLSCEvent::Reset</span><span class="sxs-lookup"><span data-stu-id="c0099-519">IEnumLSCEvent::Reset</span></span>

<span data-ttu-id="c0099-520">Restablece el enumerador al primer evento.</span><span class="sxs-lookup"><span data-stu-id="c0099-520">Resets the enumerator to the first event.</span></span>
  
`HRESULT IEnumLSCEvent::Reset ()`

##### <a name="parameters"></a><span data-ttu-id="c0099-521">Parámetros</span><span class="sxs-lookup"><span data-stu-id="c0099-521">Parameters</span></span>

<span data-ttu-id="c0099-522">Ninguno.</span><span class="sxs-lookup"><span data-stu-id="c0099-522">None.</span></span>
  
##### <a name="return-values"></a><span data-ttu-id="c0099-523">Valores devueltos</span><span class="sxs-lookup"><span data-stu-id="c0099-523">Return values</span></span>

<span data-ttu-id="c0099-524">Siempre devuelve S_OK.</span><span class="sxs-lookup"><span data-stu-id="c0099-524">Always returns S_OK.</span></span> 
  
### <a name="interface-ilscevent"></a><span data-ttu-id="c0099-525">Interfaz ILSCEvent</span><span class="sxs-lookup"><span data-stu-id="c0099-525">Interface ILSCEvent</span></span>

<span data-ttu-id="c0099-526">Esta interfaz representa un evento de sincronización.</span><span class="sxs-lookup"><span data-stu-id="c0099-526">This interface represents a synchronizing event.</span></span> <span data-ttu-id="c0099-527">Toda la información sobre el evento se puede recuperar desde la interfaz.</span><span class="sxs-lookup"><span data-stu-id="c0099-527">All information about the event can be retrieved from the interface.</span></span>
  
<span data-ttu-id="c0099-528">**Funciones miembro públicas**</span><span class="sxs-lookup"><span data-stu-id="c0099-528">**Public member functions**</span></span>

#### <a name="ilsceventgetconflictstatus"></a><span data-ttu-id="c0099-529">ILSCEvent::GetConflictStatus</span><span class="sxs-lookup"><span data-stu-id="c0099-529">ILSCEvent::GetConflictStatus</span></span>

<span data-ttu-id="c0099-530">Tenga en cuenta que este valor se rellena cuando [ILSCLocalSyncClient::GetChanges](using-csisyncclient-to-control-the-office-document-cache-odc.md#ILSCLocalSyncClient_GetChanges) se llama, no cuando se creó el evento, por lo que sólo tendrá el estado actual del archivo, no el estado del archivo cuando cambia el estado de conflicto.</span><span class="sxs-lookup"><span data-stu-id="c0099-530">Note that this value is populated when [ILSCLocalSyncClient::GetChanges ](using-csisyncclient-to-control-the-office-document-cache-odc.md#ILSCLocalSyncClient_GetChanges) is called, not when the event was created, so you will only have the current status of the file, not the status of the file when the conflict status changed.</span></span> 
  
<span data-ttu-id="c0099-531">Este valor sólo se llena cuando la [Enumeración LSCEventType](using-csisyncclient-to-control-the-office-document-cache-odc.md#Enum_LSCEventType) del evento es LSCEventType_OnLocalConflictStateChanged.</span><span class="sxs-lookup"><span data-stu-id="c0099-531">This value is only populated when the [Enum LSCEventType](using-csisyncclient-to-control-the-office-document-cache-odc.md#Enum_LSCEventType) of the event is LSCEventType_OnLocalConflictStateChanged.</span></span> 
  
`HRESULT ILSCEvent::GetConflictStatus ([out] VARIANT_BOOL * pfIsInConflict)`

##### <a name="parameters"></a><span data-ttu-id="c0099-532">Parámetros</span><span class="sxs-lookup"><span data-stu-id="c0099-532">Parameters</span></span>

 <span data-ttu-id="c0099-533">_pfIsInConflict_</span><span class="sxs-lookup"><span data-stu-id="c0099-533">_pfIsInConflict_</span></span>
  
<span data-ttu-id="c0099-534">El estado actual de conflicto del archivo asociado con el evento.</span><span class="sxs-lookup"><span data-stu-id="c0099-534">The current conflict status of the file associated with the event.</span></span>
  
##### <a name="return-values"></a><span data-ttu-id="c0099-535">Valores devueltos</span><span class="sxs-lookup"><span data-stu-id="c0099-535">Return values</span></span>

<span data-ttu-id="c0099-536">Siempre devuelve S_OK.</span><span class="sxs-lookup"><span data-stu-id="c0099-536">Always returns S_OK.</span></span> 
  
#### <a name="ilsceventgeterror"></a><span data-ttu-id="c0099-537">ILSCEvent::GetError</span><span class="sxs-lookup"><span data-stu-id="c0099-537">ILSCEvent::GetError</span></span>

<span data-ttu-id="c0099-538">Este valor sólo se rellena cuando la [Enumeración LSCEventType](using-csisyncclient-to-control-the-office-document-cache-odc.md#Enum_LSCEventType) del evento es LSCEventType_OnServerChangesDownloaded o LSCEventType_OnLocalChangesUploaded.</span><span class="sxs-lookup"><span data-stu-id="c0099-538">This value is only populated when the [Enum LSCEventType](using-csisyncclient-to-control-the-office-document-cache-odc.md#Enum_LSCEventType) of the event is LSCEventType_OnServerChangesDownloaded or LSCEventType_OnLocalChangesUploaded.</span></span> 
  
`HRESULT ILSCEvent::GetError ([out] LONG * pnError)`

##### <a name="parameters"></a><span data-ttu-id="c0099-539">Parámetros</span><span class="sxs-lookup"><span data-stu-id="c0099-539">Parameters</span></span>

 <span data-ttu-id="c0099-540">_pnError_</span><span class="sxs-lookup"><span data-stu-id="c0099-540">_pnError_</span></span>
  
<span data-ttu-id="c0099-541">El error asociado con este evento.</span><span class="sxs-lookup"><span data-stu-id="c0099-541">The error associated with this event.</span></span>
  
##### <a name="return-values"></a><span data-ttu-id="c0099-542">Valores devueltos</span><span class="sxs-lookup"><span data-stu-id="c0099-542">Return values</span></span>

<span data-ttu-id="c0099-543">Siempre devuelve S_OK.</span><span class="sxs-lookup"><span data-stu-id="c0099-543">Always returns S_OK.</span></span> 
  
#### <a name="ilsceventgetetag"></a><span data-ttu-id="c0099-544">ILSCEvent::GetETag</span><span class="sxs-lookup"><span data-stu-id="c0099-544">ILSCEvent::GetETag</span></span>

<span data-ttu-id="c0099-545">Este valor sólo se rellena cuando la [Enumeración LSCEventType](using-csisyncclient-to-control-the-office-document-cache-odc.md#Enum_LSCEventType) del evento es LSCEventType_OnServerChangesDownloaded o LSCEventType_OnLocalChangesUploaded.</span><span class="sxs-lookup"><span data-stu-id="c0099-545">This value is only populated when the [Enum LSCEventType](using-csisyncclient-to-control-the-office-document-cache-odc.md#Enum_LSCEventType) of the event is LSCEventType_OnServerChangesDownloaded or LSCEventType_OnLocalChangesUploaded.</span></span> 
  
`HRESULT ILSCEvent::GetETag ([out] BSTR * pbstrETag)`

##### <a name="parameters"></a><span data-ttu-id="c0099-546">Parámetros</span><span class="sxs-lookup"><span data-stu-id="c0099-546">Parameters</span></span>

 <span data-ttu-id="c0099-547">_pbstrETag_</span><span class="sxs-lookup"><span data-stu-id="c0099-547">_pbstrETag_</span></span>
  
<span data-ttu-id="c0099-548">El valor de ETag asociado a este evento</span><span class="sxs-lookup"><span data-stu-id="c0099-548">The ETag associated with this event</span></span>
  
##### <a name="return-values"></a><span data-ttu-id="c0099-549">Valores devueltos</span><span class="sxs-lookup"><span data-stu-id="c0099-549">Return values</span></span>

<span data-ttu-id="c0099-550">Siempre devuelve S_OK.</span><span class="sxs-lookup"><span data-stu-id="c0099-550">Always returns S_OK.</span></span> 
  
#### <a name="ilsceventgeteventtype"></a><span data-ttu-id="c0099-551">ILSCEvent::GetEventType</span><span class="sxs-lookup"><span data-stu-id="c0099-551">ILSCEvent::GetEventType</span></span>

<span data-ttu-id="c0099-552">Obtiene el tipo de este evento.</span><span class="sxs-lookup"><span data-stu-id="c0099-552">Gets the type for this event.</span></span>
  
`HRESULT ILSCEvent::GetEventType ([out] LSCEventType * pnEventType)`

##### <a name="parameters"></a><span data-ttu-id="c0099-553">Parámetros</span><span class="sxs-lookup"><span data-stu-id="c0099-553">Parameters</span></span>

 <span data-ttu-id="c0099-554">_pnEventType_</span><span class="sxs-lookup"><span data-stu-id="c0099-554">_pnEventType_</span></span>
  
<span data-ttu-id="c0099-555">El tipo de evento de este evento.</span><span class="sxs-lookup"><span data-stu-id="c0099-555">The event type of this event.</span></span> <span data-ttu-id="c0099-556">Vea [Enum LSCEventType](using-csisyncclient-to-control-the-office-document-cache-odc.md#Enum_LSCEventType) para los valores válidos.</span><span class="sxs-lookup"><span data-stu-id="c0099-556">See [Enum LSCEventType](using-csisyncclient-to-control-the-office-document-cache-odc.md#Enum_LSCEventType) for valid values.</span></span> <span data-ttu-id="c0099-557">No debe ser null.</span><span class="sxs-lookup"><span data-stu-id="c0099-557">Must not be null.</span></span> 
  
##### <a name="return-values"></a><span data-ttu-id="c0099-558">Valores devueltos</span><span class="sxs-lookup"><span data-stu-id="c0099-558">Return values</span></span>

|<span data-ttu-id="c0099-559">Valor</span><span class="sxs-lookup"><span data-stu-id="c0099-559">Value</span></span>|<span data-ttu-id="c0099-560">Descripción</span><span class="sxs-lookup"><span data-stu-id="c0099-560">Description</span></span>|
|:-----|:-----|
|<span data-ttu-id="c0099-561">E_INVALIDARG</span><span class="sxs-lookup"><span data-stu-id="c0099-561">E_INVALIDARG</span></span>  <br/> |<span data-ttu-id="c0099-562">Uno o más parámetros no son válidos.</span><span class="sxs-lookup"><span data-stu-id="c0099-562">One or more parameters are invalid.</span></span>  <br/> |
|<span data-ttu-id="c0099-563">S_OK</span><span class="sxs-lookup"><span data-stu-id="c0099-563">S_OK</span></span>  <br/> |<span data-ttu-id="c0099-564">La llamada tuvo éxito.</span><span class="sxs-lookup"><span data-stu-id="c0099-564">The call was successful.</span></span>  <br/> |
   
#### <a name="ilsceventgetlocalworkingpath"></a><span data-ttu-id="c0099-565">ILSCEvent::GetLocalWorkingPath</span><span class="sxs-lookup"><span data-stu-id="c0099-565">ILSCEvent::GetLocalWorkingPath</span></span>

<span data-ttu-id="c0099-566">Obtiene la ruta de acceso local de trabajo para este evento.</span><span class="sxs-lookup"><span data-stu-id="c0099-566">Gets the local working path for this event.</span></span>
  
`HRESULT ILSCEvent::GetLocalWorkingPath ([out] BSTR * pbstrLocalWorkingPath)`

##### <a name="parameters"></a><span data-ttu-id="c0099-567">Parámetros</span><span class="sxs-lookup"><span data-stu-id="c0099-567">Parameters</span></span>

 <span data-ttu-id="c0099-568">_pbstrLocalWorkingPath_</span><span class="sxs-lookup"><span data-stu-id="c0099-568">_pbstrLocalWorkingPath_</span></span>
  
<span data-ttu-id="c0099-569">La ruta de acceso local del archivo al que pertenece este evento.</span><span class="sxs-lookup"><span data-stu-id="c0099-569">The local path of the file to which this event pertains.</span></span> 
  
##### <a name="return-values"></a><span data-ttu-id="c0099-570">Valores devueltos</span><span class="sxs-lookup"><span data-stu-id="c0099-570">Return values</span></span>

<span data-ttu-id="c0099-571">Siempre devuelve S_OK.</span><span class="sxs-lookup"><span data-stu-id="c0099-571">Always returns S_OK.</span></span> 
  
#### <a name="ilsceventgetresourceid"></a><span data-ttu-id="c0099-572">ILSCEvent::GetResourceID</span><span class="sxs-lookup"><span data-stu-id="c0099-572">ILSCEvent::GetResourceID</span></span>

<span data-ttu-id="c0099-573">Obtiene el identificador de recurso para el evento.</span><span class="sxs-lookup"><span data-stu-id="c0099-573">Gets the resource ID for the event.</span></span>
  
`HRESULT ILSCEvent::GetResourceID ([out] BSTR * pbstrResourceID)`

##### <a name="parameters"></a><span data-ttu-id="c0099-574">Parámetros</span><span class="sxs-lookup"><span data-stu-id="c0099-574">Parameters</span></span>

 <span data-ttu-id="c0099-575">_pbstrResourceID_</span><span class="sxs-lookup"><span data-stu-id="c0099-575">_pbstrResourceID_</span></span>
  
<span data-ttu-id="c0099-576">ResourceID del archivo asociado con este evento.</span><span class="sxs-lookup"><span data-stu-id="c0099-576">The ResourceID of the file associated with this event.</span></span>
  
##### <a name="return-values"></a><span data-ttu-id="c0099-577">Valores devueltos</span><span class="sxs-lookup"><span data-stu-id="c0099-577">Return values</span></span>

<span data-ttu-id="c0099-578">Siempre devuelve S_OK.</span><span class="sxs-lookup"><span data-stu-id="c0099-578">Always returns S_OK.</span></span> 
  
#### <a name="ilsceventgetresourceidattempted"></a><span data-ttu-id="c0099-579">ILSCEvent::GetResourceIDAttempted</span><span class="sxs-lookup"><span data-stu-id="c0099-579">ILSCEvent::GetResourceIDAttempted</span></span>

<span data-ttu-id="c0099-580">Este valor sólo se llena cuando la [Enumeración LSCEventType](using-csisyncclient-to-control-the-office-document-cache-odc.md#Enum_LSCEventType) del evento es LSCEventType_OnFilePathConflict.</span><span class="sxs-lookup"><span data-stu-id="c0099-580">This value is only populated when the [Enum LSCEventType](using-csisyncclient-to-control-the-office-document-cache-odc.md#Enum_LSCEventType) of the event is LSCEventType_OnFilePathConflict.</span></span> <span data-ttu-id="c0099-581">Cuando una llamada a [ILSCLocalSyncClient::LocalFileChange ](using-csisyncclient-to-control-the-office-document-cache-odc.md#ILSCLocalSyncClient_LocalFileChange), [ILSCLocalSyncClient::ServerFileChange ](using-csisyncclient-to-control-the-office-document-cache-odc.md#ILSCLocalSyncClient_ServerFileChange)o [ILSCLocalSyncClient::RenameFile](using-csisyncclient-to-control-the-office-document-cache-odc.md#ILSCLocalSyncClient_RenameFile) provocaría un conflicto de ruta de acceso Web o la ruta de acceso Local con otro archivo en la memoria caché de archivos de Office, esto se genera el evento.</span><span class="sxs-lookup"><span data-stu-id="c0099-581">When a call to [ILSCLocalSyncClient::LocalFileChange ](using-csisyncclient-to-control-the-office-document-cache-odc.md#ILSCLocalSyncClient_LocalFileChange), [ILSCLocalSyncClient::ServerFileChange ](using-csisyncclient-to-control-the-office-document-cache-odc.md#ILSCLocalSyncClient_ServerFileChange), or [ILSCLocalSyncClient::RenameFile ](using-csisyncclient-to-control-the-office-document-cache-odc.md#ILSCLocalSyncClient_RenameFile) would cause a Web Path or Local Path collision with another file in the Office file cache, this event is generated.</span></span> 
  
`HRESULT ILSCEvent::GetResourceIDAttempted ([out] BSTR * pbstrResourceIDAttempted)`

##### <a name="parameters"></a><span data-ttu-id="c0099-582">Parámetros</span><span class="sxs-lookup"><span data-stu-id="c0099-582">Parameters</span></span>

 <span data-ttu-id="c0099-583">_pbstrResourceIDAttempted_</span><span class="sxs-lookup"><span data-stu-id="c0099-583">_pbstrResourceIDAttempted_</span></span>
  
<span data-ttu-id="c0099-584">El ResourceID que causó este evento obtener generado.</span><span class="sxs-lookup"><span data-stu-id="c0099-584">The ResourceID that caused this event to get generated.</span></span> <span data-ttu-id="c0099-585">No debe ser null.</span><span class="sxs-lookup"><span data-stu-id="c0099-585">Must not be null.</span></span> 
  
##### <a name="return-values"></a><span data-ttu-id="c0099-586">Valores devueltos</span><span class="sxs-lookup"><span data-stu-id="c0099-586">Return values</span></span>

<span data-ttu-id="c0099-587">Siempre devuelve S_OK.</span><span class="sxs-lookup"><span data-stu-id="c0099-587">Always returns S_OK.</span></span> 
  
#### <a name="ilsceventgetsyncerrortype"></a><span data-ttu-id="c0099-588">ILSCEvent::GetSyncErrorType</span><span class="sxs-lookup"><span data-stu-id="c0099-588">ILSCEvent::GetSyncErrorType</span></span>

<span data-ttu-id="c0099-589">Este valor sólo se rellena cuando la [Enumeración LSCEventType](using-csisyncclient-to-control-the-office-document-cache-odc.md#Enum_LSCEventType) del evento es LSCEventType_OnServerChangesDownloaded o LSCEventType_OnLocalChangesUploaded.</span><span class="sxs-lookup"><span data-stu-id="c0099-589">This value is only populated when the [Enum LSCEventType](using-csisyncclient-to-control-the-office-document-cache-odc.md#Enum_LSCEventType) of the event is LSCEventType_OnServerChangesDownloaded or LSCEventType_OnLocalChangesUploaded.</span></span> 
  
`HRESULT ILSCEvent::GetSyncErrorType ([out] LSCEventSyncErrorType * pnSyncErrorType)`

##### <a name="parameters"></a><span data-ttu-id="c0099-590">Parámetros</span><span class="sxs-lookup"><span data-stu-id="c0099-590">Parameters</span></span>

 <span data-ttu-id="c0099-591">_pnSyncErrorType_</span><span class="sxs-lookup"><span data-stu-id="c0099-591">_pnSyncErrorType_</span></span>
  
<span data-ttu-id="c0099-592">El tipo de error asociado con este evento.</span><span class="sxs-lookup"><span data-stu-id="c0099-592">The error type associated with this event.</span></span> <span data-ttu-id="c0099-593">Los valores posibles, vea [Enum LSCEventType](using-csisyncclient-to-control-the-office-document-cache-odc.md#Enum_LSCEventType) .</span><span class="sxs-lookup"><span data-stu-id="c0099-593">See [Enum LSCEventType](using-csisyncclient-to-control-the-office-document-cache-odc.md#Enum_LSCEventType) for potential values.</span></span> <span data-ttu-id="c0099-594">No debe ser null.</span><span class="sxs-lookup"><span data-stu-id="c0099-594">Must not be null.</span></span> 
  
##### <a name="return-values"></a><span data-ttu-id="c0099-595">Valores devueltos</span><span class="sxs-lookup"><span data-stu-id="c0099-595">Return values</span></span>

|<span data-ttu-id="c0099-596">Valor</span><span class="sxs-lookup"><span data-stu-id="c0099-596">Value</span></span>|<span data-ttu-id="c0099-597">Descripción</span><span class="sxs-lookup"><span data-stu-id="c0099-597">Description</span></span>|
|:-----|:-----|
|<span data-ttu-id="c0099-598">E_INVALIDARG</span><span class="sxs-lookup"><span data-stu-id="c0099-598">E_INVALIDARG</span></span>  <br/> |<span data-ttu-id="c0099-599">Uno o más parámetros no son válidos.</span><span class="sxs-lookup"><span data-stu-id="c0099-599">One or more parameters are invalid.</span></span>  <br/> |
|<span data-ttu-id="c0099-600">S_OK</span><span class="sxs-lookup"><span data-stu-id="c0099-600">S_OK</span></span>  <br/> |<span data-ttu-id="c0099-601">La llamada tuvo éxito.</span><span class="sxs-lookup"><span data-stu-id="c0099-601">The call was successful.</span></span>  <br/> |
   
#### <a name="ilsceventgetwebpath"></a><span data-ttu-id="c0099-602">ILSCEvent::GetWebPath</span><span class="sxs-lookup"><span data-stu-id="c0099-602">ILSCEvent::GetWebPath</span></span>

<span data-ttu-id="c0099-603">Este valor sólo se llena cuando la [Enumeración LSCEventType](using-csisyncclient-to-control-the-office-document-cache-odc.md#Enum_LSCEventType) del evento es LSCEventType_OnFilePathConflict.</span><span class="sxs-lookup"><span data-stu-id="c0099-603">This value is only populated when the [Enum LSCEventType](using-csisyncclient-to-control-the-office-document-cache-odc.md#Enum_LSCEventType) of the event is LSCEventType_OnFilePathConflict.</span></span> 
  
`HRESULT ILSCEvent::GetWebPath ([out] BSTR * pbstrWebPath)`

##### <a name="parameters"></a><span data-ttu-id="c0099-604">Parámetros</span><span class="sxs-lookup"><span data-stu-id="c0099-604">Parameters</span></span>

 <span data-ttu-id="c0099-605">_pbstrWebPath_</span><span class="sxs-lookup"><span data-stu-id="c0099-605">_pbstrWebPath_</span></span>
  
<span data-ttu-id="c0099-606">Especifica la ruta de acceso Web asociado con este evento.</span><span class="sxs-lookup"><span data-stu-id="c0099-606">Specifies the Web Path associated with this event.</span></span> <span data-ttu-id="c0099-607">No debe ser null.</span><span class="sxs-lookup"><span data-stu-id="c0099-607">Must not be null.</span></span> 
  
##### <a name="return-values"></a><span data-ttu-id="c0099-608">Valores devueltos</span><span class="sxs-lookup"><span data-stu-id="c0099-608">Return values</span></span>

<span data-ttu-id="c0099-609">Siempre devuelve S_OK.</span><span class="sxs-lookup"><span data-stu-id="c0099-609">Always returns S_OK.</span></span> 
  
### <a name="interface-ilscevent2"></a><span data-ttu-id="c0099-610">Interfaz ILSCEvent2</span><span class="sxs-lookup"><span data-stu-id="c0099-610">Interface ILSCEvent2</span></span>

<span data-ttu-id="c0099-611">Esta interfaz contiene información adicional acerca de un evento de sincronización.</span><span class="sxs-lookup"><span data-stu-id="c0099-611">This interface holds additional information about a synchronizing event.</span></span>
  
<span data-ttu-id="c0099-612">**Funciones miembro públicas**</span><span class="sxs-lookup"><span data-stu-id="c0099-612">**Public member functions**</span></span>

#### <a name="ilscevent2geterrorchain"></a><span data-ttu-id="c0099-613">ILSCEvent2::GetErrorChain</span><span class="sxs-lookup"><span data-stu-id="c0099-613">ILSCEvent2::GetErrorChain</span></span>

<span data-ttu-id="c0099-614">Obtiene la información de la cadena de error sobre un evento de sincronización.</span><span class="sxs-lookup"><span data-stu-id="c0099-614">Gets the error chain information about a synchronizing event.</span></span>
  
`HRESULT ILSCEvent2::GetErrorChain ([out] BSTR * pbstrErrorChain)`

##### <a name="parameters"></a><span data-ttu-id="c0099-615">Parámetros</span><span class="sxs-lookup"><span data-stu-id="c0099-615">Parameters</span></span>

 <span data-ttu-id="c0099-616">_pbstrErrorChain_</span><span class="sxs-lookup"><span data-stu-id="c0099-616">_pbstrErrorChain_</span></span>
  
<span data-ttu-id="c0099-617">Una cadena que contenga la información de la cadena de error.</span><span class="sxs-lookup"><span data-stu-id="c0099-617">A string to hold the error chain information.</span></span> <span data-ttu-id="c0099-618">No debe ser null.</span><span class="sxs-lookup"><span data-stu-id="c0099-618">Must not be null.</span></span> 
  
##### <a name="return-values"></a><span data-ttu-id="c0099-619">Valores devueltos</span><span class="sxs-lookup"><span data-stu-id="c0099-619">Return values</span></span>

|<span data-ttu-id="c0099-620">Valor</span><span class="sxs-lookup"><span data-stu-id="c0099-620">Value</span></span>|<span data-ttu-id="c0099-621">Descripción</span><span class="sxs-lookup"><span data-stu-id="c0099-621">Description</span></span>|
|:-----|:-----|
|<span data-ttu-id="c0099-622">E_NOTIMPL</span><span class="sxs-lookup"><span data-stu-id="c0099-622">E_NOTIMPL</span></span>  <br/> |<span data-ttu-id="c0099-623">La versión instalada de Office no admite esta interfaz</span><span class="sxs-lookup"><span data-stu-id="c0099-623">The installed version of Office does not support this interface</span></span>  <br/> |
|<span data-ttu-id="c0099-624">E_INVALIDARG</span><span class="sxs-lookup"><span data-stu-id="c0099-624">E_INVALIDARG</span></span>  <br/> |<span data-ttu-id="c0099-625">Uno o varios de los valores de parámetro no son válidos.</span><span class="sxs-lookup"><span data-stu-id="c0099-625">One or more of the parameter values are invalid.</span></span>  <br/> |
|<span data-ttu-id="c0099-626">E_FAIL</span><span class="sxs-lookup"><span data-stu-id="c0099-626">E_FAIL</span></span>  <br/> |<span data-ttu-id="c0099-627">La información de la cadena de error no está disponible.</span><span class="sxs-lookup"><span data-stu-id="c0099-627">The error chain information is not available.</span></span>  <br/> |
|<span data-ttu-id="c0099-628">S_OK</span><span class="sxs-lookup"><span data-stu-id="c0099-628">S_OK</span></span>  <br/> |<span data-ttu-id="c0099-629">La llamada tuvo éxito.</span><span class="sxs-lookup"><span data-stu-id="c0099-629">The call was successful.</span></span>  <br/> |
   
### <a name="interface-ipartneractivitycallback"></a><span data-ttu-id="c0099-630">Interfaz IPartnerActivityCallback</span><span class="sxs-lookup"><span data-stu-id="c0099-630">Interface IPartnerActivityCallback</span></span>

<span data-ttu-id="c0099-631">Esta interfaz proporciona una función de devolución de llamada para el objeto COM CSISyncClient.</span><span class="sxs-lookup"><span data-stu-id="c0099-631">This interface provides a callback function to the CSISyncClient COM object.</span></span>
  
<span data-ttu-id="c0099-632">**Funciones miembro públicas**</span><span class="sxs-lookup"><span data-stu-id="c0099-632">**Public member functions**</span></span>

#### <a name="ipartneractivitycallbackeventoccurred"></a><span data-ttu-id="c0099-633">IPartnerActivityCallback::EventOccurred</span><span class="sxs-lookup"><span data-stu-id="c0099-633">IPartnerActivityCallback::EventOccurred</span></span>

<span data-ttu-id="c0099-634">Esto es una función de devolución de llamada en el objeto dado al objeto COM CsiSyncClient.</span><span class="sxs-lookup"><span data-stu-id="c0099-634">This is a callback function on the object given to the CsiSyncClient COM object.</span></span> <span data-ttu-id="c0099-635">Se espera que cuando se produce un evento (vea la [Enumeración LSCEventTypeOccurred](using-csisyncclient-to-control-the-office-document-cache-odc.md#Enum_LSCEventTypeOccurred) para tipos de eventos válido), el objeto COM CsiSyncClient llamará a este método, el consumidor de señalización.</span><span class="sxs-lookup"><span data-stu-id="c0099-635">It's expected that when an Event occurs (see [Enum LSCEventTypeOccurred](using-csisyncclient-to-control-the-office-document-cache-odc.md#Enum_LSCEventTypeOccurred) for valid event types), the CsiSyncClient COM object will call this method, signalling the consumer.</span></span> 
  
`HRESULT IPartnerActivityCallback::EventOccurred ([in] LSCEventTypeOccurred eEventTypeOccurred)`

##### <a name="parameters"></a><span data-ttu-id="c0099-636">Parámetros</span><span class="sxs-lookup"><span data-stu-id="c0099-636">Parameters</span></span>

 <span data-ttu-id="c0099-637">_eEventTypeOccurred_</span><span class="sxs-lookup"><span data-stu-id="c0099-637">_eEventTypeOccurred_</span></span>
  
<span data-ttu-id="c0099-638">El tipo de evento de este evento.</span><span class="sxs-lookup"><span data-stu-id="c0099-638">The event type of this event.</span></span> <span data-ttu-id="c0099-639">Vea [Enum LSCEventTypeOccurred](using-csisyncclient-to-control-the-office-document-cache-odc.md#Enum_LSCEventTypeOccurred) para los valores válidos.</span><span class="sxs-lookup"><span data-stu-id="c0099-639">See [Enum LSCEventTypeOccurred](using-csisyncclient-to-control-the-office-document-cache-odc.md#Enum_LSCEventTypeOccurred) for valid values.</span></span> 
  
##### <a name="return-values"></a><span data-ttu-id="c0099-640">Valores devueltos</span><span class="sxs-lookup"><span data-stu-id="c0099-640">Return values</span></span>

<span data-ttu-id="c0099-641">Siempre devuelve S_OK.</span><span class="sxs-lookup"><span data-stu-id="c0099-641">Always returns S_OK.</span></span>
  
## <a name="enumerations"></a><span data-ttu-id="c0099-642">Enumeraciones</span><span class="sxs-lookup"><span data-stu-id="c0099-642">Enumerations</span></span>

<span data-ttu-id="c0099-643">CSISyncClient usa las siguientes enumeraciones.</span><span class="sxs-lookup"><span data-stu-id="c0099-643">CSISyncClient uses the following enumerations.</span></span>
  
### <a name="enum-lsceventsyncerrortype"></a><span data-ttu-id="c0099-644">Enumeración LSCEventSyncErrorType</span><span class="sxs-lookup"><span data-stu-id="c0099-644">Enum LSCEventSyncErrorType</span></span>
<span data-ttu-id="c0099-645"><a name="Enum_LSCEventSyncErrorType"> </a></span><span class="sxs-lookup"><span data-stu-id="c0099-645"></span></span>

<span data-ttu-id="c0099-646">Esta enumeración especifica las categorías de errores que pueden producirse durante la sincronización de un archivo.</span><span class="sxs-lookup"><span data-stu-id="c0099-646">This enumeration specifies the categories of errors that can occur while synchronizing a file.</span></span>
  
|<span data-ttu-id="c0099-647">Enumerador</span><span class="sxs-lookup"><span data-stu-id="c0099-647">Enumerator</span></span>|<span data-ttu-id="c0099-648">Descripción</span><span class="sxs-lookup"><span data-stu-id="c0099-648">Description</span></span>|
|:-----|:-----|
|<span data-ttu-id="c0099-649">LSCEventSyncErrorType_UserInterventionRequiredUnexpected</span><span class="sxs-lookup"><span data-stu-id="c0099-649">LSCEventSyncErrorType_UserInterventionRequiredUnexpected</span></span>  <br/> |<span data-ttu-id="c0099-650">El error de sincronización de este evento no se esperaba y es posible que requieren una consideración especial.</span><span class="sxs-lookup"><span data-stu-id="c0099-650">The synchronizing error of this event was unexpected, and may require special consideration.</span></span> <span data-ttu-id="c0099-651">De forma predeterminada, el usuario deba intervenir.</span><span class="sxs-lookup"><span data-stu-id="c0099-651">By default, the user may have to intervene.</span></span>  <br/> |
|<span data-ttu-id="c0099-652">LSCEventSyncErrorType_NoInterventionRequired</span><span class="sxs-lookup"><span data-stu-id="c0099-652">LSCEventSyncErrorType_NoInterventionRequired</span></span>  <br/> |<span data-ttu-id="c0099-653">El error de sincronización de este evento no necesitan una consideración especial.</span><span class="sxs-lookup"><span data-stu-id="c0099-653">The synchronizing error of this event does not need special consideration.</span></span> <span data-ttu-id="c0099-654">Office controla automáticamente.</span><span class="sxs-lookup"><span data-stu-id="c0099-654">Office will handle it automatically.</span></span>  <br/> |
|<span data-ttu-id="c0099-655">LSCEventSyncErrorType_UserInterventionRequired</span><span class="sxs-lookup"><span data-stu-id="c0099-655">LSCEventSyncErrorType_UserInterventionRequired</span></span>  <br/> |<span data-ttu-id="c0099-656">El error de sincronización de este evento requiere que un usuario resolverlo.</span><span class="sxs-lookup"><span data-stu-id="c0099-656">The synchronizing error of this event requires a user to resolve it.</span></span> <span data-ttu-id="c0099-657">Por ejemplo, error de conflicto de combinación requiere que un usuario abrir el documento y combinar.</span><span class="sxs-lookup"><span data-stu-id="c0099-657">For example, merge conflict error requires a user to open the document and merge it.</span></span>  <br/> |
|<span data-ttu-id="c0099-658">LSCEventSyncErrorType_WaitingOnClient</span><span class="sxs-lookup"><span data-stu-id="c0099-658">LSCEventSyncErrorType_WaitingOnClient</span></span>  <br/> |<span data-ttu-id="c0099-659">El error de sincronización de este evento requiere el consumidor intervenir, pero no debe requieren una consideración especial por el usuario.</span><span class="sxs-lookup"><span data-stu-id="c0099-659">The synchronizing error of this event requires the consumer to intervene, but should not require special consideration by the user.</span></span>  <br/> |
|<span data-ttu-id="c0099-660">LSCEventSyncErrorType_ClientInterventionRequired</span><span class="sxs-lookup"><span data-stu-id="c0099-660">LSCEventSyncErrorType_ClientInterventionRequired</span></span>  <br/> |<span data-ttu-id="c0099-661">El error de sincronización de este evento requiere el consumidor a intervenir como un caso especial.</span><span class="sxs-lookup"><span data-stu-id="c0099-661">The synchronizing error of this event requires the consumer to intervene as a special case.</span></span>  <br/> |
|<span data-ttu-id="c0099-662">LSCEventSyncErrorType_Max</span><span class="sxs-lookup"><span data-stu-id="c0099-662">LSCEventSyncErrorType_Max</span></span>  <br/> ||
   
### <a name="enum-lsceventtype"></a><span data-ttu-id="c0099-663">Enumeración LSCEventType</span><span class="sxs-lookup"><span data-stu-id="c0099-663">Enum LSCEventType</span></span>
<span data-ttu-id="c0099-664"><a name="Enum_LSCEventType"> </a></span><span class="sxs-lookup"><span data-stu-id="c0099-664"></span></span>

<span data-ttu-id="c0099-665">Esta enumeración especifica el tipo de eventos que se pueden producir por un archivo determinado.</span><span class="sxs-lookup"><span data-stu-id="c0099-665">This enumeration specifies the type of events that can occur for a particular file.</span></span>
  
|<span data-ttu-id="c0099-666">Enumerador</span><span class="sxs-lookup"><span data-stu-id="c0099-666">Enumerator</span></span>|<span data-ttu-id="c0099-667">Descripción</span><span class="sxs-lookup"><span data-stu-id="c0099-667">Description</span></span>|
|:-----|:-----|
|<span data-ttu-id="c0099-668">LSCEventType_None</span><span class="sxs-lookup"><span data-stu-id="c0099-668">LSCEventType_None</span></span>  <br/> ||
|<span data-ttu-id="c0099-669">LSCEventType_OnLocalChanges</span><span class="sxs-lookup"><span data-stu-id="c0099-669">LSCEventType_OnLocalChanges</span></span>  <br/> |<span data-ttu-id="c0099-670">Los cambios realizados en un archivo local.</span><span class="sxs-lookup"><span data-stu-id="c0099-670">Changes were made to a local file.</span></span>  <br/> |
|<span data-ttu-id="c0099-671">LSCEventType_OnOpenedByUser</span><span class="sxs-lookup"><span data-stu-id="c0099-671">LSCEventType_OnOpenedByUser</span></span>  <br/> |<span data-ttu-id="c0099-672">Un usuario abre un archivo.</span><span class="sxs-lookup"><span data-stu-id="c0099-672">A user opened a file.</span></span>  <br/> |
|<span data-ttu-id="c0099-673">LSCEventType_OnServerChangesDownloaded</span><span class="sxs-lookup"><span data-stu-id="c0099-673">LSCEventType_OnServerChangesDownloaded</span></span>  <br/> |<span data-ttu-id="c0099-674">Terminado de descargar los cambios del archivo desde el servidor.</span><span class="sxs-lookup"><span data-stu-id="c0099-674">Finished downloading file changes from the server.</span></span>  <br/> |
|<span data-ttu-id="c0099-675">LSCEventType_OnLocalChangesUploaded</span><span class="sxs-lookup"><span data-stu-id="c0099-675">LSCEventType_OnLocalChangesUploaded</span></span>  <br/> |<span data-ttu-id="c0099-676">Terminado de cargar los cambios de archivo en el servidor.</span><span class="sxs-lookup"><span data-stu-id="c0099-676">Finished uploading file changes to the server.</span></span>  <br/> |
|<span data-ttu-id="c0099-677">LSCEventType_OnLocalConflictStateChanged</span><span class="sxs-lookup"><span data-stu-id="c0099-677">LSCEventType_OnLocalConflictStateChanged</span></span>  <br/> |<span data-ttu-id="c0099-678">El estado de conflicto de combinación de un archivo ha cambiado.</span><span class="sxs-lookup"><span data-stu-id="c0099-678">The merge conflict state of a file has changed.</span></span>  <br/> |
|<span data-ttu-id="c0099-679">LSCEventType_OnFileAdded</span><span class="sxs-lookup"><span data-stu-id="c0099-679">LSCEventType_OnFileAdded</span></span>  <br/> |<span data-ttu-id="c0099-680">Se ha agregado un archivo.</span><span class="sxs-lookup"><span data-stu-id="c0099-680">A file was added.</span></span>  <br/> |
|<span data-ttu-id="c0099-681">LSCEventType_OnFileDeleted</span><span class="sxs-lookup"><span data-stu-id="c0099-681">LSCEventType_OnFileDeleted</span></span>  <br/> |<span data-ttu-id="c0099-682">Se eliminó un archivo.</span><span class="sxs-lookup"><span data-stu-id="c0099-682">A file was deleted.</span></span>  <br/> |
|<span data-ttu-id="c0099-683">LSCEventType_OnSyncEnabled</span><span class="sxs-lookup"><span data-stu-id="c0099-683">LSCEventType_OnSyncEnabled</span></span>  <br/> |<span data-ttu-id="c0099-684">Se habilitó la sincronización para los archivos de un usuario.</span><span class="sxs-lookup"><span data-stu-id="c0099-684">Synchronizing was enabled for a user's files.</span></span>  <br/> |
|<span data-ttu-id="c0099-685">LSCEventType_OnServerChangesDownloadStarted</span><span class="sxs-lookup"><span data-stu-id="c0099-685">LSCEventType_OnServerChangesDownloadStarted</span></span>  <br/> |<span data-ttu-id="c0099-686">Comienza a descargar los cambios del archivo desde el servidor.</span><span class="sxs-lookup"><span data-stu-id="c0099-686">Started downloading file changes from the server.</span></span>  <br/> |
|<span data-ttu-id="c0099-687">LSCEventType_OnLocalChangesUploadStarted</span><span class="sxs-lookup"><span data-stu-id="c0099-687">LSCEventType_OnLocalChangesUploadStarted</span></span>  <br/> |<span data-ttu-id="c0099-688">Cargar los cambios de archivo en el servidor se inició.</span><span class="sxs-lookup"><span data-stu-id="c0099-688">Started uploading file changes to the server.</span></span>  <br/> |
|<span data-ttu-id="c0099-689">LSCEventType_OnFilePathConflict</span><span class="sxs-lookup"><span data-stu-id="c0099-689">LSCEventType_OnFilePathConflict</span></span>  <br/> |<span data-ttu-id="c0099-690">Este evento se genera cuando una llamada a [ILSCLocalSyncClient::LocalFileChange ](using-csisyncclient-to-control-the-office-document-cache-odc.md#ILSCLocalSyncClient_LocalFileChange), [ILSCLocalSyncClient::ServerFileChange ](using-csisyncclient-to-control-the-office-document-cache-odc.md#ILSCLocalSyncClient_ServerFileChange), o [ILSCLocalSyncClient::RenameFile](using-csisyncclient-to-control-the-office-document-cache-odc.md#ILSCLocalSyncClient_RenameFile) hace que una ruta de acceso Web o la ruta de acceso Local colisión con otro archivo en el Memoria caché de archivos de Office.</span><span class="sxs-lookup"><span data-stu-id="c0099-690">This event is generated when a call to [ILSCLocalSyncClient::LocalFileChange ](using-csisyncclient-to-control-the-office-document-cache-odc.md#ILSCLocalSyncClient_LocalFileChange), [ILSCLocalSyncClient::ServerFileChange ](using-csisyncclient-to-control-the-office-document-cache-odc.md#ILSCLocalSyncClient_ServerFileChange), or [ILSCLocalSyncClient::RenameFile ](using-csisyncclient-to-control-the-office-document-cache-odc.md#ILSCLocalSyncClient_RenameFile) causes a Web Path or Local Path collision with another file in the Office file cache.</span></span>  <br/> |
|<span data-ttu-id="c0099-691">LSCEventType_OnFileForked</span><span class="sxs-lookup"><span data-stu-id="c0099-691">LSCEventType_OnFileForked</span></span>  <br/> ||
|<span data-ttu-id="c0099-692">LSCEventType_Max</span><span class="sxs-lookup"><span data-stu-id="c0099-692">LSCEventType_Max</span></span>  <br/> ||
   
### <a name="enum-lsceventtypeoccurred"></a><span data-ttu-id="c0099-693">Enumeración LSCEventTypeOccurred</span><span class="sxs-lookup"><span data-stu-id="c0099-693">Enum LSCEventTypeOccurred</span></span>
<span data-ttu-id="c0099-694"><a name="Enum_LSCEventTypeOccurred"> </a></span><span class="sxs-lookup"><span data-stu-id="c0099-694"></span></span>

<span data-ttu-id="c0099-695">Esta enumeración especifica el tipo de eventos que se pueden producir.</span><span class="sxs-lookup"><span data-stu-id="c0099-695">This enumeration specifies the type of events that can occur.</span></span> <span data-ttu-id="c0099-696">El consumidor debe llamar a funciones específicas de ILSCLocalSyncClient según el tipo de evento.</span><span class="sxs-lookup"><span data-stu-id="c0099-696">The consumer needs to call specific ILSCLocalSyncClient functions based on the event type.</span></span>
  
|<span data-ttu-id="c0099-697">Enumerador</span><span class="sxs-lookup"><span data-stu-id="c0099-697">Enumerator</span></span>|<span data-ttu-id="c0099-698">Descripción</span><span class="sxs-lookup"><span data-stu-id="c0099-698">Description</span></span>|
|:-----|:-----|
|<span data-ttu-id="c0099-699">LSCEventTypeOccurred_GetChanges</span><span class="sxs-lookup"><span data-stu-id="c0099-699">LSCEventTypeOccurred_GetChanges</span></span>  <br/> |<span data-ttu-id="c0099-700">Se ha producido un ILSCEvent.</span><span class="sxs-lookup"><span data-stu-id="c0099-700">An ILSCEvent has occurred.</span></span> <span data-ttu-id="c0099-701">El consumidor debe llamar a [ILSCLocalSyncClient::GetChanges](using-csisyncclient-to-control-the-office-document-cache-odc.md#ILSCLocalSyncClient_GetChanges) para recuperar los datos.</span><span class="sxs-lookup"><span data-stu-id="c0099-701">The consumer should call [ILSCLocalSyncClient::GetChanges ](using-csisyncclient-to-control-the-office-document-cache-odc.md#ILSCLocalSyncClient_GetChanges) to retrieve the data.</span></span>  <br/> |
|<span data-ttu-id="c0099-702">LSCEventTypeOccurred_GetSupportedFileExtensions</span><span class="sxs-lookup"><span data-stu-id="c0099-702">LSCEventTypeOccurred_GetSupportedFileExtensions</span></span>  <br/> |<span data-ttu-id="c0099-703">Han cambiado las extensiones de archivo compatibles.</span><span class="sxs-lookup"><span data-stu-id="c0099-703">The supported file extensions have changed.</span></span> <span data-ttu-id="c0099-704">El consumidor debe llamar a [ILSCLocalSyncClient::GetSupportedFileExtensions](using-csisyncclient-to-control-the-office-document-cache-odc.md#ILSCLocalSyncClient_GetSupportedFileExtensions) para recuperar la nueva lista de extensiones admitidas.</span><span class="sxs-lookup"><span data-stu-id="c0099-704">The consumer should call [ILSCLocalSyncClient::GetSupportedFileExtensions ](using-csisyncclient-to-control-the-office-document-cache-odc.md#ILSCLocalSyncClient_GetSupportedFileExtensions) to retrieve the new list of supported extensions.</span></span>  <br/> |
   
### <a name="enum-lscnetworksyncpermissiontype"></a><span data-ttu-id="c0099-705">Enumeración LSCNetworkSyncPermissionType</span><span class="sxs-lookup"><span data-stu-id="c0099-705">Enum LSCNetworkSyncPermissionType</span></span>
<span data-ttu-id="c0099-706"><a name="Enum_LSCNetworkSyncPermissionType"> </a></span><span class="sxs-lookup"><span data-stu-id="c0099-706"></span></span>

<span data-ttu-id="c0099-707">Esta enumeración especifica los indicadores que se utilizan para una heurística de costo de la red.</span><span class="sxs-lookup"><span data-stu-id="c0099-707">This enumeration specifies the flags used for a network cost heuristic.</span></span> 

|<span data-ttu-id="c0099-708">Enumerador</span><span class="sxs-lookup"><span data-stu-id="c0099-708">Enumerator</span></span>|<span data-ttu-id="c0099-709">Descripción</span><span class="sxs-lookup"><span data-stu-id="c0099-709">Description</span></span>|
|:-----|:-----|
|<span data-ttu-id="c0099-710">LSCNetworkSyncPermissionType_HighCost</span><span class="sxs-lookup"><span data-stu-id="c0099-710">LSCNetworkSyncPermissionType_HighCost</span></span>  <br/> |<span data-ttu-id="c0099-711">True si se invalida la heurística de costo para redes costosas (por ejemplo, 3 G).</span><span class="sxs-lookup"><span data-stu-id="c0099-711">True if the cost heuristic for expensive networks (such as 3G) is overridden.</span></span>  <br/> |
|<span data-ttu-id="c0099-712">LSCNetworkSyncPermissionType_HighPowerUsage</span><span class="sxs-lookup"><span data-stu-id="c0099-712">LSCNetworkSyncPermissionType_HighPowerUsage</span></span>  <br/> |<span data-ttu-id="c0099-713">True si se invalida la heurística de costo para el uso de la energía (por ejemplo, una batería).</span><span class="sxs-lookup"><span data-stu-id="c0099-713">True if the cost heuristic for power usage (such as a battery) is overridden.</span></span>  <br/> |
   
### <a name="enum-lscstatusflag"></a><span data-ttu-id="c0099-714">Enumeración LSCStatusFlag</span><span class="sxs-lookup"><span data-stu-id="c0099-714">Enum LSCStatusFlag</span></span>
<span data-ttu-id="c0099-715"><a name="Enum_LSCStatusFlag"> </a></span><span class="sxs-lookup"><span data-stu-id="c0099-715"></span></span>

<span data-ttu-id="c0099-716">Esta enumeración se usa para representar el estado de sincronización de un archivo.</span><span class="sxs-lookup"><span data-stu-id="c0099-716">This enumeration is used to represent the synchronize status of a file.</span></span> 
  
|<span data-ttu-id="c0099-717">Enumerador</span><span class="sxs-lookup"><span data-stu-id="c0099-717">Enumerator</span></span>|<span data-ttu-id="c0099-718">Descripción</span><span class="sxs-lookup"><span data-stu-id="c0099-718">Description</span></span>|
|:-----|:-----|
|<span data-ttu-id="c0099-719">LCSStatusFlag_None</span><span class="sxs-lookup"><span data-stu-id="c0099-719">LCSStatusFlag_None</span></span>  <br/> ||
|<span data-ttu-id="c0099-720">LSCStatusFlag_UploadPending</span><span class="sxs-lookup"><span data-stu-id="c0099-720">LSCStatusFlag_UploadPending</span></span>  <br/> |<span data-ttu-id="c0099-721">Es True si no hay datos para enviar al archivo del servidor pendientes.</span><span class="sxs-lookup"><span data-stu-id="c0099-721">True if there is pending data to send to the server file.</span></span>  <br/> |
|<span data-ttu-id="c0099-722">LSCStatusFlag_DownloadPending</span><span class="sxs-lookup"><span data-stu-id="c0099-722">LSCStatusFlag_DownloadPending</span></span>  <br/> |<span data-ttu-id="c0099-723">Es True si no hay datos para descargar desde el archivo del servidor pendientes.</span><span class="sxs-lookup"><span data-stu-id="c0099-723">True if there is pending data to download from the server file.</span></span>  <br/> |
|<span data-ttu-id="c0099-724">LSCStatusFlag_LocalFileUnchanged</span><span class="sxs-lookup"><span data-stu-id="c0099-724">LSCStatusFlag_LocalFileUnchanged</span></span>  <br/> |<span data-ttu-id="c0099-725">Es True si los datos de Office tiene en el archivo en su memoria caché es la copia más reciente de los datos en el disco.</span><span class="sxs-lookup"><span data-stu-id="c0099-725">True if the data Office has on the file in its cache is the most recent copy of the data on disk.</span></span>  <br/> |

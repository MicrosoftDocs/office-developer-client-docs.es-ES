...
El artículo siguiente describe Registro de telemetría y cómo usarlo. Para obtener más información acerca de los resultados específicos que se muestran en el registro de telemetría, vea [problemas de compatibilidad de Office](compatibility-issues-in-office.md).
...
> [!NOTE]
> [!NOTA] La ubicación predeterminada para el almacén de datos local es %Users%\[Current user]\AppData\Local\Microsoft\Office\15.0\Telemetry. El tamaño máximo predeterminado para el almacén de datos es de 5 MB (5.120 KB).. 
...
|:-----|:-----|:-----|
|Aplicaciones de panel de tareas  <br/> |Excel 2013, Word 2013, Project 2013  <br/> |Son Complementos de Office que se hospedan en un panel de tareas de la aplicación cliente.  <br/> |
...
|Aplicaciones de correo  <br/> |Outlook 2013  <br/> |Estos son aplicaciones que aparecen inOutlook 2013 cuando se cumplen ciertas condiciones (el asunto o el cuerpo de correo electrónico incluye ciertas palabras o frases).  <br/> |
...
|Complementos RTD XLS de Excel  <br/> |Excel 2013  <br/> |Los complementos de datos en tiempo real (RTD) XLS son hojas de cálculo de Excel que usan la función de hoja de cálculo de **RealTimeData** para llamar a un servidor de automatización y recuperar datos en tiempo real.  <br/> |
|Complementos WLL de Word  <br/> |Word 2013  <br/> |Los complementos WLL (.wll) son específicos de Word y se crean con cualquier compilador que admita la generación de archivos DLL.  <br/> |
|Complementos de aplicación  <br/> |Word 2013  <br/> PowerPoint 2013  <br/> Excel 2013  <br/> |Los complementos de aplicación son archivos específicos de aplicación que contienen código VBA. Estos incluyen plantillas Word habilitadas para macros (.dotm), complementos de Excel (.xla, .xlam) y complementos de PowerPoint (.ppa, .ppam).  <br/> |
...
> [!NOTE]
> [!NOTA] No es necesario guardar el libro Registro de telemetría en Excel 2013 para mantener un registro de los resultados, pues la información se guarda en el almacén de datos locales (que es independiente de Registro de telemetría). No obstante, guardar el libro no daña el Registro de telemetría. 
...
![El Visor de eventos de Office mostrando registros.] (media/off15_OfficeEventViewer_SD.png "Registros de visualización del Visor de eventos de Office")
  
> [!NOTE]
>  [!NOTA] La hoja **Información del sistema** de Registro de telemetría contiene información sobre el equipo en el que está instalado Office 2013. La hoja de cálculo muestra la siguiente información: 
> - Nombre de usuario.
...
> - Zona horaria para el reloj interno del equipo.
> - Versión del registro de telemetría.
> - Versión de Office que está instalada en el equipo.
> 
> Esta información puede ser útil si está interpretando los problemas y eventos que aparecen en la hoja de cálculo de **eventos** . 
...
|2  <br/> |No se pudo cargar el documento  <br/> |Advertencia  <br/> | La aplicación no pudo cargar el archivo. Podría haber problemas de compatibilidad subyacentes.  <br/><br/>Para más información sobre cómo reparar un libro dañado en Excel 2013, vea [Reparar un libro dañado](http://office.microsoft.com/en-us/excel-help/repairing-a-corrupted-workbook-HA102749554.aspx).<br/><br/>Para obtener más información sobre cómo reparar un documento dañado en Word 2013, vea [Guardar y recuperar una copia de seguridad de un documento](http://office.microsoft.com/en-us/word-help/save-and-recover-a-backup-copy-of-a-document-HA010121250.aspx). <br/> |
...
|6  <br/> |No se pudo cargar el complemento  <br/> |Crítico  <br/> | La aplicación no ha podido cargar el complemento que aparece en la columna **Archivo**.  <br/><br/>Para más información sobre cómo reparar un libro dañado en Excel 2013, vea [Reparar un libro dañado](http://office.microsoft.com/en-us/excel-help/repairing-a-corrupted-workbook-HA102749554.aspx). <br/><br/>  Para obtener más información sobre cómo reparar un documento dañado en Word 2013, vea [Guardar y recuperar una copia de seguridad de un documento](http://office.microsoft.com/en-us/word-help/save-and-recover-a-backup-copy-of-a-document-HA010121250.aspx). <br/> |
...
|8  <br/> |No se pudo descargar el manifiesto del complemento  <br/> |Crítico  <br/> |La aplicación host no pudo cargar el archivo de manifiesto para Complemento de Office desde el catálogo de SharePoint, corporativo o Tienda Office.  <br/> |
...
|10  <br/> |El complemento usó demasiado CPU  <br/> |Crítico  <br/> |Complemento de Office usó más del 90 % de los recursos de CPU durante un período de tiempo limitado.  <br/> |
|11  <br/> |La aplicación se bloqueó al cargarse  <br/> |Crítico  <br/> |La aplicación de Office trató de cargar un documento o solución cuando se inició, pero problemas con el documento o la solución impidieron que se iniciara la aplicación.  <br/> |
...
|15  <br/> |El complemento se deshabilitó por haber superado el tiempo de espera de búsqueda de cadenas  <br/> ||Los complementos de correo buscan en el mensaje y la línea de asunto de los correos electrónicos para determinar si deben mostrarse con una expresión regular. Outlook 2013 deshabilitó la aplicación de correo que se muestra en la columna **Archivo** porque agotó el tiempo de espera de forma repetida al intentar encontrar una expresión regular.  <br/> |
|16  <br/> |El documento estaba abierto cuando se bloqueó la aplicación  <br/> |Crítico  <br/> |El archivo que aparece en la columna **Archivo** estaba abierto cuando se bloqueó la aplicación (mostrada en la columna Aplicación). El archivo podría ser o no responsable del bloqueo de la **Aplicación**.  <br/> |
|17  <br/> |El complemento se ha cerrado correctamente  <br/> |Informativo  <br/> |La aplicación pudo cerrar el complemento correctamente.  <br/> |
|18  <br/> |La aplicación se ha cerrado correctamente  <br/> ||La aplicación host pudo cerrar Complemento de Office correctamente.  <br/> |
|19  <br/> |El complemento encontró un error en tiempo de ejecución  <br/> |Crítico  <br/> |Se produjo un problema en Complemento de Office que provocó un error. Para más información, vea el registro de alertas de Microsoft Office con el Visor de eventos de Windows en el equipo donde se produjo el error.  <br/> |
|20  <br/> |No se pudo comprobar la licencia del complemento  <br/> |Crítico  <br/> |La información de licencias de Complemento de Office no se pudo comprobar y puede haber expirado. Para más información, vea el registro de alertas de Microsoft Office con el Visor de eventos de Windows en el equipo donde se produjo el error.  <br/> |
|Varios  <br/> |"Cambio del comportamiento de OM: ..."  <br/> |Informativo  <br/> |El código del documento habilitado para complementos o macros usa un objeto, miembro, colección, enumeración o constante que se comporta de manera diferente que en versiones anteriores de Office.<br/><br/> Para obtener más información, vea [problemas de compatibilidad de Office](compatibility-issues-in-office.md).  <br/> |
|Varios  <br/> |"OM quitado: …"  <br/> |Crítico  <br/> |El código del documento habilitado para complementos o macros usa un objeto, miembro, colección, enumeración o constante que se ha quitado del modelo de objeto.<br/><br/>Para obtener más información, vea [problemas de compatibilidad de Office](compatibility-issues-in-office.md).  <br/> |
|Varios  <br/> |"OM oculto: …"  <br/> |Informativo  <br/> |El código del documento habilitado para complementos o macros usa un objeto, miembro, colección, enumeración o constante que se ha ocultado en el modelo de objeto.<br/><br/>Para obtener más información, vea [problemas de compatibilidad de Office](compatibility-issues-in-office.md).  <br/> |
|Varios  <br/> |"Control: …"  <br/> ||El archivo contiene un control que es posible que no se admita en Office 2013 o en el sistema operativo del ordenador.<br/><br/>Para obtener más información, vea [problemas de compatibilidad de Office](compatibility-issues-in-office.md).  <br/> |
...
- [Centro para desarrolladores de Office](http://msdn.microsoft.com/en-us/office/aa905340.aspx)
...
- [Centro para desarrolladores de Office](http://msdn.microsoft.com/en-us/office/aa905340)

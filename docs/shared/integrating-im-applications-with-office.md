...
- <span data-ttu-id="a5592-121">Póngase en contacto con el estado de presencia.</span><span class="sxs-lookup"><span data-stu-id="a5592-121">Contact presence status.</span></span>
...
<span data-ttu-id="a5592-131">![La tarjeta de personas en Office 2013] (media/ocom15_peoplecard.png "La tarjeta de personas en Office 2013")</span><span class="sxs-lookup"><span data-stu-id="a5592-131">![The People Card in Office 2013](media/ocom15_peoplecard.png "The People Card in Office 2013")</span></span>
...
### <a name="retrieving-the-capabilities-of-the-local-user"></a><span data-ttu-id="a5592-187">Recuperación de las capacidades del usuario local</span><span class="sxs-lookup"><span data-stu-id="a5592-187">Retrieving the capabilities of the local user</span></span>
...
<span data-ttu-id="a5592-197">La aplicación de Office obtiene la presencia de los contactos, incluido el usuario local, haciendo lo siguiente:</span><span class="sxs-lookup"><span data-stu-id="a5592-197">The Office application gets contact presence, including the local user, by doing the following:</span></span> 
...
>
> <span data-ttu-id="a5592-376">Para obtener más información acerca de la interfaz de **IContact** y sus miembros, vea [UCCollaborationLib.IContact](http://msdn.microsoft.com/library/UCCollaborationLib.IContact).</span><span class="sxs-lookup"><span data-stu-id="a5592-376">For more information about the **IContact** interface and its members, see [UCCollaborationLib.IContact](http://msdn.microsoft.com/library/UCCollaborationLib.IContact).</span></span> 
  
<span data-ttu-id="a5592-377">**Tabla 5. Implementación de la interfaz de IContact**</span><span class="sxs-lookup"><span data-stu-id="a5592-377">**Table 5. Implementation of the IContact interface**</span></span>

|<span data-ttu-id="a5592-378">**Elemento**</span><span class="sxs-lookup"><span data-stu-id="a5592-378">**Member**</span></span>|<span data-ttu-id="a5592-379">**Descripción**</span><span class="sxs-lookup"><span data-stu-id="a5592-379">**Description**</span></span>|
|:-----|:-----|
|<span data-ttu-id="a5592-380">**CanStart** (método)</span><span class="sxs-lookup"><span data-stu-id="a5592-380">**CanStart** method</span></span>  <br/> |<span data-ttu-id="a5592-381">Devuelve **true** si se puede iniciar un tipo determinado de modalidad en el contacto.</span><span class="sxs-lookup"><span data-stu-id="a5592-381">Returns **true** if a given type of modality can be started on the contact.</span></span>  <br/> |
|<span data-ttu-id="a5592-382">**GetContactInformation** (método)</span><span class="sxs-lookup"><span data-stu-id="a5592-382">**GetContactInformation** method</span></span>  <br/> |<span data-ttu-id="a5592-383">Obtiene un elemento de la presencia de un contacto de la publicación.</span><span class="sxs-lookup"><span data-stu-id="a5592-383">Gets one presence item from a publishing contact.</span></span>  <br/> |
|<span data-ttu-id="a5592-384">**BatchGetContactInformation** (método)</span><span class="sxs-lookup"><span data-stu-id="a5592-384">**BatchGetContactInformation** method</span></span>  <br/> |<span data-ttu-id="a5592-385">Obtiene varios elementos de la presencia de un contacto de la publicación.</span><span class="sxs-lookup"><span data-stu-id="a5592-385">Gets multiple presence items from a publishing contact.</span></span>  <br/> |
|<span data-ttu-id="a5592-386">**Settings** (propiedad)</span><span class="sxs-lookup"><span data-stu-id="a5592-386">**Settings** property</span></span>  <br/> |<span data-ttu-id="a5592-387">Obtiene una colección de propiedades de contacto.</span><span class="sxs-lookup"><span data-stu-id="a5592-387">Gets a collection of contact properties.</span></span>  <br/> |
|<span data-ttu-id="a5592-388">**CustomGroups** (propiedad)</span><span class="sxs-lookup"><span data-stu-id="a5592-388">**CustomGroups** property</span></span>  <br/> |<span data-ttu-id="a5592-389">Obtiene una colección de grupos que el contacto es un miembro de.</span><span class="sxs-lookup"><span data-stu-id="a5592-389">Gets a collection of groups that the contact is a member of.</span></span>  <br/> |
   
<span data-ttu-id="a5592-390">Durante el proceso de inicialización, la aplicación de Office llama al método de **IContact.CanStart** para determinar las capacidades de mensajería instantánea para el usuario local.</span><span class="sxs-lookup"><span data-stu-id="a5592-390">During the initialization process, the Office application calls the **IContact.CanStart** method to determine the IM capabilities for the local user.</span></span> <span data-ttu-id="a5592-391">El método **CanStart** utiliza un indicador de la enumeración [UCCollaborationLib.ModalityTypes](http://msdn.microsoft.com/library/UCCollaborationLib.ModalityTypes) como un argumento para el parámetro de_modalityTypes_ _.</span><span class="sxs-lookup"><span data-stu-id="a5592-391">The **CanStart** method takes a flag from the [UCCollaborationLib.ModalityTypes](http://msdn.microsoft.com/library/UCCollaborationLib.ModalityTypes) enumeration as an argument for the  __modalityTypes_ parameter.</span></span> <span data-ttu-id="a5592-392">Si el usuario actual puede integrarse en la modalidad solicitada (es decir, el usuario es capaz de mensajería instantánea, audio y vídeo de mensajería o uso compartido de aplicaciones), el método **CanStart** devuelve **true**.</span><span class="sxs-lookup"><span data-stu-id="a5592-392">If the current user can engage in the requested modality (that is, the user is capable of instant messaging, audio and video messaging, or application sharing), the **CanStart** method returns **true**.</span></span>
...
<span data-ttu-id="a5592-393">El método **GetContactInformation** recupera información sobre el contacto desde el objeto **IContact** .</span><span class="sxs-lookup"><span data-stu-id="a5592-393">The **GetContactInformation** method retrieves information about the contact from the **IContact** object.</span></span> <span data-ttu-id="a5592-394">El código de llamada debe pasar un valor de la enumeración [UCCollaborationLib.ContactInformationType](http://msdn.microsoft.com/library/UCCollaborationLib.ContactInformationType) para el parámetro_contactInformationType_ _, que indica los datos que se va a recuperar.</span><span class="sxs-lookup"><span data-stu-id="a5592-394">The calling code needs to pass in a value from the [UCCollaborationLib.ContactInformationType](http://msdn.microsoft.com/library/UCCollaborationLib.ContactInformationType) enumeration for the  __contactInformationType_ parameter, which indicates the data to be retrieved.</span></span> 
...
<span data-ttu-id="a5592-395">Al igual que el **GetContactInformation**, el método **BatchGetContactInformation** recupera varios elementos de presencia sobre el contacto desde el objeto **IContact** .</span><span class="sxs-lookup"><span data-stu-id="a5592-395">Similar to the **GetContactInformation**, the **BatchGetContactInformation** method retrieves multiple presence items about the contact from the **IContact** object.</span></span> <span data-ttu-id="a5592-396">El código de llamada debe pasar en una matriz de valores de la enumeración **ContactInformationType** para el parámetro de_contactInformationTypes_ _.</span><span class="sxs-lookup"><span data-stu-id="a5592-396">The calling code needs to pass in an array of values from the **ContactInformationType** enumeration for the  __contactInformationTypes_ parameter.</span></span> <span data-ttu-id="a5592-397">El método devuelve un objeto [UCCollaborationLib.IContactInformationDictionary](http://msdn.microsoft.com/library/UCCollaborationLib.IContactInformationDictionary) que contiene los datos solicitados.</span><span class="sxs-lookup"><span data-stu-id="a5592-397">The method returns an [UCCollaborationLib.IContactInformationDictionary](http://msdn.microsoft.com/library/UCCollaborationLib.IContactInformationDictionary) object that contains the requested data.</span></span> 
...
<span data-ttu-id="a5592-398">La propiedad **IContact.Settings** devuelve un objeto **IContactSettingDictionary** que contiene propiedades personalizadas sobre el contacto.</span><span class="sxs-lookup"><span data-stu-id="a5592-398">The **IContact.Settings** property returns an **IContactSettingDictionary** object that contains custom properties about the contact.</span></span> 
...
### <a name="iself-interface"></a><span data-ttu-id="a5592-400">Interfaz ISelf</span><span class="sxs-lookup"><span data-stu-id="a5592-400">ISelf interface</span></span>
<span data-ttu-id="a5592-401"><a name="off15_IMIntegration_ImplementRequired_ISelf"> </a></span><span class="sxs-lookup"><span data-stu-id="a5592-401"></span></span>

<span data-ttu-id="a5592-402">Durante el proceso de inicialización, la aplicación de Office obtiene los datos para el usuario actual mediante el acceso a la propiedad **ILyncClient.Self** , que debe devolver un objeto **ISelf** .</span><span class="sxs-lookup"><span data-stu-id="a5592-402">During the initialization process, the Office application gets the data for the current user by accessing the **ILyncClient.Self** property, which must return an **ISelf** object.</span></span> <span data-ttu-id="a5592-403">La interfaz **ISelf** representa el usuario de aplicación de cliente de mensajería instantánea local, ha iniciado sesión.</span><span class="sxs-lookup"><span data-stu-id="a5592-403">The **ISelf** interface represents the local, signed-in IM client application user.</span></span> 
  
<span data-ttu-id="a5592-404">Tabla 6 se muestran a los miembros que deben implementarse en la clase que hereda de **ISelf**.</span><span class="sxs-lookup"><span data-stu-id="a5592-404">Table 6 shows the members that must be implemented in the class that inherits from **ISelf**.</span></span>
  
> [!NOTE]
> <span data-ttu-id="a5592-405">Cualquier miembro de la interfaz de **ISelf** no aparece en la tabla debe estar presente, pero no es necesario que se va a implementar.</span><span class="sxs-lookup"><span data-stu-id="a5592-405">Any member of the **ISelf** interface not listed in the table must be present but does not need to be implemented.</span></span> <span data-ttu-id="a5592-406">Los miembros que están presentes, pero no implementado pueden producir un error **NotImplementedException** o **E_NOTIMPL** .</span><span class="sxs-lookup"><span data-stu-id="a5592-406">Members that are present but not implemented can throw a **NotImplementedException** or **E_NOTIMPL** error.</span></span> 
  
<span data-ttu-id="a5592-407">**Tabla 6. Implementación de la interfaz de ISelf**</span><span class="sxs-lookup"><span data-stu-id="a5592-407">**Table 6. Implementation of the ISelf interface**</span></span>

|<span data-ttu-id="a5592-408">**Elemento**</span><span class="sxs-lookup"><span data-stu-id="a5592-408">**Member**</span></span>|<span data-ttu-id="a5592-409">**Descripción**</span><span class="sxs-lookup"><span data-stu-id="a5592-409">**Description**</span></span>|
|:-----|:-----|
|<span data-ttu-id="a5592-410">**Contacto** (propiedad)</span><span class="sxs-lookup"><span data-stu-id="a5592-410">**Contact** property</span></span>  <br/> |<span data-ttu-id="a5592-411">Obtiene el objeto **IContact** asociado con el usuario local.</span><span class="sxs-lookup"><span data-stu-id="a5592-411">Gets the **IContact** object associated with the local user.</span></span>  <br/> |
   
<span data-ttu-id="a5592-412">Presencia, modalidades disponibles, pertenencia a grupos y las propiedades de tipo de contacto para el usuario local se exponen a través de la propiedad **ISelf.Contact** (que devuelve un objeto **IContact** ).</span><span class="sxs-lookup"><span data-stu-id="a5592-412">Presence, available modalities, group membership, and contact type properties for the local user are exposed through the **ISelf.Contact** property (which returns an **IContact** object).</span></span> <span data-ttu-id="a5592-413">Durante el proceso de inicialización, la aplicación de Office tiene acceso a la propiedad **ISelf.Contact** para obtener una referencia a la información de contacto para el usuario local.</span><span class="sxs-lookup"><span data-stu-id="a5592-413">During the initialization process, the Office application accesses the **ISelf.Contact** property to get a reference to the contact information for the local user.</span></span> 
  
<span data-ttu-id="a5592-414">Use el siguiente código para definir una clase que hereda de la interfaz **ISelf** que implementa la propiedad de **contacto** .</span><span class="sxs-lookup"><span data-stu-id="a5592-414">Use the following code to define a class that inherits from the **ISelf** interface that implements the **Contact** property.</span></span> 
...
### <a name="icontactmanager-and-icontactmanagerevents-interfaces"></a><span data-ttu-id="a5592-415">Interfaces de IContactManager y _IContactManagerEvents</span><span class="sxs-lookup"><span data-stu-id="a5592-415">IContactManager and _IContactManagerEvents interfaces</span></span>
<span data-ttu-id="a5592-416"><a name="off15_IMIntegration_ImplementRequired_IContactManager"> </a></span><span class="sxs-lookup"><span data-stu-id="a5592-416"></span></span>

<span data-ttu-id="a5592-417">El objeto **IContactManager** administra los contactos del usuario local, incluida la información de contacto del usuario local propia.</span><span class="sxs-lookup"><span data-stu-id="a5592-417">The **IContactManager** object manages the contacts for the local user, including the local user's own contact information.</span></span> <span data-ttu-id="a5592-418">La aplicación de Office, usa un objeto **IContactManager** para tener acceso a los objetos **IContact** que corresponden a los contactos del usuario local.</span><span class="sxs-lookup"><span data-stu-id="a5592-418">The Office application uses an **IContactManager** object to access **IContact** objects that correspond to the local user's contacts.</span></span> 
  
<span data-ttu-id="a5592-419">Tabla 7 se muestran a los miembros que deben implementarse en la clase que hereda de **IContactManager** y **_IContactManagerEvents**.</span><span class="sxs-lookup"><span data-stu-id="a5592-419">Table 7 shows the members that must be implemented in the class that inherits from **IContactManager** and **_IContactManagerEvents**.</span></span>
  
> [!NOTE]
> <span data-ttu-id="a5592-420">Cualquier miembro de la interfaz de **IContactManager** no aparece en la tabla debe estar presente, pero no es necesario que se va a implementar.</span><span class="sxs-lookup"><span data-stu-id="a5592-420">Any member of the **IContactManager** interface not listed in the table must be present but does not need to be implemented.</span></span> <span data-ttu-id="a5592-421">Los miembros que están presentes, pero no implementado pueden producir una **NotImplementedException** o **E\_NOTIMPL** error.</span><span class="sxs-lookup"><span data-stu-id="a5592-421">Members that are present but not implemented can throw a **NotImplementedException** or **E\_NOTIMPL** error.</span></span> 
>
> <span data-ttu-id="a5592-422">Para obtener más información acerca de la **IContactManager** y **_IContactManagerEvents** interfaces y sus miembros, vea [UCCollaborationLib.IContactManager](http://msdn.microsoft.com/library/UCCollaborationLib.IContactManager) y [UCCollaborationLib._IContactManagerEvents](http://msdn.microsoft.com/library/UCCollaborationLib._IContactManagerEvents).</span><span class="sxs-lookup"><span data-stu-id="a5592-422">For more information about the **IContactManager** and **_IContactManagerEvents** interfaces and their members, see [UCCollaborationLib.IContactManager](http://msdn.microsoft.com/library/UCCollaborationLib.IContactManager) and [UCCollaborationLib._IContactManagerEvents](http://msdn.microsoft.com/library/UCCollaborationLib._IContactManagerEvents).</span></span> 
  
<span data-ttu-id="a5592-423">**Tabla 7. Implementación de las interfaces IContactManager y _IContactManagerEvents**</span><span class="sxs-lookup"><span data-stu-id="a5592-423">**Table 7. Implementation of the IContactManager and _IContactManagerEvents interfaces**</span></span>

|<span data-ttu-id="a5592-424">**Interfaz**</span><span class="sxs-lookup"><span data-stu-id="a5592-424">**Interface**</span></span>|<span data-ttu-id="a5592-425">**Elemento**</span><span class="sxs-lookup"><span data-stu-id="a5592-425">**Member**</span></span>|<span data-ttu-id="a5592-426">**Descripción**</span><span class="sxs-lookup"><span data-stu-id="a5592-426">**Description**</span></span>|
|:-----|:-----|:-----|
|<span data-ttu-id="a5592-427">**IContactManager**</span><span class="sxs-lookup"><span data-stu-id="a5592-427">**IContactManager**</span></span> <br/> |<span data-ttu-id="a5592-428">**GetContactByUri** (método)</span><span class="sxs-lookup"><span data-stu-id="a5592-428">**GetContactByUri** method</span></span>  <br/> |<span data-ttu-id="a5592-429">Busca o crea una nueva instancia de contacto con el URI del contacto.</span><span class="sxs-lookup"><span data-stu-id="a5592-429">Finds or creates a new contact instance by using the contact URI.</span></span>  <br/> |
||<span data-ttu-id="a5592-430">**CreateSubscription** (método)</span><span class="sxs-lookup"><span data-stu-id="a5592-430">**CreateSubscription** method</span></span>  <br/> |<span data-ttu-id="a5592-431">Crea un objeto **ISubscription** que se puede usar para el procesamiento por lotes suscripciones o consultas.</span><span class="sxs-lookup"><span data-stu-id="a5592-431">Creates an **ISubscription** object that can be used for batching subscriptions or queries.</span></span>  <br/> |
||<span data-ttu-id="a5592-432">**Lookup** (método)</span><span class="sxs-lookup"><span data-stu-id="a5592-432">**Lookup** method</span></span>  <br/> |<span data-ttu-id="a5592-433">Busca un contacto o grupo de distribución.</span><span class="sxs-lookup"><span data-stu-id="a5592-433">Looks up a contact or distribution group.</span></span>  <br/> |
|<span data-ttu-id="a5592-434">**_IContactManagerEvents**</span><span class="sxs-lookup"><span data-stu-id="a5592-434">**_IContactManagerEvents**</span></span> <br/> |<span data-ttu-id="a5592-435">**OnGroupAdded** (evento)</span><span class="sxs-lookup"><span data-stu-id="a5592-435">**OnGroupAdded** event</span></span>  <br/> |<span data-ttu-id="a5592-436">Se produce cuando se agrega un grupo a una colección de grupos.</span><span class="sxs-lookup"><span data-stu-id="a5592-436">Raised when a group is added to a group collection.</span></span> <span data-ttu-id="a5592-437">La colección de grupos actualizado puede obtenerse de la propiedad **IContactManager.Groups** .</span><span class="sxs-lookup"><span data-stu-id="a5592-437">The updated group collection can be obtained from the **IContactManager.Groups** property.</span></span>  <br/> |
||<span data-ttu-id="a5592-438">**OnGroupRemoved** (evento)</span><span class="sxs-lookup"><span data-stu-id="a5592-438">**OnGroupRemoved** event</span></span>  <br/> |<span data-ttu-id="a5592-439">Se produce cuando se quita un grupo de una colección de grupos.</span><span class="sxs-lookup"><span data-stu-id="a5592-439">Raised when a group is removed from a group collection.</span></span> <span data-ttu-id="a5592-440">La colección de grupos actualizado puede obtenerse de la propiedad **IContactManager.Groups** .</span><span class="sxs-lookup"><span data-stu-id="a5592-440">The updated group collection can be obtained from the **IContactManager.Groups** property.</span></span>  <br/> |
||<span data-ttu-id="a5592-441">**OnSearchProviderStateChanged** (evento)</span><span class="sxs-lookup"><span data-stu-id="a5592-441">**OnSearchProviderStateChanged** event</span></span>  <br/> |<span data-ttu-id="a5592-442">Se produce cuando cambia el estado de un proveedor de búsqueda.</span><span class="sxs-lookup"><span data-stu-id="a5592-442">Raised when a search provider's status changes.</span></span>  <br/> |
   
<span data-ttu-id="a5592-443">Office llama a **IContactManager.GetContactByUri** para obtener información de presencia de un contacto, mediante el uso de la dirección SIP del contacto.</span><span class="sxs-lookup"><span data-stu-id="a5592-443">Office calls **IContactManager.GetContactByUri** to get a contact's presence information, by using the SIP address of the contact.</span></span> <span data-ttu-id="a5592-444">Cuando un contacto está configurado para una dirección SIP en Active Directory, Office determina esta dirección para un contacto y las llamadas **GetContactByUri**, pasando la dirección SIP del contacto en el parámetro_contactUri_ _.</span><span class="sxs-lookup"><span data-stu-id="a5592-444">When a contact is configured for an SIP address in the Active Directory, Office determines this address for a contact and calls **GetContactByUri**, passing the SIP address of the contact in for the  __contactUri_ parameter.</span></span> 
  
<span data-ttu-id="a5592-445">Cuando Office no puede determinar la dirección SIP del contacto, llama al método **IContactManager.Lookup** para encontrar el SIP mediante el servicio de mensajería instantánea.</span><span class="sxs-lookup"><span data-stu-id="a5592-445">When Office cannot determine the SIP address for the contact, it calls the **IContactManager.Lookup** method to find the SIP by using the IM service.</span></span> <span data-ttu-id="a5592-446">Aquí Office pasa los datos mejor que pueden encontrar el contacto (por ejemplo, la dirección de correo electrónico del contacto).</span><span class="sxs-lookup"><span data-stu-id="a5592-446">Here Office passes in the best data that it can find for the contact (for example, just the email address for the contact).</span></span> <span data-ttu-id="a5592-447">El método de **búsqueda** de forma asincrónica devuelve un objeto **AsynchronousOperation** .</span><span class="sxs-lookup"><span data-stu-id="a5592-447">The **Lookup** method asynchronously returns an **AsynchronousOperation** object.</span></span> <span data-ttu-id="a5592-448">Cuando invoca la devolución de llamada, el método de **búsqueda** debe devolver el éxito o el fracaso de la operación además del URI del contacto.</span><span class="sxs-lookup"><span data-stu-id="a5592-448">When it invokes the callback, the **Lookup** method should return the success or failure of the operation in addition to the URI of the contact.</span></span> 
...
### <a name="igroup-and-igroupcollection-interfaces"></a><span data-ttu-id="a5592-452">Interfaces de IGroup y IGroupCollection</span><span class="sxs-lookup"><span data-stu-id="a5592-452">IGroup and IGroupCollection interfaces</span></span>
<span data-ttu-id="a5592-453"><a name="off15_IMIntegration_ImplementRequired_IGroup"> </a></span><span class="sxs-lookup"><span data-stu-id="a5592-453"></span></span>

<span data-ttu-id="a5592-454">El objeto **IGroup** representa una colección de los contactos con propiedades adicionales para la identificación de la colección de contacto por un nombre de grupo colectiva.</span><span class="sxs-lookup"><span data-stu-id="a5592-454">The **IGroup** object represents a collection of contacts with additional properties for identifying the contact collection by a collective group name.</span></span> <span data-ttu-id="a5592-455">Un objeto **IGroupCollection** representa una colección de objetos de **IGroup** definido por un usuario local y la aplicación de cliente de mensajería instantánea.</span><span class="sxs-lookup"><span data-stu-id="a5592-455">An **IGroupCollection** object represents a collection of **IGroup** objects defined by a local user and the IM client application.</span></span> <span data-ttu-id="a5592-456">La aplicación de Office usa los objetos **IGroupCollection** y **IGroup** para tener acceso a los contactos del usuario local.</span><span class="sxs-lookup"><span data-stu-id="a5592-456">The Office application uses the **IGroupCollection** and **IGroup** objects to access the local user's contacts.</span></span> 
  
<span data-ttu-id="a5592-457">Tabla 9 se muestran a los miembros que deben implementarse en las clases que heredan de **IGroup** y **IGroupCollection** en la siguiente tabla.</span><span class="sxs-lookup"><span data-stu-id="a5592-457">Table 9 shows the members that must be implemented in the classes that inherit from **IGroup** and **IGroupCollection** in the following table.</span></span> 
  
> [!NOTE]
> <span data-ttu-id="a5592-458">Cualquier miembro de la interfaz de **IGroup** no aparece en la tabla debe estar presente, pero no es necesario que se va a implementar.</span><span class="sxs-lookup"><span data-stu-id="a5592-458">Any member of the **IGroup** interface not listed in the table must be present but does not need to be implemented.</span></span> <span data-ttu-id="a5592-459">Los miembros que están presentes, pero no implementado pueden producir un error **NotImplementedException** o **E_NOTIMPL** .</span><span class="sxs-lookup"><span data-stu-id="a5592-459">Members that are present but not implemented can throw a **NotImplementedException** or **E_NOTIMPL** error.</span></span> 
>
> <span data-ttu-id="a5592-460">Para obtener más información acerca de las interfaces **IGroup** y **IGroupCollection** y sus miembros, vea [UCCollaborationLib.IGroup](http://msdn.microsoft.com/library/UCCollaborationLib.IGroup) y [UCCollaborationLib.IGroupCollection](http://msdn.microsoft.com/library/UCCollaborationLib.IGroupCollection).</span><span class="sxs-lookup"><span data-stu-id="a5592-460">For more information about the **IGroup** and **IGroupCollection** interfaces and their members, see [UCCollaborationLib.IGroup](http://msdn.microsoft.com/library/UCCollaborationLib.IGroup) and [UCCollaborationLib.IGroupCollection](http://msdn.microsoft.com/library/UCCollaborationLib.IGroupCollection).</span></span> 
  
<span data-ttu-id="a5592-461">**Tabla 9. Implementación de las interfaces IGroup y IGroupCollection**</span><span class="sxs-lookup"><span data-stu-id="a5592-461">**Table 9. Implementation of the IGroup and IGroupCollection interfaces**</span></span>

|<span data-ttu-id="a5592-462">**Interfaz**</span><span class="sxs-lookup"><span data-stu-id="a5592-462">**Interface**</span></span>|<span data-ttu-id="a5592-463">**Elemento**</span><span class="sxs-lookup"><span data-stu-id="a5592-463">**Member**</span></span>|<span data-ttu-id="a5592-464">**Descripción**</span><span class="sxs-lookup"><span data-stu-id="a5592-464">**Description**</span></span>|
|:-----|:-----|:-----|
|<span data-ttu-id="a5592-465">**IGroupCollection**</span><span class="sxs-lookup"><span data-stu-id="a5592-465">**IGroupCollection**</span></span> <br/> |<span data-ttu-id="a5592-466">**Count** (propiedad)</span><span class="sxs-lookup"><span data-stu-id="a5592-466">**Count** property</span></span>  <br/> |<span data-ttu-id="a5592-467">Devuelve el número de objetos de **IGroup** en la colección</span><span class="sxs-lookup"><span data-stu-id="a5592-467">Returns the count of **IGroup** objects in the collection</span></span>  <br/> |
||<span data-ttu-id="a5592-468">**Elemento** (propiedad)</span><span class="sxs-lookup"><span data-stu-id="a5592-468">**Item** property</span></span>  <br/> |<span data-ttu-id="a5592-469">Devuelve el objeto **IGroup** en el índice especificado de la colección.</span><span class="sxs-lookup"><span data-stu-id="a5592-469">Returns the **IGroup** object at the specified index in the collection.</span></span>  <br/> |
|<span data-ttu-id="a5592-470">**IGroup**</span><span class="sxs-lookup"><span data-stu-id="a5592-470">**IGroup**</span></span> <br/> |<span data-ttu-id="a5592-471">**ID** (propiedad)</span><span class="sxs-lookup"><span data-stu-id="a5592-471">**Id** property</span></span>  <br/> |<span data-ttu-id="a5592-472">Devuelve el identificador del grupo.</span><span class="sxs-lookup"><span data-stu-id="a5592-472">Returns the ID of the group.</span></span>  <br/> |
   
<span data-ttu-id="a5592-473">Cuando la aplicación de Office obtiene la información para el usuario local, que obtiene acceso a las pertenencias a grupos del contacto (usuario local) mediante una llamada a la propiedad **IContact.CustomGroups** , que devuelve un objeto **IGroupCollection** .</span><span class="sxs-lookup"><span data-stu-id="a5592-473">When the Office application gets the information for the local user, it accesses the group memberships of the contact (local user) by calling the **IContact.CustomGroups** property, which returns an **IGroupCollection** object.</span></span> <span data-ttu-id="a5592-474">El **IGroupCollection** debe contener una matriz (o **lista**) de objetos de **IGroup** .</span><span class="sxs-lookup"><span data-stu-id="a5592-474">The **IGroupCollection** must contain an array (or **List**) of **IGroup** objects.</span></span> <span data-ttu-id="a5592-475">La clase que se deriva de **IGroupCollection** debe exponer una propiedad **Count** , que devuelve el número de elementos de la colección y un método de indizador, **this(int)**, que devuelve un objeto **IGroup** de la colección.</span><span class="sxs-lookup"><span data-stu-id="a5592-475">The class that derives from **IGroupCollection** must expose a **Count** property, which returns the number of items in the collection, and an indexer method, **this(int)**, which returns an **IGroup** object from the collection.</span></span> 
  
### <a name="icontactsubscription-interface"></a><span data-ttu-id="a5592-476">Interfaz IContactSubscription</span><span class="sxs-lookup"><span data-stu-id="a5592-476">IContactSubscription interface</span></span>
<span data-ttu-id="a5592-477"><a name="off15_IMIntegration_ImplementRequired_IContactSubscription"> </a></span><span class="sxs-lookup"><span data-stu-id="a5592-477"></span></span>

<span data-ttu-id="a5592-478">La interfaz de **IContactSubscription** permite especificar los contactos para recibir actualizaciones de la información de presencia de y los tipos de información de presencia que desencadenan una notificación.</span><span class="sxs-lookup"><span data-stu-id="a5592-478">The **IContactSubscription** interface allows you to specify the contacts to receive presence information updates for and the types of presence information that trigger a notification.</span></span> <span data-ttu-id="a5592-479">Aplicaciones de Office utilizan un objeto **IContactSubscription** para registrar los cambios realizados en el estado de presencia del contacto.</span><span class="sxs-lookup"><span data-stu-id="a5592-479">Office applications use an **IContactSubscription** object to register changes to contact's presence status.</span></span> 
  
<span data-ttu-id="a5592-480">Tabla 10 se muestran a los miembros que deben implementarse en las clases que heredan de **IContactSubscription**.</span><span class="sxs-lookup"><span data-stu-id="a5592-480">Table 10 shows the members that must be implemented in the classes that inherit from **IContactSubscription**.</span></span>
  
> [!NOTE]
> <span data-ttu-id="a5592-481">Cualquier miembro de la interfaz de **IContactSubscription** no aparece en la tabla debe estar presente, pero no es necesario que se va a implementar.</span><span class="sxs-lookup"><span data-stu-id="a5592-481">Any member of the **IContactSubscription** interface not listed in the table must be present but does not need to be implemented.</span></span> <span data-ttu-id="a5592-482">Los miembros que están presentes, pero no implementado pueden producir un error **NotImplementedException** o **E_NOTIMPL** .</span><span class="sxs-lookup"><span data-stu-id="a5592-482">Members that are present but not implemented can throw a **NotImplementedException** or **E_NOTIMPL** error.</span></span>
>
> <span data-ttu-id="a5592-483">Para obtener más información acerca de la interfaz de **IContactSubscription** y sus miembros, vea [UCCollaborationLib.IContactSubscription](http://msdn.microsoft.com/library/UCCollaborationLib.IContactSubscription).</span><span class="sxs-lookup"><span data-stu-id="a5592-483">For more information about the **IContactSubscription** interface and its members, see [UCCollaborationLib.IContactSubscription](http://msdn.microsoft.com/library/UCCollaborationLib.IContactSubscription).</span></span> 
  
<span data-ttu-id="a5592-484">**Tabla 10. Implementación de la interfaz de IContactSubscription**</span><span class="sxs-lookup"><span data-stu-id="a5592-484">**Table 10. Implementation of the IContactSubscription interface**</span></span>

|<span data-ttu-id="a5592-485">**Elemento**</span><span class="sxs-lookup"><span data-stu-id="a5592-485">**Member**</span></span>|<span data-ttu-id="a5592-486">**Descripción**</span><span class="sxs-lookup"><span data-stu-id="a5592-486">**Description**</span></span>|
|:-----|:-----|
|<span data-ttu-id="a5592-487">**AddContact** (método)</span><span class="sxs-lookup"><span data-stu-id="a5592-487">**AddContact** method</span></span>  <br/> |<span data-ttu-id="a5592-488">Agrega un contacto para el objeto de suscripción.</span><span class="sxs-lookup"><span data-stu-id="a5592-488">Adds a contact to the subscription object.</span></span>  <br/> |
|<span data-ttu-id="a5592-489">**SUBSCRIBE** (método)</span><span class="sxs-lookup"><span data-stu-id="a5592-489">**Subscribe** method</span></span>  <br/> |<span data-ttu-id="a5592-490">Ayuda a la aplicación de cliente de mensajería instantánea para supervisar la presencia de un contacto.</span><span class="sxs-lookup"><span data-stu-id="a5592-490">Helps the IM client application to monitor presence for a contact.</span></span>  <br/> |
   
<span data-ttu-id="a5592-491">La interfaz **IContactSubscription** debe contener una referencia a todos los objetos **IContact** que supervisa, utilizando una matriz o una **lista**.</span><span class="sxs-lookup"><span data-stu-id="a5592-491">The **IContactSubscription** interface must contain a reference to all the **IContact** objects that it monitors, using an array or a **List**.</span></span> <span data-ttu-id="a5592-492">El método **IContactSubscription.AddContact** agrega un objeto **IContact** para el a la estructura de datos subyacente del objeto **IContactSubscription** , con lo que se agrega un contacto nuevo para supervisar los cambios de presencia.</span><span class="sxs-lookup"><span data-stu-id="a5592-492">The **IContactSubscription.AddContact** method adds an **IContact** object for the to the underlying data structure of the **IContactSubscription** object, thereby adding a new contact to monitor for presence changes.</span></span> 
...
<span data-ttu-id="a5592-493">El método **IContactSubscription.Subscribe** permite que una aplicación de cliente de mensajería instantánea tener acceso a observadores de presencia del contacto.</span><span class="sxs-lookup"><span data-stu-id="a5592-493">The **IContactSubscription.Subscribe** method allows an IM client application to access presence observers for the contact.</span></span> <span data-ttu-id="a5592-494">Puede usar una estrategia de sondeo para obtener que la presencia desde el servidor para los contactos para que se ha suscrito a la aplicación de cliente de mensajería instantánea.</span><span class="sxs-lookup"><span data-stu-id="a5592-494">It can use a polling strategy to get the presence from the server for the contacts for that the IM client application has subscribed to.</span></span> <span data-ttu-id="a5592-495">El método **Subscribe** es útil en situaciones donde se solicita la presencia de una persona ajena a la lista de contactos de un usuario (por ejemplo, de una red pública mayor).</span><span class="sxs-lookup"><span data-stu-id="a5592-495">The **Subscribe** method is helpful in situations where presence is requested for someone outside of a user's contact list (for example, from a larger public network).</span></span> 
  
### <a name="icontactendpoint-interface"></a><span data-ttu-id="a5592-496">Interfaz IContactEndPoint</span><span class="sxs-lookup"><span data-stu-id="a5592-496">IContactEndPoint interface</span></span>
<span data-ttu-id="a5592-497"><a name="off15_IMIntegration_ImplementRequired_IContactEndPoint"> </a></span><span class="sxs-lookup"><span data-stu-id="a5592-497"></span></span>

<span data-ttu-id="a5592-498">El **IContactEndPoint** representa un número de teléfono de colección de un contacto de números de teléfono.</span><span class="sxs-lookup"><span data-stu-id="a5592-498">The **IContactEndPoint** represents a telephone number from a contact's collection of telephone numbers.</span></span> 
  
<span data-ttu-id="a5592-499">La tabla 11 se muestran a los miembros que deben implementarse en las clases que heredan de **IContactEndPoint**.</span><span class="sxs-lookup"><span data-stu-id="a5592-499">Table 11 shows the members that must be implemented in the classes that inherit from **IContactEndPoint**.</span></span>
  
> [!NOTE]
> <span data-ttu-id="a5592-500">Cualquier miembro de la interfaz de **IContactEndPoint** no aparece en la tabla debe estar presente, pero no es necesario que se va a implementar.</span><span class="sxs-lookup"><span data-stu-id="a5592-500">Any member of the **IContactEndPoint** interface not listed in the table must be present but does not need to be implemented.</span></span> <span data-ttu-id="a5592-501">Los miembros que están presentes, pero no implementado pueden producir un error **NotImplementedException** o **E_NOTIMPL** .</span><span class="sxs-lookup"><span data-stu-id="a5592-501">Members that are present but not implemented can throw a **NotImplementedException** or **E_NOTIMPL** error.</span></span>
>
> <span data-ttu-id="a5592-502">Para obtener más información acerca de la interfaz de **IContactEndPoint** y sus miembros, vea [UCCollaborationLib.IContactEndpoint](http://msdn.microsoft.com/library/UCCollaborationLib.IContactEndpoint).</span><span class="sxs-lookup"><span data-stu-id="a5592-502">For more information about the **IContactEndPoint** interface and its members, see [UCCollaborationLib.IContactEndpoint](http://msdn.microsoft.com/library/UCCollaborationLib.IContactEndpoint).</span></span> 
  
<span data-ttu-id="a5592-503">**Tabla 11. Implementación de la interfaz de IContactEndPoint**</span><span class="sxs-lookup"><span data-stu-id="a5592-503">**Table 11. Implementation of the IContactEndPoint interface**</span></span>

|<span data-ttu-id="a5592-504">**Elemento**</span><span class="sxs-lookup"><span data-stu-id="a5592-504">**Member**</span></span>|<span data-ttu-id="a5592-505">**Descripción**</span><span class="sxs-lookup"><span data-stu-id="a5592-505">**Description**</span></span>|
|:-----|:-----|
|<span data-ttu-id="a5592-506">**DisplayName** (propiedad)</span><span class="sxs-lookup"><span data-stu-id="a5592-506">**DisplayName** property</span></span>  <br/> |<span data-ttu-id="a5592-507">Obtiene la cadena para mostrar.</span><span class="sxs-lookup"><span data-stu-id="a5592-507">Gets the display string.</span></span>  <br/> |
|<span data-ttu-id="a5592-508">**Tipo** (propiedad)</span><span class="sxs-lookup"><span data-stu-id="a5592-508">**Type** property</span></span>  <br/> |<span data-ttu-id="a5592-509">Obtiene el tipo de contacto de extremo</span><span class="sxs-lookup"><span data-stu-id="a5592-509">Gets the contact endpoint type</span></span>  <br/> |
|<span data-ttu-id="a5592-510">**URI** (propiedad)</span><span class="sxs-lookup"><span data-stu-id="a5592-510">**Uri** property</span></span>  <br/> |<span data-ttu-id="a5592-511">Obtiene el identificador URI del contacto.</span><span class="sxs-lookup"><span data-stu-id="a5592-511">Gets the contact URI.</span></span>  <br/> |
   
### <a name="ilocalestring-interface"></a><span data-ttu-id="a5592-512">Interfaz ILocaleString</span><span class="sxs-lookup"><span data-stu-id="a5592-512">ILocaleString interface</span></span>
<span data-ttu-id="a5592-513"><a name="off15_IMIntegration_ImplementRequired_ILocaleString"> </a></span><span class="sxs-lookup"><span data-stu-id="a5592-513"></span></span>

<span data-ttu-id="a5592-514">El **ILocaleString** es una estructura de cadena localizada que contiene una cadena localizada y el identificador de configuración regional de la localización.</span><span class="sxs-lookup"><span data-stu-id="a5592-514">The **ILocaleString** is a localized string structure that contains both a localized string and the locale ID of the localization.</span></span> <span data-ttu-id="a5592-515">La interfaz de **ILocaleString** se usa para dar formato a la cadena de estado personalizado en la tarjeta de contacto.</span><span class="sxs-lookup"><span data-stu-id="a5592-515">The **ILocaleString** interface is used to format the custom status string on the contact card.</span></span> 
  
<span data-ttu-id="a5592-516">La tabla 12 se muestran a los miembros que deben implementarse en las clases que heredan de **ILocaleString**.</span><span class="sxs-lookup"><span data-stu-id="a5592-516">Table 12 shows the members that must be implemented in the classes that inherit from **ILocaleString**.</span></span>
  
> [!NOTE]
> <span data-ttu-id="a5592-517">Cualquier miembro de la interfaz de **ILocaleString** no aparece en la tabla debe estar presente, pero no es necesario que se va a implementar.</span><span class="sxs-lookup"><span data-stu-id="a5592-517">Any member of the **ILocaleString** interface not listed in the table must be present but does not need to be implemented.</span></span> <span data-ttu-id="a5592-518">Los miembros que están presentes, pero no implementado pueden producir un error **NotImplementedException** o **E_NOTIMPL** .</span><span class="sxs-lookup"><span data-stu-id="a5592-518">Members that are present but not implemented can throw a **NotImplementedException** or **E_NOTIMPL** error.</span></span>
>
> <span data-ttu-id="a5592-519">Para obtener más información acerca de la interfaz de **ILocalString** y sus miembros, vea [UCCollaborationLib.ILocaleString](http://msdn.microsoft.com/library/UCCollaborationLib.ILocaleString).</span><span class="sxs-lookup"><span data-stu-id="a5592-519">For more information about the **ILocalString** interface and its members, see [UCCollaborationLib.ILocaleString](http://msdn.microsoft.com/library/UCCollaborationLib.ILocaleString).</span></span> 
  
<span data-ttu-id="a5592-520">**Tabla 12. Implementación de la interfaz de ILocaleString**</span><span class="sxs-lookup"><span data-stu-id="a5592-520">**Table 12. Implementation of the ILocaleString interface**</span></span>

|<span data-ttu-id="a5592-521">**Elemento**</span><span class="sxs-lookup"><span data-stu-id="a5592-521">**Member**</span></span>|<span data-ttu-id="a5592-522">**Descripción**</span><span class="sxs-lookup"><span data-stu-id="a5592-522">**Description**</span></span>|
|:-----|:-----|
|<span data-ttu-id="a5592-523">**LocaleId** (propiedad)</span><span class="sxs-lookup"><span data-stu-id="a5592-523">**LocaleId** property</span></span>  <br/> |<span data-ttu-id="a5592-524">Obtiene el identificador de configuración regional.</span><span class="sxs-lookup"><span data-stu-id="a5592-524">Gets the locale ID.</span></span>  <br/> |
|<span data-ttu-id="a5592-525">**Valor** (propiedad)</span><span class="sxs-lookup"><span data-stu-id="a5592-525">**Value** property</span></span>  <br/> |<span data-ttu-id="a5592-526">Obtiene la cadena.</span><span class="sxs-lookup"><span data-stu-id="a5592-526">Gets the string.</span></span>  <br/> |
   
## <a name="see-also"></a><span data-ttu-id="a5592-527">Vea también</span><span class="sxs-lookup"><span data-stu-id="a5592-527">See also</span></span>

- <span data-ttu-id="a5592-528">Espacio de nombres [UCCollaborationLib](http://msdn.microsoft.com/library/UCCollaborationLib)</span><span class="sxs-lookup"><span data-stu-id="a5592-528">[UCCollaborationLib](http://msdn.microsoft.com/library/UCCollaborationLib) namespace</span></span> 

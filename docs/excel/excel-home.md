...
> [!NOTE]
> ¿Le interesa el desarrollo de soluciones que amplían la experiencia de Office en [varias plataformas](https://docs.microsoft.com/office/dev/add-ins/overview/office-add-in-availability)? Vea el nuevo [modelo de complementos de Excel](https://docs.microsoft.com/office/dev/add-ins/excel/excel-add-ins-overview). 
  
### <a name="viewed-most"></a>Más vistos
  
- [Referencia de VBA para Excel](https://docs.microsoft.com/office/vba/api/overview/excel)
...
- [Ejemplos de código de Excel en el Centro para desarrolladores de Office](https://developer.microsoft.com/excel/gallery/?filterBy=Samples)
  
### <a name="other-resources"></a>Otros recursos
  
- [Sugerencias para salvar los obstáculos de rendimiento](https://docs.microsoft.com/office/vba/excel/concepts/excel-performance/excel-tips-for-optimizing-performance-obstructions) 

...
Si la función se ejecuta en un proceso Excel, devuelve 0 en **un XLOPER12** de tipo **xlTypeInt**. Si la función se ejecuta en un clúster, el proveedor de conectores de clúster determina el tipo y el valor devueltos.

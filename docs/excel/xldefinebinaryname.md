...
Estructura bigdata que especifica los datos que se almacenarán. Al llamar a esta función, el miembro **lpbData** de la estructura **de bigdata** debe apuntar a los datos para los que se define el nombre y el miembro **cbData** debe contener la longitud de los datos en bytes. 
...
[Problemas conocidos en Excel desarrollo XLL](known-issues-in-excel-xll-development.md)

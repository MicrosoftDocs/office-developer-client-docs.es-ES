...
[Desarrollo de DLL](developing-dlls.md)
  
[Obtener acceso a la instancia de Excel y los identificadores de ventana principal](how-to-access-excel-instance-and-main-window-handles.md)

...
- [Programación de cliente de Project](project-client-programming.md) , se incluye una introducción a los complementos de panel de tareas en Project Professional 2013. Un SDK independiente incluye artículos y referencias para complementos en el proyecto y los otros clientes de Office 2013. Para obtener más información, consulte la [documentación para desarrolladores](https://msdn.microsoft.com/library/office/jj220060.aspx) de complementos de Office. 

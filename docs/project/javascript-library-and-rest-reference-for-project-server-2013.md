...
description: La biblioteca de JavaScript y la referencia de REST para Project Server 2013 contienen información sobre el modelo de objetos de JavaScript y la interfaz REST que se usa para obtener acceso a la funcionalidad de Project Server. Puede usar estas API para desarrollar aplicaciones web entre exploradores, complementos de Project Professional 2013 y aplicaciones para dispositivos que no son windows que tienen acceso a Project Server 2013 y Project Online.
...
La biblioteca de JavaScript y la referencia de REST para Project Server 2013 contienen información sobre el modelo de objetos de JavaScript y la interfaz REST que se usa para obtener acceso a la funcionalidad de Project Server. Puede usar estas API para desarrollar aplicaciones web entre exploradores, complementos de Project Professional 2013 y aplicaciones para dispositivos que no son windows que tienen acceso a Project Server 2013 y Project Online.
...
También puede obtener acceso a la funcionalidad de Project Server a través de la interfaz REST. El punto de entrada a la interfaz REST es **el recurso ProjectServer,** al que se tiene acceso mediante el  `https://ServerName/pwaName/_api/ProjectServer` URI del extremo. Por ejemplo, la siguiente consulta obtiene las asignaciones en el proyecto especificado (reemplace  _ServerName_ y  _pwaName_ y cambie el GUID para que coincida con un proyecto).
  
`https://ServerName/pwaName/_api/ProjectServer/Projects('263fc8d7-427c-e111-92fc-00155d3ba208')/Assignments`

El **recurso ProjectServer** se describe en [recursos de ProjectServer en la interfaz REST.](https://msdn.microsoft.com/library/a490b675-a845-ee94-3877-b99ada9bf2b0%28Office.15%29.aspx#bk_ProjectServerResources) Otros recursos rest se describen en la documentación para los objetos y miembros de JavaScript correspondientes en esta referencia. Para obtener más información acerca del uso de REST, vea Modelo de objetos de cliente [(CSOM)](client-side-object-model-csom-for-project-2013.md) para Project Server y programación con el servicio REST de [SharePoint 2013.](https://msdn.microsoft.com/library/fp142385%28office.15%29.aspx)

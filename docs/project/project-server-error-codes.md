...
|GeneralInvalidCharacters = 20012  <br/> |Algunos caracteres no son válidos. Además del carácter de tabulación, los siguientes caracteres no son válidos en un nombre de proyecto: `\ / " : ; < > | , . ' ? * #` <br/> |

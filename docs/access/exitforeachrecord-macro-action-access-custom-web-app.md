...
---
# <a name="exitforeachrecord-macro-action-access-custom-web-app"></a>Acción de Macro Salirdecadaregistro (aplicación web personalizado de Access)
...
> [!NOTE]
> [!NOTA] La acción **ParaCadaRegistro** solo está disponible en macros de datos. 

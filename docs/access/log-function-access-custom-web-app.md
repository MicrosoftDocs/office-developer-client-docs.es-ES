...
La **función Log** contiene los argumentos siguientes. 
...
La función **Log10** es similar, pero siempre devuelve el logaritmo común, lo que significa el logaritmo para la base 10. 
  
El logaritmo natural es el logaritmo de la base e, donde e es una constante irracional aproximadamente igual a 2,718281828.

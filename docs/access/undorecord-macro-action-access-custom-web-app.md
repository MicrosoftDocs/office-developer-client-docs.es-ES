...
---
# <a name="undorecord-macro-action-access-custom-web-app"></a>Acción de Macro UndoRecord (aplicación web personalizado de Access)
...
La acción **UndoRecord** es equivalente a usar el botón **Cancelar** en la acción de la barra descartar cambios. 

...
ms.locfileid: "28706229"
---
# <a name="move-method-example-vb"></a><span data-ttu-id="bafc5-102">Ejemplo del método Move (VB)</span><span class="sxs-lookup"><span data-stu-id="bafc5-102">Move method example (VB)</span></span>


<span data-ttu-id="bafc5-103">**Se aplica a**: Access 2013, Office 2013</span><span class="sxs-lookup"><span data-stu-id="bafc5-103">**Applies to**: Access 2013, Office 2013</span></span>

<span data-ttu-id="bafc5-104">En este ejemplo se utiliza el método [Move](move-method-ado.md) para ubicar el puntero de registros, basándose en los datos proporcionados por el usuario.</span><span class="sxs-lookup"><span data-stu-id="bafc5-104">This example uses the [Move](move-method-ado.md) method to position the record pointer based on user input.</span></span>

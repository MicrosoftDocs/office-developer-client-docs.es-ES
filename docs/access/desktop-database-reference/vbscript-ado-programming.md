...
ms.locfileid: "25486306"
---
# <a name="vbscript-ado-programming"></a><span data-ttu-id="f3260-102">Programación ADO en VBScript</span><span class="sxs-lookup"><span data-stu-id="f3260-102">VBScript ADO Programming</span></span>


<span data-ttu-id="f3260-103">**Se aplica a**: Access 2013 | Office 2013</span><span class="sxs-lookup"><span data-stu-id="f3260-103">**Applies to**: Access 2013 | Office 2013</span></span> 

## <a name="creating-an-ado-project"></a><span data-ttu-id="f3260-104">Crear un proyecto de ADO</span><span class="sxs-lookup"><span data-stu-id="f3260-104">Creating an ADO Project</span></span>
...
## <a name="creating-ado-objects-in-vbscript"></a><span data-ttu-id="f3260-112">Crear objetos de ADO en VBScript</span><span class="sxs-lookup"><span data-stu-id="f3260-112">Creating ADO Objects in VBScript</span></span>

<span data-ttu-id="f3260-p102">No es posible utilizar la instrucción **Dim** para asignar objetos a un tipo específico en VBScript. Además, VBScript no admite la sintaxis **New** utilizada con la instrucción **Dim** en Visual Basic para Aplicaciones (VBA). Deberá utilizar la llamada a la función **CreateObject**:</span><span class="sxs-lookup"><span data-stu-id="f3260-p102">You cannot use the **Dim** statement to assign objects to a specific type in VBScript. Also, VBScript does not support the **New** syntax used with the **Dim** statement in Visual Basic for Applications. You must instead use the **CreateObject** function call:</span></span>
...
## <a name="vbscript-examples"></a><span data-ttu-id="f3260-116">Ejemplos de VBScript</span><span class="sxs-lookup"><span data-stu-id="f3260-116">VBScript Examples</span></span>

<span data-ttu-id="f3260-117">El código siguiente es un ejemplo genérico de programación de servidor con VBScript en un archivo ASP:</span><span class="sxs-lookup"><span data-stu-id="f3260-117">The following code is a generic example of VBScript server-side programming in an Active Server Page (ASP) file:</span></span>

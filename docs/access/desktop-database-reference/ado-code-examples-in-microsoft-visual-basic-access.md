...
ms.locfileid: "25862635"
---
# <a name="ado-code-examples-in-microsoft-visual-basic-access"></a>Ejemplos de código de ADO en Microsoft Visual Basic (Access)
...
<<<<<<< HEAD
  ...
  - [Ejemplo de las propiedades ActiveConnection, CommandText, CommandTimeout, CommandType, Size y Direction (VB)](activeconnection-commandtext-commandtimeout-commandtype-size-and-direction-properties-example-vb.md)

  - [ActualSize y DefinedSize (VB) de propiedades](actualsize-and-definedsize-properties-example-vb.md)
=======
  - [Ejemplo de las propiedades AbsolutePage, PageCount y PageSize (VB)](absolutepage-pagecount-and-pagesize-properties-example-vb.md)
...
<<<<<<< HEAD
  - [Ejemplo de las propiedades Attributes y Name (VB)](attributes-and-name-properties-example-vb.md)
...
<<<<<<< HEAD
  - [ConnectionString, ConnectionTimeout y ejemplo de las propiedades State (VB)](connectionstring-connectiontimeout-and-state-properties-example-vb.md)
=======
...
<<<<<<< HEAD
  ...
  - [CursorType, LockType y EditMode ejemplo de las propiedades (VB)](cursortype-locktype-and-editmode-properties-example-vb.md)
=======
  - [Ejemplo de la propiedad Count (VB)](count-property-example-vb.md)
...
>>>>>>> master
  ...
  - [Ejemplo del método Delete (VB)](delete-method-example-vb.md)

  - [Ejemplo de los métodos DeleteRecord y MoveRecord (VB)](deleterecord-and-moverecord-methods-example-vb.md)

<<<<<<< HEAD
  - [Description, ContextoDeAyuda (HelpContext), HelpFile, NativeError, número, origen y ejemplo de las propiedades SQLState (VB)](description-helpcontext-helpfile-nativeerror-number-source-and-sqlstate-properties-example-vb.md)
=======
  - [Ejemplo de las propiedades Description, HelpContext, HelpFile, NativeError, Number, Source y SQLState (VB)](description-helpcontext-helpfile-nativeerror-number-source-and-sqlstate-properties-example-vb.md)
>>>>>>> master

  - [Ejemplo del método EOS y LineSeparator propiedades y SkipLine (VB)](eos-and-lineseparator-properties-and-skipline-method-example-vb.md)

  - [Ejemplo de los métodos Execute, Requery y Clear (VB)](execute-requery-and-clear-methods-example-vb.md)

<<<<<<< HEAD
  - [Filtro y ejemplo de las propiedades RecordCount (VB)](filter-and-recordcount-properties-example-vb.md)
=======
...
<<<<<<< HEAD
  - [ADO NumericScale y Precision propiedades (VB)](ado-numericscale-and-precision-properties-example-vb.md)
=======
  - [Ejemplo de las propiedades de ADO NumericScale y Precision (VB)](ado-numericscale-and-precision-properties-example-vb.md)
>>>>>>> master
...
<<<<<<< HEAD
  ...
  - [Ejemplo Provider y DefaultDatabase propiedades (VB)](provider-and-defaultdatabase-properties-example-vb.md)
=======
  - [Ejemplo de la propiedad Optimize (VB)](optimize-property-example-vb.md)
...
>>>>>>> master
  ...
  - [Ejemplo de los métodos Read, ReadText, Write y WriteText (VB)](read-readtext-write-and-writetext-methods-example-vb.md)
...
<<<<<<< HEAD
  - [Ejemplo del método Seek y de la propiedad Index (VB)](seek-method-and-index-property-example-vb.md)
  ...
  - [Ejemplo de la propiedad Status (Field) (VB)](status-property-example-field-vb.md)
  ...
  - [Ejemplo de la propiedad Type (Field) (VB)](type-property-example-field-vb.md)

  - [Ejemplo de la propiedad tipo (propiedad) (VB)](type-property-example-property-vb.md)
=======
  - [Seek (método) y el índice de propiedad (VB)](seek-method-and-index-property-example-vb.md)
  ...
  - [Ejemplo de la propiedad Type (VB)](type-property-example-property-vb.md)
>>>>>>> master

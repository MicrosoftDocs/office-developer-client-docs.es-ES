...
ms.locfileid: "28713768"
---
# <a name="delete-method-example-vj"></a><span data-ttu-id="012ce-102">Ejemplo del método Delete (VJ++)</span><span class="sxs-lookup"><span data-stu-id="012ce-102">Delete method example (VJ++)</span></span>


<span data-ttu-id="012ce-103">**Se aplica a**: Access 2013, Office 2013</span><span class="sxs-lookup"><span data-stu-id="012ce-103">**Applies to**: Access 2013, Office 2013</span></span>

<span data-ttu-id="012ce-104">En este ejemplo se usa el método [Delete](delete-method-ado-recordset.md) para quitar un registro especificado de un objeto [Recordset](recordset-object-ado.md).</span><span class="sxs-lookup"><span data-stu-id="012ce-104">This example uses the [Delete](delete-method-ado-recordset.md) method to remove a specified record from a [Recordset](recordset-object-ado.md).</span></span>

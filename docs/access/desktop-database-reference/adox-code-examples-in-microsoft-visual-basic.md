...
- [Ejemplo de método Append de Keys, propiedades Type, RelatedColumn, RelatedTable y UpdateRule de Keys (VB)](keys-append-method-key-type-relatedcolumn-relatedtable-and-updaterule-properties-example-vb.md)
...
- [Ejemplo de propiedad Command y colección Parameters (VB)](parameters-collection-command-property-example-vb.md)
...
- [Ejemplo de las propiedades Tipo de clave, RelatedColumn, RelatedTable y UpdateRule, método Append de Keys (VB)](keys-append-method-key-type-relatedcolumn-relatedtable-and-updaterule-properties-example-vb.md)
...
- [Ejemplo de propiedad Table Type, método Connection Close (VB)](connection-close-method-table-type-property-example-vb.md)

...
Use la [propiedad dinámica Tiempo](microsoft-cursor-service-for-ole-db-ado-service-component.md)de espera del **comando** del servicio de cursores para modificar la duración del tiempo de espera.

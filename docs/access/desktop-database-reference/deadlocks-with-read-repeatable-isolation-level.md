...
Use la propiedad dinámica**Command Time Out** del [servicio](microsoft-cursor-service-for-ole-db-ado-service-component.md)de cursores para modificar la duración del tiempo de espera.

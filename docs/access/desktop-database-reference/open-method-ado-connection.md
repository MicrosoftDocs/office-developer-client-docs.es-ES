...
**Uso del servicio de datos remotos** Cuando se usa en un objeto **Connection** del lado cliente, el método **Open** no establece realmente una conexión al servidor hasta que se abre un [objeto Recordset](recordset-object-ado.md) en el **objeto Connection.**

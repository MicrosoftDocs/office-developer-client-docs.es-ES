...
---
# <a name="levels-collection-ado-md"></a>Levels (colección) (ADO MD)


**Se aplica a:** Access 2013, Office 2013

Contiene los objetos [Level](level-object-ado-md.md) que componen una jerarquía.

## <a name="remarks"></a>Comentarios

**Levels** es una colección de ADO estándar. Con las propiedades y los métodos de una colección, puede realizar las siguientes operaciones:

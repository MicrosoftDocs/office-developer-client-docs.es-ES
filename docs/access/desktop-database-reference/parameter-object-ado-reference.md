...
---
# <a name="parameter-object-ado-reference"></a>Referencia del objeto Parameter (ADO)

**Se aplica a:** Access 2013, Office 2013

- [Parameter (objeto) (ADO)](parameter-object-ado.md)
- [Propiedades, métodos y eventos de Parameter (ADO)](parameter-properties-methods-and-events-ado.md)

...
En este ejemplo se usa el método [Find](find-method-ado.md) del objeto [Recordset](recordset-object-ado.md) para localizar y mostrar las compañías de la base de datos ***Northwind*** cuyo nombre comience con la letra G. Corte y pegue el código siguiente en Bloc de notas u otro editor de texto y guárdelo como **FindJS.asp**.

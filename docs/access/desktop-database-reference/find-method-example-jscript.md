...
En este ejemplo se usa el método de [Find](find-method-ado.md) del objeto [Recordset](recordset-object-ado.md) para localizar y mostrar las compañías de la base de datos ***Northwind*** cuyo nombre comienza con la letra G. corte y pegue el código siguiente en el Bloc de notas u otro editor de texto y guárdelo como ** FindJS.asp**.

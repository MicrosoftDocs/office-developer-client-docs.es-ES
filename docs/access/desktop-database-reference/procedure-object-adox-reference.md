...
---
# <a name="procedure-object-adox-reference"></a>Procedure (objeto de objeto) (ADOX)

**Se aplica a:** Access 2013, Office 2013

- [Procedure (objeto) (ADOX)](procedure-object-adox.md)
- [Propiedades, métodos y eventos de procedimientos (ADOX)](procedure-properties-methods-and-events-adox.md)

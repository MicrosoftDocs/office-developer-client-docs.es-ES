---
<<<<<<< Título HEAD: ConnectionString, ConnectionTimeout y ejemplo de propiedades de estado (VB) TOCTitle: ConnectionString, ConnectionTimeout y ejemplo de propiedades de estado (VB) === título: ConnectionString, ConnectionTimeout, ejemplo de propiedades de estado (VB) y TOCTitle: ejemplo de las propiedades ConnectionString, ConnectionTimeout y State (VB)
>>>>>>> Master ms:assetid: abdd0262-8647-d545-60e0-13f99337df06 ms:mtpsurl: https://msdn.microsoft.com/library/JJ249796(v=office.15) ms:contentKeyID: ms.date 48546984: 18/09/2015 mtps_version: Office.15
---

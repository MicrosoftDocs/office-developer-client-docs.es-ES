...
---
# <a name="tabledefvalidationtext-property-dao"></a>Propiedad TableDef. ValidationText (DAO)
...
Para un objeto **[TableDef](tabledef-object-dao.md)**, el valor de esta propiedad es de sólo lectura para una tabla vinculada y de lectura y escritura par una tabla base.

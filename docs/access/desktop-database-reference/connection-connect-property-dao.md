...
---
# <a name="connectionconnect-property-dao"></a>Propiedad Connection. Connect (DAO)
...
<td><p>unidad: \ path\filename</p></td>
</tr>
<tr class="even">
<td><p>dBASE III</p></td>
<td><p>dBASE III;</p></td>
<td><p>unidad: \ rutaDeAcceso</p></td>
</tr>
<tr class="odd">
<td><p>dBASE IV</p></td>
<td><p>dBASE IV;</p></td>
...
<td><p>Excel 3.0;</p></td>
<td><p>unidad: \ path\filename.xls</p></td>
</tr>
<tr class="odd">
...
<td><p>Lotus WK1;</p></td>
<td><p>unidad: \ path\filename.WK1</p></td>
</tr>
<tr class="odd">
<td><p>Lotus 1-2-3 WK3</p></td>
<td><p>Lotus WK3;</p></td>
<td><p>unidad: \ path\filename.WK3</p></td>
</tr>
<tr class="even">
<td><p>Lotus 1-2-3 WK4</p></td>
<td><p>Lotus WK4;</p></td>
<td><p>unidad: \ path\filename.WK4</p></td>
</tr>
<tr class="odd">
...
<tr class="even">
<td><p>ODBC</p></td>
<td><p>ODBC DATABASE = base de datos; UID = usuario; PWD = contraseña; DSN = datasourcename; [LOGINTIMEOUT = segundos;]</p></td>
<td><p>Ninguno</p></td>
</tr>
<tr class="odd">
<td><p>Microsoft Exchange</p></td>
<td><p>Exchange 4,0; MAPILEVEL = folderPath; [TABLETYPE = {0 | 1}]; [PROFILE = perfil;] [PWD = contraseña;] [DATABASE = base de datos;]</p></td>
<td><p>unidad: \ path\filename</p></td>
</tr>
</tbody>
</table>
...
Para los datos de Microsoft Exchange, la clave requerida MAPILEVEL debe establecerse en una ruta de acceso de carpeta totalmente resuelta (por ejemplo, "Buzón - Almudena BenitoIAlpha/Hoy"). La ruta de acceso no incluye el nombre de la carpeta que se abrirá como una tabla; en su lugar, el nombre de la carpeta debe especificarse como el argumento Name del método **createTable** . La clave TABLETYPE debe estar establecida en "0" para abrir una carpeta (forma predeterminada) o en "1" para abrir una libreta de direcciones. La clave PROFILE utiliza como valor predeterminado el perfil que se está utilizando.

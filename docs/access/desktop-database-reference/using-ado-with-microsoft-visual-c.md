...
- [Programación de ADO en Visual C++](visual-c-ado-programming.md)

- [Extensiones de Visual C++ para ADO](visual-c-extensions-for-ado.md)

- [Uso de las extensiones de Visual C++](using-visual-c-extensions.md)
...
- [ADO para el índice de sintaxis de Visual C++ con \#importar](https://docs.microsoft.com/office/vba/access/concepts/miscellaneous/ado-for-visual-c-plus-plus-syntax-index-with-import)
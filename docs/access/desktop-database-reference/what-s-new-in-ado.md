...
<td><p>Indica el carácter binario que se va a utilizar como separador de línea en los objetos <strong>Stream</strong> de texto.</p></td>
</tr>
<tr class="even">
<td><p><a href="mode-property-ado.md">Mode</a></p></td>
<td><p>Indica los permisos disponibles para modificar los datos de un objeto <strong>Connection</strong>, <strong>Record</strong> o <strong>Stream</strong>.</p></td>
</tr>
<tr class="odd">

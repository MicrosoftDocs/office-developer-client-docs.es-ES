...
Antes de establecer la propiedad **ActiveConnection,** llame **a** **Open** sin operandos para crear una instancia de un conjunto de registros creado anexando campos a la colección **Recordset** [Fields.](fields-collection-ado.md)

---
<<<<<<< Título HEAD: proveedor y ejemplo de las propiedades DefaultDatabase (VC ++) TOCTitle: ejemplo Provider y DefaultDatabase propiedades (VC ++) === título: ejemplo de las propiedades Provider y DefaultDatabase (VC ++) TOCTitle: proveedor y ejemplo de las propiedades DefaultDatabase (VC ++)
>>>>>>> Master ms:assetid: 21c38be4-3906-cee8-b77b-300f1226392a ms:mtpsurl: https://msdn.microsoft.com/library/JJ248995(v=office.15) ms:contentKeyID: ms.date 48543687: 18/09/2015 mtps_version: Office.15
---

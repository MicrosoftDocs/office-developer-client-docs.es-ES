...
<p><strong>NOTA:</strong>Escriba solo el nombre del campo o control en el argumento Nombre del <strong>control,</strong> no en el identificador completo, como Forms. ¡Productos! [Id. de producto].</p></td>
</tr>
</tbody>
</table>
...
No puede usar la **acción IrAControl** para mover el foco a un control de un formulario oculto.

> [!TIP]
> Puede usar la acción **IrAControl** para moverse a un subformulario, que es un tipo de control. A continuación, puede usar **la acción IrARegistro** para moverse a un registro determinado del subformulario. También puede desplazarse a un control de un subformulario mediante la acción **IrAControl** para moverse primero al subformulario y, a continuación, al control del subformulario.

Para ejecutar la **acción GoToControl** en un módulo Visual Basic para Aplicaciones (VBA), utilice el método **GoToControl** del **objeto DoCmd** . También puede usar el método **SetFocus** para mover el foco a un control de un formulario o a cualquiera de sus subformulario, o a un campo de una tabla, consulta o hoja de datos de formulario abierta.
...
<td><p>Si el código postal no tiene 5 caracteres, muestre un mensaje.</p></td>
</tr>
<tr class="odd">
<td><p>...</p></td>
...
<td><p><strong>MessageBox</strong></p></td>
<td><p>Mensaje: el código postal debe tener 4 caracteres. <strong>Bip</strong>: <strong>YesType</strong>: <strong>InformationTitle</strong>: Error de código postal</p></td>
<td><p>Si el código postal no tiene 4 caracteres, muestre un mensaje.</p></td>
</tr>
<tr class="even">
<td><p>...</p></td>
<td><p><strong>CancelEvent</strong></p></td>
...
<td><p>Si el código postal no es correcto para Canadá, muestre un mensaje. (Ejemplo de código canadiense: H1J 1C3)</p></td>
</tr>
<tr class="odd">
<td><p>...</p></td>
<td><p><strong>CancelEvent</strong></p></td>

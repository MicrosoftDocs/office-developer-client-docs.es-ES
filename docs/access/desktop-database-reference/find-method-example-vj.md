...
---
# <a name="find-method-example-vj"></a><span data-ttu-id="c6793-102">Ejemplo del método Find (VJ++)</span><span class="sxs-lookup"><span data-stu-id="c6793-102">Find method example (VJ++)</span></span>


<span data-ttu-id="c6793-103">**Se aplica a:** Access 2013, Office 2013</span><span class="sxs-lookup"><span data-stu-id="c6793-103">**Applies to**: Access 2013, Office 2013</span></span>

<span data-ttu-id="c6793-p101">En este ejemplo se usa el método [Find](find-method-ado.md) del objeto [Recordset](recordset-object-ado.md) para localizar y contar el número de nombres de empresa en la base de datos ***Pubs***. En el ejemplo, se supone que el proveedor subyacente no admite una funcionalidad similar.</span><span class="sxs-lookup"><span data-stu-id="c6793-p101">This example uses the [Recordset](recordset-object-ado.md) object's [Find](find-method-ado.md) method to locate and count the number of business titles in the ***Pubs*** database. The example assumes the underlying provider does not support similar functionality.</span></span>

...
---
# <a name="columns-and-tables-append-methods-name-property-example-vc"></a><span data-ttu-id="dd2ba-102">Ejemplo de propiedad Columns y Tables Append, Name (VC++)</span><span class="sxs-lookup"><span data-stu-id="dd2ba-102">Columns and Tables Append Methods, Name property example (VC++)</span></span>


<span data-ttu-id="dd2ba-103">**Se aplica a:** Access 2013, Office 2013</span><span class="sxs-lookup"><span data-stu-id="dd2ba-103">**Applies to**: Access 2013, Office 2013</span></span>

<span data-ttu-id="dd2ba-104">El código siguiente muestra cómo crear una tabla nueva.</span><span class="sxs-lookup"><span data-stu-id="dd2ba-104">The following code demonstrates how to create a new table.</span></span>

...
Esta propiedad reconoce el equipo\_local\_HKEY o el\_usuario\_local HKEY. Si no se proporciona ninguna clave raíz, el valor predeterminado\_es\_el equipo local HKEY.

...
Para controlar los eventos de ADO en Microsoft Visual Basic, debe declarar una variable de nivel de módulo mediante la palabra clave **WithEvents.** La variable se puede declarar sólo como parte de un módulo de clase y se debe declarar en el nivel de módulo. Para obtener una explicación más completa sobre el control de eventos de ADO, vea [chapter 7: Handling ADO events](chapter-7-handling-ado-events.md).

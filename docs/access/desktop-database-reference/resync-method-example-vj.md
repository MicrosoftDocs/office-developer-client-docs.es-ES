...
---
# <a name="resync-method-example-vj"></a><span data-ttu-id="a6ff2-102">Ejemplo del método Resync (VJ++)</span><span class="sxs-lookup"><span data-stu-id="a6ff2-102">Resync Method Example (VJ++)</span></span>


<span data-ttu-id="a6ff2-103">**Se aplica a**: Access 2013 | Office 2013</span><span class="sxs-lookup"><span data-stu-id="a6ff2-103">**Applies to**: Access 2013 | Office 2013</span></span>

<span data-ttu-id="a6ff2-104">En este ejemplo se muestra cómo utilizar el método [Resync](resync-method-ado.md) para actualizar los datos de un conjunto de registros estático.</span><span class="sxs-lookup"><span data-stu-id="a6ff2-104">This example demonstrates using the [Resync](resync-method-ado.md) method to refresh data in a static recordset.</span></span>

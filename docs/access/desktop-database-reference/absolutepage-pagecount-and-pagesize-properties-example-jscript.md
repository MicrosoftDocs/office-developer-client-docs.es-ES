...
ms.locfileid: "25483542"
---
# <a name="absolutepage-pagecount-and-pagesize-properties-example-jscript"></a><span data-ttu-id="d2338-102">Ejemplo de las propiedades AbsolutePage, PageCount y PageSize (JScript)</span><span class="sxs-lookup"><span data-stu-id="d2338-102">AbsolutePage, PageCount, and PageSize Properties Example (JScript)</span></span>

<span data-ttu-id="d2338-103">**Se aplica a**: Access 2013 | Office 2013</span><span class="sxs-lookup"><span data-stu-id="d2338-103">**Applies to**: Access 2013 | Office 2013</span></span>

<span data-ttu-id="d2338-104">En este ejemplo se muestra cómo las propiedades AbsolutePage, PageCount y PageSize.</span><span class="sxs-lookup"><span data-stu-id="d2338-104">This example demonstrates the AbsolutePage, PageCount, and PageSize properties.</span></span> <span data-ttu-id="d2338-105">Corte y pegue el código siguiente en Bloc de notas u otro editor de texto y guárdelo como **AbsolutePageJS.asp**.</span><span class="sxs-lookup"><span data-stu-id="d2338-105">Cut and paste the following code to Notepad or another text editor, and save it as **AbsolutePageJS.asp**.</span></span>

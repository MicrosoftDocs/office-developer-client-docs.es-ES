...
Si Access está configurado para usar ventanas superpuestas en lugar de documentos con pestañas, puedes usar la acción **MaximizarVentana** para ampliar la ventana activa de modo que rellene la ventana de Access. Esta acción permite ver el máximo posible del objeto en la ventana activa.

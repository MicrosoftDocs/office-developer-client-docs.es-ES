...
<td><p>Una descripción de texto del error que se produjo.</p></td>
</tr>
<tr class="even">
...
<td><p>Código de error de cinco caracteres que el proveedor devuelve durante el proceso de una instrucción SQL.</p></td>
</tr>
</tbody>
</table>

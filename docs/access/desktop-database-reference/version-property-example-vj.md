---
<<<<<<< Título HEAD: ejemplo de la propiedad Version (VJ ++) TOCTitle: ejemplo de la propiedad Version (VJ ++) === título: ejemplo de la propiedad Version (VJ ++) TOCTitle: ejemplo de la propiedad Version (VJ ++)
>>>>>>> Master ms:assetid: c4f007b8-177d-967e-7f3b-a8945264099b ms:mtpsurl: https://msdn.microsoft.com/library/JJ249963(v=office.15) ms:contentKeyID: ms.date 48547600: 18/09/2015 mtps_version: Office.15
---

<<<<<<< HEAD
# <a name="version-property-example-vj"></a>Ejemplo de la propiedad Version (VJ++)
=======
# <a name="version-property-example-vj"></a>Ejemplo de la propiedad Version (VJ ++)
>>>>>>> master

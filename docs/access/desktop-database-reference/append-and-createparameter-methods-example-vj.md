---
title: Ejemplo de los métodos Append y CreateParameter (VJ++)
...
ms.locfileid: "25483350"
---
# <a name="append-and-createparameter-methods-example-vj"></a><span data-ttu-id="2a949-102">Ejemplo de los métodos Append y CreateParameter (VJ++)</span><span class="sxs-lookup"><span data-stu-id="2a949-102">Append and CreateParameter Methods Example (VJ++)</span></span>


<span data-ttu-id="2a949-103">**Se aplica a**: Access 2013 | Office 2013</span><span class="sxs-lookup"><span data-stu-id="2a949-103">**Applies to**: Access 2013 | Office 2013</span></span>

<span data-ttu-id="2a949-104">En este ejemplo se utilizan los métodos [Append](append-method-ado.md) y [CreateParameter](createparameter-method-ado.md) para ejecutar un procedimiento almacenado con un parámetro de entrada.</span><span class="sxs-lookup"><span data-stu-id="2a949-104">This example uses the [Append](append-method-ado.md) and [CreateParameter](createparameter-method-ado.md) methods to execute a stored procedure with an input parameter.</span></span>

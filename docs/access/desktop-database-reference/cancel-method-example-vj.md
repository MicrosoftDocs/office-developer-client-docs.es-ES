...
ms.locfileid: "25876096"
---
# <a name="cancel-method-example-vj"></a><span data-ttu-id="770e0-102">Ejemplo del método Cancel (VJ++)</span><span class="sxs-lookup"><span data-stu-id="770e0-102">Cancel method example (VJ++)</span></span>


<span data-ttu-id="770e0-103">**Se aplica a**: Access 2013, Office 2013</span><span class="sxs-lookup"><span data-stu-id="770e0-103">**Applies to**: Access 2013, Office 2013</span></span>

<span data-ttu-id="770e0-104">En este ejemplo se utiliza el método [Cancel](cancel-method-ado.md) para cancelar un comando que se ejecuta en un objeto [Connection](connection-object-ado.md) si la conexión está ocupada.</span><span class="sxs-lookup"><span data-stu-id="770e0-104">This example uses the [Cancel](cancel-method-ado.md) method to cancel a command executing on a [Connection](connection-object-ado.md) object if the connection is busy.</span></span>

...
---
# <a name="stream-object-ado-reference"></a>Referencia del objeto Stream (ADO)

**Se aplica a:** Access 2013, Office 2013

- [Stream (objeto) (ADO)](stream-object-ado.md)
- [Propiedades, métodos y eventos de la secuencia (ADO)](stream-properties-methods-and-events-ado.md)

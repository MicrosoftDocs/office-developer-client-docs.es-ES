...
---
# <a name="stream-object-ado-reference"></a>Referencia de objeto stream (ADO)

**Se aplica a:** Access 2013, Office 2013

- [Objeto Stream (ADO)](stream-object-ado.md)
- [Propiedades, métodos y eventos de Stream (ADO)](stream-properties-methods-and-events-ado.md)

...
ms.locfileid: "28704423"
---
# <a name="setorderby-macro-action"></a><span data-ttu-id="6b838-102">ConfigurarOrdenarPor (acción de macro)</span><span class="sxs-lookup"><span data-stu-id="6b838-102">SetOrderBy macro action</span></span>


<span data-ttu-id="6b838-103">**Se aplica a**: Access 2013, Office 2013</span><span class="sxs-lookup"><span data-stu-id="6b838-103">**Applies to**: Access 2013, Office 2013</span></span>

<span data-ttu-id="6b838-104">Puede utilizar la acción **ConfigurarOrdenarPor** para especificar cómo desea ordenar los registros en un formulario, informe, tabla o resultado de consulta.</span><span class="sxs-lookup"><span data-stu-id="6b838-104">You can use the **SetOrderBy** action to specify how you want to sort records in a form, report, table, or query result.</span></span>

## <a name="setting"></a><span data-ttu-id="6b838-105">Valores</span><span class="sxs-lookup"><span data-stu-id="6b838-105">Setting</span></span>

<span data-ttu-id="6b838-106">La acción **ConfigurarOrdenarPor** utiliza los siguientes argumentos.</span><span class="sxs-lookup"><span data-stu-id="6b838-106">The **SetOrderBy** action has the following arguments.</span></span>

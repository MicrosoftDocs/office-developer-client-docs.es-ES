...
El nombre del proveedor de datos puede especificarse como el valor de la propiedad dinámica del **proveedor de datos** , que se agrega a la colección [Properties](properties-collection-ado.md) del objeto **Connection** mediante el servicio de forma de datos para OLE DB, o la palabra clave de la cadena de conexión "* *Proveedor de datos = * *** Provider ".

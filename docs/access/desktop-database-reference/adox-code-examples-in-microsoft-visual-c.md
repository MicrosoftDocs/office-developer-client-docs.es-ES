...
- [Claves Append, clave de tipo, RelatedColumn, RelatedTable y UpdateRule de Key propiedades ejemplo del método (VC ++)](keys-append-method-key-type-relatedcolumn-relatedtable-and-updaterule-properties-example-vc.md)
...
- [Nombre de propiedad, columnas y tablas de datos anexados ejemplo de los métodos (VC ++)](columns-and-tables-append-methods-name-property-example-vc.md)
...
- [Tabla de la propiedad Type, el ejemplo del método Close de Connection (VC ++)](connection-close-method-table-type-property-example-vc.md)

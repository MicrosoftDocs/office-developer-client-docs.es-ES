...
---
# <a name="open-and-close-methods-example-vb"></a><span data-ttu-id="6ff1c-102">Ejemplo de los métodos Open y Close (VB)</span><span class="sxs-lookup"><span data-stu-id="6ff1c-102">Open and Close Methods Example (VB)</span></span>


<span data-ttu-id="6ff1c-103">**Se aplica a**: Access 2013 | Office 2013</span><span class="sxs-lookup"><span data-stu-id="6ff1c-103">**Applies to**: Access 2013 | Office 2013</span></span>

<span data-ttu-id="6ff1c-104">En este ejemplo se usan los métodos **Open** y [Close](close-method-ado.md) en objetos [Recordset](recordset-object-ado.md) y [Connection](connection-object-ado.md) que se han abierto.</span><span class="sxs-lookup"><span data-stu-id="6ff1c-104">This example uses the **Open** and [Close](close-method-ado.md) methods on both [Recordset](recordset-object-ado.md) and [Connection](connection-object-ado.md) objects that have been opened.</span></span>

...
En Access 2013, puede crear campos de tabla que calcule valores. Los cálculos pueden incluir valores de campos de la misma tabla, así como funciones integradas de Access.

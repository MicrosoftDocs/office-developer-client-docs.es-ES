---
title: Cambiar la forma de nombre dinámico (propiedad, ADO)
...
ms.locfileid: "28714979"
---
# <a name="reshape-name-dynamic-property-ado"></a>Cambiar la forma de nombre dinámico (propiedad, ADO)

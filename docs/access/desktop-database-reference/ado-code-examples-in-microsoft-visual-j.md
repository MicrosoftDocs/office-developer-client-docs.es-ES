...
- [Ejemplo de los métodos Append y CreateParameter](append-and-createparameter-methods-example-vj.md)
...
- [Ejemplo de método Delete](delete-method-example-vj.md)
...
- [Ejemplo del método Resync](resync-method-example-vj.md)
- [Ejemplo de los métodos Save y Open](save-and-open-methods-example-vj.md)
- [Ejemplo de método Supports](supports-method-example-vj.md)
...
- [Ejemplo de propiedades Attributes y Name](attributes-and-name-properties-example-vj.md)
...
- [Ejemplo de las propiedades Description, HelpContext, HelpFile, NativeError, Number, Source y SQLState](description-helpcontext-helpfile-nativeerror-number-source-and-sqlstate-properties-example-vj.md)
...
- [Ejemplo de propiedad Item](item-property-example-vj.md)
...
- [Ejemplo de propiedad Prepared](prepared-property-example-vj.md)
- [Ejemplo de las propiedades Provider y DefaultDatabase](provider-and-defaultdatabase-properties-example-vj.md)
- [Ejemplo de propiedad Sort](sort-property-example-vj.md)
- [Ejemplo de propiedad Source](source-property-example-vj.md)
- [Ejemplo de propiedad State](state-property-example-vj.md)
...
- [Ejemplo de la propiedad Type (Fields)](https://docs.microsoft.com/office/vba/access/concepts/miscellaneous/type-property-example-fieldvj-plus-plus)
- [Ejemplo de la propiedad Type (Property)](https://docs.microsoft.com/office/vba/access/concepts/miscellaneous/type-property-example-propertyvj-plus-plus)

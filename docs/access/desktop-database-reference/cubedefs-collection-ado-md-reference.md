...
---
# <a name="cubedefs-collection-ado-md-reference"></a>Colección CubeDefs (referencia de ADO MD)

**Se aplica a**: Access 2013, Office 2013

- [CubeDefs (colección, ADO MD)](cubedefs-collection-ado-md.md)
- [Propiedades de la colección CubeDefs, métodos y eventos (ADO MD)](cubedefs-collection-properties-methods-and-events-ado-md.md)

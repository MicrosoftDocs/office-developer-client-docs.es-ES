...
ms.locfileid: "32301431"
---
# <a name="prepared-property-example-vc"></a><span data-ttu-id="c6c1b-102">Ejemplo de la propiedad Prepared (VC++)</span><span class="sxs-lookup"><span data-stu-id="c6c1b-102">Prepared property example (VC++)</span></span>


<span data-ttu-id="c6c1b-103">**Se aplica a:** Access 2013, Office 2013</span><span class="sxs-lookup"><span data-stu-id="c6c1b-103">**Applies to**: Access 2013, Office 2013</span></span>

<span data-ttu-id="c6c1b-104">En este ejemplo se muestra la propiedad [Prepared](prepared-property-ado.md) al abrir dos objetos [Command](command-object-ado.md), uno preparado y otro sin preparar.</span><span class="sxs-lookup"><span data-stu-id="c6c1b-104">This example demonstrates the [Prepared](prepared-property-ado.md) property by opening two [Command](command-object-ado.md) objects — one prepared and one not prepared.</span></span>

...
- [Ejemplo de los métodos Execute, Requery y Clear](execute-requery-and-clear-methods-example-vb.md)
...
- [Ejemplo de método SkipLine, propiedades EOS y LineSeparator](eos-and-lineseparator-properties-and-skipline-method-example-vb.md)
...
- [Ejemplo de los métodos Open y Close](open-and-close-methods-example-vb.md)
- [Ejemplo del método OpenSchema](openschema-method-example-vb.md)
- [Ejemplo de los métodos Read, ReadText, Write y WriteText](read-readtext-write-and-writetext-methods-example-vb.md)
...
- [Ejemplo de método Seek y propiedad Index](seek-method-and-index-property-example-vb.md)
...
- [Ejemplo de propiedades Attributes y Name](attributes-and-name-properties-example-vb.md)
...
- [Ejemplo de las propiedades Description, HelpContext, HelpFile, NativeError, Number, Source y SQLState](description-helpcontext-helpfile-nativeerror-number-source-and-sqlstate-properties-example-vb.md)
- [Propiedades EOS y LineSeparator, ejemplo del método SkipLine](eos-and-lineseparator-properties-and-skipline-method-example-vb.md)
...
- [Ejemplo de propiedad Item](item-property-example-vb.md)
...
- [Ejemplo de propiedad Sort](sort-property-example-vb.md)
- [Ejemplo de propiedad Source](source-property-example-vb.md)
- [Ejemplo de propiedad State](state-property-example-vb.md)
...
- [Ejemplo de la propiedad Type (Property)](type-property-example-property-vb.md)
- [Ejemplo de la propiedad Value](value-property-example-vb.md)
- [Ejemplo de propiedad Version](version-property-example-vb.md)

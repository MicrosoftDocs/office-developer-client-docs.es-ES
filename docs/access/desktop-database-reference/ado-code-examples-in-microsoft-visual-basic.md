...
- [Append y CreateParameter ejemplo de los métodos](append-and-createparameter-methods-example-vb.md)
...
- [Execute, Requery y Clear ejemplo de los métodos](execute-requery-and-clear-methods-example-vb.md)
...
- [Método SkipLine, EOS y ejemplo de las propiedades LineSeparator](eos-and-lineseparator-properties-and-skipline-method-example-vb.md)
...
- [Ejemplo de los métodos de lectura, ReadText, Write y WriteText](read-readtext-write-and-writetext-methods-example-vb.md)
- [Ejemplo del método Refresh](refresh-method-example-vb.md)
- [Ejemplo del método Resync](resync-method-example-vb.md)
- [Ejemplo de los métodos Open y Save](save-and-open-methods-example-vb.md)

...
<span data-ttu-id="ef45d-107">Una vez que se ha fabricado el objeto **Recordset,** se puede rellenar, manipular o conservar en un archivo.</span><span class="sxs-lookup"><span data-stu-id="ef45d-107">After the **Recordset** has been fabricated, it can be populated, manipulated, or persisted to a file.</span></span>

...
---
# <a name="keys-collection-adox-reference"></a>Referencia de claves (colección) (ADOX)

**Se aplica a**: Access 2013, Office 2013

- [Keys (colección, ADOX)](keys-collection-adox.md)
- [Eventos, métodos y propiedades de colección Keys (ADOX)](keys-collection-properties-methods-and-events-adox.md)

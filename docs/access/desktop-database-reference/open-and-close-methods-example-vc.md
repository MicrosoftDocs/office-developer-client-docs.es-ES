...
ms.locfileid: "25877201"
---
# <a name="open-and-close-methods-example-vc"></a><span data-ttu-id="bb5b4-102">Ejemplo de los métodos Open y Close (VC++)</span><span class="sxs-lookup"><span data-stu-id="bb5b4-102">Open and Close methods example (VC++)</span></span>


<span data-ttu-id="bb5b4-103">**Se aplica a**: Access 2013, Office 2013</span><span class="sxs-lookup"><span data-stu-id="bb5b4-103">**Applies to**: Access 2013, Office 2013</span></span>

<span data-ttu-id="bb5b4-104">En este ejemplo se usan los métodos **Open** y [Close](close-method-ado.md) en objetos [Recordset](recordset-object-ado.md) y [Connection](connection-object-ado.md) que se han abierto.</span><span class="sxs-lookup"><span data-stu-id="bb5b4-104">This example uses the **Open** and [Close](close-method-ado.md) methods on both [Recordset](recordset-object-ado.md) and [Connection](connection-object-ado.md) objects that have been opened.</span></span>
...
<span data-ttu-id="bb5b4-105">**OpenX.h**</span><span class="sxs-lookup"><span data-stu-id="bb5b4-105">**OpenX.h**</span></span>

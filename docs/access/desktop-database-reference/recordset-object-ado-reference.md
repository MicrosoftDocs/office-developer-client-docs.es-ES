...
---
# <a name="recordset-object-ado-reference"></a>Referencia de objeto Recordset (objeto) (ADO)

**Se aplica a**: Access 2013, Office 2013

- [Recordset (objeto, ADO)](recordset-object-ado.md)
- [Propiedades Recordset, métodos y eventos (ADO)](recordset-properties-methods-and-events-ado.md)

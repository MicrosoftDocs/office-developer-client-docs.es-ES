...
---
# <a name="indexes-append-method-example-vc"></a><span data-ttu-id="b6d87-102">Ejemplo del método Append de Indexes (VC++)</span><span class="sxs-lookup"><span data-stu-id="b6d87-102">Indexes Append method example (VC++)</span></span>


<span data-ttu-id="b6d87-103">**Se aplica a:** Access 2013, Office 2013</span><span class="sxs-lookup"><span data-stu-id="b6d87-103">**Applies to**: Access 2013, Office 2013</span></span>

<span data-ttu-id="b6d87-p101">El código siguiente muestra cómo crear un índice nuevo. El índice es para dos columnas de la tabla.</span><span class="sxs-lookup"><span data-stu-id="b6d87-p101">The following code demonstrates how to create a new index. The index is on two columns in the table.</span></span>

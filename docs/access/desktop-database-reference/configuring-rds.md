...
- [Concesión de privilegios de invitado a un equipo servidor web](granting-guest-privileges-to-a-web-server-computer;-rds-guest-privileges.md)
- [Marcado de objetos de negocio como seguros para el scripting](marking-business-objects-as-safe-for-scripting.md)
- [Registro de un objeto de negocio personalizado](https://docs.microsoft.com/office/vba/access/concepts/miscellaneous/registering-a-custom-business-object)

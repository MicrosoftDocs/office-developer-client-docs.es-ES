...
---
# <a name="save-and-open-methods-example-vc"></a>Ejemplo de los métodos Save y Open (VC++)


**Se aplica a**: Access 2013, Office 2013

En estos tres ejemplos se muestra cómo se pueden utilizar conjuntamente los métodos [Save](save-method-ado.md) y **Open**.

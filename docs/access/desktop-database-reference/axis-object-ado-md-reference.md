...
---
# <a name="axis-object-ado-md-reference"></a>Objeto Axis (referencia de ADO MD)

**Se aplica a**: Access 2013, Office 2013

- [Axis (objeto, ADO MD)](axis-object-ado-md.md)
- [Propiedades de eje, métodos y eventos (ADO MD)](axis-properties-methods-and-events-ado-md.md)

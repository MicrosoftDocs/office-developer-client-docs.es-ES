...
ms.locfileid: "25483547"
---
# <a name="resync-method-example-vc"></a><span data-ttu-id="3ee93-102">Ejemplo del método Resync (VC++)</span><span class="sxs-lookup"><span data-stu-id="3ee93-102">Resync Method Example (VC++)</span></span>


<span data-ttu-id="3ee93-103">**Se aplica a**: Access 2013 | Office 2013</span><span class="sxs-lookup"><span data-stu-id="3ee93-103">**Applies to**: Access 2013 | Office 2013</span></span>

<span data-ttu-id="3ee93-104">En este ejemplo se muestra cómo utilizar el método [Resync](resync-method-ado.md) para actualizar los datos de un conjunto de registros estático.</span><span class="sxs-lookup"><span data-stu-id="3ee93-104">This example demonstrates using the [Resync](resync-method-ado.md) method to refresh data in a static recordset.</span></span>

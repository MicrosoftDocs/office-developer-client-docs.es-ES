...
En este ejemplo se usa el método [Delete](delete-method-ado-recordset.md) para quitar un registro especificado de un objeto [Recordset](recordset-object-ado.md).

Utilice el ejemplo siguiente en una página Active Server (ASP).

Utilice **Buscar** para localizar el archivo Adovbs.inc y colocarlo en el directorio que desee usar. Corte y pegue el código siguiente en el Bloc de notas u otro editor de texto y guárdelo como **DeleteVBS.asp**. Podrá ver el resultado en cualquier explorador de cliente.

Para practicar con el ejemplo, prueba a utilizar primero el ejemplo de [AddNew](addnew-method-example-vbscript.md) para agregar algunos registros. A continuación, podrá probar a eliminarlos. Vea el resultado en cualquier explorador de cliente.

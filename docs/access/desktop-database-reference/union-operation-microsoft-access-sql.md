...
---
# <a name="union-operation-microsoft-access-sql"></a>UNION (operación de Microsoft Access SQL)
...
En este ejemplo, se recuperan los nombres y ciudades de todos los proveedores y clientes de Brasil.

...
ms.locfileid: "25486284"
---
# <a name="move-method-example-vj"></a><span data-ttu-id="60a39-102">Ejemplo del método Move (VJ++)</span><span class="sxs-lookup"><span data-stu-id="60a39-102">Move Method Example (VJ++)</span></span>


<span data-ttu-id="60a39-103">**Se aplica a**: Access 2013 | Office 2013</span><span class="sxs-lookup"><span data-stu-id="60a39-103">**Applies to**: Access 2013 | Office 2013</span></span>

<span data-ttu-id="60a39-104">En este ejemplo se utiliza el método [Move](move-method-ado.md) para ubicar el puntero de registros, basándose en los datos proporcionados por el usuario.</span><span class="sxs-lookup"><span data-stu-id="60a39-104">This example uses the [Move](move-method-ado.md) method to position the record pointer based on user input.</span></span>

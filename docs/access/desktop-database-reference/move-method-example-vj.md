---
title: Ejemplo del método Move (VJ++)
...
ms.locfileid: "25861508"
---
# <a name="move-method-example-vj"></a><span data-ttu-id="12c42-102">Ejemplo del método Move (VJ++)</span><span class="sxs-lookup"><span data-stu-id="12c42-102">Move method example (VJ++)</span></span>


<span data-ttu-id="12c42-103">**Se aplica a**: Access 2013 | Office 2013</span><span class="sxs-lookup"><span data-stu-id="12c42-103">**Applies to**: Access 2013 | Office 2013</span></span>

<span data-ttu-id="12c42-104">En este ejemplo se utiliza el método [Move](move-method-ado.md) para ubicar el puntero de registros, basándose en los datos proporcionados por el usuario.</span><span class="sxs-lookup"><span data-stu-id="12c42-104">This example uses the [Move](move-method-ado.md) method to position the record pointer based on user input.</span></span>

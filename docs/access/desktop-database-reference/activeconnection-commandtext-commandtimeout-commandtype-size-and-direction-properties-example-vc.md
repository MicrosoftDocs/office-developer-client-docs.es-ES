---
<span data-ttu-id="5778e-101"><<<<<<< Título HEAD: ActiveConnection, CommandText, CommandTimeout ejemplo de las propiedades (VC ++) TOCTitle: ActiveConnection, CommandText, CommandTimeout, CommandType, tamaño y ejemplo de las propiedades de dirección (VC ++) ms:assetid: 254e6d48-fc07-1df0-215C-a91141238985 ms:mtpsurl: https://msdn.microsoft.com/library/JJ249021(v=office.15) ms:contentKeyID: ms.date 48543780: 18/09/2015 mtps_version: Office.15</span><span class="sxs-lookup"><span data-stu-id="5778e-101"><<<<<<< HEAD title: ActiveConnection, CommandText, CommandTimeout Properties Example (VC++) TOCTitle: ActiveConnection, CommandText, CommandTimeout, CommandType, Size, and Direction Properties Example (VC++) ms:assetid: 254e6d48-fc07-1df0-215c-a91141238985 ms:mtpsurl: https://msdn.microsoft.com/library/JJ249021(v=office.15) ms:contentKeyID: 48543780 ms.date: 09/18/2015 mtps_version: v=office.15</span></span>
---

# <a name="activeconnection-commandtext-commandtimeout-commandtype-size-and-direction-properties-example-vc"></a><span data-ttu-id="5778e-102">Ejemplo de las propiedades ActiveConnection, CommandText, CommandTimeout, CommandType, Size y Direction (VC++)</span><span class="sxs-lookup"><span data-stu-id="5778e-102">ActiveConnection, CommandText, CommandTimeout, CommandType, Size, and Direction Properties Example (VC++)</span></span>

<span data-ttu-id="5778e-103">=== título: ActiveConnection, CommandText, CommandTimeout ejemplo de las propiedades (VC ++) TOCTitle: ms:assetid de ejemplo (VC ++) de las propiedades ActiveConnection, CommandText, CommandTimeout, CommandType, tamaño y dirección: 254e6d48-fc07-1df0-215C-a91141238985 ms:mtpsurl: https://msdn.microsoft.com/library/JJ249021(v=office.15) ms:contentKeyID: ms.date 48543780: 17/10/2018 mtps_version: Office.15</span><span class="sxs-lookup"><span data-stu-id="5778e-103">======= title: ActiveConnection, CommandText, CommandTimeout properties example (VC++) TOCTitle: ActiveConnection, CommandText, CommandTimeout, CommandType, Size, and Direction properties example (VC++) ms:assetid: 254e6d48-fc07-1df0-215c-a91141238985 ms:mtpsurl: https://msdn.microsoft.com/library/JJ249021(v=office.15) ms:contentKeyID: 48543780 ms.date: 10/17/2018 mtps_version: v=office.15</span></span>
---

# <a name="activeconnection-commandtext-commandtimeout-commandtype-size-and-direction-properties-example-vc"></a><span data-ttu-id="5778e-104">Ejemplo de las propiedades ActiveConnection, CommandText, CommandTimeout, CommandType, tamaño y Direction (VC ++)</span><span class="sxs-lookup"><span data-stu-id="5778e-104">ActiveConnection, CommandText, CommandTimeout, CommandType, Size, and Direction properties example (VC++)</span></span>
>>>>>>> <span data-ttu-id="5778e-105">master</span><span class="sxs-lookup"><span data-stu-id="5778e-105">master</span></span>

<span data-ttu-id="5778e-106">**Se aplica a**: Access 2013 | Office 2013</span><span class="sxs-lookup"><span data-stu-id="5778e-106">**Applies to**: Access 2013 | Office 2013</span></span>

<span data-ttu-id="5778e-107">En este ejemplo se utilizan las propiedades [ActiveConnection](activeconnection-property-ado.md), [CommandText](commandtext-property-ado.md), [CommandTimeout](commandtimeout-property-ado.md), [CommandType](commandtype-property-ado.md), [Size](size-property-ado.md) y [Direction](direction-property-ado.md) para ejecutar un procedimiento almacenado.</span><span class="sxs-lookup"><span data-stu-id="5778e-107">This example uses the [ActiveConnection](activeconnection-property-ado.md), [CommandText](commandtext-property-ado.md), [CommandTimeout](commandtimeout-property-ado.md), [CommandType](commandtype-property-ado.md), [Size](size-property-ado.md), and [Direction](direction-property-ado.md) properties to execute a stored procedure.</span></span>
...
<span data-ttu-id="5778e-108">**ActiveConnectionX.h**</span><span class="sxs-lookup"><span data-stu-id="5778e-108">**ActiveConnectionX.h**</span></span>

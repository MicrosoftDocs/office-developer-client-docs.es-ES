...
Por ejemplo, el *comando principal* podría devolver un **conjunto de registros** de clientes para una compañía desde una tabla Customers y el *comando secundario* podría devolver un **conjunto de registros** de pedidos correspondientes a todos los clientes desde una tabla Orders.
...
Para obtener información acerca de la navegación por un **Recordset** jerárquico, vea [Obtener acceso a filas en un Recordset jerárquico](accessing-rows-in-a-hierarchical-recordset.md).

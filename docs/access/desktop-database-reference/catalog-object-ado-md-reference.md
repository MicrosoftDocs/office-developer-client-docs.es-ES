...
---
# <a name="catalog-object-ado-md-reference"></a>Catalog (objeto, referencia de ADO MD)

**Se aplica a:** Access 2013, Office 2013

- [Catalog (objeto) (ADO MD)](catalog-object-ado-md.md)
- [Propiedades, métodos y eventos del catálogo (ADO MD)](catalog-properties-methods-and-events-ado-md.md)

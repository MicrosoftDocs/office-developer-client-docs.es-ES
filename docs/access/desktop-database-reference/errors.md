...
Toda operación que implique a objetos de ADO puede generar errores de proveedor. Cuando se produce alguno de estos errores, se colocan objetos **Error** en la colección **Errors** del objeto **Connection**. Para obtener detalles acerca del tratamiento de advertencias y errores en una aplicación de ADO, vea el [Capítulo 6: Tratamiento de errores](chapter-6-error-handling.md).

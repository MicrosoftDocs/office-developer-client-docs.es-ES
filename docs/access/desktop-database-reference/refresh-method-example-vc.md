...
ms.locfileid: "32309251"
---
# <a name="refresh-method-example-vc"></a><span data-ttu-id="16efe-102">Ejemplo del método Refresh (VC++)</span><span class="sxs-lookup"><span data-stu-id="16efe-102">Refresh method example (VC++)</span></span>
...
<span data-ttu-id="16efe-104">En este ejemplo se muestra cómo utilizar el método [Refresh](refresh-method-ado.md) para actualizar la colección [Parameters](parameters-collection-ado.md) de un objeto [Command](command-object-ado.md) de un procedimiento almacenado.</span><span class="sxs-lookup"><span data-stu-id="16efe-104">This example demonstrates using the [Refresh](refresh-method-ado.md) method to refresh the [Parameters](parameters-collection-ado.md) collection for a stored procedure [Command](command-object-ado.md) object.</span></span>
...
<span data-ttu-id="16efe-105">**RefreshX. h**</span><span class="sxs-lookup"><span data-stu-id="16efe-105">**RefreshX.h**</span></span>

...
## <a name="typical-connection-string"></a><span data-ttu-id="8e8e7-108">Cadena de conexión típica</span><span class="sxs-lookup"><span data-stu-id="8e8e7-108">Typical Connection String</span></span>
...
<tr class="odd">
<td><p><span data-ttu-id="8e8e7-121"><strong>Password</strong> o <strong>pwd</strong></span><span class="sxs-lookup"><span data-stu-id="8e8e7-121"><strong>Password</strong> or <strong>pwd</strong></span></span></p></td>
...
<td><p><span data-ttu-id="8e8e7-p103">Indica un nombre de idioma de SQL Server. Identifica el idioma utilizado para la selección de mensajes del sistema y el formato. El idioma debe estar instalado en el servidor SQL Server, de lo contrario, se producirá un error al establecer la conexión.</span><span class="sxs-lookup"><span data-stu-id="8e8e7-p103">Indicates a SQL Server language name. Identifies the language used for system message selection and formatting. The language must be installed on the SQL Server, otherwise opening the connection will fail.</span></span></p></td>
</tr>
<tr class="odd">
...
<tr class="even">
<td><p><span data-ttu-id="8e8e7-157">Application Name</span><span class="sxs-lookup"><span data-stu-id="8e8e7-157">Application Name</span></span></p></td>
...
## <a name="dynamic-properties"></a><span data-ttu-id="8e8e7-179">Propiedades dinámicas</span><span class="sxs-lookup"><span data-stu-id="8e8e7-179">Dynamic Properties</span></span>
...
<td><p><span data-ttu-id="8e8e7-216">DBPROP_DBMSVER</span><span class="sxs-lookup"><span data-stu-id="8e8e7-216">DBPROP_DBMSVER</span></span></p></td>
</tr>
<tr class="odd">
...
<tr class="odd">
<td><p><span data-ttu-id="8e8e7-237">Maximum Row Size Includes BLOB</span><span class="sxs-lookup"><span data-stu-id="8e8e7-237">Maximum Row Size Includes BLOB</span></span></p></td>
...
<td><p><span data-ttu-id="8e8e7-280">DBPROP_PROVIDERFRIENDLYNAME</span><span class="sxs-lookup"><span data-stu-id="8e8e7-280">DBPROP_PROVIDERFRIENDLYNAME</span></span></p></td>
</tr>
<tr class="odd">
...
<tr class="odd">
<td><p><span data-ttu-id="8e8e7-301">Transaction DDL</span><span class="sxs-lookup"><span data-stu-id="8e8e7-301">Transaction DDL</span></span></p></td>
...
<tr class="odd">
<td><p><span data-ttu-id="8e8e7-317">Bookmark Type</span><span class="sxs-lookup"><span data-stu-id="8e8e7-317">Bookmark Type</span></span></p></td>
...
<tr class="odd">
<td><p><span data-ttu-id="8e8e7-380">Notification Phases</span><span class="sxs-lookup"><span data-stu-id="8e8e7-380">Notification Phases</span></span></p></td>
...
<td><p><span data-ttu-id="8e8e7-423">DBPROP_NOTIFYROWUNDOINSERT</span><span class="sxs-lookup"><span data-stu-id="8e8e7-423">DBPROP_NOTIFYROWUNDOINSERT</span></span></p></td>
</tr>
<tr class="odd">
...
<tr class="odd">
<td><p><span data-ttu-id="8e8e7-460">Column Privileges</span><span class="sxs-lookup"><span data-stu-id="8e8e7-460">Column Privileges</span></span></p></td>
...
<td><p><span data-ttu-id="8e8e7-501">DBPROP_IRowsetResynch</span><span class="sxs-lookup"><span data-stu-id="8e8e7-501">DBPROP_IRowsetResynch</span></span></p></td>
</tr>
<tr class="even">
<td><p><span data-ttu-id="8e8e7-502">IRowsetScroll</span><span class="sxs-lookup"><span data-stu-id="8e8e7-502">IRowsetScroll</span></span></p></td>
<td><p><span data-ttu-id="8e8e7-503">DBPROP_IRowsetScroll</span><span class="sxs-lookup"><span data-stu-id="8e8e7-503">DBPROP_IRowsetScroll</span></span></p></td>
</tr>
<tr class="odd">
<td><p><span data-ttu-id="8e8e7-504">IRowsetUpdate</span><span class="sxs-lookup"><span data-stu-id="8e8e7-504">IRowsetUpdate</span></span></p></td>
<td><p><span data-ttu-id="8e8e7-505">DBPROP_IRowsetUpdate</span><span class="sxs-lookup"><span data-stu-id="8e8e7-505">DBPROP_IRowsetUpdate</span></span></p></td>
</tr>
<tr class="even">
<td><p><span data-ttu-id="8e8e7-506">ISequentialStream</span><span class="sxs-lookup"><span data-stu-id="8e8e7-506">ISequentialStream</span></span></p></td>
<td><p><span data-ttu-id="8e8e7-507">DBPROP_ISequentialStream</span><span class="sxs-lookup"><span data-stu-id="8e8e7-507">DBPROP_ISequentialStream</span></span></p></td>
</tr>
<tr class="odd">
<td><p><span data-ttu-id="8e8e7-508">ISupportErrorInfo</span><span class="sxs-lookup"><span data-stu-id="8e8e7-508">ISupportErrorInfo</span></span></p></td>
<td><p><span data-ttu-id="8e8e7-509">DBPROP_ISupportErrorInfo</span><span class="sxs-lookup"><span data-stu-id="8e8e7-509">DBPROP_ISupportErrorInfo</span></span></p></td>
</tr>
<tr class="even">
<td><p><span data-ttu-id="8e8e7-510">Literal Bookmarks</span><span class="sxs-lookup"><span data-stu-id="8e8e7-510">Literal Bookmarks</span></span></p></td>
<td><p><span data-ttu-id="8e8e7-511">DBPROP_LITERALBOOKMARKS</span><span class="sxs-lookup"><span data-stu-id="8e8e7-511">DBPROP_LITERALBOOKMARKS</span></span></p></td>
</tr>
<tr class="odd">
<td><p><span data-ttu-id="8e8e7-512">Literal Row Identity</span><span class="sxs-lookup"><span data-stu-id="8e8e7-512">Literal Row Identity</span></span></p></td>
<td><p><span data-ttu-id="8e8e7-513">DBPROP_LITERALIDENTITY</span><span class="sxs-lookup"><span data-stu-id="8e8e7-513">DBPROP_LITERALIDENTITY</span></span></p></td>
</tr>
<tr class="even">
<td><p><span data-ttu-id="8e8e7-514">Lock Mode</span><span class="sxs-lookup"><span data-stu-id="8e8e7-514">Lock Mode</span></span></p></td>
<td><p><span data-ttu-id="8e8e7-515">DBPROP_LOCKMODE</span><span class="sxs-lookup"><span data-stu-id="8e8e7-515">DBPROP_LOCKMODE</span></span></p></td>
</tr>
<tr class="odd">
<td><p><span data-ttu-id="8e8e7-516">Maximum Open Rows</span><span class="sxs-lookup"><span data-stu-id="8e8e7-516">Maximum Open Rows</span></span></p></td>
<td><p><span data-ttu-id="8e8e7-517">DBPROP_MAXOPENROWS</span><span class="sxs-lookup"><span data-stu-id="8e8e7-517">DBPROP_MAXOPENROWS</span></span></p></td>
</tr>
<tr class="even">
<td><p><span data-ttu-id="8e8e7-518">Maximum Pending Rows</span><span class="sxs-lookup"><span data-stu-id="8e8e7-518">Maximum Pending Rows</span></span></p></td>
<td><p><span data-ttu-id="8e8e7-519">DBPROP_MAXPENDINGROWS</span><span class="sxs-lookup"><span data-stu-id="8e8e7-519">DBPROP_MAXPENDINGROWS</span></span></p></td>
</tr>
<tr class="odd">
<td><p><span data-ttu-id="8e8e7-520">Maximum Rows</span><span class="sxs-lookup"><span data-stu-id="8e8e7-520">Maximum Rows</span></span></p></td>
<td><p><span data-ttu-id="8e8e7-521">DBPROP_MAXROWS</span><span class="sxs-lookup"><span data-stu-id="8e8e7-521">DBPROP_MAXROWS</span></span></p></td>
</tr>
<tr class="even">
<td><p><span data-ttu-id="8e8e7-522">Notification Granularity</span><span class="sxs-lookup"><span data-stu-id="8e8e7-522">Notification Granularity</span></span></p></td>
<td><p><span data-ttu-id="8e8e7-523">DBPROP_NOTIFICATIONGRANULARITY</span><span class="sxs-lookup"><span data-stu-id="8e8e7-523">DBPROP_NOTIFICATIONGRANULARITY</span></span></p></td>
</tr>
<tr class="odd">
<td><p><span data-ttu-id="8e8e7-524">Notification Phases</span><span class="sxs-lookup"><span data-stu-id="8e8e7-524">Notification Phases</span></span></p></td>
<td><p><span data-ttu-id="8e8e7-525">DBPROP_NOTIFICATIONPHASES</span><span class="sxs-lookup"><span data-stu-id="8e8e7-525">DBPROP_NOTIFICATIONPHASES</span></span></p></td>
</tr>
<tr class="even">
<td><p><span data-ttu-id="8e8e7-526">Objects Transacted</span><span class="sxs-lookup"><span data-stu-id="8e8e7-526">Objects Transacted</span></span></p></td>
<td><p><span data-ttu-id="8e8e7-527">DBPROP_TRANSACTEDOBJECT</span><span class="sxs-lookup"><span data-stu-id="8e8e7-527">DBPROP_TRANSACTEDOBJECT</span></span></p></td>
</tr>
<tr class="odd">
<td><p><span data-ttu-id="8e8e7-528">Others' Changes Visible</span><span class="sxs-lookup"><span data-stu-id="8e8e7-528">Others' Changes Visible</span></span></p></td>
<td><p><span data-ttu-id="8e8e7-529">DBPROP_OTHERUPDATEDELETE</span><span class="sxs-lookup"><span data-stu-id="8e8e7-529">DBPROP_OTHERUPDATEDELETE</span></span></p></td>
</tr>
<tr class="even">
<td><p><span data-ttu-id="8e8e7-530">Others' Inserts Visible</span><span class="sxs-lookup"><span data-stu-id="8e8e7-530">Others' Inserts Visible</span></span></p></td>
<td><p><span data-ttu-id="8e8e7-531">DBPROP_OTHERINSERT</span><span class="sxs-lookup"><span data-stu-id="8e8e7-531">DBPROP_OTHERINSERT</span></span></p></td>
</tr>
<tr class="odd">
<td><p><span data-ttu-id="8e8e7-532">Output Encoding Property</span><span class="sxs-lookup"><span data-stu-id="8e8e7-532">Output Encoding Property</span></span></p></td>
<td><p><span data-ttu-id="8e8e7-533">DBPROP_OUTPUTENCODING</span><span class="sxs-lookup"><span data-stu-id="8e8e7-533">DBPROP_OUTPUTENCODING</span></span></p></td>
</tr>
<tr class="even">
<td><p><span data-ttu-id="8e8e7-534">Output Stream Property</span><span class="sxs-lookup"><span data-stu-id="8e8e7-534">Output Stream Property</span></span></p></td>
<td><p><span data-ttu-id="8e8e7-535">DBPROP_OUTPUTSTREAM</span><span class="sxs-lookup"><span data-stu-id="8e8e7-535">DBPROP_OUTPUTSTREAM</span></span></p></td>
</tr>
<tr class="odd">
<td><p><span data-ttu-id="8e8e7-536">Own Changes Visible</span><span class="sxs-lookup"><span data-stu-id="8e8e7-536">Own Changes Visible</span></span></p></td>
<td><p><span data-ttu-id="8e8e7-537">DBPROP_OWNUPDATEDELETE</span><span class="sxs-lookup"><span data-stu-id="8e8e7-537">DBPROP_OWNUPDATEDELETE</span></span></p></td>
</tr>
<tr class="even">
<td><p><span data-ttu-id="8e8e7-538">Own Inserts Visible</span><span class="sxs-lookup"><span data-stu-id="8e8e7-538">Own Inserts Visible</span></span></p></td>
<td><p><span data-ttu-id="8e8e7-539">DBPROP_OWNINSERT</span><span class="sxs-lookup"><span data-stu-id="8e8e7-539">DBPROP_OWNINSERT</span></span></p></td>
</tr>
<tr class="odd">
<td><p><span data-ttu-id="8e8e7-540">Preserve on Abort</span><span class="sxs-lookup"><span data-stu-id="8e8e7-540">Preserve on Abort</span></span></p></td>
<td><p><span data-ttu-id="8e8e7-541">DBPROP_ABORTPRESERVE</span><span class="sxs-lookup"><span data-stu-id="8e8e7-541">DBPROP_ABORTPRESERVE</span></span></p></td>
</tr>
<tr class="even">
<td><p><span data-ttu-id="8e8e7-542">Preserve on Commit</span><span class="sxs-lookup"><span data-stu-id="8e8e7-542">Preserve on Commit</span></span></p></td>
<td><p><span data-ttu-id="8e8e7-543">DBPROP_COMMITPRESERVE</span><span class="sxs-lookup"><span data-stu-id="8e8e7-543">DBPROP_COMMITPRESERVE</span></span></p></td>
</tr>
<tr class="odd">
<td><p><span data-ttu-id="8e8e7-544">Quick Restart</span><span class="sxs-lookup"><span data-stu-id="8e8e7-544">Quick Restart</span></span></p></td>
<td><p><span data-ttu-id="8e8e7-545">DBPROP_QUICKRESTART</span><span class="sxs-lookup"><span data-stu-id="8e8e7-545">DBPROP_QUICKRESTART</span></span></p></td>
</tr>
<tr class="even">
<td><p><span data-ttu-id="8e8e7-546">Reentrant Events</span><span class="sxs-lookup"><span data-stu-id="8e8e7-546">Reentrant Events</span></span></p></td>
<td><p><span data-ttu-id="8e8e7-547">DBPROP_REENTRANTEVENTS</span><span class="sxs-lookup"><span data-stu-id="8e8e7-547">DBPROP_REENTRANTEVENTS</span></span></p></td>
</tr>
<tr class="odd">
<td><p><span data-ttu-id="8e8e7-548">Remove Deleted Rows</span><span class="sxs-lookup"><span data-stu-id="8e8e7-548">Remove Deleted Rows</span></span></p></td>
<td><p><span data-ttu-id="8e8e7-549">DBPROP_REMOVEDELETED</span><span class="sxs-lookup"><span data-stu-id="8e8e7-549">DBPROP_REMOVEDELETED</span></span></p></td>
</tr>
<tr class="even">
<td><p><span data-ttu-id="8e8e7-550">Report Multiple Changes</span><span class="sxs-lookup"><span data-stu-id="8e8e7-550">Report Multiple Changes</span></span></p></td>
<td><p><span data-ttu-id="8e8e7-551">DBPROP_REPORTMULTIPLECHANGES</span><span class="sxs-lookup"><span data-stu-id="8e8e7-551">DBPROP_REPORTMULTIPLECHANGES</span></span></p></td>
</tr>
<tr class="odd">
<td><p><span data-ttu-id="8e8e7-552">Return Pending Inserts</span><span class="sxs-lookup"><span data-stu-id="8e8e7-552">Return Pending Inserts</span></span></p></td>
<td><p><span data-ttu-id="8e8e7-553">DBPROP_RETURNPENDINGINSERTS</span><span class="sxs-lookup"><span data-stu-id="8e8e7-553">DBPROP_RETURNPENDINGINSERTS</span></span></p></td>
</tr>
<tr class="even">
<td><p><span data-ttu-id="8e8e7-554">Row Delete Notification</span><span class="sxs-lookup"><span data-stu-id="8e8e7-554">Row Delete Notification</span></span></p></td>
<td><p><span data-ttu-id="8e8e7-555">DBPROP_NOTIFYROWDELETE</span><span class="sxs-lookup"><span data-stu-id="8e8e7-555">DBPROP_NOTIFYROWDELETE</span></span></p></td>
</tr>
<tr class="odd">
<td><p><span data-ttu-id="8e8e7-556">Row First Change Notification</span><span class="sxs-lookup"><span data-stu-id="8e8e7-556">Row First Change Notification</span></span></p></td>
<td><p><span data-ttu-id="8e8e7-557">DBPROP_NOTIFYROWFIRSTCHANGE</span><span class="sxs-lookup"><span data-stu-id="8e8e7-557">DBPROP_NOTIFYROWFIRSTCHANGE</span></span></p></td>
</tr>
<tr class="even">
<td><p><span data-ttu-id="8e8e7-558">Row Insert Notification</span><span class="sxs-lookup"><span data-stu-id="8e8e7-558">Row Insert Notification</span></span></p></td>
<td><p><span data-ttu-id="8e8e7-559">DBPROP_NOTIFYROWINSERT</span><span class="sxs-lookup"><span data-stu-id="8e8e7-559">DBPROP_NOTIFYROWINSERT</span></span></p></td>
</tr>
<tr class="odd">
<td><p><span data-ttu-id="8e8e7-560">Row Privileges</span><span class="sxs-lookup"><span data-stu-id="8e8e7-560">Row Privileges</span></span></p></td>
<td><p><span data-ttu-id="8e8e7-561">DBPROP_ROWRESTRICT</span><span class="sxs-lookup"><span data-stu-id="8e8e7-561">DBPROP_ROWRESTRICT</span></span></p></td>
</tr>
<tr class="even">
<td><p><span data-ttu-id="8e8e7-562">Row Resynchronization Notification</span><span class="sxs-lookup"><span data-stu-id="8e8e7-562">Row Resynchronization Notification</span></span></p></td>
<td><p><span data-ttu-id="8e8e7-563">DBPROP_NOTIFYROWRESYNCH</span><span class="sxs-lookup"><span data-stu-id="8e8e7-563">DBPROP_NOTIFYROWRESYNCH</span></span></p></td>
</tr>
<tr class="odd">
<td><p><span data-ttu-id="8e8e7-564">Row Threading Model</span><span class="sxs-lookup"><span data-stu-id="8e8e7-564">Row Threading Model</span></span></p></td>
<td><p><span data-ttu-id="8e8e7-565">DBPROP_ROWTHREADMODEL</span><span class="sxs-lookup"><span data-stu-id="8e8e7-565">DBPROP_ROWTHREADMODEL</span></span></p></td>
</tr>
<tr class="even">
<td><p><span data-ttu-id="8e8e7-566">Row Undo Change Notification</span><span class="sxs-lookup"><span data-stu-id="8e8e7-566">Row Undo Change Notification</span></span></p></td>
<td><p><span data-ttu-id="8e8e7-567">DBPROP_NOTIFYROWUNDOCHANGE</span><span class="sxs-lookup"><span data-stu-id="8e8e7-567">DBPROP_NOTIFYROWUNDOCHANGE</span></span></p></td>
</tr>
<tr class="odd">
<td><p><span data-ttu-id="8e8e7-568">Row Undo Delete Notification</span><span class="sxs-lookup"><span data-stu-id="8e8e7-568">Row Undo Delete Notification</span></span></p></td>
<td><p><span data-ttu-id="8e8e7-569">DBPROP_NOTIFYROWUNDODELETE</span><span class="sxs-lookup"><span data-stu-id="8e8e7-569">DBPROP_NOTIFYROWUNDODELETE</span></span></p></td>
</tr>
<tr class="even">
<td><p><span data-ttu-id="8e8e7-570">Row Undo Insert Notification</span><span class="sxs-lookup"><span data-stu-id="8e8e7-570">Row Undo Insert Notification</span></span></p></td>
<td><p><span data-ttu-id="8e8e7-571">DBPROP_NOTIFYROWUNDOINSERT</span><span class="sxs-lookup"><span data-stu-id="8e8e7-571">DBPROP_NOTIFYROWUNDOINSERT</span></span></p></td>
</tr>
<tr class="odd">
<td><p><span data-ttu-id="8e8e7-572">Row Update Notification</span><span class="sxs-lookup"><span data-stu-id="8e8e7-572">Row Update Notification</span></span></p></td>
<td><p><span data-ttu-id="8e8e7-573">DBPROP_NOTIFYROWUPDATE</span><span class="sxs-lookup"><span data-stu-id="8e8e7-573">DBPROP_NOTIFYROWUPDATE</span></span></p></td>
</tr>
<tr class="even">
<td><p><span data-ttu-id="8e8e7-574">Rowset Fetch Position Change Notification</span><span class="sxs-lookup"><span data-stu-id="8e8e7-574">Rowset Fetch Position Change Notification</span></span></p></td>
<td><p><span data-ttu-id="8e8e7-575">DBPROP_NOTIFYROWSETFETCHPOSITIONCHANGE</span><span class="sxs-lookup"><span data-stu-id="8e8e7-575">DBPROP_NOTIFYROWSETFETCHPOSITIONCHANGE</span></span></p></td>
</tr>
<tr class="odd">
<td><p><span data-ttu-id="8e8e7-576">Rowset Release Notification</span><span class="sxs-lookup"><span data-stu-id="8e8e7-576">Rowset Release Notification</span></span></p></td>
<td><p><span data-ttu-id="8e8e7-577">DBPROP_NOTIFYROWSETRELEASE</span><span class="sxs-lookup"><span data-stu-id="8e8e7-577">DBPROP_NOTIFYROWSETRELEASE</span></span></p></td>
</tr>
<tr class="even">
<td><p><span data-ttu-id="8e8e7-578">Scroll Backwards</span><span class="sxs-lookup"><span data-stu-id="8e8e7-578">Scroll Backwards</span></span></p></td>
<td><p><span data-ttu-id="8e8e7-579">DBPROP_CANSCROLLBACKWARDS</span><span class="sxs-lookup"><span data-stu-id="8e8e7-579">DBPROP_CANSCROLLBACKWARDS</span></span></p></td>
</tr>
<tr class="odd">
<td><p><span data-ttu-id="8e8e7-580">Server Cursor</span><span class="sxs-lookup"><span data-stu-id="8e8e7-580">Server Cursor</span></span></p></td>
<td><p><span data-ttu-id="8e8e7-581">DBPROP_SERVERCURSOR</span><span class="sxs-lookup"><span data-stu-id="8e8e7-581">DBPROP_SERVERCURSOR</span></span></p></td>
</tr>
<tr class="even">
<td><p><span data-ttu-id="8e8e7-582">Server Data on Insert</span><span class="sxs-lookup"><span data-stu-id="8e8e7-582">Server Data on Insert</span></span></p></td>
<td><p><span data-ttu-id="8e8e7-583">DBPROP_SERVERDATAONINSERT</span><span class="sxs-lookup"><span data-stu-id="8e8e7-583">DBPROP_SERVERDATAONINSERT</span></span></p></td>
</tr>
<tr class="odd">
<td><p><span data-ttu-id="8e8e7-584">Skip Deleted Bookmarks</span><span class="sxs-lookup"><span data-stu-id="8e8e7-584">Skip Deleted Bookmarks</span></span></p></td>
<td><p><span data-ttu-id="8e8e7-585">DBPROP_BOOKMARKSKIP</span><span class="sxs-lookup"><span data-stu-id="8e8e7-585">DBPROP_BOOKMARKSKIP</span></span></p></td>
</tr>
<tr class="even">
<td><p><span data-ttu-id="8e8e7-586">Strong Row Identity</span><span class="sxs-lookup"><span data-stu-id="8e8e7-586">Strong Row Identity</span></span></p></td>
<td><p><span data-ttu-id="8e8e7-587">DBPROP_STRONGIDENTITY</span><span class="sxs-lookup"><span data-stu-id="8e8e7-587">DBPROP_STRONGIDENTITY</span></span></p></td>
</tr>
<tr class="odd">
<td><p><span data-ttu-id="8e8e7-588">Updatability</span><span class="sxs-lookup"><span data-stu-id="8e8e7-588">Updatability</span></span></p></td>
<td><p><span data-ttu-id="8e8e7-589">DBPROP_UPDATABILITY</span><span class="sxs-lookup"><span data-stu-id="8e8e7-589">DBPROP_UPDATABILITY</span></span></p></td>
</tr>
<tr class="even">
<td><p><span data-ttu-id="8e8e7-590">Use Bookmarks</span><span class="sxs-lookup"><span data-stu-id="8e8e7-590">Use Bookmarks</span></span></p></td>
<td><p><span data-ttu-id="8e8e7-591">DBPROP_BOOKMARKS</span><span class="sxs-lookup"><span data-stu-id="8e8e7-591">DBPROP_BOOKMARKS</span></span></p></td>
</tr>
<tr class="odd">
<td><p><span data-ttu-id="8e8e7-592">XML Root</span><span class="sxs-lookup"><span data-stu-id="8e8e7-592">XML Root</span></span></p></td>
<td><p><span data-ttu-id="8e8e7-593">SSPROP_STREAM_XMLROOT</span><span class="sxs-lookup"><span data-stu-id="8e8e7-593">SSPROP_STREAM_XMLROOT</span></span></p></td>
</tr>
<tr class="even">
<td><p><span data-ttu-id="8e8e7-594">XSL</span><span class="sxs-lookup"><span data-stu-id="8e8e7-594">XSL</span></span></p></td>
<td><p><span data-ttu-id="8e8e7-595">SSPROP_STREAM_XSL</span><span class="sxs-lookup"><span data-stu-id="8e8e7-595">SSPROP_STREAM_XSL</span></span></p></td>
</tr>
</tbody>
</table>


<span data-ttu-id="8e8e7-596">Para obtener detalles específicos sobre la implementación e información funcional acerca de Proveedor de Microsoft OLE DB para SQL Server, vea la documentación del Proveedor OLE DB para SQL Server de la sección OLE DB del paquete MDAC SDK.</span><span class="sxs-lookup"><span data-stu-id="8e8e7-596">For specific implementation details and functional information about the Microsoft SQL Server OLE DB Provider, consult the OLE DB Provider for SQL Server documentation in the OLE DB section of the MDAC SDK.</span></span>

---
title: Ejemplo de colección paraMeters, propiedad comando (VC + +)
...
---
# <a name="parameters-collection-command-property-example-vc"></a><span data-ttu-id="f332f-102">Ejemplo de colección paraMeters, propiedad comando (VC + +)</span><span class="sxs-lookup"><span data-stu-id="f332f-102">Parameters Collection, Command property example (VC++)</span></span>


<span data-ttu-id="f332f-103">**Se aplica a:** Access 2013, Office 2013</span><span class="sxs-lookup"><span data-stu-id="f332f-103">**Applies to**: Access 2013, Office 2013</span></span>

<span data-ttu-id="f332f-104">El código siguiente muestra cómo utilizar la propiedad [Comando](command-property-adox.md) con el objeto [Command](command-object-ado.md) para recuperar información de parámetros para el procedimiento.</span><span class="sxs-lookup"><span data-stu-id="f332f-104">The following code demonstrates how to use the [Command](command-property-adox.md) property with the [Command](command-object-ado.md) object to retrieve parameter information for the procedure.</span></span>

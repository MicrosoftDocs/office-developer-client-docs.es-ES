...
Cuando se produce el evento **Después de eliminar**, los valores contenidos en el registro eliminado siguen estando disponibles. Es posible que desee usar un valor eliminado para incrementar o disminuir un total, crear un seguimiento de auditoría o compararlo con un valor existente en un *argumento WhereCondition.*

---
<<<<<<< Título HEAD: BOF, EOF y ejemplo de las propiedades Bookmark (VJ ++) TOCTitle: BOF, EOF y ejemplo de las propiedades Bookmark (VJ ++) === título: ejemplo de las propiedades BOF, EOF y Bookmark (VJ ++) TOCTitle: las propiedades BOF, EOF y Bookmark ejemplo (VJ ++)
>>>>>>> Master ms:assetid: 68e6fcc5-506a-9064-3e7c-9ce3d64371aa ms:mtpsurl: https://msdn.microsoft.com/library/JJ249412(v=office.15) ms:contentKeyID: ms.date 48545400: 18/09/2015 mtps_version: Office.15
---

<<<<<<< HEAD
# <a name="bof-eof-and-bookmark-properties-example-vj"></a>Ejemplo de las propiedades BOF, EOF y Bookmark (VJ++)
=======
# <a name="bof-eof-and-bookmark-properties-example-vj"></a>Ejemplo de las propiedades BOF, EOF y Bookmark (VJ ++)
>>>>>>> master

...
---
# <a name="ado-code-examples-in-microsoft-visual-c-access"></a>Ejemplos de código de ADO en Microsoft Visual C++ (acceso)
...
**Se aplica a**: Access 2013 | Office 2013
  ...
  - [Ejemplo del modelo de eventos de ADO (VC++)](ado-events-model-example-vc.md)
  ...
  - [Ejemplo de la propiedad Número máximo de registros (MaxRecords) (VC++)](maxrecords-property-example-vc.md)

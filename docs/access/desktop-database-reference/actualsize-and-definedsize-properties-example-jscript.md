...
---
# <a name="actualsize-and-definedsize-properties-example-jscript"></a><span data-ttu-id="a53e4-102">Ejemplo de las propiedades ActualSize y DefinedSize (JScript)</span><span class="sxs-lookup"><span data-stu-id="a53e4-102">ActualSize and DefinedSize properties example (JScript)</span></span>

<span data-ttu-id="a53e4-103">**Se aplica a:** Access 2013, Office 2013</span><span class="sxs-lookup"><span data-stu-id="a53e4-103">**Applies to**: Access 2013, Office 2013</span></span>

<span data-ttu-id="a53e4-p101">En este ejemplo se utilizan las propiedades [ActualSize](actualsize-property-ado.md) y [DefinedSize](definedsize-property-ado.md) para mostrar el tamaño definido y el tamaño real de un campo. Corte y pegue el código siguiente en Bloc de notas u otro editor de texto, y guárdelo como **ActualSizeJS.asp**.</span><span class="sxs-lookup"><span data-stu-id="a53e4-p101">This example uses the [ActualSize](actualsize-property-ado.md) and [DefinedSize](definedsize-property-ado.md) properties to display the defined size and actual size of a field. Cut and paste the following code to Notepad or another text editor, and save it as **ActualSizeJS.asp**.</span></span>

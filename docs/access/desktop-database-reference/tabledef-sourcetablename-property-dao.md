...
En este ejemplo se usan las propiedades **Connect** y **SourceTableName** para vincular diversas tablas externas a una base de datos de Microsoft Access. Para que este procedimiento se ejecute se necesita el procedimiento ConnectOutput.

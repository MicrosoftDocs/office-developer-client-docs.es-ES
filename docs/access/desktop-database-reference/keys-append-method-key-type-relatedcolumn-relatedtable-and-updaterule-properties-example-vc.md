...
---
# <a name="keys-append-method-key-type-relatedcolumn-relatedtable-and-updaterule-properties-example-vc"></a>Ejemplo de las propiedades Keys Append Method, Key Type, RelatedColumn, RelatedTable y UpdateRule (VC++)

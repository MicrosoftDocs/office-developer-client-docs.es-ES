...
En este documento, se supone que se tiene un conocimiento práctico del lenguaje de programación Visual Basic y conocimientos generales de ADO y de OLAP. Para obtener más información, consulte la [Guía del programador de ADO](ado-programmer-s-guide.md) y OLE DB para la referencia del programador de OLAP. 

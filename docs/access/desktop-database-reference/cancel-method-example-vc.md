...
ms.locfileid: "28710142"
---
# <a name="cancel-method-example-vc"></a><span data-ttu-id="54028-102">Ejemplo del método Cancel (VC++)</span><span class="sxs-lookup"><span data-stu-id="54028-102">Cancel method example (VC++)</span></span>


<span data-ttu-id="54028-103">**Se aplica a**: Access 2013, Office 2013</span><span class="sxs-lookup"><span data-stu-id="54028-103">**Applies to**: Access 2013, Office 2013</span></span>

<span data-ttu-id="54028-104">En este ejemplo se utiliza el método [Cancel](cancel-method-ado.md) para cancelar un comando que se ejecuta en un objeto [Connection](connection-object-ado.md) si la conexión está ocupada.</span><span class="sxs-lookup"><span data-stu-id="54028-104">This example uses the [Cancel](cancel-method-ado.md) method to cancel a command executing on a [Connection](connection-object-ado.md) object if the connection is busy.</span></span>

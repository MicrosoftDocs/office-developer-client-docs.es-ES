...
*AdReason*de RecordsetChangeComplete, *perror*, adStatus, *pRecordset* **
...
Los eventos **WillChangeRecordset** o **RecordsetChangeComplete** pueden ocurrir debido a los métodos [Open](open-method-ado-recordset.md) o Requery del **objeto Recordset** [](requery-method-ado.md) .

...
ms.locfileid: "25928365"
---
# <a name="procedures-collection-adox-reference"></a>Referencia de procedimientos (colección) (ADOX)

**Se aplica a**: Access 2013, Office 2013

- [Procedures (colección, ADOX)](procedures-collection-adox.md)
- [Eventos, métodos y propiedades de colección Procedures (ADOX)](procedures-collection-properties-methods-and-events-adox.md)

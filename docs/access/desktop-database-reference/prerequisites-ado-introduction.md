...
---
# <a name="prerequisites-ado-introduction"></a>Requisitos previos (introducción de ADO)

**Se aplica a:** Access 2013, Office 2013

La *guía del programador de ADO* será útil para desarrolladores con una amplia variedad de fondos. Como mínimo, los lectores deben tener un nivel intermedio de experiencia en el desarrollo de aplicaciones con Microsoft Visual Basic, ya que la mayoría de los ejemplos de la guía están escritos en este lenguaje. Otros ejemplos se escriben en Microsoft Visual C++, Java, Visual Basic, Scripting Edition (VBScript) y Microsoft JScript.
...
ADO forma parte de la estrategia Microsoft Data Access (UDA) (para obtener más información acerca de UDA, vea "El papel de ADO en Microsoft Data Access", más adelante en este capítulo). (Para obtener más información acerca de UDA, vea [The Role of ADO in Microsoft Data Access](the-role-of-ado-in-microsoft-data-access.md), más adelante en este capítulo). Por lo tanto, interopera con la tecnología OLE DB. OLE DB se basa en el modelo de objetos de componentes de Microsoft (COM). Por tanto, estar familiarizado con COM también puede ser útil para comprender algunos de los conceptos más avanzados en ADO.

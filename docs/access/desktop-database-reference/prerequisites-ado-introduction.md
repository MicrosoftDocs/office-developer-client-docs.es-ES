...
La *guía del programador de ADO será* útil para desarrolladores con una amplia variedad de antecedentes. Como mínimo, los lectores deben tener un nivel intermedio de experiencia en el desarrollo de aplicaciones con Microsoft Visual Basic, ya que la mayoría de los ejemplos de la guía están escritos en este lenguaje. Otros ejemplos están escritos en Microsoft Visual C++, Java, Visual Basic, Scripting Edition (VBScript) y Microsoft JScript.

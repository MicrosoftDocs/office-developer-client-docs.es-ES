...
<span data-ttu-id="13072-110">Parte del código simplemente refleja el estilo de codificación.</span><span class="sxs-lookup"><span data-stu-id="13072-110">Some of the code simply reflects coding style.</span></span>

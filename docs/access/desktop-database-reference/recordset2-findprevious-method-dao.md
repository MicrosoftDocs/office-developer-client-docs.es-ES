...
*expresión* . FindPrevious(***Criteria***)
...
> [!NOTE]
> - Para obtener un mejor rendimiento, los criterios *** deben tener el formato *"* valor de campo " donde campo es un campo indizado en la tabla base subyacente o " prefijo LIKE " donde campo es un campo indizado en la tabla base subyacente y prefijo es una cadena de búsqueda de prefijo  =  (por ejemplo, "ART*").     

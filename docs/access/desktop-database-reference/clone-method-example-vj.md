...
ms.locfileid: "25879546"
---
# <a name="clone-method-example-vj"></a><span data-ttu-id="d4989-102">Ejemplo del método Clone (VJ++)</span><span class="sxs-lookup"><span data-stu-id="d4989-102">Clone method example (VJ++)</span></span>


<span data-ttu-id="d4989-103">**Se aplica a**: Access 2013, Office 2013</span><span class="sxs-lookup"><span data-stu-id="d4989-103">**Applies to**: Access 2013, Office 2013</span></span>

<span data-ttu-id="d4989-104">En este ejemplo se usa el método [Clone](clone-method-ado.md) para crear copias de un [conjunto de registros](recordset-object-ado.md) y, después, se deja que el usuario coloque el puntero de registros de cada copia de manera independiente.</span><span class="sxs-lookup"><span data-stu-id="d4989-104">This example uses the [Clone](clone-method-ado.md) method to create copies of a [Recordset](recordset-object-ado.md) and then lets the user position the record pointer of each copy independently.</span></span>

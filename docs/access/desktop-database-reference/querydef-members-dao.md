...
---
# <a name="querydef-members-dao"></a>Miembros de QueryDef (DAO)
...
<td><p>Devuelve una colección <strong><a href="fields-collection-dao.md">Fields</a></strong> que representa todos los objetos <strong><a href="field-object-dao.md">Field</a></strong> almacenados para el objeto especificado. Solo lectura.</p></td>
</tr>
<tr class="odd">
...
<td><p>Establece o devuelve un valor que indica el tipo operativo o el tipo de datos de un objeto. InTeger de<strong></strong>sólo lectura.</p></td>
</tr>
<tr class="odd">

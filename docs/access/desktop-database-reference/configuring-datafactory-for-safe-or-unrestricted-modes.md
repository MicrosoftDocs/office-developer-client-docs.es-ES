...
Después de ejecutar handsafe.reg o handunsf.reg, debe detener y reiniciar world wide web publishing service en el servidor web escribiendo los siguientes comandos en una ventana de comandos: "NET STOP W3SVC" y "NET START W3SVC".

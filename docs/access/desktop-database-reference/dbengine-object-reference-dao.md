...
---
# <a name="dbengine-object-reference-dao"></a>Referencia al objeto DBEngine (DAO)

**Se aplica a**: Access 2013, Office 2013

- [Objeto DBEngine (DAO)](dbengine-object-dao.md)
- [DBEngine (miembros) (DAO)](dbengine-members-dao.md)
- [Propiedades DBEngine (DAO)](dbengine-properties-dao.md)
- [Métodos de DBEngine (DAO)](dbengine-methods-dao.md)

...
---
# <a name="refresh-method-ado"></a><span data-ttu-id="1ef05-102">Método Refresh (ADO)</span><span class="sxs-lookup"><span data-stu-id="1ef05-102">Refresh method (ADO)</span></span>

<span data-ttu-id="1ef05-103">**Se aplica a:** Access 2013, Office 2013</span><span class="sxs-lookup"><span data-stu-id="1ef05-103">**Applies to**: Access 2013, Office 2013</span></span>

<span data-ttu-id="1ef05-104">Actualiza los objetos de una colección para reflejar los objetos disponibles y específicos del proveedor.</span><span class="sxs-lookup"><span data-stu-id="1ef05-104">Updates the objects in a collection to reflect objects available from, and specific to, the provider.</span></span>

## <a name="syntax"></a><span data-ttu-id="1ef05-105">Sintaxis</span><span class="sxs-lookup"><span data-stu-id="1ef05-105">Syntax</span></span>

<span data-ttu-id="1ef05-106">*colección*. Actualizar</span><span class="sxs-lookup"><span data-stu-id="1ef05-106">*collection*.Refresh</span></span>

## <a name="remarks"></a><span data-ttu-id="1ef05-107">Comentarios</span><span class="sxs-lookup"><span data-stu-id="1ef05-107">Remarks</span></span>

<span data-ttu-id="1ef05-108">El método **Refresh** realiza diferentes tareas según la colección desde la que se llame al método.</span><span class="sxs-lookup"><span data-stu-id="1ef05-108">The **Refresh** method accomplishes different tasks depending on the collection from which you call it.</span></span>

## <a name="parameters"></a><span data-ttu-id="1ef05-109">Parámetros</span><span class="sxs-lookup"><span data-stu-id="1ef05-109">Parameters</span></span>

<span data-ttu-id="1ef05-p101">Si se usa el método **Refresh** en la colección [Parameters](command-object-ado.md) de un objeto [Command](parameters-collection-ado.md), se recupera la información de parámetros del proveedor para el procedimiento almacenado o la consulta parametrizada especificada en el objeto **Command**. La colección estará vacía para los proveedores que no admitan llamadas a procedimientos almacenados o consultas parametrizadas.</span><span class="sxs-lookup"><span data-stu-id="1ef05-p101">Using the **Refresh** method on a [Command](command-object-ado.md) object's [Parameters](parameters-collection-ado.md) collection retrieves provider-side parameter information for the stored procedure or parameterized query specified in the **Command** object. The collection will be empty for providers that do not support stored procedure calls or parameterized queries.</span></span>

...
---
# <a name="sortorder-property-adox"></a>Propiedad SortOrder (ADOX)
...
Esta propiedad sólo se aplica a objetos [Column](column-object-adox.md) de la colección [Columns](columns-collection-adox.md) de un [índice](index-object-adox.md).

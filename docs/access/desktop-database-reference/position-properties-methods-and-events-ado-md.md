...
---
# <a name="position-properties-methods-and-events-ado-md"></a>Posición propiedades, métodos y eventos (ADO MD)

**Se aplica a**: Access 2013, Office 2013

## <a name="propertiescollections"></a>Propiedades y colecciones

- [Colección Members](members-collection-ado-md.md)
- [Ordinal (propiedad, posición)](ordinal-property-ado-md-position.md)

...
- [Ejemplo de método Delete](delete-method-example-vc.md)
...
- [Ejemplo de método Seek y propiedad Index](seek-method-and-index-property-example-vc.md)
- [Ejemplo de método Supports](supports-method-example-vc.md)
...
- [Ejemplo de propiedad Item](item-property-example-vc.md)
...
- [Ejemplo de propiedad Sort](sort-property-example-vc.md)
- [Ejemplo de propiedad Source](source-property-example-vc.md)
- [Ejemplo de propiedad State](state-property-example-vc.md)
...
- [Ejemplo de la propiedad Type (Property)](type-property-example-property-vc.md)

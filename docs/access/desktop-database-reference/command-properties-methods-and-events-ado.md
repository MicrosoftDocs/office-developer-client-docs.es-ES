...
---
# <a name="command-properties-methods-and-events-ado"></a>Propiedades de comandos, métodos y eventos (ADO)
...
- [Parameters (colección)](parameters-collection-ado.md)
- [Prepared (propiedad)](prepared-property-ado.md)
...
- [Método Execute (comando ADO)](https://docs.microsoft.com/office/vba/access/concepts/miscellaneous/execute-method-ado-command)

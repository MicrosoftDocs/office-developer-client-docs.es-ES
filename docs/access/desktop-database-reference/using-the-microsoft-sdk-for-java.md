...
3.  <span data-ttu-id="f11ed-124">Para utilizar estos archivos, abra un proyecto en Visual J++.</span><span class="sxs-lookup"><span data-stu-id="f11ed-124">To use these files, open your project in Visual J++.</span></span> <span data-ttu-id="f11ed-125">En el menú **Proyecto**, elija **Agregar al proyecto**.</span><span class="sxs-lookup"><span data-stu-id="f11ed-125">From the **Project** menu, choose **Add To Project**.</span></span> <span data-ttu-id="f11ed-126">Seleccione **archivos**y agregue todos los. Archivos de JAVA generados en las bibliotecas de confianza\\directory msado15 a su proyecto.</span><span class="sxs-lookup"><span data-stu-id="f11ed-126">Select **Files**, and add all of the .JAVA files generated in the trustlib\\msado15 directory to your project.</span></span>

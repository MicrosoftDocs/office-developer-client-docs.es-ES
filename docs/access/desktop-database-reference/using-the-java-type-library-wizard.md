...
El Asistente para bibliotecas de tipos de Java genera las clases en la \\ \<siguiente ubicación\>\\:\\Windows\\Directory de Windows trustlib msado15. El archivo Summary.txt, ubicado en el directorio donde se han generado las clases, muestra las definiciones de clase generadas.
...
**Para ejecutar el Asistente para bibliotecas de tipos de Java desde Visual J++ versión 1. ****
...
3.  Para utilizar estos archivos, abra un proyecto en Visual J++. En el menú **Proyecto**, elija **Agregar al proyecto**. Seleccione **archivos**y agregue todos los. Archivos JAVA generados en \\el directorio trustlib (de forma predeterminada,\\en\\c\\:\\WinNT Java trustlib msado15) en el proyecto.

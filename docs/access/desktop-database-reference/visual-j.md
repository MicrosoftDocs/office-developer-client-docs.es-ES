...
A continuación, la función *principal* crea un objeto **Connection** y habilita el control de eventos llamando al método **addOnConnectComplete** y pasándole la dirección de la función de *controlador*.

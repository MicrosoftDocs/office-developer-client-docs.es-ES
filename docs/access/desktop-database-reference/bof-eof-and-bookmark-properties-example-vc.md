...
---
# <a name="bof-eof-and-bookmark-properties-example-vc"></a><span data-ttu-id="07e51-102">Ejemplo de las propiedades BOF, EOF y Bookmark (VC++)</span><span class="sxs-lookup"><span data-stu-id="07e51-102">BOF, EOF, and Bookmark properties example (VC++)</span></span>


<span data-ttu-id="07e51-103">**Se aplica a:** Access 2013, Office 2013</span><span class="sxs-lookup"><span data-stu-id="07e51-103">**Applies to**: Access 2013, Office 2013</span></span>

<span data-ttu-id="07e51-p101">La primera función de este ejemplo usa las propiedades [BOF](bof-eof-properties-ado.md) y [EOF](bof-eof-properties-ado.md) para mostrar un mensaje si un usuario intenta moverse hasta un punto situado más allá del primer registro o del último registro de un objeto [Recordset](recordset-object-ado.md). Usa la propiedad [Bookmark](bookmark-property-ado.md) para que el usuario pueda marcar un registro de un objeto **Recordset** y volver al mismo más adelante.</span><span class="sxs-lookup"><span data-stu-id="07e51-p101">The first function in this example uses the [BOF](bof-eof-properties-ado.md) and [EOF](bof-eof-properties-ado.md) properties to display a message if a user tries to move past the first or last record of a [Recordset](recordset-object-ado.md). It uses the [Bookmark](bookmark-property-ado.md) property to let the user flag a record in a **Recordset** and return to it later.</span></span>

<span data-ttu-id="07e51-106">La segunda función utiliza la propiedad Bookmark para colocar el **marcador** de cada dos registros de un objeto **Recordset** en una matriz y, a continuación, filtra el objeto Recordset mediante la matriz.</span><span class="sxs-lookup"><span data-stu-id="07e51-106">The second function uses the Bookmark property to place the **Bookmark** of every other record from a **Recordset** into an array, and then filters the Recordset using the array.</span></span>
...
<span data-ttu-id="07e51-107">**BofEofBookmark.h**</span><span class="sxs-lookup"><span data-stu-id="07e51-107">**BofEofBookmark.h**</span></span>

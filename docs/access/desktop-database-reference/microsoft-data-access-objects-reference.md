...
---
# <a name="microsoft-data-access-objects-reference"></a>Microsoft Data Access Objects reference
...
- [Base de datos](database-object-reference-dao.md)
...
- [Documentos](documents-object-reference-dao.md)
- [Error](error-object-reference-dao.md)
- [Errores](errors-object-reference-dao.md)
- [Field](field-object-reference-dao.md)
- [Field2](field2-object-reference-dao.md)
- [Fields](fields-object-reference-dao.md)
- [Índice](index-object-reference-dao.md)
- [Indexes](indexes-object-reference-dao.md)
- [Parámetro](parameter-object-reference-dao.md)
- [Parámetros](parameters-object-reference-dao.md)
- [Propiedades](properties-object-reference-dao.md)
- [Propiedad](property-object-reference-dao.md)
...
- [Relación](relation-object-reference-dao.md)
...
- [Enumeraciones (referencia DAO)](enumerations-dao-reference.md)

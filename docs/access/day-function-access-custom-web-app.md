...
---
# <a name="day-function-access-custom-web-app"></a>Función Day (aplicación web personalizada de Access)

Devuelve un entero que representa el día (el día del mes) de la fecha especificada en el calendario gregoriano.
...
La función **Day** contiene el siguiente argumento. 

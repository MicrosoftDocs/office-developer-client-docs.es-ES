...
Devuelve un valor de hora basado en partes especificadas.
...
La **función TimeFromParts** contiene los argumentos siguientes. 
 ...
 **TimeFromParts** devuelve un valor de hora completamente inicializado. Si los argumentos no son válidos, se genera un error. Si alguno de los parámetros es null, se devuelve null. 

...
---
# <a name="rundatamacro-macro-action-access-custom-web-app"></a>EjecutarMacroDeDatos (aplicación web personalizada de Access)

Puede usar la acción **EjecutarMacroDeDatos** para ejecutar una macro de datos independiente. 

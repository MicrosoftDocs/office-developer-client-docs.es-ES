...
Combina dos condiciones. Devuelve TRUE cuando se cumple alguna de las dos condiciones.
...
Cuando se usa más de un operador lógico en una instrucción, **o** los operadores se evalúan después de **los operadores And.** Sin embargo, puede cambiar el orden de evaluación mediante paréntesis. 

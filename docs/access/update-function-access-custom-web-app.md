...
Devuelve si se intentó realizar una operación INSERT o UPDATE en el campo especificado.
...
La **función Update** devuelve TRUE independientemente de si un intento insert o UPDATE es correcto. 

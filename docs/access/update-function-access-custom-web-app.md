...
Devuelve si se intentó realizar una operación de inserción o actualización en el campo especificado.
 ...
 **Actualización** de (*Columna*) 
  
La función **Update** contiene los siguientes argumentos. 
  
|**Nombre de argumento**|**Descripción**|
|:-----|:-----|
| *Column*  <br/> |Nombre del campo en el que se busca una operación de inserción o actualización.  <br/> |
   
## <a name="remarks"></a>Comentarios

La función **Update** devuelve true independientemente de si un intento de inserción o actualización se ha realizado correctamente. 

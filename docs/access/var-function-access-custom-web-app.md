...
Devuelve la varianza estadística de una muestra de población representada como un conjunto de valores contenidos en un campo especificado de una consulta.
 ...
 **Var** sólo se puede usar con columnas numéricas. Los valores nulos se omiten. 

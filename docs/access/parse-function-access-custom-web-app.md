...
Analiza un valor de texto y devuelve su valor en un tipo determinado utilizando la referencia cultural de la aplicación.
 ...
 **Análisis** (*TextExpression*, *DataType*) 
  
La **** función Parse contiene los siguientes argumentos. 
...
Use **Parse** Only para convertir de cadena en tipos de número, fecha y hora. Para las conversiones de tipo generales, use la función **Convert** . Tenga en cuenta que hay una cierta sobrecarga en el rendimiento al analizar el valor de cadena. 

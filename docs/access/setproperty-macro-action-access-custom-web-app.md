...
---
# <a name="setproperty-macro-action-access-custom-web-app"></a>Acción de macro SetProperty (aplicación web personalizada de Access)

Puede usar la acción **SetProperty** para establecer una propiedad para un control en una vista. 
...
La **acción SetProperty** tiene los argumentos enumerados en la tabla siguiente. 
...
Puede usar la acción **SetProperty** para establecer las siguientes propiedades de un control: 

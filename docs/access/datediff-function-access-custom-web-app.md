...
Devuelve el recuento de los límites de la parte de fecha especificados cruzados entre la fecha de inicio y la fecha de finalización especificadas.
...
La **función DateDiff** contiene los argumentos siguientes. 

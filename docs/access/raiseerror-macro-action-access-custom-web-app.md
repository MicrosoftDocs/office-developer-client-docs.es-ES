...
---
# <a name="raiseerror-macro-action-access-custom-web-app"></a>Acción de macro Provocarerror (aplicación web personalizada de Access)
...
Cuando se llama a la acción **provocarerror** , se deshacen todas las operaciones de la transacción actual. 

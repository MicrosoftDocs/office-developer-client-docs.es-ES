...
---
# <a name="max-function-access-custom-web-app"></a>Función Max (aplicación web personalizada de Access)

Devuelve el valor máximo de la expresión de una consulta o tabla.

---
title: DeleteRecord (acción de macro) (aplicación web personalizada de Access)
manager: kelbow
ms.date: 09/05/2017
...
---
# <a name="deleterecord-macro-action-access-custom-web-app"></a>DeleteRecord (acción de macro) (aplicación web personalizada de Access)

...
|**flPrintOuts** <br/> |2,5  <br/> |Establece dónde se archivarán las copias impresas de la impresora de OneNote.  <br/> |
...
|**hePages** <br/> |8,5  <br/> |Hace referencia a los elementos de la página.  <br/> |
...
|**nfoNoWacUrl** <br/> |8,5  <br/> |Cualquier Bloc de notas en ubicaciones que no tienen un cliente web.  <br/> |
...
|**piBinaryDataFileType** <br/> |2,5  <br/> |Devuelve el contenido de la página con información de tipo de archivo para objetos de datos binarios y objetos de datos binarios  <br/> |
|**piSelectionFileType** <br/> |6,5  <br/> |Devuelve el contenido de la página con marcado de selección y la información de tipo de archivo de los datos binarios.  <br/> |
|**piAll** <br/> |0,7  <br/> |Devuelve todo el contenido de la página.  <br/> |
...
|**pfWord** <br/> |2,5  <br/> |La página publicada está en formato. doc o. docx.  <br/> |
|**pfEMF** <br/> |6,5  <br/> |La página publicada está en formato de metarchivo mejorado (. EMF).  <br/> |
|**pfHTML** <br/> |0,7  <br/> |La página publicada está en formato. html. Este miembro es nuevo en OneNote 2013.  <br/> |
|**pfOneNote2007** <br/> |8,5  <br/> |La página publicada está en el formato 2007. One. Este miembro es nuevo en OneNote 2013.  <br/> |

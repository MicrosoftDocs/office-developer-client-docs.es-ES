...
Cuando se pasa al método **OpenHierarchy,** especifica el tipo de objeto que se va a crear, si lo hay, si la ruta de acceso pasada al método aún no existe. 
...
|**cftFolder** <br/> |2   <br/> |Crea un grupo de secciones con el nombre y la ubicación especificados.  <br/> |
|**cftSection** <br/> |3   <br/> |Crea una sección con el nombre y la ubicación especificados.  <br/> |
   
## <a name="docklocation"></a>DockLocation
<a name="odc_CreateFileType"> </a>

Indica la ubicación acoplada de una ventana de OneNote 2013 mediante la interfaz [de ventana.](window-interfaces-onenote.md) Cuando se establece en **la propiedad DockedLocation,** especifica la ubicación en la que se acopla una ventana de OneNote. Esta enumeración es nueva en OneNote 2013. 
  
|**Miembro**|**Valor**|**Descripción**|
|:-----|:-----|:-----|
|**dlDefault** <br/> |-1  <br/> |La ventana de OneNote está acoplada en la ubicación predeterminada del escritorio.  <br/> |
...
|**Miembro**|**Valor**|**Descripción**|
|:-----|:-----|:-----|
|**flEMail** <br/> |0  <br/> |Establece dónde se van a presentar los mensajes de correo electrónico de Outlook.  <br/> |
|**flContacts** <br/> |1   <br/> |Establece dónde se van a presentar los contactos de Outlook.  <br/> |
|**flTasks** <br/> |2   <br/> |Establece dónde se van a presentar las tareas de Outlook.  <br/> |
|**flMeetings** <br/> |3   <br/> |Establece dónde se van a presentar las reuniones de Outlook.  <br/> |
|**flWebContent** <br/> |4   <br/> |Establece dónde se va a presentar el contenido de Internet Explorer.  <br/> |
|**flPrintOuts** <br/> |5   <br/> |Establece dónde se van a presentar las copias impresas de la impresora de OneNote.  <br/> |
   
## <a name="filinglocationtype"></a>FilingLocationType
<a name="odc_CreateFileType"> </a>

Cuando se pasa al **método SetFilingLocation,** especifica dónde se va a presentar el contenido que se envía a OneNote. Esta enumeración es nueva en OneNote 2013. 
...
|**fltCurrentSectionNewPage** <br/> |1   <br/> |Establece el contenido que se va a presentar en una nueva página de la sección actual.  <br/> |
...
Cuando se pasa al **método GetHierarchy,** especifica el nivel más bajo que se debe obtener en la jerarquía de nodos del bloc de notas. 
  
|**Miembro**|**Valor**|**Descripción**|
|:-----|:-----|:-----|
|**hsSelf** <br/> |0  <br/> |Obtiene solo el nodo de inicio especificado y ningún descendiente.  <br/> |
|**hsChildren** <br/> |1   <br/> |Obtiene los nodos secundarios inmediatos del nodo de inicio y no hay descendientes en grupos de subsección superiores o inferiores.  <br/> |
|**hsNotebooks** <br/> |2   <br/> |Obtiene todos los blocs de notas debajo del nodo de inicio o raíz.  <br/> |
|**hsSections** <br/> |3   <br/> |Obtiene todas las secciones debajo del nodo de inicio, incluidas las secciones de los grupos de secciones y los grupos de subsección.  <br/> |
|**hsPages** <br/> |4   <br/> |Obtiene todas las páginas debajo del nodo de inicio, incluidas todas las páginas de los grupos de secciones y los grupos de subsección.  <br/> |
...
Cuando se pasa al método **NotebookFilterOut** del objeto **ELEMENTD,** especifica los blocs de notas que se mostrarán cuando se represente el cuadro ESTAD. 
  
|**Miembro**|**Valor**|**Descripción**|
|:-----|:-----|:-----|
|**nfoLocal** <br/> |1   <br/> |Permitir solo blocs de notas locales.  <br/> |
|**nfoNetwork** <br/> |2   <br/> |Permite blocs de notas unc o de SharePoint.  <br/> |
|**nfoWeb** <br/> |4   <br/> |Permite blocs de notas de OneDrive.  <br/> |
...
|**Miembro**|**Valor**|**Descripción**|
|:-----|:-----|:-----|
|**piBasic** <br/> |0  <br/> |Devuelve solo el contenido de página básico, sin marcado de selección, tipos de archivo para objetos de datos binarios y objetos de datos binarios. Este es el valor estándar que se debe pasar.  <br/> |
...
|**piBinaryDataSelection** <br/> |3   <br/> |Devuelve el contenido de la página con el marcado de selección y todos los datos binarios.  <br/> |
...
|**pfWord** <br/> |5   <br/> |La página publicada tiene el formato .doc o .docx.  <br/> |
|**pfEMF** <br/> |6   <br/> |La página publicada está en el formato de metarchivo mejorado (.emf).  <br/> |
|**pfHTML** <br/> |7   <br/> |La página publicada tiene el formato .html. Este miembro es nuevo en OneNote 2013.  <br/> |
...
Cuando se pasa al **método TreeCollapsedState** del objeto **GLID,** especifica si el árbol de jerarquía debe expandirse o contraerse. 
...
Cuando se pasa a uno de los métodos siguientes, especifica la versión del esquema XML de OneNote que se usará:

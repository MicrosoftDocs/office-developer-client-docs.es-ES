...
---
# <a name="quick-filing-dialog-box-interfaces-onenote"></a>Interfaces de cuadro de diálogo de archivado rápido (OneNote)

En este tema se describen las interfaces que puede usar para personalizar mediante programación el cuadro de diálogo Archivado rápido en OneNote 2013.
  
## <a name="quick-filing-dialog-box"></a>Cuadro de diálogo Archivado rápido

El cuadro de diálogo Archivado rápido de OneNote 2013 es un cuadro de diálogo personalizable que permite a los usuarios seleccionar una ubicación dentro de la estructura jerárquica de OneNote. Las ubicaciones seleccionables incluyen blocs de notas, grupos de secciones, secciones, páginas y subpáginas. El cuadro de diálogo se usa tanto en la aplicación de OneNote como en aplicaciones externas a través de la API de OneNote 2013. La figura 1 muestra el cuadro de diálogo Archivado rápido en su estado predeterminado.
  
**Figura 1. Cuadro de diálogo Archivado rápido sin personalizaciones**

![Cuadro de diálogo Archivado rápido sin personalizaciones]Cuadro de diálogo(media/ON15Con_quick_filing_dialog.jpg "Archivado rápido sin personalizaciones")
...
|||
|:-----|:-----|
|**Descripción** <br/> |Establece qué lista de resultados recientes se mostrará en el cuadro de diálogo Archivado rápido e indica si se deben incluir algunas ubicaciones de archivado especiales en la lista. Los usuarios pueden seleccionar una lista de resultados recientes de la [enumeración RecentResultType.](enumerations-onenote-developer-reference.md#odc_RecentResultType) Los usuarios también pueden elegir agregar las siguientes opciones a la lista: Sección actual, Página actual o Notas sin archivo. Si **recentResultType.rrtNone** está seleccionado, no se muestra ninguna lista de resultados recientes.  <br/> |
...
|**Parámetros** <br/> | _recentResults_ &ndash; Objeto de tipo **RecentResultType** que indica qué lista de resultados recientes, si la hay, debe aparecer. Si **se selecciona rrtNone,** no aparece ninguna lista de resultados reciente en el cuadro de diálogo.<br/><br/>  _fShowCurrentSection_ &ndash; Valor booleano que indica si la sección actual debe incluirse en la lista de resultados recientes.<br/><br/>  _fShowCurrentPage_ &ndash; Un valor booleano que indica si la página actual debe incluirse en la lista de resultados recientes.<br/><br/>  _fShowUnfiledNotes_ &ndash; Un valor booleano que indica si la sección Notas sin archivo debe incluirse en la lista de resultados recientes.  <br/> |
   
> [!NOTE]
> Si no se puede seleccionar una ubicación de archivado especial mediante cualquiera de los botones del cuadro de diálogo, no se muestra en la lista. Si no se encuentra ningún elemento seleccionable en la lista de resultados recientes, no se muestra ninguna lista de resultados recientes. 
  
En el siguiente ejemplo se usa el **método SetRecentResults** para mostrar la sección actual, la página actual y la sección Notas sin archivo en la lista de resultados recientes. 
...
|**Parámetros** <br/> | _bstrText_ &ndash; Cadena que especifica el texto que se mostrará en el botón. Para personalizar el botón **Aceptar** predeterminado, pase un valor nulo como **bstrText**.  <br/><br/>_allowedElements_ &ndash; Elemento **HierarchyElement** que indica qué elementos de jerarquía de OneNote que no son de solo lectura que un usuario puede seleccionar con el botón. Para seleccionar varios elementos, el usuario debe pasar el operador **OR** para todos los valores equivalentes uint de los tipos **HierarchyElement** permitidos como **HierarchyElement**.<br/><br/>  _allowedReadOnlyElements_ &ndash; Elemento **HierarchyElement** que indica qué elementos de jerarquía de solo lectura de OneNote puede seleccionar un usuario mediante el botón. Para seleccionar varios elementos, el usuario debe pasar el operador **OR** para todos los valores **equivalentes uint** de los tipos **HierarchyElement** permitidos como **HierarchyElement**.<br/><br/>  _fDefault_ &ndash; Valor booleano que especifica si este botón debe ser el botón predeterminado. Si se establecen varios botones como predeterminados, el último botón especificado se convierte en el botón predeterminado.  <br/> |
   
En el siguiente ejemplo se agregan tres botones al cuadro de diálogo Archivado rápido. Todos los elementos del árbol jerárquicos de OneNote pueden seleccionar el primero, Todos. Los demás, **Blocs de notas** **y** páginas, solo se pueden seleccionar si se seleccionan sus elementos correspondientes, Blocs de notas y páginas.
...
|||
|:-----|:-----|
|**Descripción** <br/> |Muestra el cuadro de diálogo Archivado rápido de un nuevo subproceso. Toma una referencia a la interfaz **IQuickFilingDialogCallback,** cuyo **método OnDialogClosed** se llamará una vez que se cierre el cuadro de diálogo.  <br/> |
|**Sintaxis** <br/> | `HRESULT Run (`<br/>`[in]IQuickFilingDialogCallback piCallback);` <br/> |
|**Parámetros** <br/> | _piCallback_ &ndash; Una referencia a la **interfaz IQuickFilingDialogCallback** a la que se crearán instancias una vez que se cierre el cuadro de diálogo.  <br/> |
   
En el siguiente ejemplo se usa **el método Run** para mostrar el cuadro de diálogo De archivado rápido de un nuevo subproceso. 
...
|||
|:-----|:-----|
|**Descripción** <br/> |Agrega un usuario como editor inicial a un bloc de notas en el cuadro de diálogo Archivado rápido.  <br/> |
|**Sintaxis** <br/> | `HRESULT AddInitialEditor (BSTR initialEditor);` <br/> |
|**Parámetros** <br/> | _initialEditor:_ la dirección de correo electrónico del usuario que desea agregar como editor al bloc de notas. Cuando el bloc de notas se crea mediante el cuadro de diálogo Archivado rápido, se comparte automáticamente con todos los editores iniciales.  <br/> |
   
**ClearInitialEditors**

|||
|:-----|:-----|
|**Descripción** <br/> |Quita todos los editores iniciales del cuadro de diálogo Archivado rápido.  <br/> |
...
|||
|:-----|:-----|
|**Descripción** <br/> |Muestra el hipervínculo del tema de ayuda para uso compartido en el cuadro de diálogo Archivado rápido.  <br/> |
...
|||
|:-----|:-----|
|**Descripción** <br/> |Permite a los usuarios agregar funcionalidad para capturar y usar la selección de usuario desde el cuadro de diálogo. Se llama a este método después de cerrar el cuadro de diálogo Archivado rápido. Este método es una función que las interfaces **IQuickFilingDialogCallback** tienen que definir.  <br/> |
|**Sintaxis** <br/> | `HRESULT OnDialogClosed (`<br/>`[in]IQuickFilingDialog dialog);` <br/> |
|**Parámetros** <br/> | _dialog_ &ndash; Objeto **IQuickFilingDialog** que llamó al **método OnDialogClose.**  <br/> |
   
El siguiente ejemplo es una interfaz **de ejemplo IQuickFilingDialogCallback.** El **método OnDialogClose** imprime la selección del usuario del cuadro de diálogo Archivado rápido en la consola. 

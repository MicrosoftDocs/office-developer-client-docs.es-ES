...
Obtenga contenido sobre procedimientos, código de ejemplo, documentación de SDK y API, referencias de VBA, cursos y artículos técnicos para desarrollar soluciones y personalizar Word.
...
- [Referencia de VBA para Word](https://docs.microsoft.com/office/vba/api/overview/word)
...
- [Introducción a los complementos de Word](https://docs.microsoft.com/office/dev/add-ins/quickstarts/word-quickstart)
